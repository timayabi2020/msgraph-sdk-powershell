...
```
Test-MgGroupProperty -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
 [-DisplayName <String>] [-MailNickname <String>] [-OnBehalfOfUserId <String>] [-CustomHeader <String>]

...
### Preview (Default)
```
Invoke-MgPreviewGroupOnenotePage -GroupId <String> -OnenotePageId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgPreviewGroupOnenotePage -InputObject <IGroupsIdentity> [-CustomHeader <String>] [<CommonParameters>]
```

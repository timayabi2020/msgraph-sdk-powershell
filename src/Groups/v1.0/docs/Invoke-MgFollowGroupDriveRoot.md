...
### Follow (Default)
```
Invoke-MgFollowGroupDriveRoot -DriveId <String> -GroupId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowGroupDriveRoot -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

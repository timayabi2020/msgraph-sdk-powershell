...
### Reset (Default)
```
Reset-MgGroupUnseenCount -GroupId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgGroupUnseenCount -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

...
```
Confirm-MgGroupMemberObject -GroupId <String> [-AdditionalProperties <Hashtable>] [-Ids <String[]>]
...
```
Confirm-MgGroupMemberObject -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]

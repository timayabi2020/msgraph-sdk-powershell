...
### Delta (Default)
```
Get-MgGroupDriveItemDelta -DriveId <String> -DriveItemId <String> -GroupId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgGroupDriveItemDelta -InputObject <IGroupsIdentity> [-Count] [-Filter <String>] [-Property <String[]>]

...
### Restore (Default)
```
Restore-MgGroupSettingTemplate -GroupSettingTemplateId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgGroupSettingTemplate -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Checkout (Default)
```
Invoke-MgCheckoutGroupDriveItem -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgCheckoutGroupDriveItem -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

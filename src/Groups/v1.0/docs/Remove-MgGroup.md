...
### Delete (Default)
```
Remove-MgGroup -GroupId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgGroup -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

...
### Subscribe (Default)
```
Invoke-MgSubscribeGroupByMail -GroupId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SubscribeViaIdentity
```
Invoke-MgSubscribeGroupByMail -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

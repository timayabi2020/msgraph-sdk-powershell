...
### Follow (Default)
```
Invoke-MgFollowGroupDriveItem -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowGroupDriveItem -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgGroupMemberCountAsUser -GroupId <String> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupMemberCountAsUser -InputObject <IGroupsIdentity> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

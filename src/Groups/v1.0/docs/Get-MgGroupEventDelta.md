...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/get-mggroupeventdelta
schema: 2.0.0
---
...
### Delta (Default)
```
Get-MgGroupEventDelta -GroupId <String> -EndDateTime <String> -StartDateTime <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgGroupEventDelta -InputObject <IGroupsIdentity> -EndDateTime <String> -StartDateTime <String> [-Count]

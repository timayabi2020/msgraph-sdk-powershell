...
```
New-MgGroupOwnerByRef -GroupId <String> -OdataId <String> [-AdditionalProperties <Hashtable>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgGroupOwnerByRef -GroupId <String> -BodyParameter <IReferenceCreate> [-CustomHeader <String>] [-PassThru]

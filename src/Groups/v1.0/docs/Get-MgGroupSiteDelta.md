...
### Delta (Default)
```
Get-MgGroupSiteDelta -GroupId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgGroupSiteDelta -InputObject <IGroupsIdentity> [-Count] [-Filter <String>] [-Property <String[]>]

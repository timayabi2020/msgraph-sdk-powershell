...
### Get
```
Get-MgGroupThread -ConversationThreadId <String> -GroupId <String> [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupThread -InputObject <IGroupsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

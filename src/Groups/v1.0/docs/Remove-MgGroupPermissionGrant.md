...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/remove-mggrouppermissiongrant
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgGroupPermissionGrant -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### Remove (Default)
```
Remove-MgGroupFavorite -GroupId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgGroupFavorite -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

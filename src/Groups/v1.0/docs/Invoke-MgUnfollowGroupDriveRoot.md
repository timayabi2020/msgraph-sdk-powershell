...
### Unfollow (Default)
```
Invoke-MgUnfollowGroupDriveRoot -DriveId <String> -GroupId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgUnfollowGroupDriveRoot -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

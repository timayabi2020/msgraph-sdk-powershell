...
```
Remove-MgGroupSite -GroupId <String> [-AdditionalProperties <Hashtable>] [-ResponseHeadersVariable <String>]
 [-Value <IMicrosoftGraphSite[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Remove-MgGroupSite -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
 [-ResponseHeadersVariable <String>] [-Value <IMicrosoftGraphSite[]>] [-Headers <IDictionary>] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths8J6HbtGroupsGroupIdSitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema

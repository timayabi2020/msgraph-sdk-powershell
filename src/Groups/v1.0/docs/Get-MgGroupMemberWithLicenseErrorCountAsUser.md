...
### Get (Default)
```
Get-MgGroupMemberWithLicenseErrorCountAsUser -GroupId <String> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupMemberWithLicenseErrorCountAsUser -InputObject <IGroupsIdentity> -ConsistencyLevel <String>

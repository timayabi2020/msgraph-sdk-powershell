...
### Get (Default)
```
Get-MgGroupPhoto -GroupId <String> [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgGroupPhoto -GroupId <String> -ProfilePhotoId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupPhoto -InputObject <IGroupsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

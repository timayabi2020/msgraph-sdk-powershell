...
### Delete (Default)
```
Remove-MgGroupLifecyclePolicy -GroupLifecyclePolicyId <String> [-IfMatch <String>] [-CustomHeader <String>]
...
### DeleteViaIdentity
```
Remove-MgGroupLifecyclePolicy -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

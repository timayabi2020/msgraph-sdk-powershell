...
### Dismiss (Default)
```
Invoke-MgDismissGroupEventReminder -EventId <String> -GroupId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgDismissGroupEventReminder -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Checkout (Default)
```
Invoke-MgCheckoutGroupDriveRoot -DriveId <String> -GroupId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgCheckoutGroupDriveRoot -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

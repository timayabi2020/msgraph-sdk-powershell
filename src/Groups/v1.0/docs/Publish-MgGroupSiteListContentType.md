...
### Publish (Default)
```
Publish-MgGroupSiteListContentType -ContentTypeId <String> -GroupId <String> -ListId <String> -SiteId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgGroupSiteListContentType -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

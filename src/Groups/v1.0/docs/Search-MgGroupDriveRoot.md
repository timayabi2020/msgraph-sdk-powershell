...
### Search (Default)
```
Search-MgGroupDriveRoot -DriveId <String> -GroupId <String> -Q <String> [-Count] [-Filter <String>]
...
### SearchViaIdentity
```
Search-MgGroupDriveRoot -InputObject <IGroupsIdentity> [-Count] [-Filter <String>] [-Property <String[]>]

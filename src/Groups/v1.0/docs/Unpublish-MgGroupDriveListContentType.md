...
### Unpublish (Default)
```
Unpublish-MgGroupDriveListContentType -ContentTypeId <String> -DriveId <String> -GroupId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgGroupDriveListContentType -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

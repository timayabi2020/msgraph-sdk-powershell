...
### Publish (Default)
```
Publish-MgGroupDriveListContentType -ContentTypeId <String> -DriveId <String> -GroupId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgGroupDriveListContentType -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

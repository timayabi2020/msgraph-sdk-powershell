...
### AddExpanded (Default)
```
Add-MgGroupSite -GroupId <String> [-AdditionalProperties <Hashtable>] [-ResponseHeadersVariable <String>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsZv3WsxGroupsGroupIdSitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema

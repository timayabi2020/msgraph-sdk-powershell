...
### Check (Default)
```
Confirm-MgGroupGrantedPermissionForApp -GroupId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CheckViaIdentity
```
Confirm-MgGroupGrantedPermissionForApp -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-Confirm]

...
### Extract (Default)
```
Invoke-MgBetaExtractGroupDriveRootSensitivityLabel -DriveId <String> -GroupId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgBetaExtractGroupDriveRootSensitivityLabel -InputObject <IGroupsIdentity> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupsetting
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaGroupSetting -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

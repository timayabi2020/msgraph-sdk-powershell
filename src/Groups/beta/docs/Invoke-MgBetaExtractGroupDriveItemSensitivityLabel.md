...
### Extract (Default)
```
Invoke-MgBetaExtractGroupDriveItemSensitivityLabel -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgBetaExtractGroupDriveItemSensitivityLabel -InputObject <IGroupsIdentity> [-CustomHeader <String>]

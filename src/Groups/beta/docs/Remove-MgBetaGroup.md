...
### Delete (Default)
```
Remove-MgBetaGroup -GroupId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroup -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

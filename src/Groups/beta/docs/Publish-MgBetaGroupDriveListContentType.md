...
### Publish (Default)
```
Publish-MgBetaGroupDriveListContentType -ContentTypeId <String> -DriveId <String> -GroupId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaGroupDriveListContentType -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

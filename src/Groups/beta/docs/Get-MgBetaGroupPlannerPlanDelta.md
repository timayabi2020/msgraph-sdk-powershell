...
### Delta (Default)
```
Get-MgBetaGroupPlannerPlanDelta -GroupId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgBetaGroupPlannerPlanDelta -InputObject <IGroupsIdentity> [-Count] [-Filter <String>]

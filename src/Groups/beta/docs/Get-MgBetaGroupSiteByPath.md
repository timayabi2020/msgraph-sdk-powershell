...
### Get (Default)
```
Get-MgBetaGroupSiteByPath -GroupId <String> -Path <String> -SiteId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupSiteByPath -InputObject <IGroupsIdentity> [-CustomHeader <String>] [<CommonParameters>]
```

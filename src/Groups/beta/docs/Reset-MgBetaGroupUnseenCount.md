...
### Reset (Default)
```
Reset-MgBetaGroupUnseenCount -GroupId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaGroupUnseenCount -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

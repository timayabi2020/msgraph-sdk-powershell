...
### Get (Default)
```
Get-MgBetaGroupMemberCountAsUser -GroupId <String> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupMemberCountAsUser -InputObject <IGroupsIdentity> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

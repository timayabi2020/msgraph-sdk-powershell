...
### Follow (Default)
```
Invoke-MgBetaFollowGroupDriveRoot -DriveId <String> -GroupId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowGroupDriveRoot -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagrouppermissiongrant
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaGroupPermissionGrant -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

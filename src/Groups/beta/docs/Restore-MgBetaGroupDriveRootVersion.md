...
### Restore (Default)
```
Restore-MgBetaGroupDriveRootVersion -DriveId <String> -DriveItemVersionId <String> -GroupId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaGroupDriveRootVersion -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

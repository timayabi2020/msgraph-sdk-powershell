...
### Delete (Default)
```
Remove-MgBetaGroupByUniqueName -UniqueName <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupByUniqueName -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### Set (Default)
```
Set-MgBetaGroupPhotoContent -GroupId <String> -InFile <String> [-Data <Stream>] [-ContentType <String>]
...
### SetViaIdentity
```
Set-MgBetaGroupPhotoContent -InputObject <IGroupsIdentity> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

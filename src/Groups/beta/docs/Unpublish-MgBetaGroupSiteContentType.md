...
### Unpublish (Default)
```
Unpublish-MgBetaGroupSiteContentType -ContentTypeId <String> -GroupId <String> -SiteId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgBetaGroupSiteContentType -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

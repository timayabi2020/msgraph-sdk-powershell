...
### Dismiss (Default)
```
Invoke-MgBetaDismissGroupCalendarEventReminder -EventId <String> -GroupId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgBetaDismissGroupCalendarEventReminder -InputObject <IGroupsIdentity> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

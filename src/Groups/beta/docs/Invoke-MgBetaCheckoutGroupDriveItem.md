...
### Checkout (Default)
```
Invoke-MgBetaCheckoutGroupDriveItem -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgBetaCheckoutGroupDriveItem -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

...
### Delete (Default)
```
Remove-MgBetaGroupThread -ConversationThreadId <String> -GroupId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupThread -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

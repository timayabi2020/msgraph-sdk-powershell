...
```
New-MgBetaGroupThreadPostMention -ConversationThreadId <String> -GroupId <String> -PostId <String>
 -BodyParameter <IMicrosoftGraphMention> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgBetaGroupThreadPostMention -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-MentionText <String>] [-ServerCreatedDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

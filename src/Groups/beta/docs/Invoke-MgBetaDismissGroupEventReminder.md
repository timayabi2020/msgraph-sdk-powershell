...
### Dismiss (Default)
```
Invoke-MgBetaDismissGroupEventReminder -EventId <String> -GroupId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgBetaDismissGroupEventReminder -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

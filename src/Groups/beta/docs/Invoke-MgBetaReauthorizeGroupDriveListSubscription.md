...
### Reauthorize (Default)
```
Invoke-MgBetaReauthorizeGroupDriveListSubscription -DriveId <String> -GroupId <String>
 -SubscriptionId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeGroupDriveListSubscription -InputObject <IGroupsIdentity> [-CustomHeader <String>]

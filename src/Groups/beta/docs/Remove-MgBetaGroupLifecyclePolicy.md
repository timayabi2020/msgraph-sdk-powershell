...
### Delete (Default)
```
Remove-MgBetaGroupLifecyclePolicy -GroupLifecyclePolicyId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Delete1
```
Remove-MgBetaGroupLifecyclePolicy -GroupId <String> -GroupLifecyclePolicyId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupLifecyclePolicy -InputObject <IGroupsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

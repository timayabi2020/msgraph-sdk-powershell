...
```
New-MgBetaGroupMember -GroupId <String> [-DirectoryObjectId <String>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaGroupMember -GroupId <String> -BodyParameter <Hashtable> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaGroupMember -InputObject <IGroupsIdentity> -BodyParameter <Hashtable> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaGroupMember -InputObject <IGroupsIdentity> [-DirectoryObjectId <String>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

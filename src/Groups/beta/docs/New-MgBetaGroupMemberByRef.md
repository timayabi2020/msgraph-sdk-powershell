...
```
New-MgBetaGroupMemberByRef -GroupId <String> -OdataId <String> [-AdditionalProperties <Hashtable>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaGroupMemberByRef -GroupId <String> -BodyParameter <IReferenceCreate> [-CustomHeader <String>]
...
```
New-MgBetaGroupMemberByRef -InputObject <IGroupsIdentity> -OdataId <String>

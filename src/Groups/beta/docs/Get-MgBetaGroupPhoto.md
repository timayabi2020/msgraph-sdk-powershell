...
### Get (Default)
```
Get-MgBetaGroupPhoto -GroupId <String> [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaGroupPhoto -GroupId <String> -ProfilePhotoId <String> [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupPhoto -InputObject <IGroupsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

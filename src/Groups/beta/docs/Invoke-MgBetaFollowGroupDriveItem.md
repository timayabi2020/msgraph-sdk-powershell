...
### Follow (Default)
```
Invoke-MgBetaFollowGroupDriveItem -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowGroupDriveItem -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

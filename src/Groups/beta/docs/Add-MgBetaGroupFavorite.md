...
### Add (Default)
```
Add-MgBetaGroupFavorite -GroupId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### AddViaIdentity
```
Add-MgBetaGroupFavorite -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

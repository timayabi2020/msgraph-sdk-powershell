...
```
New-MgBetaGroupOwnerByRef -GroupId <String> -OdataId <String> [-AdditionalProperties <Hashtable>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaGroupOwnerByRef -GroupId <String> -BodyParameter <IReferenceCreate> [-CustomHeader <String>]

...
### Remove (Default)
```
Remove-MgBetaGroupFavorite -GroupId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaGroupFavorite -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

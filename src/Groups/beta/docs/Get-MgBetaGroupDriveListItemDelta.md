...
### Delta (Default)
```
Get-MgBetaGroupDriveListItemDelta -DriveId <String> -GroupId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaGroupDriveListItemDelta -InputObject <IGroupsIdentity> [-Count] [-Filter <String>]

...
### Get (Default)
```
Get-MgBetaGroupPhotoContent -GroupId <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgBetaGroupPhotoContent -InputObject <IGroupsIdentity> -OutFile <String> [-CustomHeader <String>]

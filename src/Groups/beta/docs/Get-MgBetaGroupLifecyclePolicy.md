...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagrouplifecyclepolicy
schema: 2.0.0
---
...
### Get1
```
Get-MgBetaGroupLifecyclePolicy -GroupId <String> -GroupLifecyclePolicyId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
```
Move-MgBetaGroupPlannerPlanToContainer -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
 [-Container <IMicrosoftGraphPlannerPlanContainer>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

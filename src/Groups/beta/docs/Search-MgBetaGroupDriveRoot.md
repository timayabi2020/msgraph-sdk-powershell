...
### Search (Default)
```
Search-MgBetaGroupDriveRoot -DriveId <String> -GroupId <String> -Q <String> [-Count] [-Filter <String>]
...
### SearchViaIdentity
```
Search-MgBetaGroupDriveRoot -InputObject <IGroupsIdentity> [-Count] [-Filter <String>] [-Property <String[]>]

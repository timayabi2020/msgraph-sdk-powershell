...
### Subscribe (Default)
```
Invoke-MgBetaSubscribeGroupByMail -GroupId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SubscribeViaIdentity
```
Invoke-MgBetaSubscribeGroupByMail -InputObject <IGroupsIdentity> [-CustomHeader <String>] [-PassThru]

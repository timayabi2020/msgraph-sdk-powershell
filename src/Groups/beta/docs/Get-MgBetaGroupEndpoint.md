...
### List (Default)
```
Get-MgBetaGroupEndpoint -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaGroupEndpoint -EndpointId <String> -GroupId <String> [-ExpandProperty <String[]>]

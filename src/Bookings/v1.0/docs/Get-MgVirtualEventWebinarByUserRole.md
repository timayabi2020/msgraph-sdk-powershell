...
### Get (Default)
```
Get-MgVirtualEventWebinarByUserRole -Role <String> [-Count] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgVirtualEventWebinarByUserRole -InputObject <IBookingsIdentity> [-Count] [-Filter <String>]

...
### Publish (Default)
```
Publish-MgBookingBusiness -BookingBusinessId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBookingBusiness -InputObject <IBookingsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

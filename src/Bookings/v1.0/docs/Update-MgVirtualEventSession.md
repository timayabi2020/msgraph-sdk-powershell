...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/update-mgvirtualeventsession
schema: 2.0.0
---
...
```
Update-MgVirtualEventSession -VirtualEventId <String> -VirtualEventSessionId <String>
...
### UpdateViaIdentity
```
Update-MgVirtualEventSession -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphVirtualEventSession> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgVirtualEventSession -InputObject <IBookingsIdentity> [-AdditionalProperties <Hashtable>]

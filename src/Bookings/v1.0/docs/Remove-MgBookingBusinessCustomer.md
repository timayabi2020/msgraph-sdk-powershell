...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/remove-mgbookingbusinesscustomer
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBookingBusinessCustomer -InputObject <IBookingsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

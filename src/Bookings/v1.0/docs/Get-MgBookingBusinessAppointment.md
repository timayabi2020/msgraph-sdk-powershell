...
### List (Default)
```
Get-MgBookingBusinessAppointment -BookingBusinessId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBookingBusinessAppointment -BookingAppointmentId <String> -BookingBusinessId <String>

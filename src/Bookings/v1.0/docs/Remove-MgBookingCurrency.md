...
### Delete (Default)
```
Remove-MgBookingCurrency -BookingCurrencyId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBookingCurrency -InputObject <IBookingsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### List (Default)
```
Get-MgVirtualEventWebinarRegistration -VirtualEventWebinarId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgVirtualEventWebinarRegistration -VirtualEventRegistrationId <String> -VirtualEventWebinarId <String>

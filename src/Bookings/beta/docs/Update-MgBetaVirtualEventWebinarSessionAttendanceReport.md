...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetavirtualeventwebinarsessionattendancereport
schema: 2.0.0
---
...
```
Update-MgBetaVirtualEventWebinarSessionAttendanceReport -MeetingAttendanceReportId <String>
...
### UpdateViaIdentity
```
Update-MgBetaVirtualEventWebinarSessionAttendanceReport -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphMeetingAttendanceReport> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

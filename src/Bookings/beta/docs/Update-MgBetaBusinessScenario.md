...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabusinessscenario
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgBetaBusinessScenario -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphBusinessScenario> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

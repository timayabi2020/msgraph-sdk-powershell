...
Update-MgBetaBusinessScenarioPlanner -BusinessScenarioId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Tasks <IMicrosoftGraphBusinessScenarioTask[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaBusinessScenarioPlanner -BusinessScenarioId <String>
 -BodyParameter <IMicrosoftGraphBusinessScenarioPlanner> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgBetaVirtualEventWebinarByUserIdAndRole -Role <String> -UserId <String> [-Count] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaVirtualEventWebinarByUserIdAndRole -InputObject <IBookingsIdentity> [-Count] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-CustomHeader <String>] [<CommonParameters>]
```

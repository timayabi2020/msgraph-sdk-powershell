...
New-MgBetaBookingBusiness [-AdditionalProperties <Hashtable>] [-Address <IMicrosoftGraphPhysicalAddress>]
 ...
 [-WebSiteUrl <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaBookingBusiness -BodyParameter <IMicrosoftGraphBookingBusiness> [-CustomHeader <String>] [-Confirm]

...
New-MgBetaBusinessScenario [-AdditionalProperties <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 ...
 [-Planner <IMicrosoftGraphBusinessScenarioPlanner>] [-UniqueName <String>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaBusinessScenario -BodyParameter <IMicrosoftGraphBusinessScenario> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaVirtualEventWebinarSessionAttendanceReport -VirtualEventSessionId <String>
...
### Get
```
Get-MgBetaVirtualEventWebinarSessionAttendanceReport -MeetingAttendanceReportId <String>
...
### GetViaIdentity
```
Get-MgBetaVirtualEventWebinarSessionAttendanceReport -InputObject <IBookingsIdentity>

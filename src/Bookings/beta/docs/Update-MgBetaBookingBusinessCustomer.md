...
Update-MgBetaBookingBusinessCustomer -BookingBusinessId <String> -BookingCustomerId <String>
 ...
 [-EmailAddress <String>] [-Id <String>] [-Phones <IMicrosoftGraphPhone[]>] [-CustomHeader <String>]
...
```
Update-MgBetaBookingBusinessCustomer -BookingBusinessId <String> -BookingCustomerId <String>
 -BodyParameter <IMicrosoftGraphBookingCustomer> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaBookingBusinessCustomer -InputObject <IBookingsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-Phones <IMicrosoftGraphPhone[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

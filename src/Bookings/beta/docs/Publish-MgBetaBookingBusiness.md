...
### Publish (Default)
```
Publish-MgBetaBookingBusiness -BookingBusinessId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaBookingBusiness -InputObject <IBookingsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetavirtualeventtownhallsessionattendancereport
schema: 2.0.0
---
...
```
New-MgBetaVirtualEventTownhallSessionAttendanceReport -VirtualEventSessionId <String>
 -VirtualEventTownhallId <String> [-AdditionalProperties <Hashtable>]
 [-AttendanceRecords <IMicrosoftGraphAttendanceRecord[]>] [-Id <String>] [-MeetingEndDateTime <DateTime>]
 [-MeetingStartDateTime <DateTime>] [-TotalParticipantCount <Int32>] [-CustomHeader <String>] [-Confirm]
...
```
New-MgBetaVirtualEventTownhallSessionAttendanceReport -VirtualEventSessionId <String>
 -VirtualEventTownhallId <String> -BodyParameter <IMicrosoftGraphMeetingAttendanceReport>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaVirtualEventTownhallSessionAttendanceReport -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphMeetingAttendanceReport> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

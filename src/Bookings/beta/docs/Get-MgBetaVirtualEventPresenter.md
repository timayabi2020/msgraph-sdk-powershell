...
### List (Default)
```
Get-MgBetaVirtualEventPresenter -VirtualEventId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaVirtualEventPresenter -VirtualEventId <String> -VirtualEventPresenterId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaVirtualEventPresenter -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]

...
New-MgBetaVirtualEventTownhall [-AdditionalProperties <Hashtable>] [-Audience <String>]
 ...
 [-StartDateTime <IMicrosoftGraphDateTimeZone>] [-Status <String>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaVirtualEventTownhall -BodyParameter <IMicrosoftGraphVirtualEventTownhall> [-CustomHeader <String>]

...
### Get (Default)
```
Get-MgBetaVirtualEventTownhallByUserRole -Role <String> [-Count] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaVirtualEventTownhallByUserRole -InputObject <IBookingsIdentity> [-Count] [-Filter <String>]

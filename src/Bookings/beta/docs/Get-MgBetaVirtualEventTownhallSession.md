...
### List (Default)
```
Get-MgBetaVirtualEventTownhallSession -VirtualEventTownhallId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaVirtualEventTownhallSession -VirtualEventSessionId <String> -VirtualEventTownhallId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaVirtualEventTownhallSession -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]

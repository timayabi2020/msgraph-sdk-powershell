...
### Get (Default)
```
Get-MgBetaBusinessScenarioPlannerTaskDetail -BusinessScenarioId <String> -BusinessScenarioTaskId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaBusinessScenarioPlannerTaskDetail -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]

...
New-MgBetaVirtualEventTownhallPresenter -VirtualEventTownhallId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Sessions <IMicrosoftGraphVirtualEventSession[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaVirtualEventTownhallPresenter -VirtualEventTownhallId <String>
 -BodyParameter <IMicrosoftGraphVirtualEventPresenter> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

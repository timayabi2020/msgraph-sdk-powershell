...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/get-mgbetabusinessscenario
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaBusinessScenario -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]

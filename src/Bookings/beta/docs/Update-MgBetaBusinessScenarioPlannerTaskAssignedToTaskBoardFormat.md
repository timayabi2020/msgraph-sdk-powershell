...
Update-MgBetaBusinessScenarioPlannerTaskAssignedToTaskBoardFormat -BusinessScenarioId <String>
 ...
 [-OrderHintsByAssignee <Hashtable>] [-UnassignedOrderHint <String>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaBusinessScenarioPlannerTaskAssignedToTaskBoardFormat -BusinessScenarioId <String>
 ...
 -BodyParameter <IMicrosoftGraphPlannerAssignedToTaskBoardTaskFormat> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaBusinessScenarioPlannerTaskAssignedToTaskBoardFormat -InputObject <IBookingsIdentity>
 ...
 [-UnassignedOrderHint <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

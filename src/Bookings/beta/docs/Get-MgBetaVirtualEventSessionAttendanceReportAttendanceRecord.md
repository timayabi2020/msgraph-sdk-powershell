...
### List (Default)
```
Get-MgBetaVirtualEventSessionAttendanceReportAttendanceRecord -MeetingAttendanceReportId <String>
...
### Get
```
Get-MgBetaVirtualEventSessionAttendanceReportAttendanceRecord -AttendanceRecordId <String>
...
### GetViaIdentity
```
Get-MgBetaVirtualEventSessionAttendanceReportAttendanceRecord -InputObject <IBookingsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

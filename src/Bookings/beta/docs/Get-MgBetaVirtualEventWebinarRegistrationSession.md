...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/get-mgbetavirtualeventwebinarregistrationsession
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaVirtualEventWebinarRegistrationSession -VirtualEventRegistrationId <String>
...
### GetViaIdentity
```
Get-MgBetaVirtualEventWebinarRegistrationSession -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

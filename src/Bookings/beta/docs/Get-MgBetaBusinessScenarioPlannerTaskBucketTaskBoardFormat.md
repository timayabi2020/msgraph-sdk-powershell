...
### Get (Default)
```
Get-MgBetaBusinessScenarioPlannerTaskBucketTaskBoardFormat -BusinessScenarioId <String>
...
### GetViaIdentity
```
Get-MgBetaBusinessScenarioPlannerTaskBucketTaskBoardFormat -InputObject <IBookingsIdentity>

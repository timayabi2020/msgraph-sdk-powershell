...
Update-MgBetaBusinessScenarioPlannerPlanConfigurationLocalization -BusinessScenarioId <String>
 ...
 [-LanguageTag <String>] [-PlanTitle <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaBusinessScenarioPlannerPlanConfigurationLocalization -BusinessScenarioId <String>
 ...
 -BodyParameter <IMicrosoftGraphPlannerPlanConfigurationLocalization> [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaBusinessScenarioPlannerPlanConfigurationLocalization -InputObject <IBookingsIdentity>
 ...
 [-Id <String>] [-LanguageTag <String>] [-PlanTitle <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

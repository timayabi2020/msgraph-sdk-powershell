...
New-MgBetaBookingBusinessService -BookingBusinessId <String> [-AdditionalInformation <String>]
 ...
 [-StaffMemberIds <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-MgBetaBookingBusinessService -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphBookingService> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgBetaBusinessScenarioPlannerTaskProgressTaskBoardFormat -BusinessScenarioId <String>
...
### GetViaIdentity
```
Get-MgBetaBusinessScenarioPlannerTaskProgressTaskBoardFormat -InputObject <IBookingsIdentity>

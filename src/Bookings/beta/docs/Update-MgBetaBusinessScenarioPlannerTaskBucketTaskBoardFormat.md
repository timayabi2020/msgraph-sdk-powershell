...
Update-MgBetaBusinessScenarioPlannerTaskBucketTaskBoardFormat -BusinessScenarioId <String>
 ...
 -BodyParameter <IMicrosoftGraphPlannerBucketTaskBoardTaskFormat> [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaBusinessScenarioPlannerTaskBucketTaskBoardFormat -InputObject <IBookingsIdentity>
 -IfMatch <String> -BodyParameter <IMicrosoftGraphPlannerBucketTaskBoardTaskFormat> [-CustomHeader <String>]

...
```
New-MgBetaTenantRelationshipDelegatedAdminCustomerServiceManagementDetail -DelegatedAdminCustomerId <String>
 -BodyParameter <IMicrosoftGraphDelegatedAdminServiceManagementDetail> [-CustomHeader <String>] [-Confirm]
...
New-MgBetaTenantRelationshipDelegatedAdminCustomerServiceManagementDetail
 ...
 [-ServiceManagementUrl <String>] [-ServiceName <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
New-MgPlannerBucket [-AdditionalProperties <Hashtable>] [-Id <String>] [-Name <String>] [-OrderHint <String>]
 [-PlanId <String>] [-Tasks <IMicrosoftGraphPlannerTask[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgPlannerBucket -BodyParameter <IMicrosoftGraphPlannerBucket> [-CustomHeader <String>] [-Confirm]

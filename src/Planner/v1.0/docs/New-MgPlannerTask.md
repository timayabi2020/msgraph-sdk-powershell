...
New-MgPlannerTask [-ActiveChecklistItemCount <Int32>] [-AdditionalProperties <Hashtable>]
 ...
 [-ReferenceCount <Int32>] [-StartDateTime <DateTime>] [-Title <String>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgPlannerTask -BodyParameter <IMicrosoftGraphPlannerTask> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

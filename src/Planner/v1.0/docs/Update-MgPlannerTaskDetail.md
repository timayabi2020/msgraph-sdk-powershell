...
Update-MgPlannerTaskDetail -PlannerTaskId <String> -IfMatch <String> [-AdditionalProperties <Hashtable>]
 ...
 [-References <Hashtable>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgPlannerTaskDetail -PlannerTaskId <String> -IfMatch <String>
 -BodyParameter <IMicrosoftGraphPlannerTaskDetails> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgPlannerTaskDetail -InputObject <IPlannerIdentity> -IfMatch <String>
 ...
 [-PreviewType <String>] [-References <Hashtable>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgPlannerBucket -PlannerBucketId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgPlannerBucket -InputObject <IPlannerIdentity> [-IfMatch <String>] [-CustomHeader <String>]

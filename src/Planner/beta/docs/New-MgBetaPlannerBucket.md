...
New-MgBetaPlannerBucket [-AdditionalProperties <Hashtable>]
 ...
 [-OrderHint <String>] [-PlanId <String>] [-Tasks <IMicrosoftGraphPlannerTask[]>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaPlannerBucket -BodyParameter <IMicrosoftGraphPlannerBucket> [-CustomHeader <String>] [-Confirm]

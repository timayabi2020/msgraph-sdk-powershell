...
Update-MgBetaPlanner [-AdditionalProperties <Hashtable>] [-Buckets <IMicrosoftGraphPlannerBucket[]>]
 ...
 [-Tasks <IMicrosoftGraphPlannerTask[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaPlanner -BodyParameter <IMicrosoftGraphPlanner> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphPlanner
...
`BODYPARAMETER <IMicrosoftGraphPlanner>`: planner
  ...
  - `[Rosters <IMicrosoftGraphPlannerRoster[]>]`: Read-only. Nullable. Returns a collection of the specified rosters
    - `[Id <String>]`: The unique identifier for an entity. Read-only.

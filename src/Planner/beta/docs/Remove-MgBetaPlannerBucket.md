...
### Delete (Default)
```
Remove-MgBetaPlannerBucket -PlannerBucketId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPlannerBucket -InputObject <IPlannerIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetauserplannerplan
schema: 2.0.0
---
...
```
Get-MgBetaUserPlannerPlan -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]

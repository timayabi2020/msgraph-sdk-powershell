...
Update-MgBetaPlannerPlanDetail -PlannerPlanId <String> -IfMatch <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-SharedWith <Hashtable>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaPlannerPlanDetail -PlannerPlanId <String> -IfMatch <String>
 -BodyParameter <IMicrosoftGraphPlannerPlanDetails> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaPlannerPlanDetail -InputObject <IPlannerIdentity> -IfMatch <String>
 ...
 [-ContextDetails <Hashtable>] [-Id <String>] [-SharedWith <Hashtable>] [-CustomHeader <String>] [-Confirm]

...
### Reset (Default)
```
Reset-MgBetaPrintPrinterDefault -PrinterId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaPrintPrinterDefault -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-PassThru]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.cloudprint/update-mgbetaprintprinterjobtask
schema: 2.0.0
---
...
```
Update-MgBetaPrintPrinterJobTask -PrinterId <String> -PrintJobId <String> -PrintTaskId <String>
...
### UpdateViaIdentity
```
Update-MgBetaPrintPrinterJobTask -InputObject <IDevicesCloudPrintIdentity>
 -BodyParameter <IMicrosoftGraphPrintTask> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaPrintPrinterJobTask -InputObject <IDevicesCloudPrintIdentity> [-AdditionalProperties <Hashtable>]

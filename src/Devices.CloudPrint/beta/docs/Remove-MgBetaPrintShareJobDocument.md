...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.cloudprint/remove-mgbetaprintsharejobdocument
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaPrintShareJobDocument -PrintDocumentId <String> -PrinterShareId <String> -PrintJobId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPrintShareJobDocument -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>]

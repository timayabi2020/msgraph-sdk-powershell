...
### Start (Default)
```
Start-MgBetaPrintPrinterShareJob -PrinterShareId <String> -PrintJobId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterShareJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-Confirm]

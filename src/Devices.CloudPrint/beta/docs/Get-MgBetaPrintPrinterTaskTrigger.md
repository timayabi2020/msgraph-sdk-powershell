...
### List (Default)
```
Get-MgBetaPrintPrinterTaskTrigger -PrinterId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaPrintPrinterTaskTrigger -PrinterId <String> -PrintTaskTriggerId <String>

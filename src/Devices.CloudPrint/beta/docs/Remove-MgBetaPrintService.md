...
### Delete (Default)
```
Remove-MgBetaPrintService -PrintServiceId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPrintService -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>]

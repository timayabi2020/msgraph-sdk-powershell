...
```
Update-MgBetaPrintPrinterJob -PrinterId <String> -PrintJobId <String> [-AcknowledgedDateTime <DateTime>]
...
### Update
```
Update-MgBetaPrintPrinterJob -PrinterId <String> -PrintJobId <String> -BodyParameter <IMicrosoftGraphPrintJob>

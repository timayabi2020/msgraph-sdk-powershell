...
### Delete (Default)
```
Remove-MgBetaPrintShare -PrinterShareId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPrintShare -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### Set (Default)
```
Set-MgBetaPrintPrinterJobDocumentContent -PrintDocumentId <String> -PrinterId <String> -PrintJobId <String>
...
### SetViaIdentity
```
Set-MgBetaPrintPrinterJobDocumentContent -InputObject <IDevicesCloudPrintIdentity> -InFile <String>

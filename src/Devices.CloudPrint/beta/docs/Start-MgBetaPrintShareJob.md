...
### Start (Default)
```
Start-MgBetaPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

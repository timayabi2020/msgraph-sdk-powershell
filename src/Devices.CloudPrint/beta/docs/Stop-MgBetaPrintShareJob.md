...
### Cancel (Default)
```
Stop-MgBetaPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgBetaPrintPrinterCapability -PrinterId <String> [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPrintPrinterCapability -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

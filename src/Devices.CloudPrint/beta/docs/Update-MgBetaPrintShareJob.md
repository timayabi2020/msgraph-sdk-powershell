...
```
Update-MgBetaPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-AcknowledgedDateTime <DateTime>]
...
### Update
```
Update-MgBetaPrintShareJob -PrinterShareId <String> -PrintJobId <String>

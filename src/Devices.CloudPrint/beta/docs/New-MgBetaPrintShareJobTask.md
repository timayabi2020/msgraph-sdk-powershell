...
```
New-MgBetaPrintShareJobTask -PrinterShareId <String> -PrintJobId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaPrintShareJobTask -PrinterShareId <String> -PrintJobId <String>

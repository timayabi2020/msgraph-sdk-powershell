...
### Restore (Default)
```
Restore-MgBetaPrintPrinterFactoryDefault -PrinterId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaPrintPrinterFactoryDefault -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>]

...
```
Update-MgBetaPrintPrinterShareJobDocument -PrintDocumentId <String> -PrinterShareId <String>
...
```
Update-MgBetaPrintPrinterShareJobDocument -PrintDocumentId <String> -PrinterShareId <String>
 -PrintJobId <String> -BodyParameter <IMicrosoftGraphPrintDocument> [-CustomHeader <String>] [-Confirm]

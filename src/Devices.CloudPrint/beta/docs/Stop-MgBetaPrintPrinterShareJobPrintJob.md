...
### Cancel (Default)
```
Stop-MgBetaPrintPrinterShareJobPrintJob -PrinterShareId <String> -PrintJobId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaPrintPrinterShareJobPrintJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

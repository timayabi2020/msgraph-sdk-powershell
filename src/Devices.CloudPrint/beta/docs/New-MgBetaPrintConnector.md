...
New-MgBetaPrintConnector [-AdditionalProperties <Hashtable>] [-AppVersion <String>]
 ...
 [-RegisteredDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaPrintConnector -BodyParameter <IMicrosoftGraphPrintConnector> [-CustomHeader <String>] [-Confirm]

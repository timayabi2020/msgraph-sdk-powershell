...
Update-MgBetaPrintConnector -PrintConnectorId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Name <String>] [-OperatingSystem <String>] [-RegisteredDateTime <DateTime>] [-CustomHeader <String>]
...
Update-MgBetaPrintConnector -InputObject <IDevicesCloudPrintIdentity>
 -BodyParameter <IMicrosoftGraphPrintConnector> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

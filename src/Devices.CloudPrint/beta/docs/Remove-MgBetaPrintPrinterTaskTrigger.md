...
### Delete (Default)
```
Remove-MgBetaPrintPrinterTaskTrigger -PrinterId <String> -PrintTaskTriggerId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPrintPrinterTaskTrigger -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

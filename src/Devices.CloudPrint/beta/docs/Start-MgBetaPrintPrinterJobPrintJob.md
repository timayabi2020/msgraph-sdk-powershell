...
### Start (Default)
```
Start-MgBetaPrintPrinterJobPrintJob -PrinterId <String> -PrintJobId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterJobPrintJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

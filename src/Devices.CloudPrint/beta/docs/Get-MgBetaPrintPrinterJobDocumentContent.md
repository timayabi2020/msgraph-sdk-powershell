...
### Get (Default)
```
Get-MgBetaPrintPrinterJobDocumentContent -PrintDocumentId <String> -PrinterId <String> -PrintJobId <String>
 -OutFile <String> [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPrintPrinterJobDocumentContent -InputObject <IDevicesCloudPrintIdentity> -OutFile <String>

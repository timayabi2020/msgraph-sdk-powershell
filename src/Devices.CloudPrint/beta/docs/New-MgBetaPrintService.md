...
New-MgBetaPrintService [-AdditionalProperties <Hashtable>]
 [-Endpoints <IMicrosoftGraphPrintServiceEndpoint[]>] [-Id <String>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaPrintService -BodyParameter <IMicrosoftGraphPrintService> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

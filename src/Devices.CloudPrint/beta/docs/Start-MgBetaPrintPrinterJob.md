...
### Start (Default)
```
Start-MgBetaPrintPrinterJob -PrinterId <String> -PrintJobId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

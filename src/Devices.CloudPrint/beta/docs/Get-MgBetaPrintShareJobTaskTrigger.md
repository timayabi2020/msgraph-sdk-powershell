...
### Get (Default)
```
Get-MgBetaPrintShareJobTaskTrigger -PrinterShareId <String> -PrintJobId <String> -PrintTaskId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPrintShareJobTaskTrigger -InputObject <IDevicesCloudPrintIdentity> [-ExpandProperty <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.cloudprint/update-mgbetaprintsharejobtask
schema: 2.0.0
---
...
```
Update-MgBetaPrintShareJobTask -PrinterShareId <String> -PrintJobId <String> -PrintTaskId <String>
...
```
Update-MgBetaPrintShareJobTask -InputObject <IDevicesCloudPrintIdentity> [-AdditionalProperties <Hashtable>]

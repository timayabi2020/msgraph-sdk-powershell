...
### List (Default)
```
Get-MgPrintPrinterTaskTrigger -PrinterId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgPrintPrinterTaskTrigger -PrinterId <String> -PrintTaskTriggerId <String> [-ExpandProperty <String[]>]

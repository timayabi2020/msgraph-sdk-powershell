...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/update-mgprintprinter
schema: 2.0.0
---
...
Update-MgPrintPrinter -PrinterId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-RegisteredDateTime <DateTime>] [-ResponseHeadersVariable <String>]
 [-Shares <IMicrosoftGraphPrinterShare[]>] [-Status <IMicrosoftGraphPrinterStatus>]
 [-TaskTriggers <IMicrosoftGraphPrintTaskTrigger[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgPrintPrinter -PrinterId <String> -BodyParameter <IMicrosoftGraphPrinter>

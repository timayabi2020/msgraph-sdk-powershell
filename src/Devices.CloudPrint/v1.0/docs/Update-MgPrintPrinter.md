...
Update-MgPrintPrinter -PrinterId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Status <IMicrosoftGraphPrinterStatus>] [-TaskTriggers <IMicrosoftGraphPrintTaskTrigger[]>]
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgPrintPrinter -PrinterId <String> -BodyParameter <IMicrosoftGraphPrinter> [-CustomHeader <String>]

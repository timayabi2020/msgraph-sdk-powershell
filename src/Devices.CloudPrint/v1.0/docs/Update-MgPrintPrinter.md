...
Update-MgPrintPrinter -PrinterId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Status <IMicrosoftGraphPrinterStatus>] [-TaskTriggers <IMicrosoftGraphPrintTaskTrigger[]>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgPrintPrinter -PrinterId <String> -BodyParameter <IMicrosoftGraphPrinter> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

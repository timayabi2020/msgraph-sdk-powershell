...
### Cancel (Default)
```
Stop-MgPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

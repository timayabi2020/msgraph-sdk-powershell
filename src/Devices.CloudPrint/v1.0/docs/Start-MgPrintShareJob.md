...
### Start (Default)
```
Start-MgPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

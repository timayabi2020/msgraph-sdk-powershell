...
### Delete (Default)
```
Remove-MgPrintShare -PrinterShareId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgPrintShare -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
```
Invoke-MgAbortPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-AdditionalProperties <Hashtable>]
 [-Reason <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Abort
```
Invoke-MgAbortPrintShareJob -PrinterShareId <String> -PrintJobId <String>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsP8CwgsPrintSharesPrintershareIdJobsPrintjobIdMicrosoftGraphAbortPostRequestbodyContentApplicationJsonSchema

...
### Start (Default)
```
Start-MgPrintPrinterJob -PrinterId <String> -PrintJobId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgPrintPrinterJob -InputObject <IDevicesCloudPrintIdentity> [-CustomHeader <String>] [-Confirm]

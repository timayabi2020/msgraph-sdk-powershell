...
### List (Default)
```
Get-MgPrintShareJob -PrinterShareId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgPrintShareJob -PrinterShareId <String> -PrintJobId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPrintShareJob -InputObject <IDevicesCloudPrintIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

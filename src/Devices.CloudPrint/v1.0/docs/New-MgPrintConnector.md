...
New-MgPrintConnector [-AdditionalProperties <Hashtable>] [-AppVersion <String>] [-DisplayName <String>]
 ...
 [-OperatingSystem <String>] [-RegisteredDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgPrintConnector -BodyParameter <IMicrosoftGraphPrintConnector> [-CustomHeader <String>] [-Confirm]

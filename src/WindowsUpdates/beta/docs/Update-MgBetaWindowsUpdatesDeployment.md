...
Update-MgBetaWindowsUpdatesDeployment -DeploymentId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-State <IMicrosoftGraphWindowsUpdatesDeploymentState>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaWindowsUpdatesDeployment -DeploymentId <String>
 -BodyParameter <IMicrosoftGraphWindowsUpdatesDeployment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

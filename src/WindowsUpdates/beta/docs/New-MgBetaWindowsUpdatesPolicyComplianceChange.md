...
New-MgBetaWindowsUpdatesPolicyComplianceChange -UpdatePolicyId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UpdatePolicy <IMicrosoftGraphWindowsUpdatesUpdatePolicy>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaWindowsUpdatesPolicyComplianceChange -UpdatePolicyId <String>
 -BodyParameter <IMicrosoftGraphWindowsUpdatesComplianceChange> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

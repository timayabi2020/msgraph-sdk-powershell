...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetadevicemanagementwindowsautopilotdeploymentprofileassigneddevicecount
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementWindowsAutopilotDeploymentProfileAssignedDeviceCount
 -WindowsAutopilotDeploymentProfileId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

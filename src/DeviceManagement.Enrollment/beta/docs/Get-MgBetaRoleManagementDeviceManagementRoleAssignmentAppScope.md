...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetarolemanagementdevicemanagementroleassignmentappscope
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaRoleManagementDeviceManagementRoleAssignmentAppScope -UnifiedRoleAssignmentMultipleId <String>
...
### Get
```
Get-MgBetaRoleManagementDeviceManagementRoleAssignmentAppScope -AppScopeId <String>

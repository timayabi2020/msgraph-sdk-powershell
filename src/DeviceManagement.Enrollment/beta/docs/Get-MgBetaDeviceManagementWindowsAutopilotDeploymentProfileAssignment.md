...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetadevicemanagementwindowsautopilotdeploymentprofileassignment
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementWindowsAutopilotDeploymentProfileAssignment
 -WindowsAutopilotDeploymentProfileId <String> [-ExpandProperty <String[]>] [-Filter <String>]

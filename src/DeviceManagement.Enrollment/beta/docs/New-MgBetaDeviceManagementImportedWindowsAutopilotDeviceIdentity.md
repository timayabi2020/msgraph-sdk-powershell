...
New-MgBetaDeviceManagementImportedWindowsAutopilotDeviceIdentity [-AdditionalProperties <Hashtable>]
 ...
 [-State <IMicrosoftGraphImportedWindowsAutopilotDeviceIdentityState>] [-CustomHeader <String>] [-Confirm]
...
```
New-MgBetaDeviceManagementImportedWindowsAutopilotDeviceIdentity
 -BodyParameter <IMicrosoftGraphImportedWindowsAutopilotDeviceIdentity> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

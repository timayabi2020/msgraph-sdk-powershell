...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetadevicemanagementappleuserinitiatedenrollmentprofile
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementAppleUserInitiatedEnrollmentProfile [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementAppleUserInitiatedEnrollmentProfile -AppleUserInitiatedEnrollmentProfileId <String>

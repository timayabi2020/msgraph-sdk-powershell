...
Update-MgBetaDeviceManagementImportedDeviceIdentity -ImportedDeviceIdentityId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-Platform <Platform>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementImportedDeviceIdentity -ImportedDeviceIdentityId <String>
 -BodyParameter <IMicrosoftGraphImportedDeviceIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

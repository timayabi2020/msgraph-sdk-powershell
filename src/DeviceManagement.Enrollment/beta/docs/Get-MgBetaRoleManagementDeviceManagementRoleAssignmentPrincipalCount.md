...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetarolemanagementdevicemanagementroleassignmentprincipalcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaRoleManagementDeviceManagementRoleAssignmentPrincipalCount -UnifiedRoleAssignmentMultipleId <String>

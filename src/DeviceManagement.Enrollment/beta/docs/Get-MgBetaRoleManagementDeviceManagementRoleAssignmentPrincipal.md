...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetarolemanagementdevicemanagementroleassignmentprincipal
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaRoleManagementDeviceManagementRoleAssignmentPrincipal -UnifiedRoleAssignmentMultipleId <String>
...
### Get
```
Get-MgBetaRoleManagementDeviceManagementRoleAssignmentPrincipal -DirectoryObjectId <String>

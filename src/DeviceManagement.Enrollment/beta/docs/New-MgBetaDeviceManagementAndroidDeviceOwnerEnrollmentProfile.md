...
New-MgBetaDeviceManagementAndroidDeviceOwnerEnrollmentProfile [-AccountId <String>]
 ...
 [-WifiSecurityType <AospWifiSecurityType>] [-WifiSsid <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementAndroidDeviceOwnerEnrollmentProfile
 -BodyParameter <IMicrosoftGraphAndroidDeviceOwnerEnrollmentProfile> [-CustomHeader <String>] [-Confirm]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetadevicemanagementappleuserinitiatedenrollmentprofileassignmentcount
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementAppleUserInitiatedEnrollmentProfileAssignmentCount
 -AppleUserInitiatedEnrollmentProfileId <String> [-Filter <String>] [-Search <String>]

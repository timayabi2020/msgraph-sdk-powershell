...
Update-MgBetaDeviceManagementWindowsAutopilotDeploymentProfileAssignedDevice
 ...
 [-ResponseHeadersVariable <String>] [-SerialNumber <String>] [-SkuNumber <String>] [-SystemFamily <String>]
...
`BODYPARAMETER <IMicrosoftGraphWindowsAutopilotDeviceIdentity>`: The windowsAutopilotDeviceIdentity resource represents a Windows Autopilot Device.
  ...
  - `[DeploymentProfile <IMicrosoftGraphWindowsAutopilotDeploymentProfile>]`: Windows Autopilot Deployment Profile
    ...
    - `[OutOfBoxExperienceSetting <IMicrosoftGraphOutOfBoxExperienceSetting>]`: The Windows Autopilot Deployment Profile settings used by the device for the out-of-box experience. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported.
      - `[(Any) <Object>]`: This indicates any property can be added to this object.

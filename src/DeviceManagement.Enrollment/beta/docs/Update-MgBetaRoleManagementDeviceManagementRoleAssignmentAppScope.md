...
```
Update-MgBetaRoleManagementDeviceManagementRoleAssignmentAppScope -AppScopeId <String>
...
```
Update-MgBetaRoleManagementDeviceManagementRoleAssignmentAppScope -AppScopeId <String>
 -UnifiedRoleAssignmentMultipleId <String> -BodyParameter <IMicrosoftGraphAppScope> [-CustomHeader <String>]
...
Update-MgBetaRoleManagementDeviceManagementRoleAssignmentAppScope
 ...
 [-DisplayName <String>] [-Id <String>] [-Type <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

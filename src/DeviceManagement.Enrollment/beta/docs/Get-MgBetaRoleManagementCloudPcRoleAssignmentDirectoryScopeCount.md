...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetarolemanagementcloudpcroleassignmentdirectoryscopecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaRoleManagementCloudPcRoleAssignmentDirectoryScopeCount -UnifiedRoleAssignmentMultipleId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetadevicemanagementwindowsfeatureupdateprofileassignmentcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementWindowsFeatureUpdateProfileAssignmentCount -WindowsFeatureUpdateProfileId <String>

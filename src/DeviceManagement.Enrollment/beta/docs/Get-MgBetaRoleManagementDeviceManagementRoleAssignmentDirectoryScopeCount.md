...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetarolemanagementdevicemanagementroleassignmentdirectoryscopecount
schema: 2.0.0
---
...
```
Get-MgBetaRoleManagementDeviceManagementRoleAssignmentDirectoryScopeCount
 -UnifiedRoleAssignmentMultipleId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

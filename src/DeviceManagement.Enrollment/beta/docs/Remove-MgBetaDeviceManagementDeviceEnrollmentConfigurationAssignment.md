...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceEnrollmentConfigurationAssignment -DeviceEnrollmentConfigurationId <String>
 -EnrollmentConfigurationAssignmentId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

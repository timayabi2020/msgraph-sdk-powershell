...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/remove-mgbetadevicemanagementimporteddeviceidentity
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementImportedDeviceIdentity -ImportedDeviceIdentityId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementImportedDeviceIdentity -InputObject <IDeviceManagementEnrollmentIdentity>

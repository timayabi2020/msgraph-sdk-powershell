...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/get-mgbetarolemanagementcloudpcresourcenamespaceresourceactioncount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaRoleManagementCloudPcResourceNamespaceResourceActionCount -UnifiedRbacResourceNamespaceId <String>

...
New-MgDeviceManagementWindowsAutopilotDeviceIdentity [-AdditionalProperties <Hashtable>]
 ...
 [-SystemFamily <String>] [-UserPrincipalName <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgDeviceManagementWindowsAutopilotDeviceIdentity
 -BodyParameter <IMicrosoftGraphWindowsAutopilotDeviceIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgIdentityB2XUserFlowApiConnectorConfiguration -B2XIdentityUserFlowId <String>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphUserFlowApiConnectorConfiguration

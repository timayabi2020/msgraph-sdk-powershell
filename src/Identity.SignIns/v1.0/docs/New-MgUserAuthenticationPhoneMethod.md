...
New-MgUserAuthenticationPhoneMethod -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-PhoneNumber <String>] [-PhoneType <String>] [-SmsSignInState <String>] [-CustomHeader <String>] [-Confirm]
...
New-MgUserAuthenticationPhoneMethod -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphPhoneAuthenticationMethod> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgUserAuthenticationPhoneMethod -InputObject <IIdentitySignInsIdentity>
 ...
 [-SmsSignInState <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

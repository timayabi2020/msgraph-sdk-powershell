...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/update-mgpolicytokenissuancepolicy
schema: 2.0.0
---
...
### Update
```
Update-MgPolicyTokenIssuancePolicy -TokenIssuancePolicyId <String> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgRiskyUserHistoryCount -RiskyUserId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgRiskyUserHistoryCount -InputObject <IIdentitySignInsIdentity> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

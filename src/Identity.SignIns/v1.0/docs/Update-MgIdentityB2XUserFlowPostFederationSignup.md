...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/update-mgidentityb2xuserflowpostfederationsignup
schema: 2.0.0
---
...
```
Update-MgIdentityB2XUserFlowPostFederationSignup -B2XIdentityUserFlowId <String>
...
### UpdateViaIdentity
```
Update-MgIdentityB2XUserFlowPostFederationSignup -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphIdentityApiConnector> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/update-mgriskyuser
schema: 2.0.0
---
...
### Update
```
Update-MgRiskyUser -RiskyUserId <String> -BodyParameter <IMicrosoftGraphRiskyUser> [-CustomHeader <String>]

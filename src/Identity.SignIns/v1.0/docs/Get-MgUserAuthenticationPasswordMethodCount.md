...
### Get (Default)
```
Get-MgUserAuthenticationPasswordMethodCount -UserId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserAuthenticationPasswordMethodCount -InputObject <IIdentitySignInsIdentity> [-Filter <String>]

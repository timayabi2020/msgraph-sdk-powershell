...
### Delete (Default)
```
Remove-MgRiskDetection -RiskDetectionId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgRiskDetection -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

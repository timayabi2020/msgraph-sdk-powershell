...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/new-mgpolicyfeaturerolloutpolicyapplytobyref
schema: 2.0.0
---
...
```
New-MgPolicyFeatureRolloutPolicyApplyToByRef -FeatureRolloutPolicyId <String> -OdataId <String>
...
```
New-MgPolicyFeatureRolloutPolicyApplyToByRef -InputObject <IIdentitySignInsIdentity> -OdataId <String>
 [-AdditionalProperties <Hashtable>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

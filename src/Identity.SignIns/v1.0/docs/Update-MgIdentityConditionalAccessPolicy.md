...
Update-MgIdentityConditionalAccessPolicy -ConditionalAccessPolicyId <String>
 ...
 [-State <String>] [-TemplateId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgIdentityConditionalAccessPolicy -ConditionalAccessPolicyId <String>
 -BodyParameter <IMicrosoftGraphConditionalAccessPolicy> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

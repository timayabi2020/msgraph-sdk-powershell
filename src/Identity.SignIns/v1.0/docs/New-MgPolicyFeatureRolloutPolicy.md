...
New-MgPolicyFeatureRolloutPolicy [-AdditionalProperties <Hashtable>]
 ...
 [-Feature <String>] [-Id <String>] [-IsAppliedToOrganization] [-IsEnabled] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgPolicyFeatureRolloutPolicy -BodyParameter <IMicrosoftGraphFeatureRolloutPolicy> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgDataPolicyOperation -DataPolicyOperationId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDataPolicyOperation -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]

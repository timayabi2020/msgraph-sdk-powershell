...
### List (Default)
```
Get-MgIdentityB2XUserFlowLanguageOverridePage -B2XIdentityUserFlowId <String>
...
### GetViaIdentity
```
Get-MgIdentityB2XUserFlowLanguageOverridePage -InputObject <IIdentitySignInsIdentity>

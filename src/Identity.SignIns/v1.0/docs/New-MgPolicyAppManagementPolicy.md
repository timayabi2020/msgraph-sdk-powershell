...
New-MgPolicyAppManagementPolicy [-AdditionalProperties <Hashtable>]
 ...
 [-Restrictions <IMicrosoftGraphAppManagementConfiguration>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgPolicyAppManagementPolicy -BodyParameter <IMicrosoftGraphAppManagementPolicy> [-CustomHeader <String>]

...
### Delete (Default)
```
Remove-MgOauth2PermissionGrant -OAuth2PermissionGrantId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgOauth2PermissionGrant -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]

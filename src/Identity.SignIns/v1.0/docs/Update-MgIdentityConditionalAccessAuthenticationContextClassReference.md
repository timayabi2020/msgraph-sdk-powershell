...
Update-MgIdentityConditionalAccessAuthenticationContextClassReference
 ...
 [-DisplayName <String>] [-Id <String>] [-IsAvailable] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityConditionalAccessAuthenticationContextClassReference
 ...
 -BodyParameter <IMicrosoftGraphAuthenticationContextClassReference> [-CustomHeader <String>] [-Confirm]
...
Update-MgIdentityConditionalAccessAuthenticationContextClassReference -InputObject <IIdentitySignInsIdentity>
 ...
 [-IsAvailable] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

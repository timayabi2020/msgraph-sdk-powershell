...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/remove-mgserviceprincipalriskdetection
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgServicePrincipalRiskDetection -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgUserAuthenticationWindowsHelloForBusinessMethod -UserId <String>
...
### DeleteViaIdentity
```
Remove-MgUserAuthenticationWindowsHelloForBusinessMethod -InputObject <IIdentitySignInsIdentity>

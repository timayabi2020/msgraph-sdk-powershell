...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicymobileappmanagementpolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaPolicyMobileAppManagementPolicy [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaPolicyMobileAppManagementPolicy -MobilityManagementPolicyId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPolicyMobileAppManagementPolicy -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

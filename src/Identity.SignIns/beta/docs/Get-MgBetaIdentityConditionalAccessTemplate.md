...
### List (Default)
```
Get-MgBetaIdentityConditionalAccessTemplate [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaIdentityConditionalAccessTemplate -InputObject <IIdentitySignInsIdentity>

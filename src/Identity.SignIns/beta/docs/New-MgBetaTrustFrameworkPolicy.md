...
```
New-MgBetaTrustFrameworkPolicy [-AdditionalProperties <Hashtable>] [-Id <String>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaTrustFrameworkPolicy -BodyParameter <Hashtable> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

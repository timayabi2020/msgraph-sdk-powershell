...
New-MgBetaIdentityB2CUserFlow [-AdditionalProperties <Hashtable>]
 ...
 [-UserFlowTypeVersion <Single>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaIdentityB2CUserFlow -BodyParameter <IMicrosoftGraphB2CIdentityUserFlow> [-CustomHeader <String>]

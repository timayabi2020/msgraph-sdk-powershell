...
### List (Default)
```
Get-MgBetaPolicyPermissionGrantPolicyInclude -PermissionGrantPolicyId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaPolicyPermissionGrantPolicyInclude -PermissionGrantConditionSetId <String>
 -PermissionGrantPolicyId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPolicyPermissionGrantPolicyInclude -InputObject <IIdentitySignInsIdentity>

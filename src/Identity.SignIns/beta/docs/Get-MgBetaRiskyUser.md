...
### Get
```
Get-MgBetaRiskyUser -RiskyUserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaRiskyUser -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]

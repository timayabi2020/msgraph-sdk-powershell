...
### List (Default)
```
Get-MgBetaPolicyActivityBasedTimeoutPolicy [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaPolicyActivityBasedTimeoutPolicy -InputObject <IIdentitySignInsIdentity>

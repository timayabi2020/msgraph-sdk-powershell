...
### List (Default)
```
Get-MgBetaUserInformationProtectionThreatAssessmentRequestResult -ThreatAssessmentRequestId <String>
...
```
Get-MgBetaUserInformationProtectionThreatAssessmentRequestResult -ThreatAssessmentRequestId <String>
 -ThreatAssessmentResultId <String> -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserInformationProtectionThreatAssessmentRequestResult -InputObject <IIdentitySignInsIdentity>

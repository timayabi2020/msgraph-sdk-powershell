...
Update-MgBetaTrustFrameworkKeySet -TrustFrameworkKeySetId <String> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Keys <IMicrosoftGraphTrustFrameworkKey[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaTrustFrameworkKeySet -TrustFrameworkKeySetId <String>
 -BodyParameter <IMicrosoftGraphTrustFrameworkKeySet> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaInformationProtectionBitlockerRecoveryKey [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaInformationProtectionBitlockerRecoveryKey -BitlockerRecoveryKeyId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaInformationProtectionBitlockerRecoveryKey -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

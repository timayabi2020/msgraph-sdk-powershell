...
Update-MgBetaRiskDetection -RiskDetectionId <String> [-Activity <String>] [-ActivityDateTime <DateTime>]
 ...
 [-UserDisplayName <String>] [-UserId <String>] [-UserPrincipalName <String>] [-CustomHeader <String>]
...
Update-MgBetaRiskDetection -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphRiskDetection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgBetaTrustFrameworkKeySetActiveKey -TrustFrameworkKeySetId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaTrustFrameworkKeySetActiveKey -InputObject <IIdentitySignInsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

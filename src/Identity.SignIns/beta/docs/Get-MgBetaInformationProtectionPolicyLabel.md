...
### List (Default)
```
Get-MgBetaInformationProtectionPolicyLabel [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaInformationProtectionPolicyLabel -InformationProtectionLabelId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaInformationProtectionPolicyLabel -InputObject <IIdentitySignInsIdentity>

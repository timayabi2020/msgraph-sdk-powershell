...
### Delete (Default)
```
Remove-MgBetaUserAuthenticationPlatformCredentialMethod -PlatformCredentialAuthenticationMethodId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserAuthenticationPlatformCredentialMethod -InputObject <IIdentitySignInsIdentity>

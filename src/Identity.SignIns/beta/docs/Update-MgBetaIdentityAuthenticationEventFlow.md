...
Update-MgBetaIdentityAuthenticationEventFlow -AuthenticationEventsFlowId <String>
 ...
 [-Description <String>] [-DisplayName <String>] [-Id <String>] [-Priority <Int32>] [-CustomHeader <String>]
...
```
Update-MgBetaIdentityAuthenticationEventFlow -AuthenticationEventsFlowId <String>
 -BodyParameter <IMicrosoftGraphAuthenticationEventsFlow> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
Update-MgBetaTenantRelationshipMultiTenantOrganizationTenant -MultiTenantOrganizationMemberId <String>
 ...
 [-TransitionDetails <IMicrosoftGraphMultiTenantOrganizationMemberTransitionDetails>] [-CustomHeader <String>]
...
```
Update-MgBetaTenantRelationshipMultiTenantOrganizationTenant -MultiTenantOrganizationMemberId <String>
 -BodyParameter <IMicrosoftGraphMultiTenantOrganizationMember> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

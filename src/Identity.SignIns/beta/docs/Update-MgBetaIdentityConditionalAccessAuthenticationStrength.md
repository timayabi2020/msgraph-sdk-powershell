...
Update-MgBetaIdentityConditionalAccessAuthenticationStrength [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-Policies <IMicrosoftGraphAuthenticationStrengthPolicy[]>] [-CustomHeader <String>]
...
```
Update-MgBetaIdentityConditionalAccessAuthenticationStrength
 -BodyParameter <IMicrosoftGraphAuthenticationStrengthRoot> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetapolicyserviceprincipalcreationpolicyexclude
schema: 2.0.0
---
...
```
Update-MgBetaPolicyServicePrincipalCreationPolicyExclude -ServicePrincipalCreationConditionSetId <String>
 ...
 [-ApplicationTenantIds <String[]>] [-CertifiedApplicationsOnly] [-Id <String>] [-CustomHeader <String>]
...
Update-MgBetaPolicyServicePrincipalCreationPolicyExclude -ServicePrincipalCreationConditionSetId <String>
 ...
 -BodyParameter <IMicrosoftGraphServicePrincipalCreationConditionSet> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaPolicyServicePrincipalCreationPolicyExclude -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphServicePrincipalCreationConditionSet> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

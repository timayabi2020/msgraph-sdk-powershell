...
Update-MgBetaPolicyDirectoryRoleAccessReviewPolicy [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-Settings <IMicrosoftGraphAccessReviewScheduleSettings>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaPolicyDirectoryRoleAccessReviewPolicy
 -BodyParameter <IMicrosoftGraphDirectoryRoleAccessReviewPolicy> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaIdentityProvider [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgBetaIdentityProvider -IdentityProviderBaseId <String> [-ExpandProperty <String[]>]

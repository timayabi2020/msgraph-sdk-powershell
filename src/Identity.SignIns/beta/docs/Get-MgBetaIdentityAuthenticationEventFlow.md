...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetaidentityauthenticationeventflow
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaIdentityAuthenticationEventFlow [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaIdentityAuthenticationEventFlow -AuthenticationEventsFlowId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaIdentityAuthenticationEventFlow -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/remove-mgbetaidentityconditionalaccesspolicy
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaIdentityConditionalAccessPolicy -ConditionalAccessPolicyId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaIdentityConditionalAccessPolicy -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaOrganizationCertificateBasedAuthConfiguration -CertificateBasedAuthConfigurationId <String>
 -OrganizationId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaOrganizationCertificateBasedAuthConfiguration -InputObject <IIdentitySignInsIdentity>

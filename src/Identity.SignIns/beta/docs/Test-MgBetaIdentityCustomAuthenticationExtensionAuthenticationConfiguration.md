...
Test-MgBetaIdentityCustomAuthenticationExtensionAuthenticationConfiguration
 ...
 [-EndpointConfiguration <Hashtable>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Validate
```
Test-MgBetaIdentityCustomAuthenticationExtensionAuthenticationConfiguration
 -CustomAuthenticationExtensionId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Test-MgBetaIdentityCustomAuthenticationExtensionAuthenticationConfiguration
 -InputObject <IIdentitySignInsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicyauthorizationpolicydefaultuserroleoverride
schema: 2.0.0
---
...
```
Get-MgBetaPolicyAuthorizationPolicyDefaultUserRoleOverride -AuthorizationPolicyId <String>
 -DefaultUserRoleOverrideId <String> [-ExpandProperty <String[]>] [-Property <String[]>]

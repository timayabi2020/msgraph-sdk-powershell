...
New-MgBetaDataPolicyOperation [-AdditionalProperties <Hashtable>] [-CompletedDateTime <DateTime>]
 ...
 [-SubmittedDateTime <DateTime>] [-UserId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaDataPolicyOperation -BodyParameter <IMicrosoftGraphDataPolicyOperation> [-CustomHeader <String>]

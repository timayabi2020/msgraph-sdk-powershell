...
### List (Default)
```
Get-MgBetaIdentityB2CUserFlowLanguageDefaultPage -B2CIdentityUserFlowId <String>
...
### GetViaIdentity
```
Get-MgBetaIdentityB2CUserFlowLanguageDefaultPage -InputObject <IIdentitySignInsIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetauserauthenticationwindowshelloforbusinessmethoddevice
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaUserAuthenticationWindowsHelloForBusinessMethodDevice -UserId <String>
...
### GetViaIdentity
```
Get-MgBetaUserAuthenticationWindowsHelloForBusinessMethodDevice -InputObject <IIdentitySignInsIdentity>

...
### List (Default)
```
Get-MgBetaPolicyRoleManagementPolicyEffectiveRule -UnifiedRoleManagementPolicyId <String>
...
### GetViaIdentity
```
Get-MgBetaPolicyRoleManagementPolicyEffectiveRule -InputObject <IIdentitySignInsIdentity>

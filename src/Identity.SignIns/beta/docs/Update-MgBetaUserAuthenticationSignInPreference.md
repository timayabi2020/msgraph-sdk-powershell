...
Update-MgBetaUserAuthenticationSignInPreference -UserId <String>
 -BodyParameter <IMicrosoftGraphSignInPreferences> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaUserAuthenticationSignInPreference -InputObject <IIdentitySignInsIdentity>
 ...
 [-UserPreferredMethodForSecondaryAuthentication <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSignInPreferences

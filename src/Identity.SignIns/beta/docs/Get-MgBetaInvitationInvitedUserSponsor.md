...
### List (Default)
```
Get-MgBetaInvitationInvitedUserSponsor -InvitationId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaInvitationInvitedUserSponsor -DirectoryObjectId <String> -InvitationId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaInvitationInvitedUserSponsor -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]

...
Update-MgBetaTenantRelationshipManagedTenantAppPerformance -AppPerformanceId <String>
 ...
 [-TotalAppCrashCount <Int32>] [-TotalAppFreezeCount <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaTenantRelationshipManagedTenantAppPerformance -AppPerformanceId <String>
 -BodyParameter <IMicrosoftGraphManagedTenantsAppPerformance> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

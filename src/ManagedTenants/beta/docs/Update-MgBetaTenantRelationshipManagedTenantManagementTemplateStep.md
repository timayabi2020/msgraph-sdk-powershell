...
Update-MgBetaTenantRelationshipManagedTenantManagementTemplateStep -ManagementTemplateStepId <String>
 ...
 [-Versions <IMicrosoftGraphManagedTenantsManagementTemplateStepVersion[]>] [-CustomHeader <String>]
...
```
Update-MgBetaTenantRelationshipManagedTenantManagementTemplateStep -ManagementTemplateStepId <String>
 -BodyParameter <IMicrosoftGraphManagedTenantsManagementTemplateStep> [-CustomHeader <String>] [-Confirm]

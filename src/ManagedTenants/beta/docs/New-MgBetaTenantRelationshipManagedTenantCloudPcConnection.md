...
New-MgBetaTenantRelationshipManagedTenantCloudPcConnection [-AdditionalProperties <Hashtable>]
 ...
 [-TenantDisplayName <String>] [-TenantId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaTenantRelationshipManagedTenantCloudPcConnection
 -BodyParameter <IMicrosoftGraphManagedTenantsCloudPcConnection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
New-MgBetaTenantRelationshipManagedTenantAlertRuleDefinition [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-LastActionByUserId <String>] [-LastActionDateTime <DateTime>] [-CustomHeader <String>]
...
```
New-MgBetaTenantRelationshipManagedTenantAlertRuleDefinition
 -BodyParameter <IMicrosoftGraphManagedTenantsManagedTenantAlertRuleDefinition> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

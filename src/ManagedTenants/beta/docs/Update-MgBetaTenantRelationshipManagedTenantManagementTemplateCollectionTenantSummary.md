...
Update-MgBetaTenantRelationshipManagedTenantManagementTemplateCollectionTenantSummary
 ...
 [-TenantId <String>] [-UnlicensedUsersCount <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaTenantRelationshipManagedTenantManagementTemplateCollectionTenantSummary
 ...
 [-UnlicensedUsersCount <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

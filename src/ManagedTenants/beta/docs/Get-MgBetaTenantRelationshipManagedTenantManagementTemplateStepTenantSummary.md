...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.managedtenants/get-mgbetatenantrelationshipmanagedtenantmanagementtemplatesteptenantsummary
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaTenantRelationshipManagedTenantManagementTemplateStepTenantSummary [-ExpandProperty <String[]>]
...
```
Get-MgBetaTenantRelationshipManagedTenantManagementTemplateStepTenantSummary
 -ManagementTemplateStepTenantSummaryId <String> [-ExpandProperty <String[]>] [-Property <String[]>]

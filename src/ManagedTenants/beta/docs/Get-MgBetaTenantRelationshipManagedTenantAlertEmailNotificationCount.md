...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.managedtenants/get-mgbetatenantrelationshipmanagedtenantalertemailnotificationcount
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaTenantRelationshipManagedTenantAlertEmailNotificationCount -InputObject <IManagedTenantsIdentity>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

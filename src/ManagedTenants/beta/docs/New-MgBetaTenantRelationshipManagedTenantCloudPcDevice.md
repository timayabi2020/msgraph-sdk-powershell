...
New-MgBetaTenantRelationshipManagedTenantCloudPcDevice [-AdditionalProperties <Hashtable>]
 ...
 [-TenantDisplayName <String>] [-TenantId <String>] [-UserPrincipalName <String>] [-CustomHeader <String>]
...
```
New-MgBetaTenantRelationshipManagedTenantCloudPcDevice
 -BodyParameter <IMicrosoftGraphManagedTenantsCloudPcDevice> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

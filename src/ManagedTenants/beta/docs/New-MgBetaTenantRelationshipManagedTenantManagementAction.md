...
New-MgBetaTenantRelationshipManagedTenantManagementAction [-AdditionalProperties <Hashtable>]
 ...
 [-WorkloadActions <IMicrosoftGraphManagedTenantsWorkloadAction[]>] [-CustomHeader <String>] [-Confirm]
...
```
New-MgBetaTenantRelationshipManagedTenantManagementAction
 -BodyParameter <IMicrosoftGraphManagedTenantsManagementAction> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

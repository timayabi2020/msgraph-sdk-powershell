...
Update-MgBetaTenantRelationshipManagedTenantEmailNotification -ManagedTenantEmailNotificationId <String>
 ...
 [-LastActionByUserId <String>] [-LastActionDateTime <DateTime>] [-Subject <String>] [-CustomHeader <String>]
...
```
Update-MgBetaTenantRelationshipManagedTenantEmailNotification -ManagedTenantEmailNotificationId <String>
 -BodyParameter <IMicrosoftGraphManagedTenantsManagedTenantEmailNotification> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
Update-MgBetaTenantRelationshipManagedTenantDeviceAppPerformance -DeviceAppPerformanceId <String>
 ...
 [-TenantId <String>] [-TotalAppCrashCount <Int32>] [-TotalAppFreezeCount <Int32>] [-CustomHeader <String>]
...
```
Update-MgBetaTenantRelationshipManagedTenantDeviceAppPerformance -DeviceAppPerformanceId <String>
 -BodyParameter <IMicrosoftGraphManagedTenantsDeviceAppPerformance> [-CustomHeader <String>] [-Confirm]

...
New-MgBetaTenantRelationshipManagedTenantAlert [-AdditionalProperties <Hashtable>]
 ...
 [-Status <String>] [-TenantId <String>] [-Title <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaTenantRelationshipManagedTenantAlert
 -BodyParameter <IMicrosoftGraphManagedTenantsManagedTenantAlert> [-CustomHeader <String>] [-Confirm]

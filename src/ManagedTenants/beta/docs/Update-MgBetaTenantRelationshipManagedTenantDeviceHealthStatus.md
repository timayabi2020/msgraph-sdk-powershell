...
Update-MgBetaTenantRelationshipManagedTenantDeviceHealthStatus -DeviceHealthStatusId <String>
 ...
 [-TenantDisplayName <String>] [-TenantId <String>] [-TopProcesses <String>] [-CustomHeader <String>]
...
```
Update-MgBetaTenantRelationshipManagedTenantDeviceHealthStatus -DeviceHealthStatusId <String>
 -BodyParameter <IMicrosoftGraphManagedTenantsDeviceHealthStatus> [-CustomHeader <String>] [-Confirm]

...
Update-MgBetaTenantRelationshipManagedTenant -TenantId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-TenantStatusInformation <IMicrosoftGraphManagedTenantsTenantStatusInformation>] [-CustomHeader <String>]
...
Update-MgBetaTenantRelationshipManagedTenant -TenantId <String>
 -BodyParameter <IMicrosoftGraphManagedTenantsTenant> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaTenantRelationshipManagedTenantAlertRule [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaTenantRelationshipManagedTenantAlertRule -ManagedTenantAlertRuleId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaTenantRelationshipManagedTenantAlertRule -ManagedTenantAlertId <String> [-ExpandProperty <String[]>]

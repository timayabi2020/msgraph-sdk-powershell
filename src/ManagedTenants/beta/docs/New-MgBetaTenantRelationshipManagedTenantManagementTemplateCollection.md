...
New-MgBetaTenantRelationshipManagedTenantManagementTemplateCollection [-AdditionalProperties <Hashtable>]
 ...
 [-ManagementTemplates <IMicrosoftGraphManagedTenantsManagementTemplate[]>] [-CustomHeader <String>]
...
```
New-MgBetaTenantRelationshipManagedTenantManagementTemplateCollection
 -BodyParameter <IMicrosoftGraphManagedTenantsManagementTemplateCollection> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

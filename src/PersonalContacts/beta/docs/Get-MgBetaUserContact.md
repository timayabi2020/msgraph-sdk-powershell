...
### List (Default)
```
Get-MgBetaUserContact -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgBetaUserContact -ContactId <String> -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]

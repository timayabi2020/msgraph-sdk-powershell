...
### Set (Default)
```
Set-MgBetaUserContactPhotoContent -ContactId <String> -UserId <String> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaUserContactPhotoContent -InputObject <IPersonalContactsIdentity> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

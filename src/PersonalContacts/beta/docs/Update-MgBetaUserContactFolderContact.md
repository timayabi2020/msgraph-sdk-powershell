...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/update-mgbetausercontactfoldercontact
schema: 2.0.0
---
...
```
Update-MgBetaUserContactFolderContact -ContactFolderId <String> -ContactId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserContactFolderContact -InputObject <IPersonalContactsIdentity>
 -BodyParameter <IMicrosoftGraphContact> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/update-mgbetausercontactfolderchildfoldercontact
schema: 2.0.0
---
...
```
Update-MgBetaUserContactFolderChildFolderContact -ContactFolderId <String> -ContactFolderId1 <String>
 ...
 [-YomiCompanyName <String>] [-YomiGivenName <String>] [-YomiSurname <String>] [-CustomHeader <String>]
...
```
Update-MgBetaUserContactFolderChildFolderContact -ContactFolderId <String> -ContactFolderId1 <String>
 -ContactId <String> -UserId <String> -BodyParameter <IMicrosoftGraphContact> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaUserContactFolderChildFolderContact -InputObject <IPersonalContactsIdentity>
 -BodyParameter <IMicrosoftGraphContact> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

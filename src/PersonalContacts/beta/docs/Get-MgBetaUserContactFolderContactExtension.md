...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactfoldercontactextension
schema: 2.0.0
---
...
### Get
```
Get-MgBetaUserContactFolderContactExtension -ContactFolderId <String> -ContactId <String>
...
### GetViaIdentity
```
Get-MgBetaUserContactFolderContactExtension -InputObject <IPersonalContactsIdentity>

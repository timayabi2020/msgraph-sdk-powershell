...
```
New-MgUserContactFolderChildFolderContact -ContactFolderId <String> -ContactFolderId1 <String>
...
```
New-MgUserContactFolderChildFolderContact -ContactFolderId <String> -ContactFolderId1 <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphContact> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaPlace -PlaceId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPlace -InputObject <ICalendarIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

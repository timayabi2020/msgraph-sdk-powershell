...
### Get (Default)
```
Get-MgBetaUserEventExtensionCount -EventId <String> -UserId <String> [-Filter <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserEventExtensionCount -InputObject <ICalendarIdentity> [-Filter <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaPlaceAsRoomListWorkspace -PlaceId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaPlaceAsRoomListWorkspace -PlaceId <String> -WorkspaceId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPlaceAsRoomListWorkspace -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
### Get
```
Get-MgBetaGroupEvent -EventId <String> -GroupId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupEvent -InputObject <ICalendarIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetagroupcalendarpermission
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaGroupCalendarPermission -InputObject <ICalendarIdentity> [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaUserEventExceptionOccurrenceAttachment -EventId <String> -EventId1 <String> -UserId <String>
...
### Get
```
Get-MgBetaUserEventExceptionOccurrenceAttachment -AttachmentId <String> -EventId <String> -EventId1 <String>
...
### GetViaIdentity
```
Get-MgBetaUserEventExceptionOccurrenceAttachment -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]

...
### Delete (Default)
```
Remove-MgBetaUserEventExtension -EventId <String> -ExtensionId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserEventExtension -InputObject <ICalendarIdentity> [-IfMatch <String>] [-CustomHeader <String>]

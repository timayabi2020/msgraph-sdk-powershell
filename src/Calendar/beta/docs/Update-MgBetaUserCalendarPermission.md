...
Update-MgBetaUserCalendarPermission -CalendarPermissionId <String> -UserId <String>
 ...
 [-Id <String>] [-IsInsideOrganization] [-IsRemovable] [-Role <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaUserCalendarPermission -CalendarPermissionId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphCalendarPermission> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update1
```
Update-MgBetaUserCalendarPermission -CalendarId <String> -CalendarPermissionId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphCalendarPermission> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserCalendarPermission -InputObject <ICalendarIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-IsInsideOrganization] [-IsRemovable] [-Role <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

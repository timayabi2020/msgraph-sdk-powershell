...
### Get (Default)
```
Get-MgBetaUserEventCalendar -EventId <String> -UserId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserEventCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

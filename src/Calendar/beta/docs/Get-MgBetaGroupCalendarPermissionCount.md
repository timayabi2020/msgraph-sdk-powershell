...
### Get (Default)
```
Get-MgBetaGroupCalendarPermissionCount -GroupId <String> [-Filter <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupCalendarPermissionCount -InputObject <ICalendarIdentity> [-Filter <String>]

...
### Delete (Default)
```
Remove-MgGroupEventInstanceExtension -EventId <String> -EventId1 <String> -ExtensionId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupEventInstanceExtension -InputObject <ICalendarIdentity> [-IfMatch <String>]

...
### Create
```
New-MgGroupEventExtension -EventId <String> -GroupId <String> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupEventExtension -InputObject <ICalendarIdentity> -BodyParameter <Hashtable> [-CustomHeader <String>]

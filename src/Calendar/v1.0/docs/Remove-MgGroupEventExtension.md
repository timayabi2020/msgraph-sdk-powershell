...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/remove-mggroupeventextension
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgGroupEventExtension -InputObject <ICalendarIdentity> [-IfMatch <String>] [-CustomHeader <String>]

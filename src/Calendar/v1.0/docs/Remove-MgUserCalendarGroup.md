...
### Delete (Default)
```
Remove-MgUserCalendarGroup -CalendarGroupId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserCalendarGroup -InputObject <ICalendarIdentity> [-IfMatch <String>] [-CustomHeader <String>]

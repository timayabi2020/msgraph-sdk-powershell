...
### Create
```
New-MgUserEvent -UserId <String> -BodyParameter <IMicrosoftGraphEvent> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>

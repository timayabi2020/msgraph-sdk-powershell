...
### Get (Default)
```
Get-MgGroupEventAttachmentCount -EventId <String> -GroupId <String> [-Filter <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupEventAttachmentCount -InputObject <ICalendarIdentity> [-Filter <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

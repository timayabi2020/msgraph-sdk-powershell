...
### Get (Default)
```
Get-MgGroupCalendar -GroupId <String> [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendar -InputObject <ICalendarIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

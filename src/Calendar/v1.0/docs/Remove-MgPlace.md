...
### Delete (Default)
```
Remove-MgPlace -PlaceId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgPlace -InputObject <ICalendarIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

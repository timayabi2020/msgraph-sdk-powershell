...
### Get (Default)
```
Get-MgUserCalendarPermissionCount -UserId <String> [-Filter <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgUserCalendarPermissionCount -InputObject <ICalendarIdentity> [-Filter <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

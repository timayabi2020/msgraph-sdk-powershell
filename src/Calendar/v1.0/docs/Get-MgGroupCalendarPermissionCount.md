...
### Get (Default)
```
Get-MgGroupCalendarPermissionCount -GroupId <String> [-Filter <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendarPermissionCount -InputObject <ICalendarIdentity> [-Filter <String>]

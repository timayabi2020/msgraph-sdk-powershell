...
```
New-MgGroupCalendarEvent -GroupId <String> [-AdditionalProperties <Hashtable>] [-AllowNewTimeProposals]
 ...
 [-WebLink <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgGroupCalendarEvent -GroupId <String> -BodyParameter <IMicrosoftGraphEvent> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupCalendarEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupCalendarEvent -InputObject <ICalendarIdentity> [-AdditionalProperties <Hashtable>]

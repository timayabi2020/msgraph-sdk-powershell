...
### Comment (Default)
```
Invoke-MgCommentSecurityAlert -AlertId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### CommentViaIdentity
```
Invoke-MgCommentSecurityAlert -InputObject <ISecurityIdentity> [-Filter <String>] [-Search <String>]

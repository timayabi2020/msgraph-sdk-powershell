...
### Delete (Default)
```
Remove-MgSecurityTriggerRetentionEvent -RetentionEventId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSecurityTriggerRetentionEvent -InputObject <ISecurityIdentity> [-IfMatch <String>]

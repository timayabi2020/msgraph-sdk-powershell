...
### Delete (Default)
```
Remove-MgSecurityAttackSimulationLandingPageDetail -LandingPageDetailId <String> -LandingPageId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSecurityAttackSimulationLandingPageDetail -InputObject <ISecurityIdentity> [-IfMatch <String>]

...
### Delete (Default)
```
Remove-MgSecurityAlertV2 -AlertId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSecurityAlertV2 -InputObject <ISecurityIdentity> [-IfMatch <String>] [-CustomHeader <String>]

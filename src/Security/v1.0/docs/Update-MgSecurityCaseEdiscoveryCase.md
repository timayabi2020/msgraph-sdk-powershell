...
Update-MgSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Tags <IMicrosoftGraphSecurityEdiscoveryReviewTag[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String>
 -BodyParameter <IMicrosoftGraphSecurityEdiscoveryCase> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

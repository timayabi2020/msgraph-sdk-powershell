...
Update-MgSecurityTriggerType [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-RetentionEventTypes <IMicrosoftGraphSecurityRetentionEventType[]>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgSecurityTriggerType -BodyParameter <IMicrosoftGraphSecurityTriggerTypesRoot> [-CustomHeader <String>]

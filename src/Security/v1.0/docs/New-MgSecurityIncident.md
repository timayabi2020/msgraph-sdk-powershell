...
New-MgSecurityIncident [-AdditionalProperties <Hashtable>] [-Alerts <IMicrosoftGraphSecurityAlert[]>]
 ...
 [-SystemTags <String[]>] [-TenantId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgSecurityIncident -BodyParameter <IMicrosoftGraphSecurityIncident> [-CustomHeader <String>] [-Confirm]

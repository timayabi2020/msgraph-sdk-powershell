...
### List (Default)
```
Get-MgSecurityThreatIntelligenceHostPort [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSecurityThreatIntelligenceHostPort -HostPortId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgSecurityThreatIntelligenceHostPort -HostId <String> -HostPortId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityThreatIntelligenceHostPort -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```
...
### List1
```
Get-MgSecurityThreatIntelligenceHostPort -HostId <String> [-ExpandProperty <String[]>] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>] [-All]
 [-CountVariable <String>] [-CustomHeader <String>] [-PageSize <Int32>] [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgSecurityThreatIntelligencePassiveDnsRecordArtifact -PassiveDnsRecordId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityThreatIntelligencePassiveDnsRecordArtifact -InputObject <ISecurityIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

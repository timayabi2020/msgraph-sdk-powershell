...
### Get (Default)
```
Get-MgSecurityThreatIntelligenceArticleIndicatorCount [-Filter <String>] [-Search <String>]
...
### GetViaIdentity
```
Get-MgSecurityThreatIntelligenceArticleIndicatorCount -InputObject <ISecurityIdentity> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

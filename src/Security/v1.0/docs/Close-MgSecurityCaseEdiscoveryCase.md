...
### Close (Default)
```
Close-MgSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CloseViaIdentity
```
Close-MgSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity> [-CustomHeader <String>] [-PassThru]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/new-mgsecuritythreatintelligencewhoishistoryrecord
schema: 2.0.0
---
...
```
New-MgSecurityThreatIntelligenceWhoisHistoryRecord [-Abuse <IMicrosoftGraphSecurityWhoisContact>]
...
### Create
```
New-MgSecurityThreatIntelligenceWhoisHistoryRecord -BodyParameter <Hashtable> [-CustomHeader <String>]

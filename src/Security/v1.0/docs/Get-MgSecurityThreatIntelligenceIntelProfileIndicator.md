...
### List (Default)
```
Get-MgSecurityThreatIntelligenceIntelProfileIndicator -IntelligenceProfileId <String>
...
### GetViaIdentity
```
Get-MgSecurityThreatIntelligenceIntelProfileIndicator -InputObject <ISecurityIdentity>

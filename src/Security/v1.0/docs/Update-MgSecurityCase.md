...
Update-MgSecurityCase [-AdditionalProperties <Hashtable>]
 [-EdiscoveryCases <IMicrosoftGraphSecurityEdiscoveryCase[]>] [-Id <String>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgSecurityCase -BodyParameter <IMicrosoftGraphSecurityCasesRoot> [-CustomHeader <String>] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityCasesRoot
...
`BODYPARAMETER <IMicrosoftGraphSecurityCasesRoot>`: casesRoot
  ...
  - `[EdiscoveryCases <IMicrosoftGraphSecurityEdiscoveryCase[]>]`: 
    ...
    - `[Custodians <IMicrosoftGraphSecurityEdiscoveryCustodian[]>]`: Returns a list of case ediscoveryCustodian objects for this case.
      ...
      - `[UserSources <IMicrosoftGraphSecurityUserSource[]>]`: Data source entity for a the custodian. This is the container for a custodian's mailbox and OneDrive for Business site.
        - `[CreatedBy <IMicrosoftGraphIdentitySet>]`: identitySet
        - `[CreatedDateTime <DateTime?>]`: The date and time the dataSource was created.
        - `[DisplayName <String>]`: The display name of the dataSource and is the name of the SharePoint site.
        - `[HoldStatus <String>]`: dataSourceHoldStatus

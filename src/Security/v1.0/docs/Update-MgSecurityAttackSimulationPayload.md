...
Update-MgSecurityAttackSimulationPayload -PayloadId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Technique <String>] [-Theme <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgSecurityAttackSimulationPayload -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphPayload> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

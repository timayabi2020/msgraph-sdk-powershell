...
### List (Default)
```
Get-MgSecurityAttackSimulationEndUserNotification [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSecurityAttackSimulationEndUserNotification -EndUserNotificationId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityAttackSimulationEndUserNotification -InputObject <ISecurityIdentity>

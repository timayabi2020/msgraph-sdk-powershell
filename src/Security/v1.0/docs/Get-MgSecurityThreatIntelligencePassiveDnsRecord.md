...
### List (Default)
```
Get-MgSecurityThreatIntelligencePassiveDnsRecord [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSecurityThreatIntelligencePassiveDnsRecord -PassiveDnsRecordId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityThreatIntelligencePassiveDnsRecord -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
```
New-MgSecurityThreatIntelligenceWhoisRecord [-Abuse <IMicrosoftGraphSecurityWhoisContact>]
...
### Create
```
New-MgSecurityThreatIntelligenceWhoisRecord -BodyParameter <IMicrosoftGraphSecurityWhoisRecord>

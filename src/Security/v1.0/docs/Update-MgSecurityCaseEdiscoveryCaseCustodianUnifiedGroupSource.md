...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritycaseediscoverycasecustodianunifiedgroupsource
schema: 2.0.0
---
...
Update-MgSecurityCaseEdiscoveryCaseCustodianUnifiedGroupSource -EdiscoveryCaseId <String>
 ...
 -BodyParameter <IMicrosoftGraphSecurityUnifiedGroupSource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgSecurityCaseEdiscoveryCaseCustodianUnifiedGroupSource -InputObject <ISecurityIdentity>
 ...
 [-IncludedSources <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

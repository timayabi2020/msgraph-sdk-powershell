...
```
New-MgSecurityAttackSimulationOperation [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
...
### Create
```
New-MgSecurityAttackSimulationOperation -BodyParameter <IMicrosoftGraphAttackSimulationOperation>

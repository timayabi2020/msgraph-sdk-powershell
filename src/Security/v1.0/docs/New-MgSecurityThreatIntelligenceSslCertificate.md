...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/new-mgsecuritythreatintelligencesslcertificate
schema: 2.0.0
---
...
New-MgSecurityThreatIntelligenceSslCertificate [-AdditionalProperties <Hashtable>]
 ...
 [-Sha1 <String>] [-Subject <IMicrosoftGraphSecuritySslCertificateEntity>] [-CustomHeader <String>] [-Confirm]

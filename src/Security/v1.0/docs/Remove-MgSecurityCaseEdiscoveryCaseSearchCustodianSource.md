...
### Delete (Default)
```
Remove-MgSecurityCaseEdiscoveryCaseSearchCustodianSource -DataSourceId <String> -EdiscoveryCaseId <String>
...
### DeleteViaIdentity
```
Remove-MgSecurityCaseEdiscoveryCaseSearchCustodianSource -InputObject <ISecurityIdentity> [-IfMatch <String>]

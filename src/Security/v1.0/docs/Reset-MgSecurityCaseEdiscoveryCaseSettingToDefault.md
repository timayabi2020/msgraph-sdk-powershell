...
### Reset (Default)
```
Reset-MgSecurityCaseEdiscoveryCaseSettingToDefault -EdiscoveryCaseId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgSecurityCaseEdiscoveryCaseSettingToDefault -InputObject <ISecurityIdentity> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
New-MgSecurityAttackSimulationPayload [-AdditionalProperties <Hashtable>] [-Brand <String>]
 ...
 [-Status <String>] [-Technique <String>] [-Theme <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgSecurityAttackSimulationPayload -BodyParameter <IMicrosoftGraphPayload> [-CustomHeader <String>]

...
### List (Default)
```
Get-MgSecurityThreatIntelligenceSubdomain [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSecurityThreatIntelligenceSubdomain -SubdomainId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityThreatIntelligenceSubdomain -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

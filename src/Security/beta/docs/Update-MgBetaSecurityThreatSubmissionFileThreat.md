...
Update-MgBetaSecurityThreatSubmissionFileThreat -FileThreatSubmissionId <String>
 ...
 [-Status <String>] [-TenantId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityThreatSubmissionFileThreat -FileThreatSubmissionId <String>
 -BodyParameter <IMicrosoftGraphSecurityFileThreatSubmission> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

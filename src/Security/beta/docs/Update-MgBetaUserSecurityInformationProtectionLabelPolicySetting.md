...
Update-MgBetaUserSecurityInformationProtectionLabelPolicySetting -UserId <String>
 ...
 [-IsDowngradeJustificationRequired] [-IsMandatory] [-MoreInfoUrl <String>] [-CustomHeader <String>]
...
```
Update-MgBetaUserSecurityInformationProtectionLabelPolicySetting -UserId <String>
 -BodyParameter <IMicrosoftGraphSecurityInformationProtectionPolicySetting> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
# Update-MgBetaSecurityLabelAuthority
...
### Update
```
Update-MgBetaSecurityLabelAuthority -AuthorityTemplateId <String> -BodyParameter <Hashtable>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaSecurityLabelAuthority -InputObject <ISecurityIdentity> -BodyParameter <Hashtable>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaSecurityLabelCategorySubCategory -CategoryTemplateId <String> -SubCategoryTemplateId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaSecurityLabelCategorySubCategory -InputObject <ISecurityIdentity> [-IfMatch <String>]

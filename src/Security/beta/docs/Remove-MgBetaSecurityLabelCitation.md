...
### Delete (Default)
```
Remove-MgBetaSecurityLabelCitation -CitationTemplateId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecurityLabelCitation -InputObject <ISecurityIdentity> [-IfMatch <String>]

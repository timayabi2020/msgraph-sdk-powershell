...
Update-MgBetaSecurityLabelCategory -CategoryTemplateId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-SubCategories <IMicrosoftGraphSecuritySubCategoryTemplate[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaSecurityLabelCategory -CategoryTemplateId <String>
 -BodyParameter <IMicrosoftGraphSecurityCategoryTemplate> [-Confirm] [-WhatIf] [<CommonParameters>]
```

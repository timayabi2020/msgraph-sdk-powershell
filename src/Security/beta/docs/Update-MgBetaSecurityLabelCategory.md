...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritylabelcategory
schema: 2.0.0
---
...
```
Update-MgBetaSecurityLabelCategory -CategoryTemplateId <String> [-AdditionalProperties <Hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DisplayName <String>]
 [-Id <String>] [-SubCategories <IMicrosoftGraphSecuritySubCategoryTemplate[]>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityLabelCategory -CategoryTemplateId <String>
 -BodyParameter <IMicrosoftGraphSecurityCategoryTemplate> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaSecurityLabelCategory -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityCategoryTemplate> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaSecurityLabelCategory -InputObject <ISecurityIdentity> [-AdditionalProperties <Hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DisplayName <String>]
 [-Id <String>] [-SubCategories <IMicrosoftGraphSecuritySubCategoryTemplate[]>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

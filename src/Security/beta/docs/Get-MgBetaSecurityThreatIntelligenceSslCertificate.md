...
### List (Default)
```
Get-MgBetaSecurityThreatIntelligenceSslCertificate [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityThreatIntelligenceSslCertificate -SslCertificateId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceSslCertificate -InputObject <ISecurityIdentity>

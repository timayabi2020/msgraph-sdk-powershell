...
### Activate (Default)
```
Initialize-MgBetaSecurityCaseEdiscoveryCaseCustodian -EdiscoveryCaseId <String>
...
### ActivateViaIdentity
```
Initialize-MgBetaSecurityCaseEdiscoveryCaseCustodian -InputObject <ISecurityIdentity> [-CustomHeader <String>]

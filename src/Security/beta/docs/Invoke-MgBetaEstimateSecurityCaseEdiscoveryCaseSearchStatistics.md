...
Invoke-MgBetaEstimateSecurityCaseEdiscoveryCaseSearchStatistics -EdiscoveryCaseId <String>
 -EdiscoverySearchId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EstimateViaIdentity
```
Invoke-MgBetaEstimateSecurityCaseEdiscoveryCaseSearchStatistics -InputObject <ISecurityIdentity>

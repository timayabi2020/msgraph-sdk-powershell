...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritythreatintelligencehostsslcertificate
schema: 2.0.0
---
...
Update-MgBetaSecurityThreatIntelligenceHostSslCertificate -HostSslCertificateId <String>
 ...
 [-SslCertificate <IMicrosoftGraphSecuritySslCertificate>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaSecurityThreatIntelligenceHostSslCertificate -HostSslCertificateId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostSslCertificate> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -FirstSeenDateTime
The first date and time that this hostSslCertificate was observed.
...
### -LastSeenDateTime
The most recent date and time that this hostSslCertificate was observed.
The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time.
For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityHostSslCertificatePort[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:

...
### List (Default)
```
Get-MgBetaSecurityThreatIntelligenceHostChildHostPair -HostId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaSecurityThreatIntelligenceHostChildHostPair -HostId <String> -HostPairId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceHostChildHostPair -InputObject <ISecurityIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

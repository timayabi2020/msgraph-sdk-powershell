...
```
New-MgBetaSecurityLabelDepartment [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaSecurityLabelDepartment -BodyParameter <Hashtable> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

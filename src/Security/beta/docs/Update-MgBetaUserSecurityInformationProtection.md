...
Update-MgBetaUserSecurityInformationProtection -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-SensitivityLabels <IMicrosoftGraphSecuritySensitivityLabel[]>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaUserSecurityInformationProtection -UserId <String>
 -BodyParameter <IMicrosoftGraphSecurityInformationProtection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

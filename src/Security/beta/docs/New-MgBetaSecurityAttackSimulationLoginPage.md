...
New-MgBetaSecurityAttackSimulationLoginPage [-AdditionalProperties <Hashtable>] [-Content <String>]
 ...
 [-LastModifiedDateTime <DateTime>] [-Source <String>] [-Status <String>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaSecurityAttackSimulationLoginPage -BodyParameter <IMicrosoftGraphLoginPage> [-CustomHeader <String>]

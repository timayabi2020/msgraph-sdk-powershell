...
Update-MgBetaSecurityIPSecurityProfile -IPSecurityProfileId <String> [-ActivityGroupNames <String[]>]
 ...
 [-Tags <String[]>] [-VendorInformation <IMicrosoftGraphSecurityVendorInformation>] [-CustomHeader <String>]
...
Update-MgBetaSecurityIPSecurityProfile -IPSecurityProfileId <String>
 -BodyParameter <IMicrosoftGraphIPSecurityProfile> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaSecurityThreatIntelligenceIntelProfile [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityThreatIntelligenceIntelProfile -IntelligenceProfileId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceIntelProfile -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

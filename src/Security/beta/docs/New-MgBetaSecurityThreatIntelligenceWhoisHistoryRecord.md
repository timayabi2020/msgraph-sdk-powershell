...
```
New-MgBetaSecurityThreatIntelligenceWhoisHistoryRecord [-Abuse <IMicrosoftGraphSecurityWhoisContact>]
...
### Create
```
New-MgBetaSecurityThreatIntelligenceWhoisHistoryRecord -BodyParameter <Hashtable> [-CustomHeader <String>]

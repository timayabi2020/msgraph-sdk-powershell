...
Update-MgBetaSecurityThreatIntelligenceHostReputation -HostId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Score <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityThreatIntelligenceHostReputation -HostId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostReputation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaSecurityThreatIntelligenceHostReputation -InputObject <ISecurityIdentity>
 ...
 [-Rules <IMicrosoftGraphSecurityHostReputationRule[]>] [-Score <Int32>] [-CustomHeader <String>] [-Confirm]

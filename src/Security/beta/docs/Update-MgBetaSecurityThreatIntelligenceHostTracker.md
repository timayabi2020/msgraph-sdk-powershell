...
Update-MgBetaSecurityThreatIntelligenceHostTracker -HostTrackerId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostTracker> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaSecurityThreatIntelligenceHostTracker -InputObject <ISecurityIdentity>
 ...
 [-Id <String>] [-Kind <String>] [-LastSeenDateTime <DateTime>] [-Value <String>] [-CustomHeader <String>]

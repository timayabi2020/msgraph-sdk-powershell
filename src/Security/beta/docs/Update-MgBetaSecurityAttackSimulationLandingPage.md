...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecurityattacksimulationlandingpage
schema: 2.0.0
---
...
```
Update-MgBetaSecurityAttackSimulationLandingPage -LandingPageId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgBetaSecurityAttackSimulationLandingPage -LandingPageId <String>
 -BodyParameter <IMicrosoftGraphLandingPage> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaSecurityAttackSimulationLandingPage -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphLandingPage> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaSecurityAttackSimulationLandingPage -InputObject <ISecurityIdentity>
 ...
 [-Locale <String>] [-ResponseHeadersVariable <String>] [-Source <String>] [-Status <String>]
 [-SupportedLocales <String[]>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

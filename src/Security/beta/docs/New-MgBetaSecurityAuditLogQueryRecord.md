...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecurityauditlogqueryrecord
schema: 2.0.0
---
...
New-MgBetaSecurityAuditLogQueryRecord -AuditLogQueryId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UserType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaSecurityAuditLogQueryRecord -AuditLogQueryId <String>
 -BodyParameter <IMicrosoftGraphSecurityAuditLogRecord> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

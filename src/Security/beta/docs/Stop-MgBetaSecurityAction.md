...
### Cancel (Default)
```
Stop-MgBetaSecurityAction -SecurityActionId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaSecurityAction -InputObject <ISecurityIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

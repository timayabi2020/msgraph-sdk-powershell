...
Update-MgBetaSecurityThreatIntelligenceHostCookie -HostCookieId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastSeenDateTime <DateTime>] [-Name <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaSecurityThreatIntelligenceHostCookie -HostCookieId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostCookie> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaSecurityCaseEdiscoveryCaseSearchNoncustodialSource -EdiscoveryCaseId <String>
 -EdiscoveryNoncustodialDataSourceId <String> -EdiscoverySearchId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecurityCaseEdiscoveryCaseSearchNoncustodialSource -InputObject <ISecurityIdentity>

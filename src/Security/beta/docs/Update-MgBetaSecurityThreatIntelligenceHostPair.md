...
Update-MgBetaSecurityThreatIntelligenceHostPair -HostPairId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostPair> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaSecurityThreatIntelligenceHostPair -InputObject <ISecurityIdentity>
 ...
 [-ParentHost <IMicrosoftGraphSecurityHost>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

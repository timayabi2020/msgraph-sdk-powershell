...
Update-MgBetaSecurityLabel [-AdditionalProperties <Hashtable>]
 ...
 [-RetentionLabels <IMicrosoftGraphSecurityRetentionLabel[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityLabel -BodyParameter <IMicrosoftGraphSecurityLabelsRoot> [-CustomHeader <String>]

...
Update-MgBetaSecurityAlert -AlertId <String> [-ActivityGroupName <String>] [-AdditionalProperties <Hashtable>]
 ...
 [-VulnerabilityStates <IMicrosoftGraphVulnerabilityState[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityAlert -AlertId <String> -BodyParameter <IMicrosoftGraphAlert> [-CustomHeader <String>]

...
Update-MgBetaSecurityThreatSubmissionUrlThreat -UrlThreatSubmissionId <String>
 ...
 [-TenantId <String>] [-WebUrl <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityThreatSubmissionUrlThreat -UrlThreatSubmissionId <String>
 -BodyParameter <IMicrosoftGraphSecurityUrlThreatSubmission> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

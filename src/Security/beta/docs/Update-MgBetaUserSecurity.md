...
Update-MgBetaUserSecurity -UserId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-InformationProtection <IMicrosoftGraphSecurityInformationProtection>] [-ResponseHeadersVariable <String>]
...
Update-MgBetaUserSecurity -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityAutoGenerated> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
Update-MgBetaSecurityThreatIntelligenceSslCertificate -SslCertificateId <String>
 ...
 [-Subject <IMicrosoftGraphSecuritySslCertificateEntity>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaSecurityThreatIntelligenceSslCertificate -SslCertificateId <String>
 -BodyParameter <IMicrosoftGraphSecuritySslCertificate> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

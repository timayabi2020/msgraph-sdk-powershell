...
```
Update-MgBetaSecurityThreatIntelligenceArticle -ArticleId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Title <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaSecurityThreatIntelligenceArticle -ArticleId <String>
 -BodyParameter <IMicrosoftGraphSecurityArticle> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

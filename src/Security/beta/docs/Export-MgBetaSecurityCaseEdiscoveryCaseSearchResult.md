...
Export-MgBetaSecurityCaseEdiscoveryCaseSearchResult -EdiscoveryCaseId <String> -EdiscoverySearchId <String>
 [-AdditionalOptions <String>] [-AdditionalProperties <Hashtable>] [-Description <String>]
 [-DisplayName <String>] [-ExportCriteria <String>] [-ExportFormat <String>] [-ExportLocation <String>]
 [-ExportSingleItems] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths12QiiylSecurityCasesEdiscoverycasesEdiscoverycaseIdSearchesEdiscoverysearchIdMicrosoftGraphSecurityExportresultPostRequestbodyContentApplicationJsonSchema

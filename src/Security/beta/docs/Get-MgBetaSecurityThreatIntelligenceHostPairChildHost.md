...
### Get (Default)
```
Get-MgBetaSecurityThreatIntelligenceHostPairChildHost -HostPairId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceHostPairChildHost -InputObject <ISecurityIdentity>

...
### Get (Default)
```
Get-MgBetaSecurityThreatIntelligenceHostComponentHost -HostComponentId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceHostComponentHost -InputObject <ISecurityIdentity>

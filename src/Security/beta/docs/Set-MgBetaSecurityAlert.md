...
### Set (Default)
```
Set-MgBetaSecurityAlert -AlertId <String> -BodyParameter <IMicrosoftGraphSecurityAlertComment[]>
 [-IfMatch <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaSecurityAlert -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityAlertComment[]> [-IfMatch <String>] [-CustomHeader <String>]

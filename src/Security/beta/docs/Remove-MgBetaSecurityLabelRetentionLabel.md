...
### Delete (Default)
```
Remove-MgBetaSecurityLabelRetentionLabel -RetentionLabelId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaSecurityLabelRetentionLabel -InputObject <ISecurityIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

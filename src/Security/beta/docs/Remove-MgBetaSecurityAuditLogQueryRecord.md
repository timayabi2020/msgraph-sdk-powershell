...
### Delete (Default)
```
Remove-MgBetaSecurityAuditLogQueryRecord -AuditLogQueryId <String> -AuditLogRecordId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecurityAuditLogQueryRecord -InputObject <ISecurityIdentity> [-IfMatch <String>]

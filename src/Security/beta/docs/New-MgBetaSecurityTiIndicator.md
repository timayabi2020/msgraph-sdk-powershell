...
New-MgBetaSecurityTiIndicator [-Action <String>] [-ActivityGroupNames <String[]>]
 ...
 [-Url <String>] [-UserAgent <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaSecurityTiIndicator -BodyParameter <IMicrosoftGraphTiIndicator> [-CustomHeader <String>] [-Confirm]

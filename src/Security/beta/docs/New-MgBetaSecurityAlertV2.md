...
```
New-MgBetaSecurityAlertV2 [-ActorDisplayName <String>] [-AdditionalData <Hashtable>]
...
### Create
```
New-MgBetaSecurityAlertV2 -BodyParameter <IMicrosoftGraphSecurityAlert> [-CustomHeader <String>] [-Confirm]

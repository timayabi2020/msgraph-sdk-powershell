...
### List (Default)
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate -HostSslCertificateId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate -HostId <String> -HostSslCertificateId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate -InputObject <ISecurityIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```
...
### List1
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate -HostId <String> [-ExpandProperty <String[]>]

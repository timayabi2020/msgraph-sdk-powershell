...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecurityattacksimulationtraininglanguagedetail
schema: 2.0.0
---
...
Remove-MgBetaSecurityAttackSimulationTrainingLanguageDetail -TrainingId <String>
 -TrainingLanguageDetailId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]

...
### Close (Default)
```
Close-MgBetaSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CloseViaIdentity
```
Close-MgBetaSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

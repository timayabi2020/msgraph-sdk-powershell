...
### Close (Default)
```
Close-MgBetaSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CloseViaIdentity
```
Close-MgBetaSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

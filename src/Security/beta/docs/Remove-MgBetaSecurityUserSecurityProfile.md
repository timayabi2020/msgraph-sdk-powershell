...
### Delete (Default)
```
Remove-MgBetaSecurityUserSecurityProfile -UserSecurityProfileId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaSecurityUserSecurityProfile -InputObject <ISecurityIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

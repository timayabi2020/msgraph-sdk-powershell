...
### List (Default)
```
Get-MgBetaSecurityThreatIntelligenceSubdomain [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityThreatIntelligenceSubdomain -SubdomainId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceSubdomain -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

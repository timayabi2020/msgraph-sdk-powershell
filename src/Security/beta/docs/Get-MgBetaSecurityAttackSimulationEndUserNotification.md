...
### List (Default)
```
Get-MgBetaSecurityAttackSimulationEndUserNotification [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityAttackSimulationEndUserNotification -EndUserNotificationId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaSecurityAttackSimulationEndUserNotification -InputObject <ISecurityIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

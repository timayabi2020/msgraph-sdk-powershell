...
### Reopen (Default)
```
Invoke-MgBetaReopenSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReopenViaIdentity
```
Invoke-MgBetaReopenSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity> [-CustomHeader <String>]

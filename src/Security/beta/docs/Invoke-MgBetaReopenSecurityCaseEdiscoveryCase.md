...
### Reopen (Default)
```
Invoke-MgBetaReopenSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReopenViaIdentity
```
Invoke-MgBetaReopenSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity>

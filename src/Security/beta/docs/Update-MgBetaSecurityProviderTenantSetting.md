...
Update-MgBetaSecurityProviderTenantSetting -ProviderTenantSettingId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-Provider <String>] [-Vendor <String>] [-CustomHeader <String>]
...
```
Update-MgBetaSecurityProviderTenantSetting -ProviderTenantSettingId <String>
 -BodyParameter <IMicrosoftGraphProviderTenantSetting> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

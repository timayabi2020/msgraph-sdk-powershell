...
### Create
```
New-MgBetaUserDevice -UserId <String> -BodyParameter <IMicrosoftGraphDevice> [-CustomHeader <String>]
...
```
New-MgBetaUserDevice -InputObject <ICrossDeviceExperiencesIdentity> [-AccountEnabled]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.crossdeviceexperiences/get-mgbetauserdevicememberofasadministrativeunit
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserDeviceMemberOfAsAdministrativeUnit -DeviceId <String> -UserId <String>
...
### Get
```
Get-MgBetaUserDeviceMemberOfAsAdministrativeUnit -DeviceId <String> -DirectoryObjectId <String>
...
### GetViaIdentity
```
Get-MgBetaUserDeviceMemberOfAsAdministrativeUnit -InputObject <ICrossDeviceExperiencesIdentity>

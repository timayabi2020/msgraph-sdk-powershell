...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.crossdeviceexperiences/get-mgbetauserdeviceregistereduserasserviceprincipal
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserDeviceRegisteredUserAsServicePrincipal -DeviceId <String> -UserId <String>
...
### Get
```
Get-MgBetaUserDeviceRegisteredUserAsServicePrincipal -DeviceId <String> -DirectoryObjectId <String>
...
### GetViaIdentity
```
Get-MgBetaUserDeviceRegisteredUserAsServicePrincipal -InputObject <ICrossDeviceExperiencesIdentity>

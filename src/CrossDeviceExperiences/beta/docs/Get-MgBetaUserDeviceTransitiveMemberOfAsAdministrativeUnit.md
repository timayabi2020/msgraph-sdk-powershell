...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.crossdeviceexperiences/get-mgbetauserdevicetransitivememberofasadministrativeunit
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserDeviceTransitiveMemberOfAsAdministrativeUnit -DeviceId <String> -UserId <String>
...
### Get
```
Get-MgBetaUserDeviceTransitiveMemberOfAsAdministrativeUnit -DeviceId <String> -DirectoryObjectId <String>
...
### GetViaIdentity
```
Get-MgBetaUserDeviceTransitiveMemberOfAsAdministrativeUnit -InputObject <ICrossDeviceExperiencesIdentity>

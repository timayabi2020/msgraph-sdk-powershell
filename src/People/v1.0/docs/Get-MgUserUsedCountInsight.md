...
### Get (Default)
```
Get-MgUserUsedCountInsight -UserId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserUsedCountInsight -InputObject <IPeopleIdentity> [-Filter <String>] [-Search <String>]

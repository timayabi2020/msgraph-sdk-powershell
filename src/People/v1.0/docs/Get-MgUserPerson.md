...
### Get
```
Get-MgUserPerson -PersonId <String> -UserId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPerson -InputObject <IPeopleIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

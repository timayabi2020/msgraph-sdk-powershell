...
Update-MgBetaUserProfilePatent -ItemPatentId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Source <IMicrosoftGraphPersonDataSources>] [-WebUrl <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserProfilePatent -ItemPatentId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphItemPatent> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

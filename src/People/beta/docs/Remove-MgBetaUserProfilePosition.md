...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/remove-mgbetauserprofileposition
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaUserProfilePosition -UserId <String> -WorkPositionId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfilePosition -InputObject <IPeopleIdentity> [-IfMatch <String>] [-CustomHeader <String>]

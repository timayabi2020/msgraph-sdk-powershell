...
### Create
```
New-MgBetaUserProfileAccount -UserId <String> -BodyParameter <IMicrosoftGraphUserAccountInformation>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaUserProfileAccount -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphUserAccountInformation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaUserProfileAccount -InputObject <IPeopleIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Source <IMicrosoftGraphPersonDataSources>] [-UserPrincipalName <String>] [-CustomHeader <String>]

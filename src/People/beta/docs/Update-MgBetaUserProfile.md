...
Update-MgBetaUserProfile -UserId <String> [-Account <IMicrosoftGraphUserAccountInformation[]>]
 ...
 [-Websites <IMicrosoftGraphPersonWebsite[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaUserProfile -UserId <String> -BodyParameter <IMicrosoftGraphProfile> [-CustomHeader <String>]

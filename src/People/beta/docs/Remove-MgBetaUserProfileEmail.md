...
### Delete (Default)
```
Remove-MgBetaUserProfileEmail -ItemEmailId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileEmail -InputObject <IPeopleIdentity> [-IfMatch <String>] [-CustomHeader <String>]

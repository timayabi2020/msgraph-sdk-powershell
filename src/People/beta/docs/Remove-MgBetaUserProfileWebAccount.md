...
### Delete (Default)
```
Remove-MgBetaUserProfileWebAccount -UserId <String> -WebAccountId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileWebAccount -InputObject <IPeopleIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### Delete (Default)
```
Remove-MgBetaUserProfile -UserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfile -InputObject <IPeopleIdentity> [-IfMatch <String>] [-CustomHeader <String>]

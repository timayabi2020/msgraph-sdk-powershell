...
```
Update-MgBetaUserProfilePublication -ItemPublicationId <String> -UserId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-PublishedDate <DateTime>] [-Publisher <String>]
...
```
Update-MgBetaUserProfilePublication -ItemPublicationId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphItemPublication> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaUserProfilePublication -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphItemPublication> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaUserProfilePublication -InputObject <IPeopleIdentity> [-AdditionalProperties <Hashtable>]

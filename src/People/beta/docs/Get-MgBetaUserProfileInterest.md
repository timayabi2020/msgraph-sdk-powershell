...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/get-mgbetauserprofileinterest
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaUserProfileInterest -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

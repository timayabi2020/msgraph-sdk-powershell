...
New-MgBetaUserProfileEducationalActivity -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-StartMonthYear <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-MgBetaUserProfileEducationalActivity -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphEducationalActivity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

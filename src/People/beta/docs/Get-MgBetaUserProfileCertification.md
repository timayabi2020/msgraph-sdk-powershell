...
### List (Default)
```
Get-MgBetaUserProfileCertification -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaUserProfileCertification -PersonCertificationId <String> -UserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserProfileCertification -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>]

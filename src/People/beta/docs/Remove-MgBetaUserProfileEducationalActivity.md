...
### Delete (Default)
```
Remove-MgBetaUserProfileEducationalActivity -EducationalActivityId <String> -UserId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileEducationalActivity -InputObject <IPeopleIdentity> [-IfMatch <String>]

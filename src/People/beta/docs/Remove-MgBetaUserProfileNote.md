...
### Delete (Default)
```
Remove-MgBetaUserProfileNote -PersonAnnotationId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileNote -InputObject <IPeopleIdentity> [-IfMatch <String>] [-CustomHeader <String>]

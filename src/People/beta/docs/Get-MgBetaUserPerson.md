...
### Get
```
Get-MgBetaUserPerson -PersonId <String> -UserId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserPerson -InputObject <IPeopleIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

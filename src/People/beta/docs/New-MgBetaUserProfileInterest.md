...
```
New-MgBetaUserProfileInterest -UserId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaUserProfileInterest -UserId <String> -BodyParameter <IMicrosoftGraphPersonInterest>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
```
Update-MgBetaUserProfileLanguage -LanguageProficiencyId <String> -UserId <String>
 ...
 [-Written <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaUserProfileLanguage -LanguageProficiencyId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphLanguageProficiency> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaUserProfileLanguage -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphLanguageProficiency> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaUserProfileLanguage -InputObject <IPeopleIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-ThumbnailUrl <String>] [-Written <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

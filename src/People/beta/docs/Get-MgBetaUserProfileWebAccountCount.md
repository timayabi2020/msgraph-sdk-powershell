...
### Get (Default)
```
Get-MgBetaUserProfileWebAccountCount -UserId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserProfileWebAccountCount -InputObject <IPeopleIdentity> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

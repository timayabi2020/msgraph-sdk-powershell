...
Update-MgBetaUserProfileProject -ProjectParticipationId <String> -UserId <String>
 ...
 [-ThumbnailUrl <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaUserProfileProject -ProjectParticipationId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphProjectParticipation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserProfileProject -InputObject <IPeopleIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Sponsors <IMicrosoftGraphRelatedPerson[]>] [-ThumbnailUrl <String>] [-CustomHeader <String>] [-Confirm]

...
### Delete (Default)
```
Remove-MgBetaUserProfileSkill -SkillProficiencyId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileSkill -InputObject <IPeopleIdentity> [-IfMatch <String>] [-CustomHeader <String>]

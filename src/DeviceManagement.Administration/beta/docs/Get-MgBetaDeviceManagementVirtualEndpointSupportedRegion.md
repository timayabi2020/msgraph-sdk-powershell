...
### List (Default)
```
Get-MgBetaDeviceManagementVirtualEndpointSupportedRegion [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementVirtualEndpointSupportedRegion -CloudPcSupportedRegionId <String>

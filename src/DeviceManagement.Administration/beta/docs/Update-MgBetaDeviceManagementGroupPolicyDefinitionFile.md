...
Update-MgBetaDeviceManagementGroupPolicyDefinitionFile -GroupPolicyDefinitionFileId <String>
 ...
 [-Revision <String>] [-TargetNamespace <String>] [-TargetPrefix <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaDeviceManagementGroupPolicyDefinitionFile -GroupPolicyDefinitionFileId <String>
 -BodyParameter <IMicrosoftGraphGroupPolicyDefinitionFile> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

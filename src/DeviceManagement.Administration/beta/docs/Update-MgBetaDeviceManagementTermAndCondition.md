...
Update-MgBetaDeviceManagementTermAndCondition -TermsAndConditionsId <String> [-AcceptanceStatement <String>]
 ...
 [-Title <String>] [-Version <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaDeviceManagementTermAndCondition -TermsAndConditionsId <String>
 -BodyParameter <IMicrosoftGraphTermsAndConditions> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
Update-MgBetaDeviceManagementUserPfxCertificate -UserPfxCertificateId <String>
 ...
 [-Thumbprint <String>] [-UserPrincipalName <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementUserPfxCertificate -UserPfxCertificateId <String>
 -BodyParameter <IMicrosoftGraphUserPfxCertificate> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

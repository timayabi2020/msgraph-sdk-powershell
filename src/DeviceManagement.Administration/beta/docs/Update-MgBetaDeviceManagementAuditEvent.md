...
Update-MgBetaDeviceManagementAuditEvent -AuditEventId <String> [-Activity <String>]
 ...
 [-Id <String>] [-Resources <IMicrosoftGraphAuditResource[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementAuditEvent -InputObject <IDeviceManagementAdministrationIdentity>
 -BodyParameter <IMicrosoftGraphAuditEvent> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementAuditEvent -InputObject <IDeviceManagementAdministrationIdentity>
 ...
 [-DisplayName <String>] [-Id <String>] [-Resources <IMicrosoftGraphAuditResource[]>] [-CustomHeader <String>]

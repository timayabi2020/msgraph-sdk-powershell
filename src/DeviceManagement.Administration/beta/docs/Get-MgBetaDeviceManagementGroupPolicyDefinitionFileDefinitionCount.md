...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/get-mgbetadevicemanagementgrouppolicydefinitionfiledefinitioncount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementGroupPolicyDefinitionFileDefinitionCount -GroupPolicyDefinitionFileId <String>

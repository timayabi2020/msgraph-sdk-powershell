...
New-MgBetaDeviceManagementTermAndConditionGroupAssignment -TermsAndConditionsId <String>
 ...
 [-TermsAndConditions <IMicrosoftGraphTermsAndConditions>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementTermAndConditionGroupAssignment -TermsAndConditionsId <String>
 -BodyParameter <IMicrosoftGraphTermsAndConditionsGroupAssignment> [-CustomHeader <String>] [-Confirm]
...
New-MgBetaDeviceManagementTermAndConditionGroupAssignment
 ...
 [-TargetGroupId <String>] [-TermsAndConditions <IMicrosoftGraphTermsAndConditions>] [-CustomHeader <String>]

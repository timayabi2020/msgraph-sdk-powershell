...
Update-MgBetaDeviceManagementVirtualEndpointGalleryImage -CloudPcGalleryImageId <String>
 ...
 [-SkuDisplayName <String>] [-StartDate <DateTime>] [-Status <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaDeviceManagementVirtualEndpointGalleryImage -CloudPcGalleryImageId <String>
 -BodyParameter <IMicrosoftGraphCloudPcGalleryImage> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementVirtualEndpointGalleryImage
 ...
 [-Sku <String>] [-SkuDisplayName <String>] [-StartDate <DateTime>] [-Status <String>]
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

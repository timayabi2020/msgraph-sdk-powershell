...
Update-MgBetaDeviceManagementTelecomExpenseManagementPartner -TelecomExpenseManagementPartnerId <String>
 ...
 [-LastConnectionDateTime <DateTime>] [-Url <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementTelecomExpenseManagementPartner -TelecomExpenseManagementPartnerId <String>
 -BodyParameter <IMicrosoftGraphTelecomExpenseManagementPartner> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

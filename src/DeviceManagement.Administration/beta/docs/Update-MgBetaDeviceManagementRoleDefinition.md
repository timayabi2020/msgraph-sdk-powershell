...
Update-MgBetaDeviceManagementRoleDefinition -RoleDefinitionId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-RolePermissions <IMicrosoftGraphRolePermission[]>] [-RoleScopeTagIds <String[]>] [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementRoleDefinition -RoleDefinitionId <String>
 -BodyParameter <IMicrosoftGraphRoleDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
Update-MgBetaDeviceManagementVirtualEndpointExternalPartnerSetting -CloudPcExternalPartnerSettingId <String>
 ...
 [-PartnerId <String>] [-Status <String>] [-StatusDetails <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaDeviceManagementVirtualEndpointExternalPartnerSetting -CloudPcExternalPartnerSettingId <String>
 -BodyParameter <IMicrosoftGraphCloudPcExternalPartnerSetting> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementVirtualEndpointExternalPartnerSetting
 ...
 [-StatusDetails <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

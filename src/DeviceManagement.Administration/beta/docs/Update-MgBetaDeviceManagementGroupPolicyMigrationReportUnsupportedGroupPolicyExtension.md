...
Update-MgBetaDeviceManagementGroupPolicyMigrationReportUnsupportedGroupPolicyExtension
 ...
 [-NodeName <String>] [-SettingScope <GroupPolicySettingScope>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementGroupPolicyMigrationReportUnsupportedGroupPolicyExtension
 -GroupPolicyMigrationReportId <String> -UnsupportedGroupPolicyExtensionId <String>
 -BodyParameter <IMicrosoftGraphUnsupportedGroupPolicyExtension> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementGroupPolicyMigrationReportUnsupportedGroupPolicyExtension
 ...
 [-SettingScope <GroupPolicySettingScope>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

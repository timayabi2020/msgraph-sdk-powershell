...
Update-MgBetaDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <String>
 ...
 [-ScopeType <RoleAssignmentScopeType>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <String>
 -RoleDefinitionId <String> -BodyParameter <IMicrosoftGraphRoleAssignment> [-CustomHeader <String>] [-Confirm]

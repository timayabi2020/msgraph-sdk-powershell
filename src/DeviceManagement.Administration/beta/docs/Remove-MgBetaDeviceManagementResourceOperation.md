...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/remove-mgbetadevicemanagementresourceoperation
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementResourceOperation -ResourceOperationId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementResourceOperation -InputObject <IDeviceManagementAdministrationIdentity>

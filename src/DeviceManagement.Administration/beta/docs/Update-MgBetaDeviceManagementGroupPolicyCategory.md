...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/update-mgbetadevicemanagementgrouppolicycategory
schema: 2.0.0
---
...
```
Update-MgBetaDeviceManagementGroupPolicyCategory -GroupPolicyCategoryId <String>
 ...
 [-Parent <IMicrosoftGraphGroupPolicyCategory>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementGroupPolicyCategory -GroupPolicyCategoryId <String>
 -BodyParameter <IMicrosoftGraphGroupPolicyCategory> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaDeviceManagementGroupPolicyCategory -InputObject <IDeviceManagementAdministrationIdentity>
 -BodyParameter <IMicrosoftGraphGroupPolicyCategory> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaDeviceManagementVirtualEndpointOnPremiseConnection [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementVirtualEndpointOnPremiseConnection -CloudPcOnPremisesConnectionId <String>

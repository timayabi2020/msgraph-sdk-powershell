...
New-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFile [-AdditionalProperties <Hashtable>]
 ...
 [-TargetPrefix <String>] [-UploadDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFile
 -BodyParameter <IMicrosoftGraphGroupPolicyUploadedDefinitionFile> [-CustomHeader <String>] [-Confirm]

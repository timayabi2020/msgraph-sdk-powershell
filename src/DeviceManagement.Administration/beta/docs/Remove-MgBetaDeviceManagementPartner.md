...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/remove-mgbetadevicemanagementpartner
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementPartner -DeviceManagementPartnerId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementPartner -InputObject <IDeviceManagementAdministrationIdentity>

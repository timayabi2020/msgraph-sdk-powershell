...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/remove-mgbetadevicemanagementtermandcondition
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementTermAndCondition -TermsAndConditionsId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementTermAndCondition -InputObject <IDeviceManagementAdministrationIdentity>

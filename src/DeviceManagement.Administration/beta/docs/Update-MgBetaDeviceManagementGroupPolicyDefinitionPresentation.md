...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/update-mgbetadevicemanagementgrouppolicydefinitionpresentation
schema: 2.0.0
---
...
```
Update-MgBetaDeviceManagementGroupPolicyDefinitionPresentation -GroupPolicyDefinitionId <String>
...
```
Update-MgBetaDeviceManagementGroupPolicyDefinitionPresentation -GroupPolicyDefinitionId <String>
 -GroupPolicyPresentationId <String> -BodyParameter <IMicrosoftGraphGroupPolicyPresentation>
...
Update-MgBetaDeviceManagementGroupPolicyDefinitionPresentation
 ...
 -BodyParameter <IMicrosoftGraphGroupPolicyPresentation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

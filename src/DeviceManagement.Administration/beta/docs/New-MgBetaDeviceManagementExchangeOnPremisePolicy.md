...
New-MgBetaDeviceManagementExchangeOnPremisePolicy
 ...
 [-NotificationContentInputFile <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaDeviceManagementExchangeOnPremisePolicy
 -BodyParameter <IMicrosoftGraphDeviceManagementExchangeOnPremisesPolicy> [-CustomHeader <String>] [-Confirm]

...
Update-MgBetaDeviceManagementRemoteAssistancePartner -RemoteAssistancePartnerId <String>
 ...
 [-OnboardingStatus <RemoteAssistanceOnboardingStatus>] [-OnboardingUrl <String>] [-CustomHeader <String>]
...
```
Update-MgBetaDeviceManagementRemoteAssistancePartner -RemoteAssistancePartnerId <String>
 -BodyParameter <IMicrosoftGraphRemoteAssistancePartner> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

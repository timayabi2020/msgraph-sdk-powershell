...
Update-MgBetaDeviceManagementVirtualEndpointServicePlan -CloudPcServicePlanId <String>
 ...
 [-UserProfileInGb <Int32>] [-VCpuCount <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementVirtualEndpointServicePlan -CloudPcServicePlanId <String>
 -BodyParameter <IMicrosoftGraphCloudPcServicePlan> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

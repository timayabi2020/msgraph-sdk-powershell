...
New-MgBetaDeviceManagementComplianceManagementPartner [-AdditionalProperties <Hashtable>]
 ...
 [-PartnerState <DeviceManagementPartnerTenantState>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDeviceManagementComplianceManagementPartner
 -BodyParameter <IMicrosoftGraphComplianceManagementPartner> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

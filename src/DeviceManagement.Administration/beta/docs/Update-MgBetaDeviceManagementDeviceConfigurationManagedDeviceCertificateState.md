...
Update-MgBetaDeviceManagementDeviceConfigurationManagedDeviceCertificateState
 ...
 [-ManagedDeviceDisplayName <String>] [-UserPrincipalName <String>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaDeviceManagementDeviceConfigurationManagedDeviceCertificateState
 ...
 -BodyParameter <IMicrosoftGraphManagedAllDeviceCertificateState> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

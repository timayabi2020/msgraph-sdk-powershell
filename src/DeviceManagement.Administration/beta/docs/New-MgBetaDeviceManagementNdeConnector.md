...
New-MgBetaDeviceManagementNdeConnector [-AdditionalProperties <Hashtable>] [-ConnectorVersion <String>]
 ...
 [-MachineName <String>] [-RoleScopeTagIds <String[]>] [-State <NdesConnectorState>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaDeviceManagementNdeConnector -BodyParameter <IMicrosoftGraphNdesConnector> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

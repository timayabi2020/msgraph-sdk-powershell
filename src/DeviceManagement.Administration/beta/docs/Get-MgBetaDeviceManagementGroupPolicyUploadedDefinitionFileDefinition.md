...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/get-mgbetadevicemanagementgrouppolicyuploadeddefinitionfiledefinition
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFileDefinition
 -GroupPolicyUploadedDefinitionFileId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementGroupPolicyUploadedDefinitionFileDefinition -GroupPolicyDefinitionId <String>
 -GroupPolicyUploadedDefinitionFileId <String> [-ExpandProperty <String[]>] [-Property <String[]>]

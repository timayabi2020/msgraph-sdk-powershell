...
Update-MgBetaDeviceManagementApplePushNotificationCertificate [-AdditionalProperties <Hashtable>]
 ...
 [-LastModifiedDateTime <DateTime>] [-TopicIdentifier <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementApplePushNotificationCertificate
 -BodyParameter <IMicrosoftGraphApplePushNotificationCertificate> [-CustomHeader <String>] [-Confirm]

...
Update-MgBetaDeviceManagementCartToClassAssociation -CartToClassAssociationId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-Version <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementCartToClassAssociation -CartToClassAssociationId <String>
 -BodyParameter <IMicrosoftGraphCartToClassAssociation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

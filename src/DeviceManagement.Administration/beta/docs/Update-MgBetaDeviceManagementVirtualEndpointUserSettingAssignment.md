...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.administration/update-mgbetadevicemanagementvirtualendpointusersettingassignment
schema: 2.0.0
---
...
Update-MgBetaDeviceManagementVirtualEndpointUserSettingAssignment -CloudPcUserSettingAssignmentId <String>
 ...
 [-Id <String>] [-Target <Hashtable>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaDeviceManagementVirtualEndpointUserSettingAssignment -CloudPcUserSettingAssignmentId <String>
 -CloudPcUserSettingId <String> -BodyParameter <IMicrosoftGraphCloudPcUserSettingAssignment>
...
Update-MgBetaDeviceManagementVirtualEndpointUserSettingAssignment
 ...
 -BodyParameter <IMicrosoftGraphCloudPcUserSettingAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementVirtualEndpointUserSettingAssignment
 ...
 [-CreatedDateTime <DateTime>] [-Id <String>] [-Target <Hashtable>] [-CustomHeader <String>] [-Confirm]

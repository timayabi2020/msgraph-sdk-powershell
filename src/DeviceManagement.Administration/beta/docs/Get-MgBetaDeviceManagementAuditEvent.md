...
### List (Default)
```
Get-MgBetaDeviceManagementAuditEvent [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgBetaDeviceManagementAuditEvent -AuditEventId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementAuditEvent -InputObject <IDeviceManagementAdministrationIdentity>

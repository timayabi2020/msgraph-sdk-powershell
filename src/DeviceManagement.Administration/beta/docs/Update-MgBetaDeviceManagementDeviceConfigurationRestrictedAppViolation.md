...
Update-MgBetaDeviceManagementDeviceConfigurationRestrictedAppViolation -RestrictedAppsViolationId <String>
 ...
 [-UserId <String>] [-UserName <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaDeviceManagementDeviceConfigurationRestrictedAppViolation -RestrictedAppsViolationId <String>
 -BodyParameter <IMicrosoftGraphRestrictedAppsViolation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

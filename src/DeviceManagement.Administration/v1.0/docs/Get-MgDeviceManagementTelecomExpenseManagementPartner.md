...
### List (Default)
```
Get-MgDeviceManagementTelecomExpenseManagementPartner [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDeviceManagementTelecomExpenseManagementPartner -TelecomExpenseManagementPartnerId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceManagementTelecomExpenseManagementPartner -InputObject <IDeviceManagementAdministrationIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

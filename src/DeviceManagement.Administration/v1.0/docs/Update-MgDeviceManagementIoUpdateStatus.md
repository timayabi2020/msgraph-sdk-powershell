...
Update-MgDeviceManagementIoUpdateStatus -IosUpdateDeviceStatusId <String>
 -BodyParameter <IMicrosoftGraphIosUpdateDeviceStatus> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceManagementIoUpdateStatus -InputObject <IDeviceManagementAdministrationIdentity>
 ...
 [-UserId <String>] [-UserName <String>] [-UserPrincipalName <String>] [-CustomHeader <String>] [-Confirm]

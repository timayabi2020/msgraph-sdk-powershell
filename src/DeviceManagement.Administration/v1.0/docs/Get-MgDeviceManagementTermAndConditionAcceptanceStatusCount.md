...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement.administration/get-mgdevicemanagementtermandconditionacceptancestatuscount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceManagementTermAndConditionAcceptanceStatusCount -TermsAndConditionsId <String> [-Filter <String>]

...
New-MgDeviceManagementPartner [-AdditionalProperties <Hashtable>] [-DisplayName <String>]
 ...
 [-WhenPartnerDevicesWillBeRemovedDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgDeviceManagementPartner -BodyParameter <IMicrosoftGraphDeviceManagementPartner> [-CustomHeader <String>]

...
Update-MgDeviceManagementExchangeConnector -DeviceManagementExchangeConnectorId <String>
 ...
 [-Status <DeviceManagementExchangeConnectorStatus>] [-Version <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgDeviceManagementExchangeConnector -DeviceManagementExchangeConnectorId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementExchangeConnector> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

...
# Remove-MgDriveListSubscription
...
### Delete (Default)
```
Remove-MgDriveListSubscription -DriveId <String> -SubscriptionId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveListSubscription -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

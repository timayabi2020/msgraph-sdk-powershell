...
### Get (Default)
```
Get-MgGroupDriveBundleContent -DriveId <String> -DriveItemId <String> -GroupId <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDriveBundleContent -InputObject <IFilesIdentity> -OutFile <String> [-CustomHeader <String>]

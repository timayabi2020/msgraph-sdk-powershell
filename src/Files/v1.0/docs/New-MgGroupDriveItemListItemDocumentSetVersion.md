...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdriveitemlistitemdocumentsetversion
schema: 2.0.0
---
...
```
New-MgGroupDriveItemListItemDocumentSetVersion -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### CreateViaIdentity
```
New-MgGroupDriveItemListItemDocumentSetVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

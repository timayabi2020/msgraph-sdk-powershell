...
### Is (Default)
```
Test-MgDriveListContentTypePublished -ContentTypeId <String> -DriveId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### IsViaIdentity
```
Test-MgDriveListContentTypePublished -InputObject <IFilesIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

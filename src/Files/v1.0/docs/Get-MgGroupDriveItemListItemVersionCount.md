...
### Get (Default)
```
Get-MgGroupDriveItemListItemVersionCount -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDriveItemListItemVersionCount -InputObject <IFilesIdentity> [-Filter <String>] [-Search <String>]

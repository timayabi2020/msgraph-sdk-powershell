...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdrivelistitemcreatedbyuserserviceprovisioningerror
schema: 2.0.0
---
...
```
Get-MgGroupDriveListItemCreatedByUserServiceProvisioningError -DriveId <String> -GroupId <String>

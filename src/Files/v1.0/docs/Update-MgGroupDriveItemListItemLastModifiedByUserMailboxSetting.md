...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdriveitemlistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgGroupDriveItemListItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgGroupDriveItemListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>

...
# Restore-MgDriveItemListItemVersion
...
### Restore (Default)
```
Restore-MgDriveItemListItemVersion -DriveId <String> -DriveItemId <String> -ListItemVersionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgDriveItemListItemVersion -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru]

...
### Delete (Default)
```
Remove-MgDriveListItemVersionField -DriveId <String> -ListItemId <String> -ListItemVersionId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveListItemVersionField -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### List (Default)
```
Get-MgGroupDriveRootChild -DriveId <String> -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupDriveRootChild -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDriveRootChild -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

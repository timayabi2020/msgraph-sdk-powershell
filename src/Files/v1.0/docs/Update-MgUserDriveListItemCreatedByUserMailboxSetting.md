...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdrivelistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgUserDriveListItemCreatedByUserMailboxSetting -DriveId <String> -ListItemId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgUserDriveListItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

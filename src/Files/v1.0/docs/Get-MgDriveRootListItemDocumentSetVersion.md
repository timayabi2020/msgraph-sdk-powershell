...
### List (Default)
```
Get-MgDriveRootListItemDocumentSetVersion -DriveId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDriveRootListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveRootListItemDocumentSetVersion -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgsharelastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgShareLastModifiedByUserMailboxSetting -SharedDriveItemId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgShareLastModifiedByUserMailboxSetting -SharedDriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgShareLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

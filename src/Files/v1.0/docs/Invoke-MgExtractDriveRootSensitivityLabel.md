...
### Extract (Default)
```
Invoke-MgExtractDriveRootSensitivityLabel -DriveId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgExtractDriveRootSensitivityLabel -InputObject <IFilesIdentity> [-CustomHeader <String>] [-Confirm]

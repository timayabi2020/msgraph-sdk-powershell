...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgsharelistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgShareListItemLastModifiedByUserMailboxSetting -SharedDriveItemId <String>
...
### Update
```
Update-MgShareListItemLastModifiedByUserMailboxSetting -ListItemId <String> -SharedDriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgShareListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

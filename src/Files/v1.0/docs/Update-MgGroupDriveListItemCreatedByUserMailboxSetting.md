...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdrivelistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgGroupDriveListItemCreatedByUserMailboxSetting -DriveId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupDriveListItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>

...
### List (Default)
```
Get-MgGroupDriveRootThumbnail -DriveId <String> -GroupId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgGroupDriveRootThumbnail -DriveId <String> -GroupId <String> -ThumbnailSetId <String>

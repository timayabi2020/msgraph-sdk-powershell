...
### Delete (Default)
```
Remove-MgGroupDriveItemListItemDocumentSetVersionField -DocumentSetVersionId <String> -DriveId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupDriveItemListItemDocumentSetVersionField -InputObject <IFilesIdentity> [-IfMatch <String>]

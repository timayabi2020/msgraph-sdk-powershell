...
```
Update-MgGroupDriveListCreatedByUserMailboxSetting -DriveId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupDriveListCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

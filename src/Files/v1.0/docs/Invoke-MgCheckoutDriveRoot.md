...
### Checkout (Default)
```
Invoke-MgCheckoutDriveRoot -DriveId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgCheckoutDriveRoot -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

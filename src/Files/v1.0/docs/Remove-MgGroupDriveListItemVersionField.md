...
### Delete (Default)
```
Remove-MgGroupDriveListItemVersionField -DriveId <String> -GroupId <String> -ListItemId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupDriveListItemVersionField -InputObject <IFilesIdentity> [-IfMatch <String>]

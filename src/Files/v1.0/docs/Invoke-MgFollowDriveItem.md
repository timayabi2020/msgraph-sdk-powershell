...
### Follow (Default)
```
Invoke-MgFollowDriveItem -DriveId <String> -DriveItemId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowDriveItem -InputObject <IFilesIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

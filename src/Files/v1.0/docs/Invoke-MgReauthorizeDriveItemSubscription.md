...
### Reauthorize (Default)
```
Invoke-MgReauthorizeDriveItemSubscription -DriveId <String> -DriveItemId <String> -SubscriptionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgReauthorizeDriveItemSubscription -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru]

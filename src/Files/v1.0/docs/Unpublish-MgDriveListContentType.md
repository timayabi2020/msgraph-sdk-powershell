...
### Unpublish (Default)
```
Unpublish-MgDriveListContentType -ContentTypeId <String> -DriveId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgDriveListContentType -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

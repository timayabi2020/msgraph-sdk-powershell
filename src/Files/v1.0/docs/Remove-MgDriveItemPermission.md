...
### Delete (Default)
```
Remove-MgDriveItemPermission -DriveId <String> -DriveItemId <String> -PermissionId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveItemPermission -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### Delete (Default)
```
Remove-MgShareListColumn -ColumnDefinitionId <String> -SharedDriveItemId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgShareListColumn -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

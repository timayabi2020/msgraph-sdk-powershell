...
### Restore (Default)
```
Restore-MgDriveListItemVersion -DriveId <String> -ListItemId <String> -ListItemVersionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgDriveListItemVersion -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

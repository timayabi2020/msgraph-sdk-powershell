...
### Delete (Default)
```
Remove-MgUserDriveRootListItemDocumentSetVersionField -DocumentSetVersionId <String> -DriveId <String>
...
### DeleteViaIdentity
```
Remove-MgUserDriveRootListItemDocumentSetVersionField -InputObject <IFilesIdentity> [-IfMatch <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriveitemlistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgUserDriveItemListItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgUserDriveItemListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>

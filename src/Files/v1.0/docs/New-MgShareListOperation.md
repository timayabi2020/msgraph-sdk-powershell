...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgsharelistoperation
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgShareListOperation -InputObject <IFilesIdentity>

...
### Delete (Default)
```
Remove-MgDriveRootAnalyticItemActivityStat -DriveId <String> -ItemActivityStatId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveRootAnalyticItemActivityStat -InputObject <IFilesIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

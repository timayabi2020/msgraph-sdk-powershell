...
### Reauthorize (Default)
```
Invoke-MgReauthorizeShareListSubscription -SharedDriveItemId <String> -SubscriptionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgReauthorizeShareListSubscription -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru]

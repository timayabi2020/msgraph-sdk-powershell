...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdrivelistcontenttype
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupDriveListContentType -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphContentType>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

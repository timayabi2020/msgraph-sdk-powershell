...
### Get (Default)
```
Get-MgGroupDriveLastModifiedByUserMailboxSetting -DriveId <String> -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupDriveLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

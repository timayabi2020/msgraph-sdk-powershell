...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdrivelistcontenttypecolumn
schema: 2.0.0
---
...
```
Update-MgGroupDriveListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String>

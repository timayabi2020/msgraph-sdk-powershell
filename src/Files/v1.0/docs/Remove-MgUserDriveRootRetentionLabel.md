...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/remove-mguserdriverootretentionlabel
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgUserDriveRootRetentionLabel -DriveId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserDriveRootRetentionLabel -InputObject <IFilesIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdrivelistsubscription
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserDriveListSubscription -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphSubscription>

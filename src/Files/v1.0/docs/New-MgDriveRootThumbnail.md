...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriverootthumbnail
schema: 2.0.0
---
...
### Create
```
New-MgDriveRootThumbnail -DriveId <String> -BodyParameter <IMicrosoftGraphThumbnailSet>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgDriveRootThumbnail -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphThumbnailSet>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

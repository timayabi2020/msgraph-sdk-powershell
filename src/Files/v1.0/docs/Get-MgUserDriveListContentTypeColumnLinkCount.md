...
### Get (Default)
```
Get-MgUserDriveListContentTypeColumnLinkCount -ContentTypeId <String> -DriveId <String> -UserId <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserDriveListContentTypeColumnLinkCount -InputObject <IFilesIdentity> [-Filter <String>]

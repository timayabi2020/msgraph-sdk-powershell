...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriveitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgUserDriveItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgUserDriveItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriverootanalyticitemactivitystat
schema: 2.0.0
---
...
```
Update-MgUserDriveRootAnalyticItemActivityStat -DriveId <String> -ItemActivityStatId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgUserDriveRootAnalyticItemActivityStat -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityStat> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

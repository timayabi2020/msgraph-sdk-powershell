...
### Checkout (Default)
```
Invoke-MgCheckoutDriveItem -DriveId <String> -DriveItemId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgCheckoutDriveItem -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

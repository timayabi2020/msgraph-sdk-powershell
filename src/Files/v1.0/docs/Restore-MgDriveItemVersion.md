...
### Restore (Default)
```
Restore-MgDriveItemVersion -DriveId <String> -DriveItemId <String> -DriveItemVersionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgDriveItemVersion -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

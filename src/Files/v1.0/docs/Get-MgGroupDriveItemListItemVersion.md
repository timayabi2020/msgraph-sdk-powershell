...
### List (Default)
```
Get-MgGroupDriveItemListItemVersion -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### GetViaIdentity
```
Get-MgGroupDriveItemListItemVersion -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

...
### Restore (Default)
```
Restore-MgDriveRootListItemVersion -DriveId <String> -ListItemVersionId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgDriveRootListItemVersion -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru]

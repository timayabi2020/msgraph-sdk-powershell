...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdrivelistlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgDriveListLastModifiedByUserMailboxSetting -DriveId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgDriveListLastModifiedByUserMailboxSetting -DriveId <String>
...
### UpdateViaIdentity
```
Update-MgDriveListLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

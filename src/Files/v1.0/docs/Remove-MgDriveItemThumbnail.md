...
### Delete (Default)
```
Remove-MgDriveItemThumbnail -DriveId <String> -DriveItemId <String> -ThumbnailSetId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveItemThumbnail -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

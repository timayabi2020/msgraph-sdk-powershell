...
### Delete (Default)
```
Remove-MgGroupDriveItemAnalyticItemActivityStat -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupDriveItemAnalyticItemActivityStat -InputObject <IFilesIdentity> [-IfMatch <String>]

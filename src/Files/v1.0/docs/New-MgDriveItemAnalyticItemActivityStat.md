...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriveitemanalyticitemactivitystat
schema: 2.0.0
---

# New-MgDriveItemAnalyticItemActivityStat
...
```
New-MgDriveItemAnalyticItemActivityStat -DriveId <String> -DriveItemId <String>
...
### CreateViaIdentity
```
New-MgDriveItemAnalyticItemActivityStat -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityStat> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

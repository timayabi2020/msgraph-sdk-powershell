...
### Unfollow (Default)
```
Invoke-MgUnfollowDriveRoot -DriveId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgUnfollowDriveRoot -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

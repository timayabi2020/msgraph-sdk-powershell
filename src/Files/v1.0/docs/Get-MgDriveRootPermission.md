...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdriverootpermission
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDriveRootPermission -DriveId <String> [-ExpandProperty <String[]>] [-Filter <String>]

...
### Delete (Default)
```
Remove-MgUserDriveRootListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
...
### DeleteViaIdentity
```
Remove-MgUserDriveRootListItemDocumentSetVersion -InputObject <IFilesIdentity> [-IfMatch <String>]

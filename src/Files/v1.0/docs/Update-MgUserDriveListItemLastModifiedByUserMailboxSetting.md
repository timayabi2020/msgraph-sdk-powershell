...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdrivelistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgUserDriveListItemLastModifiedByUserMailboxSetting -DriveId <String> -ListItemId <String>
...
### UpdateViaIdentity
```
Update-MgUserDriveListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>

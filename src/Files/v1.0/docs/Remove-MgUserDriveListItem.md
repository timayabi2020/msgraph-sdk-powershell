...
### Delete (Default)
```
Remove-MgUserDriveListItem -DriveId <String> -ListItemId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserDriveListItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

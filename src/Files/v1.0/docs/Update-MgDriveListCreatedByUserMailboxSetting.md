...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdrivelistcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgDriveListCreatedByUserMailboxSetting -DriveId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgDriveListCreatedByUserMailboxSetting -DriveId <String>
...
### UpdateViaIdentity
```
Update-MgDriveListCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

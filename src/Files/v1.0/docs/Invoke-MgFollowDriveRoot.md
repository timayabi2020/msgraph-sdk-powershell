...
### Follow (Default)
```
Invoke-MgFollowDriveRoot -DriveId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowDriveRoot -InputObject <IFilesIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

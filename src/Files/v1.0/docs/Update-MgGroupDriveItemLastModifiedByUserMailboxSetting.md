...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdriveitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgGroupDriveItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgGroupDriveItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>

...
### Delete (Default)
```
Remove-MgDriveItemAnalytic -DriveId <String> -DriveItemId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveItemAnalytic -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

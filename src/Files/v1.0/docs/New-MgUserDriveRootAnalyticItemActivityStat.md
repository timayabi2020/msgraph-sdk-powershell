...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdriverootanalyticitemactivitystat
schema: 2.0.0
---
...
```
New-MgUserDriveRootAnalyticItemActivityStat -DriveId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserDriveRootAnalyticItemActivityStat -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityStat> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgGroupDriveSpecial -DriveId <String> -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupDriveSpecial -DriveId <String> -DriveItemId <String> -GroupId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDriveSpecial -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

...
### List (Default)
```
Get-MgGroupDriveItemPermission -DriveId <String> -DriveItemId <String> -GroupId <String>
...
```
Get-MgGroupDriveItemPermission -DriveId <String> -DriveItemId <String> -GroupId <String>
 -PermissionId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDriveItemPermission -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

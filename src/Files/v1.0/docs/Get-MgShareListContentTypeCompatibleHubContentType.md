...
### Get (Default)
```
Get-MgShareListContentTypeCompatibleHubContentType -SharedDriveItemId <String> [-Count] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgShareListContentTypeCompatibleHubContentType -InputObject <IFilesIdentity> [-Count] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-CustomHeader <String>] [<CommonParameters>]
```

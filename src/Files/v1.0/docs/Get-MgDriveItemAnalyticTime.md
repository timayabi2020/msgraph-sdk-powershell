...
### Get (Default)
```
Get-MgDriveItemAnalyticTime -DriveId <String> -DriveItemId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDriveItemAnalyticTime -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

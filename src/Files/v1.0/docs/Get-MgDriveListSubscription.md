...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdrivelistsubscription
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDriveListSubscription -DriveId <String> [-ExpandProperty <String[]>] [-Filter <String>]

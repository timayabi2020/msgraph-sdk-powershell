...
### Delete (Default)
```
Remove-MgUserDriveRootChild -DriveId <String> -DriveItemId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserDriveRootChild -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

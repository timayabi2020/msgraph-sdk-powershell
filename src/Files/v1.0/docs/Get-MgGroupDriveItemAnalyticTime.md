...
### Get (Default)
```
Get-MgGroupDriveItemAnalyticTime -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDriveItemAnalyticTime -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

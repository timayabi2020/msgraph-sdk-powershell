...
### Restore1 (Default)
```
Restore-MgShareListItemVersion -ListItemVersionId <String> -SharedDriveItemId <String>
...
### RestoreViaIdentity
```
Restore-MgShareListItemVersion -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriverootlistitemversion
schema: 2.0.0
---
...
### Create
```
New-MgDriveRootListItemVersion -DriveId <String> -BodyParameter <IMicrosoftGraphListItemVersion>

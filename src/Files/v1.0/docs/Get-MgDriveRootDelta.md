...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdriverootdelta
schema: 2.0.0
---
...
### DeltaViaIdentity
```
Get-MgDriveRootDelta -InputObject <IFilesIdentity> [-Count] [-Filter <String>] [-Property <String[]>]

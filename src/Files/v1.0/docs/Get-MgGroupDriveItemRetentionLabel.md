...
### Get (Default)
```
Get-MgGroupDriveItemRetentionLabel -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupDriveItemRetentionLabel -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

...
Update-MgGroupDriveItemAnalyticItemActivityStat -DriveId <String> -DriveItemId <String> -GroupId <String>
 ...
 [-ResponseHeadersVariable <String>] [-StartDateTime <DateTime>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgGroupDriveItemAnalyticItemActivityStat -DriveId <String> -DriveItemId <String> -GroupId <String>
 -ItemActivityStatId <String> -BodyParameter <IMicrosoftGraphItemActivityStat>
...
Update-MgGroupDriveItemAnalyticItemActivityStat -InputObject <IFilesIdentity>
 ...
 [-Move <IMicrosoftGraphItemActionStat>] [-ResponseHeadersVariable <String>] [-StartDateTime <DateTime>]

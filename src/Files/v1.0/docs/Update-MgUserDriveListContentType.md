...
```
Update-MgUserDriveListContentType -ContentTypeId <String> -DriveId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgUserDriveListContentType -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphContentType>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserDriveListContentType -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgsharelistcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgShareListCreatedByUserMailboxSetting -SharedDriveItemId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgShareListCreatedByUserMailboxSetting -SharedDriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgShareListCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

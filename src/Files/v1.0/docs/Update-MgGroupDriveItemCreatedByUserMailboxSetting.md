...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdriveitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgGroupDriveItemCreatedByUserMailboxSetting -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupDriveItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

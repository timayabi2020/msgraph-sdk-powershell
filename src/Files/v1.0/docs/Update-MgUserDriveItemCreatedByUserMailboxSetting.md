...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriveitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgUserDriveItemCreatedByUserMailboxSetting -DriveId <String> -DriveItemId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgUserDriveItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdriveitemanalyticitemactivitystat
schema: 2.0.0
---
...
```
New-MgUserDriveItemAnalyticItemActivityStat -DriveId <String> -DriveItemId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserDriveItemAnalyticItemActivityStat -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivityStat> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdrivelistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgDriveListItemLastModifiedByUserMailboxSetting -DriveId <String> -ListItemId <String>
...
### UpdateViaIdentity
```
Update-MgDriveListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

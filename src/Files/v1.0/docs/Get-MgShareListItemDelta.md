...
### Delta (Default)
```
Get-MgShareListItemDelta -SharedDriveItemId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Delta1
```
Get-MgShareListItemDelta -SharedDriveItemId <String> -Token <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgShareListItemDelta -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>]

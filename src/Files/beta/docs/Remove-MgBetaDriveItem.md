...
### Delete (Default)
```
Remove-MgBetaDriveItem -DriveId <String> -DriveItemId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDriveItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

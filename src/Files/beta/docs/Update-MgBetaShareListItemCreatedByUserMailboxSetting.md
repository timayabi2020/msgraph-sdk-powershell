...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetasharelistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaShareListItemCreatedByUserMailboxSetting -SharedDriveItemId <String>
...
### Update
```
Update-MgBetaShareListItemCreatedByUserMailboxSetting -ListItemId <String> -SharedDriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgBetaShareListItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

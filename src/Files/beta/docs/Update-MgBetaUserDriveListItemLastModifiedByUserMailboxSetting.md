...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdrivelistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveListItemLastModifiedByUserMailboxSetting -DriveId <String> -ListItemId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>

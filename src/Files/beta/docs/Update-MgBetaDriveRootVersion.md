...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriverootversion
schema: 2.0.0
---

# Update-MgBetaDriveRootVersion
...
```
Update-MgBetaDriveRootVersion -DriveId <String> -DriveItemVersionId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDriveRootVersion -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphDriveItemVersion>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaDriveRootVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]

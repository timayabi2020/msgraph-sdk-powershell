...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriveitemlistitemversion
schema: 2.0.0
---
...
```
New-MgBetaDriveItemListItemVersion -DriveId <String> -DriveItemId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaDriveItemListItemVersion -DriveId <String> -DriveItemId <String>
...
### CreateViaIdentity
```
New-MgBetaDriveItemListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDriveItemListItemVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
 [-Fields <Hashtable>] [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-Publication <IMicrosoftGraphPublicationFacet>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

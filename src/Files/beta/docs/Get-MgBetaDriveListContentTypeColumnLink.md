...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetadrivelistcontenttypecolumnlink
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDriveListContentTypeColumnLink -ContentTypeId <String> -DriveId <String>

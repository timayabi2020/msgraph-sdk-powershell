...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriveitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveItemCreatedByUserMailboxSetting -DriveId <String> -DriveItemId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

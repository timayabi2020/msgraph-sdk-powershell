...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetasharelastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaShareLastModifiedByUserMailboxSetting -SharedDriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgBetaShareLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

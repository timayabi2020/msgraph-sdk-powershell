...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriverootcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveRootCreatedByUserMailboxSetting -DriveId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveRootCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

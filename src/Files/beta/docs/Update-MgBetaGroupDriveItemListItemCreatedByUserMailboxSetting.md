...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriveitemlistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupDriveItemListItemCreatedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupDriveItemListItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>

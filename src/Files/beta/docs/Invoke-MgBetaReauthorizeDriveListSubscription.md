...
### Reauthorize (Default)
```
Invoke-MgBetaReauthorizeDriveListSubscription -DriveId <String> -SubscriptionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeDriveListSubscription -InputObject <IFilesIdentity> [-CustomHeader <String>]

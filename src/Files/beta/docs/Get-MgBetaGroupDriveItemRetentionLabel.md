...
### Get (Default)
```
Get-MgBetaGroupDriveItemRetentionLabel -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupDriveItemRetentionLabel -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

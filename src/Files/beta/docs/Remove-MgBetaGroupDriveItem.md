...
### Delete (Default)
```
Remove-MgBetaGroupDriveItem -DriveId <String> -DriveItemId <String> -GroupId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupDriveItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

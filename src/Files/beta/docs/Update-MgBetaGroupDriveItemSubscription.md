...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriveitemsubscription
schema: 2.0.0
---
...
```
Update-MgBetaGroupDriveItemSubscription -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupDriveItemSubscription -InputObject <IFilesIdentity>
...
```
Update-MgBetaGroupDriveItemSubscription -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]

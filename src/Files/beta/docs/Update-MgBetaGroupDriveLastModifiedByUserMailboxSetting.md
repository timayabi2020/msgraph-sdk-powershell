...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdrivelastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupDriveLastModifiedByUserMailboxSetting -DriveId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupDriveLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

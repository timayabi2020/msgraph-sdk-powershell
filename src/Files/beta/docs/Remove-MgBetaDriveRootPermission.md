...
### Delete (Default)
```
Remove-MgBetaDriveRootPermission -DriveId <String> -PermissionId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDriveRootPermission -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriverootpermission
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserDriveRootPermission -DriveId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaUserDriveRootPermission -DriveId <String> -PermissionId <String> -UserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserDriveRootPermission -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

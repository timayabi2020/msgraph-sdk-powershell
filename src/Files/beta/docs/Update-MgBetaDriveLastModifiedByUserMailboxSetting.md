...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaDriveLastModifiedByUserMailboxSetting -DriveId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgBetaDriveLastModifiedByUserMailboxSetting -DriveId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDriveLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

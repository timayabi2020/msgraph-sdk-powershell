...
### Restore (Default)
```
Restore-MgBetaDriveRootVersion -DriveId <String> -DriveItemVersionId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaDriveRootVersion -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

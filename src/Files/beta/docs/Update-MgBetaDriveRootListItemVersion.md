...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriverootlistitemversion
schema: 2.0.0
---
...
```
Update-MgBetaDriveRootListItemVersion -DriveId <String> -ListItemVersionId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDriveRootListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDriveRootListItemVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]

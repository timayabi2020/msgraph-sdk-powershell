...
### Reauthorize (Default)
```
Invoke-MgBetaReauthorizeShareListSubscription -SharedDriveItemId <String> -SubscriptionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeShareListSubscription -InputObject <IFilesIdentity> [-CustomHeader <String>]

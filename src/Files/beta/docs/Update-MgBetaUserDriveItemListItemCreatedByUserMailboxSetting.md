...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriveitemlistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveItemListItemCreatedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveItemListItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>

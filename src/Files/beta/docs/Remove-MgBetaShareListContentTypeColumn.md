...
### Delete (Default)
```
Remove-MgBetaShareListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaShareListContentTypeColumn -InputObject <IFilesIdentity> [-IfMatch <String>]

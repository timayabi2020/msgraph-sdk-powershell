...
### Delete (Default)
```
Remove-MgBetaDriveItemPermission -DriveId <String> -DriveItemId <String> -PermissionId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDriveItemPermission -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

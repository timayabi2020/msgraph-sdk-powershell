...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdrivelistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveListItemCreatedByUserMailboxSetting -DriveId <String> -ListItemId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveListItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>

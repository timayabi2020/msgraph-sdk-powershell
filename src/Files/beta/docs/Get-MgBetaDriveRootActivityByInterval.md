...
### Get (Default)
```
Get-MgBetaDriveRootActivityByInterval -DriveId <String> -EndDateTime <String> -Interval <String>
...
### GetViaIdentity
```
Get-MgBetaDriveRootActivityByInterval -InputObject <IFilesIdentity> [-Count] [-Filter <String>]

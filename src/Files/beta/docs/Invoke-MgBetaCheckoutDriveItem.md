...
### Checkout (Default)
```
Invoke-MgBetaCheckoutDriveItem -DriveId <String> -DriveItemId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckoutViaIdentity
```
Invoke-MgBetaCheckoutDriveItem -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

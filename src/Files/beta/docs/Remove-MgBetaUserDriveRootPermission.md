...
### Delete (Default)
```
Remove-MgBetaUserDriveRootPermission -DriveId <String> -PermissionId <String> -UserId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserDriveRootPermission -InputObject <IFilesIdentity> [-IfMatch <String>]

...
### Publish (Default)
```
Publish-MgBetaDriveListContentType -ContentTypeId <String> -DriveId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaDriveListContentType -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru]

...
### List (Default)
```
Get-MgBetaDriveItemPermission -DriveId <String> -DriveItemId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDriveItemPermission -DriveId <String> -DriveItemId <String> -PermissionId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveItemPermission -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]

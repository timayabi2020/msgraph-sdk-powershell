...
### List (Default)
```
Get-MgBetaDriveFollowing -DriveId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDriveFollowing -DriveId <String> -DriveItemId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveFollowing -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

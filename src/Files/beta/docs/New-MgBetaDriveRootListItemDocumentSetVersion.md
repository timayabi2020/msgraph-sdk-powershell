...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriverootlistitemdocumentsetversion
schema: 2.0.0
---
...
```
New-MgBetaDriveRootListItemDocumentSetVersion -DriveId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaDriveRootListItemDocumentSetVersion -DriveId <String>
...
### CreateViaIdentity
```
New-MgBetaDriveRootListItemDocumentSetVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

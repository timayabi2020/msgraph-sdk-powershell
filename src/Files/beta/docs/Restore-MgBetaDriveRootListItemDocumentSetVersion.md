...
### Restore (Default)
```
Restore-MgBetaDriveRootListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaDriveRootListItemDocumentSetVersion -InputObject <IFilesIdentity> [-CustomHeader <String>]

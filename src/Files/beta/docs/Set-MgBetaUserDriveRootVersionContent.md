...
### Set (Default)
```
Set-MgBetaUserDriveRootVersionContent -DriveId <String> -DriveItemVersionId <String> -UserId <String>
...
### SetViaIdentity
```
Set-MgBetaUserDriveRootVersionContent -InputObject <IFilesIdentity> -InFile <String> [-Data <Stream>]

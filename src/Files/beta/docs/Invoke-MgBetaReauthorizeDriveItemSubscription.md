...
### Reauthorize (Default)
```
Invoke-MgBetaReauthorizeDriveItemSubscription -DriveId <String> -DriveItemId <String> -SubscriptionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeDriveItemSubscription -InputObject <IFilesIdentity> [-CustomHeader <String>]

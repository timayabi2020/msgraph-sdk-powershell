...
### Delete (Default)
```
Remove-MgBetaDriveItemChild -DriveId <String> -DriveItemId <String> -DriveItemId1 <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDriveItemChild -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

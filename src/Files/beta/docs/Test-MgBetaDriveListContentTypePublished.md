...
### Is (Default)
```
Test-MgBetaDriveListContentTypePublished -ContentTypeId <String> -DriveId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### IsViaIdentity
```
Test-MgBetaDriveListContentTypePublished -InputObject <IFilesIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

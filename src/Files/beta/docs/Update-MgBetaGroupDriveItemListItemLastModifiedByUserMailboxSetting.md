...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriveitemlistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupDriveItemListItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
```
Update-MgBetaGroupDriveItemListItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
 -GroupId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaGroupDriveItemListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>

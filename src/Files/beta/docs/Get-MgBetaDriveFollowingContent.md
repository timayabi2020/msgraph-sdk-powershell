...
### Get (Default)
```
Get-MgBetaDriveFollowingContent -DriveId <String> -DriveItemId <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveFollowingContent -InputObject <IFilesIdentity> -OutFile <String> [-CustomHeader <String>]

...
### Is (Default)
```
Test-MgBetaShareListContentTypePublished -ContentTypeId <String> -SharedDriveItemId <String>
 [-CustomHeader <String>] [<CommonParameters>]
```

### IsViaIdentity
```
Test-MgBetaShareListContentTypePublished -InputObject <IFilesIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

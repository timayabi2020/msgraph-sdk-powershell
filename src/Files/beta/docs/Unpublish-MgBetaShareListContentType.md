...
### Unpublish (Default)
```
Unpublish-MgBetaShareListContentType -ContentTypeId <String> -SharedDriveItemId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgBetaShareListContentType -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru]

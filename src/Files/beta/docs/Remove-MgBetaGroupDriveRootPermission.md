...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/remove-mgbetagroupdriverootpermission
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaGroupDriveRootPermission -DriveId <String> -GroupId <String> -PermissionId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupDriveRootPermission -InputObject <IFilesIdentity> [-IfMatch <String>]

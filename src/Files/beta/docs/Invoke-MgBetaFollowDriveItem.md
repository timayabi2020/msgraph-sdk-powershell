...
### Follow (Default)
```
Invoke-MgBetaFollowDriveItem -DriveId <String> -DriveItemId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowDriveItem -InputObject <IFilesIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

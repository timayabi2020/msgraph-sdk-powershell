...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdrivelistcolumn
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveListColumn -ColumnDefinitionId <String> -DriveId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveListColumn -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaUserDriveListColumn -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetasharelistitemcreatedbyuserserviceprovisioningerrorcount
schema: 2.0.0
---
...
Get-MgBetaShareListItemCreatedByUserServiceProvisioningErrorCount -ListItemId <String>
 -SharedDriveItemId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

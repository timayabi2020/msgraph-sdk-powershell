...
### Delete (Default)
```
Remove-MgBetaGroupDriveListItem -DriveId <String> -GroupId <String> -ListItemId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupDriveListItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

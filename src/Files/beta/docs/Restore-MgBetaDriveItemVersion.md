...
### Restore (Default)
```
Restore-MgBetaDriveItemVersion -DriveId <String> -DriveItemId <String> -DriveItemVersionId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaDriveItemVersion -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

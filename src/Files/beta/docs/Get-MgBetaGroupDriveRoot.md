...
### Get (Default)
```
Get-MgBetaGroupDriveRoot -DriveId <String> -GroupId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupDriveRoot -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelistcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaDriveListCreatedByUserMailboxSetting -DriveId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgBetaDriveListCreatedByUserMailboxSetting -DriveId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDriveListCreatedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

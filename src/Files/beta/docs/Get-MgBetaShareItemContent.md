...
### Get (Default)
```
Get-MgBetaShareItemContent -DriveItemId <String> -SharedDriveItemId <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaShareItemContent -InputObject <IFilesIdentity> -OutFile <String> [-CustomHeader <String>]

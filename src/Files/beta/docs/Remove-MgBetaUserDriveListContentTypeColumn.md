...
### Delete (Default)
```
Remove-MgBetaUserDriveListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserDriveListContentTypeColumn -InputObject <IFilesIdentity> [-IfMatch <String>]

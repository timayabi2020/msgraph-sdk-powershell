...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriveitemlistitemdocumentsetversion
schema: 2.0.0
---
...
```
New-MgBetaGroupDriveItemListItemDocumentSetVersion -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupDriveItemListItemDocumentSetVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Follow (Default)
```
Invoke-MgBetaFollowDriveRoot -DriveId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowDriveRoot -InputObject <IFilesIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

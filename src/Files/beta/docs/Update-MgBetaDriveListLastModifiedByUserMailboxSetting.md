...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelistlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaDriveListLastModifiedByUserMailboxSetting -DriveId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UserPurposeV2 <String>] [-WorkingHours <IMicrosoftGraphWorkingHours>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaDriveListLastModifiedByUserMailboxSetting -DriveId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDriveListLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

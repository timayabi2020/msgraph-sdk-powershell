...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/remove-mgbetauserdriverootversion
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaUserDriveRootVersion -InputObject <IFilesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

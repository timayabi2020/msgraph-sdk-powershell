...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdrivelistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupDriveListItemCreatedByUserMailboxSetting -DriveId <String> -GroupId <String>
...
```
Update-MgBetaGroupDriveListItemCreatedByUserMailboxSetting -DriveId <String> -GroupId <String>
 -ListItemId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaGroupDriveListItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>

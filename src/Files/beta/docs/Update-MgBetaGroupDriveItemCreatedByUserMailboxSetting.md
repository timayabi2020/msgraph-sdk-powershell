...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriveitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupDriveItemCreatedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupDriveItemCreatedByUserMailboxSetting -InputObject <IFilesIdentity>

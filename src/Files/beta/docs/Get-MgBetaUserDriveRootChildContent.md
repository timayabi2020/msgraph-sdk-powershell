...
### Get (Default)
```
Get-MgBetaUserDriveRootChildContent -DriveId <String> -DriveItemId <String> -UserId <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserDriveRootChildContent -InputObject <IFilesIdentity> -OutFile <String> [-CustomHeader <String>]

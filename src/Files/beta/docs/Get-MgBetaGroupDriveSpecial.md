...
### List (Default)
```
Get-MgBetaGroupDriveSpecial -DriveId <String> -GroupId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaGroupDriveSpecial -DriveId <String> -DriveItemId <String> -GroupId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupDriveSpecial -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdriveitemlistitemversion
schema: 2.0.0
---
...
```
New-MgBetaUserDriveItemListItemVersion -DriveId <String> -DriveItemId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgBetaUserDriveItemListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaUserDriveItemListItemVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]

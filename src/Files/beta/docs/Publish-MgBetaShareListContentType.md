...
### Publish (Default)
```
Publish-MgBetaShareListContentType -ContentTypeId <String> -SharedDriveItemId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaShareListContentType -InputObject <IFilesIdentity> [-CustomHeader <String>] [-PassThru]

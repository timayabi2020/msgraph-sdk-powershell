...
### Keep (Default)
```
Invoke-MgBetaKeepCommunicationCallAlive -CallId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### KeepViaIdentity
```
Invoke-MgBetaKeepCommunicationCallAlive -InputObject <ICloudCommunicationsIdentity> [-CustomHeader <String>]

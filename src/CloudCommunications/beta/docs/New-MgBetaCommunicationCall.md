...
New-MgBetaCommunicationCall [-ActiveModalities <String[]>] [-AdditionalProperties <Hashtable>]
 ...
 [-Transcription <IMicrosoftGraphCallTranscriptionInfo>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaCommunicationCall -BodyParameter <IMicrosoftGraphCall> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

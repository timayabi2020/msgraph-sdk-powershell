...
New-MgBetaCommunicationCallAudioRoutingGroup -CallId <String> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Receivers <String[]>] [-RoutingMode <String>] [-Sources <String[]>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaCommunicationCallAudioRoutingGroup -CallId <String>
 -BodyParameter <IMicrosoftGraphAudioRoutingGroup> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaCommunicationCallAudioRoutingGroup -InputObject <ICloudCommunicationsIdentity>
 ...
 [-Sources <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
Clear-MgBetaCommunicationPresence -PresenceId <String> [-AdditionalProperties <Hashtable>]
 [-SessionId <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Clear-MgBetaCommunicationPresence -InputObject <ICloudCommunicationsIdentity>
 [-AdditionalProperties <Hashtable>] [-SessionId <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]

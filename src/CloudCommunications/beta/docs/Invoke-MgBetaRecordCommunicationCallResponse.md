...
Invoke-MgBetaRecordCommunicationCallResponse -CallId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Prompts <IMicrosoftGraphPrompt[]>] [-StopTones <String[]>] [-StreamWhileRecording] [-CustomHeader <String>]
...
Invoke-MgBetaRecordCommunicationCallResponse -InputObject <ICloudCommunicationsIdentity>
 ...
 [-StopTones <String[]>] [-StreamWhileRecording] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgBetaCommunicationCallRecordOrganizerV2 -CallRecordId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaCommunicationCallRecordOrganizerV2 -InputObject <ICloudCommunicationsIdentity>

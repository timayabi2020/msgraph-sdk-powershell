...
### Delete (Default)
```
Remove-MgBetaUserOnlineMeetingRegistrationRegistrant -MeetingRegistrantBaseId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserOnlineMeetingRegistrationRegistrant -InputObject <ICloudCommunicationsIdentity>

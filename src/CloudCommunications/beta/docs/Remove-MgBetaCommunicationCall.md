...
### Delete (Default)
```
Remove-MgBetaCommunicationCall -CallId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaCommunicationCall -InputObject <ICloudCommunicationsIdentity> [-IfMatch <String>]

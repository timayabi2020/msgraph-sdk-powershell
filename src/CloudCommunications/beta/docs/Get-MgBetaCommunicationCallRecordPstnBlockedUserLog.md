...
### Get (Default)
```
Get-MgBetaCommunicationCallRecordPstnBlockedUserLog -FromDateTime <DateTime> -ToDateTime <DateTime> [-Count]
...
### GetViaIdentity
```
Get-MgBetaCommunicationCallRecordPstnBlockedUserLog -InputObject <ICloudCommunicationsIdentity> [-Count]
 [-Filter <String>] [-Search <String>] [-Skip <Int32>] [-Top <Int32>] [-CustomHeader <String>]
 [<CommonParameters>]
```

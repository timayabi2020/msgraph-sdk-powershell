...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/new-mgbetacommunicationcalloperation
schema: 2.0.0
---
...
### Create
```
New-MgBetaCommunicationCallOperation -CallId <String> -BodyParameter <IMicrosoftGraphCommsOperation>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-MgBetaCommunicationCallOperation -InputObject <ICloudCommunicationsIdentity>
 -BodyParameter <IMicrosoftGraphCommsOperation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

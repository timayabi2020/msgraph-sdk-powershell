...
### Delete (Default)
```
Remove-MgBetaUserPresence -UserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserPresence -InputObject <ICloudCommunicationsIdentity> [-IfMatch <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.cloudcommunications/new-mgcommunicationonlinemeetingrecording
schema: 2.0.0
---
...
```
New-MgCommunicationOnlineMeetingRecording -OnlineMeetingId <String> [-AdditionalProperties <Hashtable>]
 [-ContentInputFile <String>] [-CreatedDateTime <DateTime>] [-Id <String>] [-MeetingId <String>]
 [-MeetingOrganizer <IMicrosoftGraphIdentitySet>] [-RecordingContentUrl <String>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgCommunicationOnlineMeetingRecording -OnlineMeetingId <String>
...
### CreateViaIdentity
```
New-MgCommunicationOnlineMeetingRecording -InputObject <ICloudCommunicationsIdentity>
 -BodyParameter <IMicrosoftGraphCallRecording> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Keep (Default)
```
Invoke-MgKeepCommunicationCallAlive -CallId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### KeepViaIdentity
```
Invoke-MgKeepCommunicationCallAlive -InputObject <ICloudCommunicationsIdentity> [-CustomHeader <String>]

...
Update-MgCommunicationCallRecordSession -CallRecordId <String> -SessionId <String>
 ...
 [-Segments <IMicrosoftGraphCallRecordsSegment[]>] [-StartDateTime <DateTime>] [-CustomHeader <String>]
...
```
Update-MgCommunicationCallRecordSession -CallRecordId <String> -SessionId <String>
 -BodyParameter <IMicrosoftGraphCallRecordsSession> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

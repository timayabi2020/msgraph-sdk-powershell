...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.cloudcommunications/new-mguseronlinemeetingrecording
schema: 2.0.0
---
...
```
New-MgUserOnlineMeetingRecording -OnlineMeetingId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnlineMeetingRecording -InputObject <ICloudCommunicationsIdentity>
 -BodyParameter <IMicrosoftGraphCallRecording> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

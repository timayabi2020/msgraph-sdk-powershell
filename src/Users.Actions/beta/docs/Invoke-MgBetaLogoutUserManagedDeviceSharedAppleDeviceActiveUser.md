...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/invoke-mgbetalogoutusermanageddevicesharedappledeviceactiveuser
schema: 2.0.0
---
...
### LogoutViaIdentity
```
Invoke-MgBetaLogoutUserManagedDeviceSharedAppleDeviceActiveUser -InputObject <IUsersActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Complete (Default)
```
Complete-MgBetaUserOutlookTask -OutlookTaskId <String> -UserId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaUserOutlookTask -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

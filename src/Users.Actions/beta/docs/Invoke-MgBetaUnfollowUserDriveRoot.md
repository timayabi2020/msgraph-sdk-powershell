...
### Unfollow (Default)
```
Invoke-MgBetaUnfollowUserDriveRoot -DriveId <String> -UserId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgBetaUnfollowUserDriveRoot -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Reboot (Default)
```
Restart-MgBetaUserManagedDeviceNow -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RebootViaIdentity
```
Restart-MgBetaUserManagedDeviceNow -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]

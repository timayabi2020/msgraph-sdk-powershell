...
```
New-MgBetaUserMobileAppTroubleshootingEventAppLogCollectionRequestDownloadUrl
 -AppLogCollectionRequestId <String> -MobileAppTroubleshootingEventId <String> -UserId <String>
...
```
New-MgBetaUserMobileAppTroubleshootingEventAppLogCollectionRequestDownloadUrl
 -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

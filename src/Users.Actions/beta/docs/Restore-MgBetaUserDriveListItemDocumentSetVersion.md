...
### Restore (Default)
```
Restore-MgBetaUserDriveListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
...
### RestoreViaIdentity
```
Restore-MgBetaUserDriveListItemDocumentSetVersion -InputObject <IUsersActionsIdentity>

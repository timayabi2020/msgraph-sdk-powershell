...
### Locate (Default)
```
Find-MgBetaUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgBetaUserManagedDevice -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

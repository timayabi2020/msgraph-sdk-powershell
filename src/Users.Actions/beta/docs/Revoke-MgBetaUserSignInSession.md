...
### Revoke (Default)
```
Revoke-MgBetaUserSignInSession -UserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RevokeViaIdentity
```
Revoke-MgBetaUserSignInSession -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm]

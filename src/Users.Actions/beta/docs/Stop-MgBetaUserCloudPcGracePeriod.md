...
### End (Default)
```
Stop-MgBetaUserCloudPcGracePeriod -CloudPcId <String> -UserId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EndViaIdentity
```
Stop-MgBetaUserCloudPcGracePeriod -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

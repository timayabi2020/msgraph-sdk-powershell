...
### Reset (Default)
```
Reset-MgBetaUserPendingAccessReviewInstanceDecision -AccessReviewInstanceId <String> -UserId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaUserPendingAccessReviewInstanceDecision -InputObject <IUsersActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

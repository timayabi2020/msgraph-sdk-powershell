...
### Unblock (Default)
```
Unblock-MgBetaUserManagedApp -UserId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnblockViaIdentity
```
Unblock-MgBetaUserManagedApp -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]
...
Parameter Sets: UnblockViaIdentity
Aliases:

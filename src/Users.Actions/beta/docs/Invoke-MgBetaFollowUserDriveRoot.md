...
### Follow (Default)
```
Invoke-MgBetaFollowUserDriveRoot -DriveId <String> -UserId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowUserDriveRoot -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

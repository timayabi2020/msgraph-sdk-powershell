...
### Request (Default)
```
Request-MgBetaUserManagedDeviceRemoteAssistance -ManagedDeviceId <String> -UserId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RequestViaIdentity
```
Request-MgBetaUserManagedDeviceRemoteAssistance -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

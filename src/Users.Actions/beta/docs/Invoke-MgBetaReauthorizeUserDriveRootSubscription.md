...
### Reauthorize (Default)
```
Invoke-MgBetaReauthorizeUserDriveRootSubscription -DriveId <String> -SubscriptionId <String> -UserId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeUserDriveRootSubscription -InputObject <IUsersActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

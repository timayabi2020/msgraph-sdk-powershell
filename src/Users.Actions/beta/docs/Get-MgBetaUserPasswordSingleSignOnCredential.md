...
### Get (Default)
```
Get-MgBetaUserPasswordSingleSignOnCredential -UserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserPasswordSingleSignOnCredential -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

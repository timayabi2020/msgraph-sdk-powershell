...
### PowerOn (Default)
```
Start-MgBetaUserCloudPc -CloudPcId <String> -UserId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PowerOnViaIdentity
```
Start-MgBetaUserCloudPc -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

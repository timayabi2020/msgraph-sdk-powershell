...
### Lock (Default)
```
Lock-MgBetaUserManagedDeviceRemote -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LockViaIdentity
```
Lock-MgBetaUserManagedDeviceRemote -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]

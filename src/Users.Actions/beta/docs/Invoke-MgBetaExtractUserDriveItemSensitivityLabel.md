...
### Extract (Default)
```
Invoke-MgBetaExtractUserDriveItemSensitivityLabel -DriveId <String> -DriveItemId <String> -UserId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgBetaExtractUserDriveItemSensitivityLabel -InputObject <IUsersActionsIdentity>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

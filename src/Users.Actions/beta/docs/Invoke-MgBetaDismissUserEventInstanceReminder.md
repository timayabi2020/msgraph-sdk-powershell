...
### Dismiss (Default)
```
Invoke-MgBetaDismissUserEventInstanceReminder -EventId <String> -EventId1 <String> -UserId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgBetaDismissUserEventInstanceReminder -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

...
### Invalidate (Default)
```
Invoke-MgBetaInvalidateAllUserRefreshToken -UserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### InvalidateViaIdentity
```
Invoke-MgBetaInvalidateAllUserRefreshToken -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

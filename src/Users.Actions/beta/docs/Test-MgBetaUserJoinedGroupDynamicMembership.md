...
Test-MgBetaUserJoinedGroupDynamicMembership -UserId <String> [-AdditionalProperties <Hashtable>]
 [-MemberId <String>] [-MembershipRule <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Test-MgBetaUserJoinedGroupDynamicMembership -InputObject <IUsersActionsIdentity>
 [-AdditionalProperties <Hashtable>] [-MemberId <String>] [-MembershipRule <String>] [-CustomHeader <String>]

...
### License (Default)
```
Invoke-MgBetaLicenseUser -UserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LicenseViaIdentity
```
Invoke-MgBetaLicenseUser -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Reenable (Default)
```
Invoke-MgBetaReenableUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReenableViaIdentity
```
Invoke-MgBetaReenableUserManagedDevice -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

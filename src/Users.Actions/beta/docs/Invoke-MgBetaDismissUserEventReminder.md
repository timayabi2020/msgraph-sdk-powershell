...
### Dismiss (Default)
```
Invoke-MgBetaDismissUserEventReminder -EventId <String> -UserId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgBetaDismissUserEventReminder -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

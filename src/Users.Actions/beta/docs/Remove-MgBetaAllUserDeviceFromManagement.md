...
### Remove (Default)
```
Remove-MgBetaAllUserDeviceFromManagement -UserId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaAllUserDeviceFromManagement -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

...
### Restore (Default)
```
Restore-MgBetaUserDriveItemListItemVersion -DriveId <String> -DriveItemId <String> -ListItemVersionId <String>
 -UserId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaUserDriveItemListItemVersion -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

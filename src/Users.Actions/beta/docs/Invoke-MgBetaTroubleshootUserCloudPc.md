...
```
Invoke-MgBetaTroubleshootUserCloudPc -CloudPcId <String> -UserId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TroubleshootViaIdentity
```
Invoke-MgBetaTroubleshootUserCloudPc -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Cloud (Default)
```
Invoke-MgBetaReprovisionUserManagedDeviceCloudPc -ManagedDeviceId <String> -UserId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CloudViaIdentity
```
Invoke-MgBetaReprovisionUserManagedDeviceCloudPc -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

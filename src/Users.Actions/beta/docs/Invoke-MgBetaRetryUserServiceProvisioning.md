...
### Retry (Default)
```
Invoke-MgBetaRetryUserServiceProvisioning -UserId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgBetaRetryUserServiceProvisioning -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

...
### Reset (Default)
```
Reset-MgUserManagedDevicePasscode -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgUserManagedDevicePasscode -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]

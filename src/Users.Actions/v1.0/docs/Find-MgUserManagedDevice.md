...
### Locate (Default)
```
Find-MgUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgUserManagedDevice -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

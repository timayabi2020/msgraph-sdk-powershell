...
### License (Default)
```
Invoke-MgLicenseUser -UserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LicenseViaIdentity
```
Invoke-MgLicenseUser -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

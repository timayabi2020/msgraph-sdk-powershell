...
### Revoke (Default)
```
Revoke-MgUserSignInSession -UserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RevokeViaIdentity
```
Revoke-MgUserSignInSession -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

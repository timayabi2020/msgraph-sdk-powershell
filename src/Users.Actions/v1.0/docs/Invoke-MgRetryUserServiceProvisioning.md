...
### Retry (Default)
```
Invoke-MgRetryUserServiceProvisioning -UserId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgRetryUserServiceProvisioning -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users.actions/send-mgusermailfoldermessage
schema: 2.0.0
---
...
### SendViaIdentity
```
Send-MgUserMailFolderMessage -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]

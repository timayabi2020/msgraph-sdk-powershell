...
### Soft (Default)
```
Invoke-MgSoftUserChatMessageDelete -ChatId <String> -ChatMessageId <String> -UserId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SoftViaIdentity
```
Invoke-MgSoftUserChatMessageDelete -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]

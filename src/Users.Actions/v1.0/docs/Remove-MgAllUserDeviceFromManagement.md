...
### Remove (Default)
```
Remove-MgAllUserDeviceFromManagement -UserId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgAllUserDeviceFromManagement -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]

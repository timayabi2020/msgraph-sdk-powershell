...
### Disable (Default)
```
Disable-MgUserManagedDeviceLostMode -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgUserManagedDeviceLostMode -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-PassThru]

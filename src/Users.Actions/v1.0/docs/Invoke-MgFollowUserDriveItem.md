...
### Follow (Default)
```
Invoke-MgFollowUserDriveItem -DriveId <String> -DriveItemId <String> -UserId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowUserDriveItem -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm]

...
### Follow (Default)
```
Invoke-MgFollowUserDriveRoot -DriveId <String> -UserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowUserDriveRoot -InputObject <IUsersActionsIdentity> [-CustomHeader <String>] [-Confirm]

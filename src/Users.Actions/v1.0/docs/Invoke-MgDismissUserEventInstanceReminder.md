...
### Dismiss (Default)
```
Invoke-MgDismissUserEventInstanceReminder -EventId <String> -EventId1 <String> -UserId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgDismissUserEventInstanceReminder -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]

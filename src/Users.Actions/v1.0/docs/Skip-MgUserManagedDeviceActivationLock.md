...
### Bypass (Default)
```
Skip-MgUserManagedDeviceActivationLock -ManagedDeviceId <String> -UserId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BypassViaIdentity
```
Skip-MgUserManagedDeviceActivationLock -InputObject <IUsersActionsIdentity> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

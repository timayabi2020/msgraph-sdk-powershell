...
```
New-MgBetaSubscription [-AdditionalProperties <Hashtable>] [-ApplicationId <String>] [-ChangeType <String>]
...
### Create
```
New-MgBetaSubscription -BodyParameter <IMicrosoftGraphSubscription> [-CustomHeader <String>] [-Confirm]

...
### Get
```
Get-MgSubscription -SubscriptionId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSubscription -InputObject <IChangeNotificationsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

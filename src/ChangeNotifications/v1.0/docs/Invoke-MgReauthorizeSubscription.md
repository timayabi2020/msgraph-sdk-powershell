...
### Reauthorize (Default)
```
Invoke-MgReauthorizeSubscription -SubscriptionId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgReauthorizeSubscription -InputObject <IChangeNotificationsIdentity> [-CustomHeader <String>]

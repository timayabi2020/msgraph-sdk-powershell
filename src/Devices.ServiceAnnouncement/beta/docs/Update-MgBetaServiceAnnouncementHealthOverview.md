...
Update-MgBetaServiceAnnouncementHealthOverview -ServiceHealthId <String>
 -BodyParameter <IMicrosoftGraphServiceHealth> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaServiceAnnouncementHealthOverview -InputObject <IDevicesServiceAnnouncementIdentity>
 ...
 [-Service <String>] [-Status <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

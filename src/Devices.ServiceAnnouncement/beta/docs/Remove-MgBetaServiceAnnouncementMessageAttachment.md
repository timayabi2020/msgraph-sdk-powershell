...
### Delete (Default)
```
Remove-MgBetaServiceAnnouncementMessageAttachment -ServiceAnnouncementAttachmentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaServiceAnnouncementMessageAttachment -InputObject <IDevicesServiceAnnouncementIdentity>

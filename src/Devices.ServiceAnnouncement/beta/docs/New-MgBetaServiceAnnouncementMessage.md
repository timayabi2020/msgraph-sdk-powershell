...
```
New-MgBetaServiceAnnouncementMessage [-ActionRequiredByDateTime <DateTime>]
 ...
 [-ViewPoint <IMicrosoftGraphServiceUpdateMessageViewpoint>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaServiceAnnouncementMessage -BodyParameter <IMicrosoftGraphServiceUpdateMessage>

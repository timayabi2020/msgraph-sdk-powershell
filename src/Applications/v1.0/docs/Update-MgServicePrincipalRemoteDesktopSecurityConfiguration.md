...
Update-MgServicePrincipalRemoteDesktopSecurityConfiguration -ServicePrincipalId <String>
 ...
 [-TargetDeviceGroups <IMicrosoftGraphTargetDeviceGroup[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgServicePrincipalRemoteDesktopSecurityConfiguration -ServicePrincipalId <String>
 -BodyParameter <IMicrosoftGraphRemoteDesktopSecurityConfiguration> [-CustomHeader <String>] [-Confirm]

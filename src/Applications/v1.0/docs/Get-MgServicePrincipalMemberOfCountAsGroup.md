...
### Get (Default)
```
Get-MgServicePrincipalMemberOfCountAsGroup -ServicePrincipalId <String> -ConsistencyLevel <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgServicePrincipalMemberOfCountAsGroup -InputObject <IApplicationsIdentity> -ConsistencyLevel <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgServicePrincipalByAppId -AppId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgServicePrincipalByAppId -InputObject <IApplicationsIdentity> [-IfMatch <String>]

...
### Create
```
New-MgApplicationOwnerByRef -ApplicationId <String> -BodyParameter <IReferenceCreate> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgApplicationOwnerByRef -InputObject <IApplicationsIdentity> -BodyParameter <IReferenceCreate>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

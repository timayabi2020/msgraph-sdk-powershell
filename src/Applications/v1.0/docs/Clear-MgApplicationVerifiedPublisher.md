...
### Unset (Default)
```
Clear-MgApplicationVerifiedPublisher -ApplicationId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UnsetViaIdentity
```
Clear-MgApplicationVerifiedPublisher -InputObject <IApplicationsIdentity> [-CustomHeader <String>] [-PassThru]

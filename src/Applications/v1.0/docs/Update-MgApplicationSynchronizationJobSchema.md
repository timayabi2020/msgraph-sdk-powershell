...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.applications/update-mgapplicationsynchronizationjobschema
schema: 2.0.0
---
...
```
Update-MgApplicationSynchronizationJobSchema -ApplicationId <String> -SynchronizationJobId <String>
 [-AdditionalProperties <Hashtable>] [-Directories <IMicrosoftGraphDirectoryDefinition[]>] [-Id <String>]
 [-SynchronizationRules <IMicrosoftGraphSynchronizationRule[]>] [-Version <String>] [-CustomHeader <String>]
...
```
Update-MgApplicationSynchronizationJobSchema -ApplicationId <String> -SynchronizationJobId <String>
 -BodyParameter <IMicrosoftGraphSynchronizationSchema> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgApplicationSynchronizationJobSchema -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphSynchronizationSchema> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

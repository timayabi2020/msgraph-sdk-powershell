...
Find-MgApplicationSynchronizationTemplateSchemaDirectory -ApplicationId <String>
 -DirectoryDefinitionId <String> -SynchronizationTemplateId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DiscoverViaIdentity
```
Find-MgApplicationSynchronizationTemplateSchemaDirectory -InputObject <IApplicationsIdentity>

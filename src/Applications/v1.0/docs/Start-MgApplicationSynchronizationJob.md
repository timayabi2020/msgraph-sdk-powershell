...
### Start (Default)
```
Start-MgApplicationSynchronizationJob -ApplicationId <String> -SynchronizationJobId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgApplicationSynchronizationJob -InputObject <IApplicationsIdentity> [-CustomHeader <String>]

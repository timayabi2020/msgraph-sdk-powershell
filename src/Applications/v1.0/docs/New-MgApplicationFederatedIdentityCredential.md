...
New-MgApplicationFederatedIdentityCredential -ApplicationId <String>
 -BodyParameter <IMicrosoftGraphFederatedIdentityCredential> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgApplicationFederatedIdentityCredential -InputObject <IApplicationsIdentity>
 ...
 [-Issuer <String>] [-Name <String>] [-Subject <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgApplicationSynchronizationJob -ApplicationId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgApplicationSynchronizationJob -InputObject <IApplicationsIdentity> [-ExpandProperty <String[]>]

...
### Delete (Default)
```
Remove-MgBetaApplicationTokenIssuancePolicyByRef -ApplicationId <String> -TokenIssuancePolicyId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaApplicationTokenIssuancePolicyByRef -InputObject <IApplicationsIdentity> [-Id <String>]

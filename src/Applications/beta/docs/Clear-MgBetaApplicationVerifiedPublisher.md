...
### Unset (Default)
```
Clear-MgBetaApplicationVerifiedPublisher -ApplicationId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnsetViaIdentity
```
Clear-MgBetaApplicationVerifiedPublisher -InputObject <IApplicationsIdentity> [-CustomHeader <String>]

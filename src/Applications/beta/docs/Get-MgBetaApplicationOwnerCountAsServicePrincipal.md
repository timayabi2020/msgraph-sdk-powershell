...
### Get (Default)
```
Get-MgBetaApplicationOwnerCountAsServicePrincipal -ApplicationId <String> -ConsistencyLevel <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaApplicationOwnerCountAsServicePrincipal -InputObject <IApplicationsIdentity>

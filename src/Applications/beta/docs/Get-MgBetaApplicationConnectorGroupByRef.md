...
### Get (Default)
```
Get-MgBetaApplicationConnectorGroupByRef -ApplicationId <String> [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaApplicationConnectorGroupByRef -InputObject <IApplicationsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

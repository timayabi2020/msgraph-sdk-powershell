...
### Get (Default)
```
Get-MgBetaApplicationSynchronizationJobSchema -ApplicationId <String> -SynchronizationJobId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaApplicationSynchronizationJobSchema -InputObject <IApplicationsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

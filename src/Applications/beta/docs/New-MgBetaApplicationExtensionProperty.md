...
New-MgBetaApplicationExtensionProperty -ApplicationId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-IsSyncedFromOnPremises] [-Name <String>] [-TargetObjects <String[]>] [-CustomHeader <String>] [-Confirm]
...
New-MgBetaApplicationExtensionProperty -ApplicationId <String>
 -BodyParameter <IMicrosoftGraphExtensionProperty> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaApplicationExtensionProperty -InputObject <IApplicationsIdentity>
 ...
 [-TargetObjects <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

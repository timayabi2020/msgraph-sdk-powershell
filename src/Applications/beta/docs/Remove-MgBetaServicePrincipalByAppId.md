...
### Delete (Default)
```
Remove-MgBetaServicePrincipalByAppId -AppId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaServicePrincipalByAppId -InputObject <IApplicationsIdentity> [-IfMatch <String>]

...
### Filter (Default)
```
Invoke-MgBetaFilterServicePrincipalSynchronizationTemplateSchemaOperator -ServicePrincipalId <String>
...
### FilterViaIdentity
```
Invoke-MgBetaFilterServicePrincipalSynchronizationTemplateSchemaOperator -InputObject <IApplicationsIdentity>

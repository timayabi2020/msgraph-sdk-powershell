...
### Discover (Default)
```
Find-MgBetaApplicationSynchronizationJobSchemaDirectory -ApplicationId <String>
 -DirectoryDefinitionId <String> -SynchronizationJobId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DiscoverViaIdentity
```
Find-MgBetaApplicationSynchronizationJobSchemaDirectory -InputObject <IApplicationsIdentity>

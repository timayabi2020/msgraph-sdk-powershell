...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/remove-mgbetaonpremisepublishingprofileconnectorgroupmemberbyref
schema: 2.0.0
---
...
Remove-MgBetaOnPremisePublishingProfileConnectorGroupMemberByRef -ConnectorGroupId <String>
 -ConnectorId <String> -OnPremisesPublishingProfileId <String> [-Id <String>] [-IfMatch <String>]

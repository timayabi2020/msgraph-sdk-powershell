...
### Filter (Default)
```
Invoke-MgBetaFilterApplicationSynchronizationTemplateSchemaOperator -ApplicationId <String>
...
### FilterViaIdentity
```
Invoke-MgBetaFilterApplicationSynchronizationTemplateSchemaOperator -InputObject <IApplicationsIdentity>

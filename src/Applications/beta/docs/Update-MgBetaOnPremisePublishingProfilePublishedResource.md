...
Update-MgBetaOnPremisePublishingProfilePublishedResource -OnPremisesPublishingProfileId <String>
 ...
 [-PublishingType <String>] [-ResourceName <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaOnPremisePublishingProfilePublishedResource -OnPremisesPublishingProfileId <String>
 -PublishedResourceId <String> -BodyParameter <IMicrosoftGraphPublishedResource> [-CustomHeader <String>]
...
Update-MgBetaOnPremisePublishingProfilePublishedResource -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphPublishedResource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaApplication -ApplicationId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaApplication -InputObject <IApplicationsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

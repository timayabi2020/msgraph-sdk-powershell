...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/get-mgbetaserviceprincipalappmanagementpolicy
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaServicePrincipalAppManagementPolicy -InputObject <IApplicationsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

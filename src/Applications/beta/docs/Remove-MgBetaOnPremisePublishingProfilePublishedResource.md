...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/remove-mgbetaonpremisepublishingprofilepublishedresource
schema: 2.0.0
---
...
Remove-MgBetaOnPremisePublishingProfilePublishedResource -OnPremisesPublishingProfileId <String>
 -PublishedResourceId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaOnPremisePublishingProfilePublishedResource -InputObject <IApplicationsIdentity>

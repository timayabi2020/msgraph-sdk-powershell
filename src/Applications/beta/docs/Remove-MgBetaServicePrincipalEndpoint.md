...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/remove-mgbetaserviceprincipalendpoint
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaServicePrincipalEndpoint -InputObject <IApplicationsIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

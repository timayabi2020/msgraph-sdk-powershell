...
New-MgBetaOnPremisePublishingProfilePublishedResourceAgentGroup -OnPremisesPublishingProfileId <String>
 ...
 [-PublishedResources <IMicrosoftGraphPublishedResource[]>] [-PublishingType <String>]
...
```
New-MgBetaOnPremisePublishingProfilePublishedResourceAgentGroup -OnPremisesPublishingProfileId <String>
 -PublishedResourceId <String> -BodyParameter <IMicrosoftGraphOnPremisesAgentGroup> [-CustomHeader <String>]
...
New-MgBetaOnPremisePublishingProfilePublishedResourceAgentGroup -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphOnPremisesAgentGroup> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaOnPremisePublishingProfilePublishedResourceAgentGroup -InputObject <IApplicationsIdentity>
 ...
 [-PublishingType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaserviceprincipalsynchronizationtemplateschemadirectory
schema: 2.0.0
---
...
```
Update-MgBetaServicePrincipalSynchronizationTemplateSchemaDirectory -DirectoryDefinitionId <String>
 ...
 [-Objects <IMicrosoftGraphObjectDefinition[]>] [-ReadOnly] [-Version <String>] [-CustomHeader <String>]
...
Update-MgBetaServicePrincipalSynchronizationTemplateSchemaDirectory -DirectoryDefinitionId <String>
 ...
 -BodyParameter <IMicrosoftGraphDirectoryDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaServicePrincipalSynchronizationTemplateSchemaDirectory -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphDirectoryDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

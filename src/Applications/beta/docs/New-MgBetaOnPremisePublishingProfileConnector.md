...
New-MgBetaOnPremisePublishingProfileConnector -OnPremisesPublishingProfileId <String>
 ...
 [-MemberOf <IMicrosoftGraphConnectorGroup[]>] [-Status <String>] [-Version <String>] [-CustomHeader <String>]
...
```
New-MgBetaOnPremisePublishingProfileConnector -OnPremisesPublishingProfileId <String>
 -BodyParameter <IMicrosoftGraphConnector> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Ping (Default)
```
Ping-MgBetaServicePrincipalSynchronization -ServicePrincipalId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### PingViaIdentity
```
Ping-MgBetaServicePrincipalSynchronization -InputObject <IApplicationsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

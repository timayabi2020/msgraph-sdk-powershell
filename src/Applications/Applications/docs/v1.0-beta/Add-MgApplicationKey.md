...
### Add
```
Add-MgApplicationKey -ApplicationId <String> -BodyParameter <IMicrosoftGraphApplicationAddKeyParameters>
...
Add-MgApplicationKey -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphApplicationAddKeyParameters> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphApplicationAddKeyParameters
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphApplicationAddKeyParameters
...
BODYPARAMETER <IMicrosoftGraphApplicationAddKeyParameters>: addKeyParameters

...
### Restore (Default)
```
Restore-MgBetaIdentityGovernanceLifecycleWorkflow -WorkflowId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaIdentityGovernanceLifecycleWorkflow -InputObject <IIdentityGovernanceIdentity>

...
### Stop (Default)
```
Stop-MgBetaAccessReview -AccessReviewId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StopViaIdentity
```
Stop-MgBetaAccessReview -InputObject <IIdentityGovernanceIdentity> [-CustomHeader <String>] [-PassThru]

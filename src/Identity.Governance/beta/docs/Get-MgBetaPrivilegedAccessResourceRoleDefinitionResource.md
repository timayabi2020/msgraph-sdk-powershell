...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaprivilegedaccessresourceroledefinitionresource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaPrivilegedAccessResourceRoleDefinitionResource -GovernanceResourceId <String>
...
### GetViaIdentity
```
Get-MgBetaPrivilegedAccessResourceRoleDefinitionResource -InputObject <IIdentityGovernanceIdentity>

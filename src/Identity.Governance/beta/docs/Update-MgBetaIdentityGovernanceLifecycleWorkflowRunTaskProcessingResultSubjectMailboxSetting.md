...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancelifecycleworkflowruntaskprocessingresultsubjectmailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowRunTaskProcessingResultSubjectMailboxSetting -RunId <String>
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowRunTaskProcessingResultSubjectMailboxSetting -RunId <String>
 -TaskProcessingResultId <String> -WorkflowId <String> -BodyParameter <IMicrosoftGraphMailboxSettings>

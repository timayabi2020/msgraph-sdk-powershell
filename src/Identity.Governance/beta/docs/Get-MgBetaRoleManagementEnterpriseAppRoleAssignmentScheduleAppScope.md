...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagemententerpriseapproleassignmentscheduleappscope
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaRoleManagementEnterpriseAppRoleAssignmentScheduleAppScope -RbacApplicationId <String>
...
### GetViaIdentity
```
Get-MgBetaRoleManagementEnterpriseAppRoleAssignmentScheduleAppScope -InputObject <IIdentityGovernanceIdentity>

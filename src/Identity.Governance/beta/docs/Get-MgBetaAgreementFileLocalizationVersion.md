...
### List (Default)
```
Get-MgBetaAgreementFileLocalizationVersion -AgreementFileLocalizationId <String> -AgreementId <String>
...
### Get
```
Get-MgBetaAgreementFileLocalizationVersion -AgreementFileLocalizationId <String>
...
### GetViaIdentity
```
Get-MgBetaAgreementFileLocalizationVersion -InputObject <IIdentityGovernanceIdentity>

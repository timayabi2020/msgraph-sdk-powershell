...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetarolemanagementdirectoryroledefinition
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaRoleManagementDirectoryRoleDefinition -UnifiedRoleDefinitionId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaRoleManagementDirectoryRoleDefinition -InputObject <IIdentityGovernanceIdentity>

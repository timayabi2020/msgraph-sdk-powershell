...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaprivilegedaccessroledefinition
schema: 2.0.0
---
...
```
New-MgBetaPrivilegedAccessRoleDefinition -PrivilegedAccessId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaPrivilegedAccessRoleDefinition -PrivilegedAccessId <String>
 -BodyParameter <IMicrosoftGraphGovernanceRoleDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaPrivilegedAccessRoleDefinition -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphGovernanceRoleDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaPrivilegedAccessRoleDefinition -InputObject <IIdentityGovernanceIdentity>
 ...
 [-RoleSetting <IMicrosoftGraphGovernanceRoleSetting>] [-TemplateId <String>] [-CustomHeader <String>]

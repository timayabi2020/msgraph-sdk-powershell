...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagemententerpriseapproleeligibilityschedulerequest
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaRoleManagementEnterpriseAppRoleEligibilityScheduleRequest -RbacApplicationId <String>
...
### GetViaIdentity
```
Get-MgBetaRoleManagementEnterpriseAppRoleEligibilityScheduleRequest -InputObject <IIdentityGovernanceIdentity>

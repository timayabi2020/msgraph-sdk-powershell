...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/reset-mgbetaaccessreviewdecision
schema: 2.0.0
---
...
### Reset (Default)
```
Reset-MgBetaAccessReviewDecision -AccessReviewId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity> [-CustomHeader <String>]

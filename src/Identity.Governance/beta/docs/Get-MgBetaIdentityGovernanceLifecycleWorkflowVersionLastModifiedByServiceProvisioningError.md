...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancelifecycleworkflowversionlastmodifiedbyserviceprovisioningerror
schema: 2.0.0
---
...
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowVersionLastModifiedByServiceProvisioningError
 -WorkflowId <String> -WorkflowVersionNumber <Int32> [-ExpandProperty <String[]>] [-Filter <String>]

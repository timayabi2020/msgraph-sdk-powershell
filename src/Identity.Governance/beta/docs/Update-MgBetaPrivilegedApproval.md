...
Update-MgBetaPrivilegedApproval -PrivilegedApprovalId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-StartDateTime <DateTime>] [-UserId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaPrivilegedApproval -PrivilegedApprovalId <String>
 -BodyParameter <IMicrosoftGraphPrivilegedApproval> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

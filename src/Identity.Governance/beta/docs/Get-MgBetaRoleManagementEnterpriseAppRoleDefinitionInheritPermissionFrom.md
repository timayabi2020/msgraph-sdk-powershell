...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagemententerpriseapproledefinitioninheritpermissionfrom
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaRoleManagementEnterpriseAppRoleDefinitionInheritPermissionFrom -RbacApplicationId <String>
 -UnifiedRoleDefinitionId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaaccessreviewdecision
schema: 2.0.0
---
...
```
Update-MgBetaAccessReviewDecision -AccessReviewDecisionId <String> -AccessReviewId <String>
...
### UpdateViaIdentity
```
Update-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessReviewDecision> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity> [-AccessReviewId <String>]

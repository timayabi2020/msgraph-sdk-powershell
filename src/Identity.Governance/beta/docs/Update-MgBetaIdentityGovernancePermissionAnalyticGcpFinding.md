...
```
Update-MgBetaIdentityGovernancePermissionAnalyticGcpFinding -FindingId <String>
...
### UpdateViaIdentity
```
Update-MgBetaIdentityGovernancePermissionAnalyticGcpFinding -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphFinding> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

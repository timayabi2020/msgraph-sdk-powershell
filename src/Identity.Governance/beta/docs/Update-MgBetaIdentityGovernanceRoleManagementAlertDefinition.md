...
Update-MgBetaIdentityGovernanceRoleManagementAlertDefinition -UnifiedRoleManagementAlertDefinitionId <String>
 ...
 [-ScopeType <String>] [-SecurityImpact <String>] [-SeverityLevel <String>] [-CustomHeader <String>]
...
```
Update-MgBetaIdentityGovernanceRoleManagementAlertDefinition -UnifiedRoleManagementAlertDefinitionId <String>
 -BodyParameter <IMicrosoftGraphUnifiedRoleManagementAlertDefinition> [-CustomHeader <String>] [-Confirm]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaprivilegedapprovalroleinfosummary
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaPrivilegedApprovalRoleInfoSummary -PrivilegedApprovalId <String> [-IfMatch <String>]

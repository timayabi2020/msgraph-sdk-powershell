...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/invoke-mgbetafilterrolemanagementdirectoryroleassignmentapprovalbycurrentuser
schema: 2.0.0
---
...
### Filter (Default)
```
Invoke-MgBetaFilterRoleManagementDirectoryRoleAssignmentApprovalByCurrentUser -On <String> [-Count]

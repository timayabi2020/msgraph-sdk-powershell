...
### List (Default)
```
Get-MgBetaIdentityGovernancePermissionManagementPermissionRequestChange [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaIdentityGovernancePermissionManagementPermissionRequestChange -PermissionsRequestChangeId <String>

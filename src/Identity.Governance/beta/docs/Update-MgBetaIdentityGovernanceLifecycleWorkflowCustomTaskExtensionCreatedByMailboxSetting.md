...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancelifecycleworkflowcustomtaskextensioncreatedbymailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowCustomTaskExtensionCreatedByMailboxSetting
 -CustomTaskExtensionId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>]

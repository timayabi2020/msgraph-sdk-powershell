...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetarolemanagemententitlementmanagementroleeligibilityschedulerequest
schema: 2.0.0
---
...
```
New-MgBetaRoleManagementEntitlementManagementRoleEligibilityScheduleRequest [-Action <String>]
 ...
 [-TicketInfo <IMicrosoftGraphTicketInfo>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaRoleManagementEntitlementManagementRoleEligibilityScheduleRequest
 -BodyParameter <IMicrosoftGraphUnifiedRoleEligibilityScheduleRequest> [-CustomHeader <String>] [-Confirm]

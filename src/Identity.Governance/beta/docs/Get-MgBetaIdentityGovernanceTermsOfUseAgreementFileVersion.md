...
### List (Default)
```
Get-MgBetaIdentityGovernanceTermsOfUseAgreementFileVersion -AgreementFileLocalizationId <String>
...
### GetViaIdentity
```
Get-MgBetaIdentityGovernanceTermsOfUseAgreementFileVersion -InputObject <IIdentityGovernanceIdentity>

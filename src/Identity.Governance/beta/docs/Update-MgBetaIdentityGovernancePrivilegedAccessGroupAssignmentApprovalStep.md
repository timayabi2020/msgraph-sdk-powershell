...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernanceprivilegedaccessgroupassignmentapprovalstep
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStep -ApprovalId <String>
...
```
Update-MgBetaIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStep -ApprovalId <String>
 -ApprovalStepId <String> -BodyParameter <IMicrosoftGraphApprovalStep> [-CustomHeader <String>] [-Confirm]

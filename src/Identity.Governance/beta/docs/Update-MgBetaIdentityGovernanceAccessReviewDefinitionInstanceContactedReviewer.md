...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernanceaccessreviewdefinitioninstancecontactedreviewer
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernanceAccessReviewDefinitionInstanceContactedReviewer
 -AccessReviewInstanceId <String> -AccessReviewReviewerId <String> -AccessReviewScheduleDefinitionId <String>
...
Update-MgBetaIdentityGovernanceAccessReviewDefinitionInstanceContactedReviewer
 -AccessReviewInstanceId <String> -AccessReviewReviewerId <String> -AccessReviewScheduleDefinitionId <String>
 -BodyParameter <IMicrosoftGraphAccessReviewReviewer> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaIdentityGovernanceAccessReviewDefinitionInstanceContactedReviewer
 ...
 [-DisplayName <String>] [-Id <String>] [-UserPrincipalName <String>] [-CustomHeader <String>] [-Confirm]

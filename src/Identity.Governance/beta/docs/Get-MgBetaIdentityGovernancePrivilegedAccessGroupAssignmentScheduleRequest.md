...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernanceprivilegedaccessgroupassignmentschedulerequest
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaIdentityGovernancePrivilegedAccessGroupAssignmentScheduleRequest [-ExpandProperty <String[]>]

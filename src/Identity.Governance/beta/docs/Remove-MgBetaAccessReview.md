...
### Delete (Default)
```
Remove-MgBetaAccessReview -AccessReviewId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaAccessReview -InputObject <IIdentityGovernanceIdentity> [-IfMatch <String>]

...
### Stop (Default)
```
Stop-MgBetaAccessReviewInstance -AccessReviewId <String> -AccessReviewId1 <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-MgBetaAccessReviewInstance -InputObject <IIdentityGovernanceIdentity> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

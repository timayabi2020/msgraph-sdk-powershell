...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaidentitygovernancepermissionanalyticazurefinding
schema: 2.0.0
---
...
```
New-MgBetaIdentityGovernancePermissionAnalyticAzureFinding [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaIdentityGovernancePermissionAnalyticAzureFinding -BodyParameter <IMicrosoftGraphFinding>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagemententerpriseapproleeligibilityscheduleappscope
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaRoleManagementEnterpriseAppRoleEligibilityScheduleAppScope -RbacApplicationId <String>

...
### Get (Default)
```
Get-MgBetaPrivilegedAccessRoleAssignmentResource -GovernanceRoleAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaPrivilegedAccessRoleAssignmentResource -InputObject <IIdentityGovernanceIdentity>

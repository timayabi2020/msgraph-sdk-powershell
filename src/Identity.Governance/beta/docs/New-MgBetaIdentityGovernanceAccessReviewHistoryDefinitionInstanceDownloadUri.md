...
```
New-MgBetaIdentityGovernanceAccessReviewHistoryDefinitionInstanceDownloadUri
 -AccessReviewHistoryDefinitionId <String> -AccessReviewHistoryInstanceId <String> [-CustomHeader <String>]
...
```
New-MgBetaIdentityGovernanceAccessReviewHistoryDefinitionInstanceDownloadUri
 -InputObject <IIdentityGovernanceIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
Update-MgBetaProgramControlType -ProgramControlTypeId <String> [-AdditionalProperties <Hashtable>]
 [-ControlTypeGroupId <String>] [-DisplayName <String>] [-Id <String>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaProgramControlType -ProgramControlTypeId <String>
 -BodyParameter <IMicrosoftGraphProgramControlType> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

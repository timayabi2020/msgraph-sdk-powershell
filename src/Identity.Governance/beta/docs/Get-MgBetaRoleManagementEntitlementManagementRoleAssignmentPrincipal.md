...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagemententitlementmanagementroleassignmentprincipal
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaRoleManagementEntitlementManagementRoleAssignmentPrincipal -UnifiedRoleAssignmentId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancelifecycleworkflowcreatedbymailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowCreatedByMailboxSetting -WorkflowId <String>

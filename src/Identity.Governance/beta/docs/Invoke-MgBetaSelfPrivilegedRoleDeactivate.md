...
### Self (Default)
```
Invoke-MgBetaSelfPrivilegedRoleDeactivate -PrivilegedRoleId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SelfViaIdentity
```
Invoke-MgBetaSelfPrivilegedRoleDeactivate -InputObject <IIdentityGovernanceIdentity> [-CustomHeader <String>]

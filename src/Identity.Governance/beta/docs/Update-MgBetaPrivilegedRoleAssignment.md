...
Update-MgBetaPrivilegedRoleAssignment -PrivilegedRoleAssignmentId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-RoleInfo <IMicrosoftGraphPrivilegedRole>] [-UserId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaPrivilegedRoleAssignment -PrivilegedRoleAssignmentId <String>
 -BodyParameter <IMicrosoftGraphPrivilegedRoleAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

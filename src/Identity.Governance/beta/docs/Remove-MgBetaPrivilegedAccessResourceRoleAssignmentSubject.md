...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaprivilegedaccessresourceroleassignmentsubject
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentSubject -GovernanceResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentSubject -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaaccessreviewreviewer
schema: 2.0.0
---
...
```
Update-MgBetaAccessReviewReviewer -AccessReviewId <String> -AccessReviewReviewerId <String>
...
### UpdateViaIdentity
```
Update-MgBetaAccessReviewReviewer -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessReviewReviewer> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

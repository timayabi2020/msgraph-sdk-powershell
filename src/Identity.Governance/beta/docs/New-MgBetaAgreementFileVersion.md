...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaagreementfileversion
schema: 2.0.0
---
...
```
New-MgBetaAgreementFileVersion -AgreementFileLocalizationId <String> -AgreementId <String>
...
### CreateViaIdentity
```
New-MgBetaAgreementFileVersion -InputObject <IIdentityGovernanceIdentity> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaAgreementFileVersion -InputObject <IIdentityGovernanceIdentity> [-AdditionalProperties <Hashtable>]

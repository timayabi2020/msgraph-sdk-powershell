...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaagreementacceptance
schema: 2.0.0
---
...
```
New-MgBetaAgreementAcceptance -AgreementId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UserId <String>] [-UserPrincipalName <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaAgreementAcceptance -AgreementId <String> -BodyParameter <IMicrosoftGraphAgreementAcceptance>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaAgreementAcceptance -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAgreementAcceptance> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaAgreementAcceptance -InputObject <IIdentityGovernanceIdentity> [-AgreementId <String>]
 ...
 [-UserEmail <String>] [-UserId <String>] [-UserPrincipalName <String>] [-CustomHeader <String>] [-Confirm]

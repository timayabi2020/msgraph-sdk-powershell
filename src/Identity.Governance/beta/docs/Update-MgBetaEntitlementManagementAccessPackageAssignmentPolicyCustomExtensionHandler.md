...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaentitlementmanagementaccesspackageassignmentpolicycustomextensionhandler
schema: 2.0.0
---
...
Update-MgBetaEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandler
 ...
 [-Id <String>] [-Stage <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionHandler
 -AccessPackageAssignmentPolicyId <String> -CustomExtensionHandlerId <String>
 -BodyParameter <IMicrosoftGraphCustomExtensionHandler> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCustomExtensionHandler
...
The unique identifier of customExtensionHandler

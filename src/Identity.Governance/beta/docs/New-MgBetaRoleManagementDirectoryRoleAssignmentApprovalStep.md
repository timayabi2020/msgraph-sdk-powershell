...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetarolemanagementdirectoryroleassignmentapprovalstep
schema: 2.0.0
---
...
```
New-MgBetaRoleManagementDirectoryRoleAssignmentApprovalStep -ApprovalId <String>
...
### CreateViaIdentity
```
New-MgBetaRoleManagementDirectoryRoleAssignmentApprovalStep -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphApprovalStep> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

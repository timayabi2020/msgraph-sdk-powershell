...
### List (Default)
```
Get-MgBetaProgram [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### Get
```
Get-MgBetaProgram -ProgramId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaProgram -InputObject <IIdentityGovernanceIdentity> [-ExpandProperty <String[]>]

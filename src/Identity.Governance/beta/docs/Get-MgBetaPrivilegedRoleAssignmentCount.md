...
### Get (Default)
```
Get-MgBetaPrivilegedRoleAssignmentCount [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### Get1
```
Get-MgBetaPrivilegedRoleAssignmentCount -PrivilegedRoleId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPrivilegedRoleAssignmentCount -InputObject <IIdentityGovernanceIdentity> [-Filter <String>]

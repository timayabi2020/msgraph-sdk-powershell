...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaprivilegedrolesummary
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaPrivilegedRoleSummary -PrivilegedRoleId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPrivilegedRoleSummary -InputObject <IIdentityGovernanceIdentity> [-ExpandProperty <String[]>]

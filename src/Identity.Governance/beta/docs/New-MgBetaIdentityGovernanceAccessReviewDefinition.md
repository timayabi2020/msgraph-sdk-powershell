...
New-MgBetaIdentityGovernanceAccessReviewDefinition
 ...
 [-StageSettings <IMicrosoftGraphAccessReviewStageSettings[]>] [-Status <String>] [-CustomHeader <String>]
...
```
New-MgBetaIdentityGovernanceAccessReviewDefinition
 -BodyParameter <IMicrosoftGraphAccessReviewScheduleDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Send (Default)
```
Send-MgBetaAccessReviewReminder -AccessReviewId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SendViaIdentity
```
Send-MgBetaAccessReviewReminder -InputObject <IIdentityGovernanceIdentity> [-CustomHeader <String>]

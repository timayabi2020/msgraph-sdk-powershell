...
Update-MgBetaIdentityGovernanceAccessReviewHistoryDefinition -AccessReviewHistoryDefinitionId <String>
 ...
 [-Scopes <IMicrosoftGraphAccessReviewScope[]>] [-Status <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaIdentityGovernanceAccessReviewHistoryDefinition -AccessReviewHistoryDefinitionId <String>
 -BodyParameter <IMicrosoftGraphAccessReviewHistoryDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

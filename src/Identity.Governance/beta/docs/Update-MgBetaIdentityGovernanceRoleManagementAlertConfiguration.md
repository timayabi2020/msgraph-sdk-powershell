...
Update-MgBetaIdentityGovernanceRoleManagementAlertConfiguration
 ...
 [-Id <String>] [-IsEnabled] [-ScopeId <String>] [-ScopeType <String>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaIdentityGovernanceRoleManagementAlertConfiguration
 ...
 -BodyParameter <IMicrosoftGraphUnifiedRoleManagementAlertConfiguration> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

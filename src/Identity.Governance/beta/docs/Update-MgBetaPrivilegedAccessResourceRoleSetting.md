...
Update-MgBetaPrivilegedAccessResourceRoleSetting -GovernanceResourceId <String>
 ...
 [-UserMemberSettings <IMicrosoftGraphGovernanceRuleSetting[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaPrivilegedAccessResourceRoleSetting -GovernanceResourceId <String>
 ...
 -BodyParameter <IMicrosoftGraphGovernanceRoleSetting> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

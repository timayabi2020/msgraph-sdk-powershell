...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagemententitlementmanagementroleassignmentscheduleinstance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaRoleManagementEntitlementManagementRoleAssignmentScheduleInstance [-ExpandProperty <String[]>]

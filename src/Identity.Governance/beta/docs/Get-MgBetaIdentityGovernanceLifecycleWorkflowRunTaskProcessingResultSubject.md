...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancelifecycleworkflowruntaskprocessingresultsubject
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowRunTaskProcessingResultSubject -RunId <String>

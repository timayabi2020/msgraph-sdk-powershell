...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetarolemanagemententerpriseapproledefinition
schema: 2.0.0
---
...
Remove-MgBetaRoleManagementEnterpriseAppRoleDefinition -RbacApplicationId <String>
 -UnifiedRoleDefinitionId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]

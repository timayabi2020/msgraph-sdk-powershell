...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaprivilegedaccessresourceroleassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignment -GovernanceResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignment -InputObject <IIdentityGovernanceIdentity>

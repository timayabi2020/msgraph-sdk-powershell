...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaprivilegedaccessresourceroleassignmentrequestsubject
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaPrivilegedAccessResourceRoleAssignmentRequestSubject -GovernanceResourceId <String>
...
### GetViaIdentity
```
Get-MgBetaPrivilegedAccessResourceRoleAssignmentRequestSubject -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaprivilegedaccess
schema: 2.0.0
---
...
New-MgBetaPrivilegedAccess [-AdditionalProperties <Hashtable>] [-DisplayName <String>] [-Id <String>]
 ...
 [-RoleSettings <IMicrosoftGraphGovernanceRoleSetting[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaPrivilegedAccess -BodyParameter <IMicrosoftGraphPrivilegedAccess> [-CustomHeader <String>]

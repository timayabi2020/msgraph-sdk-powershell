...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernanceprivilegedaccessgroupassignmentscheduleinstancegroupserviceprovisioningerror
schema: 2.0.0
---
...
```
Get-MgBetaIdentityGovernancePrivilegedAccessGroupAssignmentScheduleInstanceGroupServiceProvisioningError
 -PrivilegedAccessGroupAssignmentScheduleInstanceId <String> [-ExpandProperty <String[]>] [-Filter <String>]

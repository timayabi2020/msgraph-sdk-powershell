...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths15BodmaRolemanagementExchangeResourcenamespacesUnifiedrbacresourcenamespaceIdMicrosoftGraphImportresourceactionsPostRequestbodyContentApplicationJsonSchema

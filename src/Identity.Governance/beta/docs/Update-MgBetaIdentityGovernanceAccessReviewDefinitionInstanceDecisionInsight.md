...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernanceaccessreviewdefinitioninstancedecisioninsight
schema: 2.0.0
---
...
Update-MgBetaIdentityGovernanceAccessReviewDefinitionInstanceDecisionInsight
 ...
 [-Id <String>] [-InsightCreatedDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaIdentityGovernanceAccessReviewDefinitionInstanceDecisionInsight
 ...
 -BodyParameter <IMicrosoftGraphGovernanceInsight> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaIdentityGovernanceAccessReviewDefinitionInstanceDecisionInsight
 ...
 [-InsightCreatedDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

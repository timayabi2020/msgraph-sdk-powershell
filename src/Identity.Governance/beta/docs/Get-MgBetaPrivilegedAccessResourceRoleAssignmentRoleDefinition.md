...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaprivilegedaccessresourceroleassignmentroledefinition
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaPrivilegedAccessResourceRoleAssignmentRoleDefinition -GovernanceResourceId <String>
...
### GetViaIdentity
```
Get-MgBetaPrivilegedAccessResourceRoleAssignmentRoleDefinition -InputObject <IIdentityGovernanceIdentity>

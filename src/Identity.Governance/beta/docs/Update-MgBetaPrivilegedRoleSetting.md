...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaprivilegedrolesetting
schema: 2.0.0
---
...
```
Update-MgBetaPrivilegedRoleSetting -PrivilegedRoleId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-MinElevationDuration <TimeSpan>] [-NotificationToUserOnElevation] [-TicketingInfoOnElevation]
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaPrivilegedRoleSetting -PrivilegedRoleId <String>
 -BodyParameter <IMicrosoftGraphPrivilegedRoleSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaPrivilegedRoleSetting -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphPrivilegedRoleSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaPrivilegedRoleSetting -InputObject <IIdentityGovernanceIdentity>
 ...
 [-NotificationToUserOnElevation] [-TicketingInfoOnElevation] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

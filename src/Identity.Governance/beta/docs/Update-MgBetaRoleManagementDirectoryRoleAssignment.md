...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetarolemanagementdirectoryroleassignment
schema: 2.0.0
---
...
```
Update-MgBetaRoleManagementDirectoryRoleAssignment -UnifiedRoleAssignmentId <String>
...
### UpdateViaIdentity
```
Update-MgBetaRoleManagementDirectoryRoleAssignment -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphUnifiedRoleAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

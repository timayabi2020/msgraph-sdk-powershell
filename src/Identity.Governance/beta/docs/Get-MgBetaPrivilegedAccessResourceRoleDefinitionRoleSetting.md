...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaprivilegedaccessresourceroledefinitionrolesetting
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaPrivilegedAccessResourceRoleDefinitionRoleSetting -GovernanceResourceId <String>
...
### GetViaIdentity
```
Get-MgBetaPrivilegedAccessResourceRoleDefinitionRoleSetting -InputObject <IIdentityGovernanceIdentity>

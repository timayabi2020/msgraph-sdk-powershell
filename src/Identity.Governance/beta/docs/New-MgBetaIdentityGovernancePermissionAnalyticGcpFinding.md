...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaidentitygovernancepermissionanalyticgcpfinding
schema: 2.0.0
---
...
```
New-MgBetaIdentityGovernancePermissionAnalyticGcpFinding [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaIdentityGovernancePermissionAnalyticGcpFinding -BodyParameter <IMicrosoftGraphFinding>

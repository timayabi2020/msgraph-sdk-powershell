...
Stop-MgBetaPrivilegedAccessRoleAssignmentRequest -GovernanceRoleAssignmentRequestId <String>
 -PrivilegedAccessId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaPrivilegedAccessRoleAssignmentRequest -InputObject <IIdentityGovernanceIdentity>

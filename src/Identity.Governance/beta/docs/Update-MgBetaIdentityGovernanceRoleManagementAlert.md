...
Update-MgBetaIdentityGovernanceRoleManagementAlert [-AdditionalProperties <Hashtable>] [-ScopeId <String>]
 [-ScopeType <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgBetaIdentityGovernanceRoleManagementAlert -UnifiedRoleManagementAlertId <String>
 -BodyParameter <IMicrosoftGraphUnifiedRoleManagementAlert> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaIdentityGovernanceRoleManagementAlert -UnifiedRoleManagementAlertId <String>
 ...
 [-ScopeId <String>] [-ScopeType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

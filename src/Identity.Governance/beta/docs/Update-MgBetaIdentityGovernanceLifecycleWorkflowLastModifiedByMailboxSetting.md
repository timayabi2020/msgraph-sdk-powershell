...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancelifecycleworkflowlastmodifiedbymailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowLastModifiedByMailboxSetting -WorkflowId <String>

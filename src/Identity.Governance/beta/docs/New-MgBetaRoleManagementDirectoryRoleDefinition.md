...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetarolemanagementdirectoryroledefinition
schema: 2.0.0
---
...
```
New-MgBetaRoleManagementDirectoryRoleDefinition [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaRoleManagementDirectoryRoleDefinition -BodyParameter <IMicrosoftGraphUnifiedRoleDefinition>

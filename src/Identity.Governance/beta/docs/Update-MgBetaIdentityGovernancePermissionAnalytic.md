...
Update-MgBetaIdentityGovernancePermissionAnalytic [-AdditionalProperties <Hashtable>]
 ...
 [-Gcp <IMicrosoftGraphPermissionsAnalytics>] [-Id <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaIdentityGovernancePermissionAnalytic
 -BodyParameter <IMicrosoftGraphPermissionsAnalyticsAggregation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

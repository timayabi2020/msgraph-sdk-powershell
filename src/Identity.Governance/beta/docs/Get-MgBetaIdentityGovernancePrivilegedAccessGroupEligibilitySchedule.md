...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernanceprivilegedaccessgroupeligibilityschedule
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaIdentityGovernancePrivilegedAccessGroupEligibilitySchedule [-ExpandProperty <String[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphPrivilegedAccessGroupEligibilitySchedule

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaidentitygovernancetermsofuseagreementfileversion
schema: 2.0.0
---
...
```
New-MgBetaIdentityGovernanceTermsOfUseAgreementFileVersion -AgreementFileLocalizationId <String>
...
### CreateViaIdentity
```
New-MgBetaIdentityGovernanceTermsOfUseAgreementFileVersion -InputObject <IIdentityGovernanceIdentity>

...
### Delete (Default)
```
Remove-MgBetaRoleManagementDirectoryRoleAssignment -UnifiedRoleAssignmentId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaRoleManagementDirectoryRoleAssignment -InputObject <IIdentityGovernanceIdentity>

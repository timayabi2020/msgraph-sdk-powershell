...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaprivilegedaccessresourceroleassignmentrequestsubject
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentRequestSubject -GovernanceResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentRequestSubject -InputObject <IIdentityGovernanceIdentity>

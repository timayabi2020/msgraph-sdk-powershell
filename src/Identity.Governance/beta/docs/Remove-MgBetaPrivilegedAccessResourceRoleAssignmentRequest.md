...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaprivilegedaccessresourceroleassignmentrequest
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentRequest -GovernanceResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentRequest -InputObject <IIdentityGovernanceIdentity>

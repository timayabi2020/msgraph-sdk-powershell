...
New-MgBetaProgramControl [-ProgramId <String>] [-AdditionalProperties <Hashtable>] [-ControlId <String>]
 ...
 [-Resource <IMicrosoftGraphProgramResource>] [-Status <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaProgramControl -BodyParameter <IMicrosoftGraphProgramControl> [-CustomHeader <String>] [-Confirm]

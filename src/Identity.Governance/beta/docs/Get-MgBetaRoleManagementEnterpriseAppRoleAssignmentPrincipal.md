...
### Get (Default)
```
Get-MgBetaRoleManagementEnterpriseAppRoleAssignmentPrincipal -RbacApplicationId <String>
...
### GetViaIdentity
```
Get-MgBetaRoleManagementEnterpriseAppRoleAssignmentPrincipal -InputObject <IIdentityGovernanceIdentity>

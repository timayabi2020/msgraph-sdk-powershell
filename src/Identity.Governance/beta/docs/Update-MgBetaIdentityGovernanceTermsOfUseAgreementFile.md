...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancetermsofuseagreementfile
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernanceTermsOfUseAgreementFile -AgreementId <String>
...
```
Update-MgBetaIdentityGovernanceTermsOfUseAgreementFile -AgreementId <String>
 -BodyParameter <IMicrosoftGraphAgreementFile> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaIdentityGovernanceTermsOfUseAgreementFile -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAgreementFile> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

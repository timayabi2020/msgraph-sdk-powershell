...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaprivilegedaccessresourcerolesettingroledefinition
schema: 2.0.0
---
...
```
Update-MgBetaPrivilegedAccessResourceRoleSettingRoleDefinition -GovernanceResourceId <String>
...
### UpdateViaIdentity
```
Update-MgBetaPrivilegedAccessResourceRoleSettingRoleDefinition -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphGovernanceRoleDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

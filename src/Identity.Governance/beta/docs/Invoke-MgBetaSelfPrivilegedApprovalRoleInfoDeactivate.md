...
### Self (Default)
```
Invoke-MgBetaSelfPrivilegedApprovalRoleInfoDeactivate -PrivilegedApprovalId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SelfViaIdentity
```
Invoke-MgBetaSelfPrivilegedApprovalRoleInfoDeactivate -InputObject <IIdentityGovernanceIdentity>

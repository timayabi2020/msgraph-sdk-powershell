...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaprivilegedaccessresourceroleassignmentroledefinition
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentRoleDefinition -GovernanceResourceId <String>
 -GovernanceRoleAssignmentId <String> -PrivilegedAccessId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPrivilegedAccessResourceRoleAssignmentRoleDefinition -InputObject <IIdentityGovernanceIdentity>

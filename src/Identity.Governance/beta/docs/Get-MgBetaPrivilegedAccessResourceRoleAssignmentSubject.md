...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaprivilegedaccessresourceroleassignmentsubject
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaPrivilegedAccessResourceRoleAssignmentSubject -GovernanceResourceId <String>
...
### GetViaIdentity
```
Get-MgBetaPrivilegedAccessResourceRoleAssignmentSubject -InputObject <IIdentityGovernanceIdentity>

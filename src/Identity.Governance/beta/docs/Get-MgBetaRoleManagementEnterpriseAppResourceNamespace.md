...
### List (Default)
```
Get-MgBetaRoleManagementEnterpriseAppResourceNamespace -RbacApplicationId <String>
...
### GetViaIdentity
```
Get-MgBetaRoleManagementEnterpriseAppResourceNamespace -InputObject <IIdentityGovernanceIdentity>

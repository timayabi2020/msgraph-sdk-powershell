...
### Apply (Default)
```
Add-MgBetaAccessReviewDecision -AccessReviewId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApplyViaIdentity
```
Add-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity> [-CustomHeader <String>] [-PassThru]

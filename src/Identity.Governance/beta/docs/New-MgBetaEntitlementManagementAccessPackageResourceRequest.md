...
New-MgBetaEntitlementManagementAccessPackageResourceRequest
 ...
 [-RequestState <String>] [-RequestStatus <String>] [-RequestType <String>] [-CustomHeader <String>]
...
```
New-MgBetaEntitlementManagementAccessPackageResourceRequest
 -BodyParameter <IMicrosoftGraphAccessPackageResourceRequest> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### List (Default)
```
Get-MgBetaRoleManagementDirectoryRoleAssignment [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaRoleManagementDirectoryRoleAssignment -UnifiedRoleAssignmentId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaRoleManagementDirectoryRoleAssignment -InputObject <IIdentityGovernanceIdentity>

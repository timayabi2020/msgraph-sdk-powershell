...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/invoke-mgbetaassignedrolemanagementdevicemanagementroledefinitionprincipal
schema: 2.0.0
---
...
### Assigned (Default)
```
Invoke-MgBetaAssignedRoleManagementDeviceManagementRoleDefinitionPrincipal -UnifiedRoleDefinitionId <String>

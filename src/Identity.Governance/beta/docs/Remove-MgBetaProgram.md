...
### Delete (Default)
```
Remove-MgBetaProgram -ProgramId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaProgram -InputObject <IIdentityGovernanceIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/invoke-mgbetaassignedrolemanagemententerpriseapproledefinitioninheritpermissionfromprincipal
schema: 2.0.0
---
...
```
Invoke-MgBetaAssignedRoleManagementEnterpriseAppRoleDefinitionInheritPermissionFromPrincipal
 -RbacApplicationId <String> -UnifiedRoleDefinitionId <String> -UnifiedRoleDefinitionId1 <String> [-Count]
 [-DirectoryScopeId <String>] [-DirectoryScopeType <String>] [-Filter <String>] [-Property <String[]>]
 [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>] [-Transitive] [-CustomHeader <String>]
 [<CommonParameters>]
```
...
Invoke-MgBetaAssignedRoleManagementEnterpriseAppRoleDefinitionInheritPermissionFromPrincipal
 ...
 [-Sort <String[]>] [-Top <Int32>] [-Transitive] [-CustomHeader <String>] [<CommonParameters>]
```

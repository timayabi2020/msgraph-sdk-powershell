...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagementdirectoryroleassignmentschedulerequest
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaRoleManagementDirectoryRoleAssignmentScheduleRequest [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaRoleManagementDirectoryRoleAssignmentScheduleRequest -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaagreementfilelocalizationversion
schema: 2.0.0
---
...
```
New-MgBetaAgreementFileLocalizationVersion -AgreementFileLocalizationId <String> -AgreementId <String>
...
### CreateViaIdentity
```
New-MgBetaAgreementFileLocalizationVersion -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <Hashtable> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

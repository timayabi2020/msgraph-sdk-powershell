...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaagreementfileversion
schema: 2.0.0
---
...
```
Update-MgBetaAgreementFileVersion -AgreementFileLocalizationId <String> -AgreementFileVersionId <String>
...
### UpdateViaIdentity
```
Update-MgBetaAgreementFileVersion -InputObject <IIdentityGovernanceIdentity> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaAgreementFileVersion -InputObject <IIdentityGovernanceIdentity>

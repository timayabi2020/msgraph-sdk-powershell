...
### List (Default)
```
Get-MgIdentityGovernanceLifecycleWorkflowTemplateTask -WorkflowTemplateId <String>
...
### Get
```
Get-MgIdentityGovernanceLifecycleWorkflowTemplateTask -TaskId <String> -WorkflowTemplateId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgIdentityGovernanceLifecycleWorkflowTemplateTask -InputObject <IIdentityGovernanceIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

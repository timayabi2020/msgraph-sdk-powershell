...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourceenvironmentresourcerole
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceEnvironmentResourceRole -AccessPackageResourceEnvironmentId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceEnvironmentResourceRole -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceRole> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/remove-mgentitlementmanagementresourceroleresourcescope
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEntitlementManagementResourceRoleResourceScope -AccessPackageResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgEntitlementManagementResourceRoleResourceScope -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcerequestresourcescoperesourcerole
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementResourceRequestResourceScopeResourceRole -AccessPackageResourceRequestId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceRequestResourceScopeResourceRole -InputObject <IIdentityGovernanceIdentity>

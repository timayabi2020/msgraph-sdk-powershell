...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerequestresourcescope
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRequestResourceScope -AccessPackageResourceRequestId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRequestResourceScope -InputObject <IIdentityGovernanceIdentity>

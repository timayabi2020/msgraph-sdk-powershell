...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerolescoperoleresource
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRoleScopeRoleResource -AccessPackageResourceRoleScopeId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRoleScopeRoleResource -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

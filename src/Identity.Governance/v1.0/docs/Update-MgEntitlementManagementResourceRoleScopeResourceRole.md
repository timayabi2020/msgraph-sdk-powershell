...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerolescoperesourcerole
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRoleScopeResourceRole -AccessPackageResourceRoleId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRoleScopeResourceRole -InputObject <IIdentityGovernanceIdentity>

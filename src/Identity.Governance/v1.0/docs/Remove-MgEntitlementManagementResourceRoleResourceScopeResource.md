...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/remove-mgentitlementmanagementresourceroleresourcescoperesource
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEntitlementManagementResourceRoleResourceScopeResource -AccessPackageResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgEntitlementManagementResourceRoleResourceScopeResource -InputObject <IIdentityGovernanceIdentity>

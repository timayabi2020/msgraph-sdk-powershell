...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcescoperesourceroleresource
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceScopeResourceRoleResource -AccessPackageResourceId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceScopeResourceRoleResource -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

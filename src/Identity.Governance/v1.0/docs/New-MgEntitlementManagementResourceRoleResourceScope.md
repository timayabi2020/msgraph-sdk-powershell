...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourceroleresourcescope
schema: 2.0.0
---
...
```
New-MgEntitlementManagementResourceRoleResourceScope -AccessPackageResourceId <String>
...
### CreateViaIdentity
```
New-MgEntitlementManagementResourceRoleResourceScope -InputObject <IIdentityGovernanceIdentity>

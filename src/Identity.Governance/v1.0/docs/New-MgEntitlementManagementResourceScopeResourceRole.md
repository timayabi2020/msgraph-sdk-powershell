...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourcescoperesourcerole
schema: 2.0.0
---
...
```
New-MgEntitlementManagementResourceScopeResourceRole -AccessPackageResourceId <String>
...
### CreateViaIdentity
```
New-MgEntitlementManagementResourceScopeResourceRole -InputObject <IIdentityGovernanceIdentity>

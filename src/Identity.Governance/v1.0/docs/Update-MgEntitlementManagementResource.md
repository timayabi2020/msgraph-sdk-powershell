...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresource
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResource -AccessPackageResourceId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgEntitlementManagementResource -AccessPackageResourceId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResource -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

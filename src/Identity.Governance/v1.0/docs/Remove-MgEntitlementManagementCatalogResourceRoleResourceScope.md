...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/remove-mgentitlementmanagementcatalogresourceroleresourcescope
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEntitlementManagementCatalogResourceRoleResourceScope -AccessPackageCatalogId <String>
...
### DeleteViaIdentity
```
Remove-MgEntitlementManagementCatalogResourceRoleResourceScope -InputObject <IIdentityGovernanceIdentity>

...
```
New-MgIdentityGovernanceTermsOfUseAgreement [-Acceptances <IMicrosoftGraphAgreementAcceptance[]>]
...
### Create
```
New-MgIdentityGovernanceTermsOfUseAgreement -BodyParameter <IMicrosoftGraphAgreement> [-CustomHeader <String>]

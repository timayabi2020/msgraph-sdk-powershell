...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcescoperesourcerole
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementResourceScopeResourceRole -AccessPackageResourceId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceScopeResourceRole -InputObject <IIdentityGovernanceIdentity>

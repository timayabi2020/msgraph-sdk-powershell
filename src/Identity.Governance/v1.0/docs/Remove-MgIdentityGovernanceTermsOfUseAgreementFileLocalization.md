...
### Delete (Default)
```
Remove-MgIdentityGovernanceTermsOfUseAgreementFileLocalization -AgreementFileLocalizationId <String>
...
### DeleteViaIdentity
```
Remove-MgIdentityGovernanceTermsOfUseAgreementFileLocalization -InputObject <IIdentityGovernanceIdentity>

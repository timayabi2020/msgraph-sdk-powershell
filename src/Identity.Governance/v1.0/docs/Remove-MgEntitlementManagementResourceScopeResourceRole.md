...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/remove-mgentitlementmanagementresourcescoperesourcerole
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEntitlementManagementResourceScopeResourceRole -AccessPackageResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgEntitlementManagementResourceScopeResourceRole -InputObject <IIdentityGovernanceIdentity>

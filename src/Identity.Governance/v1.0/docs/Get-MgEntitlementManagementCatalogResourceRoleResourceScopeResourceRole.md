...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementcatalogresourceroleresourcescoperesourcerole
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementCatalogResourceRoleResourceScopeResourceRole -AccessPackageCatalogId <String>

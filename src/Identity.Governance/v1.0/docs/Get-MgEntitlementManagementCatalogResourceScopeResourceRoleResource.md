...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementcatalogresourcescoperesourceroleresource
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResource -AccessPackageCatalogId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResource -InputObject <IIdentityGovernanceIdentity>

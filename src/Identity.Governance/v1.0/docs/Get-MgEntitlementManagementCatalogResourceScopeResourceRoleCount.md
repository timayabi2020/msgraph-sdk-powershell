...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementcatalogresourcescoperesourcerolecount
schema: 2.0.0
---
...
```
Get-MgEntitlementManagementCatalogResourceScopeResourceRoleCount -AccessPackageCatalogId <String>
 -AccessPackageResourceId <String> -AccessPackageResourceScopeId <String> [-Filter <String>]

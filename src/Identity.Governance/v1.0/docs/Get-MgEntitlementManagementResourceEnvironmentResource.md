...
### List (Default)
```
Get-MgEntitlementManagementResourceEnvironmentResource -AccessPackageResourceEnvironmentId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceEnvironmentResource -InputObject <IIdentityGovernanceIdentity>

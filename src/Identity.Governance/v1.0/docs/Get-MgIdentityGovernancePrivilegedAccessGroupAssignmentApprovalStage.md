...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernanceprivilegedaccessgroupassignmentapprovalstage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStage -ApprovalId <String>
...
```
Get-MgIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStage -ApprovalId <String>
 -ApprovalStageId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

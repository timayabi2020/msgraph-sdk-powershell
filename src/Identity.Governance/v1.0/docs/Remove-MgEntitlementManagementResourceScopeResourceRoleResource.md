...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/remove-mgentitlementmanagementresourcescoperesourceroleresource
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEntitlementManagementResourceScopeResourceRoleResource -AccessPackageResourceId <String>
...
### DeleteViaIdentity
```
Remove-MgEntitlementManagementResourceScopeResourceRoleResource -InputObject <IIdentityGovernanceIdentity>

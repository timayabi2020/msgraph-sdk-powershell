...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcerequestcatalogresourceroleresource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementResourceRequestCatalogResourceRoleResource -AccessPackageResourceRequestId <String>
...
### Get1
```
Get-MgEntitlementManagementResourceRequestCatalogResourceRoleResource -AccessPackageResourceId <String>

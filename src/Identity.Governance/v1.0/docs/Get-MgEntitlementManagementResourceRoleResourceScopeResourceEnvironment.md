...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourceroleresourcescoperesourceenvironment
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementResourceRoleResourceScopeResourceEnvironment -AccessPackageResourceId <String>

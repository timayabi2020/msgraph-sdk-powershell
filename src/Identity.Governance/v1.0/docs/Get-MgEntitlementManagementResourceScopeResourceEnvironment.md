...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcescoperesourceenvironment
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementResourceScopeResourceEnvironment -AccessPackageResourceId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceScopeResourceEnvironment -InputObject <IIdentityGovernanceIdentity>

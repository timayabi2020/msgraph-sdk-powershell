...
Update-MgIdentityGovernanceLifecycleWorkflowVersionTask -TaskId <String> -WorkflowId <String>
 ...
 [-DisplayName <String>] [-ExecutionSequence <Int32>] [-Id <String>] [-IsEnabled]
 [-ResponseHeadersVariable <String>] [-TaskDefinitionId <String>]
...
Update-MgIdentityGovernanceLifecycleWorkflowVersionTask -InputObject <IIdentityGovernanceIdentity>
 ...
 [-Id <String>] [-IsEnabled] [-ResponseHeadersVariable <String>] [-TaskDefinitionId <String>]
 [-TaskProcessingResults <IMicrosoftGraphIdentityGovernanceTaskProcessingResult[]>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

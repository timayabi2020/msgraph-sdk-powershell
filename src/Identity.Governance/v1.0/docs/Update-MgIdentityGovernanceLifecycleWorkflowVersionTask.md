...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancelifecycleworkflowversiontask
schema: 2.0.0
---
...
```
Update-MgIdentityGovernanceLifecycleWorkflowVersionTask -TaskId <String> -WorkflowId <String>
 -WorkflowVersionNumber <Int32> [-AdditionalProperties <Hashtable>]
 ...
 [-TaskProcessingResults <IMicrosoftGraphIdentityGovernanceTaskProcessingResult[]>] [-CustomHeader <String>]
...
```
Update-MgIdentityGovernanceLifecycleWorkflowVersionTask -TaskId <String> -WorkflowId <String>
 -WorkflowVersionNumber <Int32> -BodyParameter <IMicrosoftGraphIdentityGovernanceTask>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgIdentityGovernanceLifecycleWorkflowVersionTask -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphIdentityGovernanceTask> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityGovernanceLifecycleWorkflowVersionTask -InputObject <IIdentityGovernanceIdentity>
 ...
 [-ContinueOnError] [-Description <String>] [-DisplayName <String>] [-ExecutionSequence <Int32>]
 [-Id <String>] [-IsEnabled] [-TaskDefinitionId <String>]
 [-TaskProcessingResults <IMicrosoftGraphIdentityGovernanceTaskProcessingResult[]>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

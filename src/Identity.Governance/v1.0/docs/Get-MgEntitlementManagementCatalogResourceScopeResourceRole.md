...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementcatalogresourcescoperesourcerole
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgEntitlementManagementCatalogResourceScopeResourceRole -AccessPackageCatalogId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementCatalogResourceScopeResourceRole -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancelifecycleworkflowtask
schema: 2.0.0
---
...
```
Update-MgIdentityGovernanceLifecycleWorkflowTask -TaskId <String> -WorkflowId <String>
...
### UpdateViaIdentity
```
Update-MgIdentityGovernanceLifecycleWorkflowTask -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphIdentityGovernanceTask> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

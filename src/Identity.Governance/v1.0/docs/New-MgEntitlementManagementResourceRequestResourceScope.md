...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourcerequestresourcescope
schema: 2.0.0
---
...
```
New-MgEntitlementManagementResourceRequestResourceScope -AccessPackageResourceRequestId <String>
...
### CreateViaIdentity
```
New-MgEntitlementManagementResourceRequestResourceScope -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceScope> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

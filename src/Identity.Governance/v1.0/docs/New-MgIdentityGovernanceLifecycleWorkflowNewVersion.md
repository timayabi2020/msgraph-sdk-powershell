...
```
New-MgIdentityGovernanceLifecycleWorkflowNewVersion -WorkflowId <String> [-AdditionalProperties <Hashtable>]
 [-ResponseHeadersVariable <String>] [-Workflow <IMicrosoftGraphIdentityGovernanceWorkflow>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgIdentityGovernanceLifecycleWorkflowNewVersion -WorkflowId <String>
...
### CreateViaIdentity
```
New-MgIdentityGovernanceLifecycleWorkflowNewVersion -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IPaths1Fqilt9IdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceCreatenewversionPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-MgIdentityGovernanceLifecycleWorkflowNewVersion -InputObject <IIdentityGovernanceIdentity>
 ...
 [-Workflow <IMicrosoftGraphIdentityGovernanceWorkflow>] [-Headers <IDictionary>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Fqilt9IdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceCreatenewversionPostRequestbodyContentApplicationJsonSchema
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphIdentityGovernanceWorkflow
Parameter Sets: CreateExpanded, CreateViaIdentityExpanded
Aliases:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Fqilt9IdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceCreatenewversionPostRequestbodyContentApplicationJsonSchema
...
`BODYPARAMETER <IPaths1Fqilt9IdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceCreatenewversionPostRequestbodyContentApplicationJsonSchema>`: .
  ...
  - `[Workflow <IMicrosoftGraphIdentityGovernanceWorkflow>]`: workflow
    ...
    - `[CreatedDateTime <DateTime?>]`: When a workflow was created.
    ...
    - `[ExecutionConditions <IMicrosoftGraphIdentityGovernanceWorkflowExecutionConditions>]`: workflowExecutionConditions
      - `[(Any) <Object>]`: This indicates any property can be added to this object.

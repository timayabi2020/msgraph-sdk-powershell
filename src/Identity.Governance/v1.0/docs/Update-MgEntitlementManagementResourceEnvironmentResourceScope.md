...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourceenvironmentresourcescope
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceEnvironmentResourceScope -AccessPackageResourceEnvironmentId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceEnvironmentResourceScope -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceScope> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourcescope
schema: 2.0.0
---
...
```
New-MgEntitlementManagementResourceScope -AccessPackageResourceId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgEntitlementManagementResourceScope -AccessPackageResourceId <String>
...
### CreateViaIdentity
```
New-MgEntitlementManagementResourceScope -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceScope> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

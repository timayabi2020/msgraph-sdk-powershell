...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancelifecycleworkflowdeleteditemworkflowtask
schema: 2.0.0
---
...
```
Update-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowTask -TaskId <String> -WorkflowId <String>
...
### UpdateViaIdentity
```
Update-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowTask -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphIdentityGovernanceTask> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

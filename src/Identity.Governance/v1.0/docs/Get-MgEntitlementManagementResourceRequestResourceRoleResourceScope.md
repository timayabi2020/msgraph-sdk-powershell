...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcerequestresourceroleresourcescope
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementResourceRequestResourceRoleResourceScope -AccessPackageResourceRequestId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceRequestResourceRoleResourceScope -InputObject <IIdentityGovernanceIdentity>

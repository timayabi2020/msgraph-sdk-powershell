...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancetermsofuseagreementfileversion
schema: 2.0.0
---
...
```
Update-MgIdentityGovernanceTermsOfUseAgreementFileVersion -AgreementFileLocalizationId <String>
...
### UpdateViaIdentity
```
Update-MgIdentityGovernanceTermsOfUseAgreementFileVersion -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancelifecycleworkflowtaskprocessingresultsubjectmailboxsetting
schema: 2.0.0
---
...
```
Update-MgIdentityGovernanceLifecycleWorkflowTaskProcessingResultSubjectMailboxSetting -TaskId <String>

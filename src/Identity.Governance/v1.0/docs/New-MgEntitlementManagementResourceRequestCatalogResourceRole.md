...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourcerequestcatalogresourcerole
schema: 2.0.0
---
...
```
New-MgEntitlementManagementResourceRequestCatalogResourceRole -AccessPackageResourceRequestId <String>
...
### Create2
```
New-MgEntitlementManagementResourceRequestCatalogResourceRole -AccessPackageResourceId <String>
 -AccessPackageResourceRequestId <String> -BodyParameter <IMicrosoftGraphAccessPackageResourceRole>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgEntitlementManagementResourceRequestCatalogResourceRole -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceRole> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

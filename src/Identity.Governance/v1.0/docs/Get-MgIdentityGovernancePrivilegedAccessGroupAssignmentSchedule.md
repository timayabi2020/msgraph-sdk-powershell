...
### List (Default)
```
Get-MgIdentityGovernancePrivilegedAccessGroupAssignmentSchedule [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgIdentityGovernancePrivilegedAccessGroupAssignmentSchedule -InputObject <IIdentityGovernanceIdentity>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphPrivilegedAccessGroupAssignmentSchedule

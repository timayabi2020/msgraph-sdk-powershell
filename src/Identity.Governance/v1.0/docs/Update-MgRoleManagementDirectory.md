...
Update-MgRoleManagementDirectory [-AdditionalProperties <Hashtable>] [-Id <String>]
 ...
 [-RoleEligibilitySchedules <IMicrosoftGraphUnifiedRoleEligibilitySchedule[]>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgRoleManagementDirectory -BodyParameter <IMicrosoftGraphRbacApplication> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

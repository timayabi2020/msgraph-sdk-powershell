...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/remove-mgentitlementmanagementresourceenvironmentresourcescope
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEntitlementManagementResourceEnvironmentResourceScope -AccessPackageResourceEnvironmentId <String>
...
### DeleteViaIdentity
```
Remove-MgEntitlementManagementResourceEnvironmentResourceScope -InputObject <IIdentityGovernanceIdentity>

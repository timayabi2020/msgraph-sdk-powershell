...
Update-MgEntitlementManagementCatalog -AccessPackageCatalogId <String>
 ...
 [-CatalogType <String>] [-CreatedDateTime <DateTime>]
 ...
 [-ResourceScopes <IMicrosoftGraphAccessPackageResourceScope[]>] [-State <String>] [-CustomHeader <String>]
...
```
Update-MgEntitlementManagementCatalog -AccessPackageCatalogId <String>
 -BodyParameter <IMicrosoftGraphAccessPackageCatalog> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

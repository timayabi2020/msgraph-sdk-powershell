...
Update-MgIdentityGovernanceAppConsentRequest -AppConsentRequestId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UserConsentRequests <IMicrosoftGraphUserConsentRequest[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgIdentityGovernanceAppConsentRequest -AppConsentRequestId <String>
 -BodyParameter <IMicrosoftGraphAppConsentRequest> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgidentitygovernancetermsofuseagreementfileversion
schema: 2.0.0
---
...
```
New-MgIdentityGovernanceTermsOfUseAgreementFileVersion -AgreementFileLocalizationId <String>
...
### CreateViaIdentity
```
New-MgIdentityGovernanceTermsOfUseAgreementFileVersion -InputObject <IIdentityGovernanceIdentity>

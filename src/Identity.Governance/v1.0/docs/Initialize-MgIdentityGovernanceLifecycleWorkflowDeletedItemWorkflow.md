...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/initialize-mgidentitygovernancelifecycleworkflowdeleteditemworkflow
schema: 2.0.0
---
...
```
Initialize-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflow -WorkflowId <String>
 [-AdditionalProperties <Hashtable>] [-ResponseHeadersVariable <String>] [-Subjects <IMicrosoftGraphUser[]>]
...
### ActivateViaIdentity
```
Initialize-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflow -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IPaths129Ny71IdentitygovernanceLifecycleworkflowsDeleteditemsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivatePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths129Ny71IdentitygovernanceLifecycleworkflowsDeleteditemsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivatePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths129Ny71IdentitygovernanceLifecycleworkflowsDeleteditemsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivatePostRequestbodyContentApplicationJsonSchema

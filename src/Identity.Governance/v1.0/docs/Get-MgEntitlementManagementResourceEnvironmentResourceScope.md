...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourceenvironmentresourcescope
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementResourceEnvironmentResourceScope -AccessPackageResourceEnvironmentId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceEnvironmentResourceScope -InputObject <IIdentityGovernanceIdentity>

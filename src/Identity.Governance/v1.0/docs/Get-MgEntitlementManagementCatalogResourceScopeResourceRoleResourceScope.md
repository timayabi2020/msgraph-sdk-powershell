...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementcatalogresourcescoperesourceroleresourcescope
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResourceScope -AccessPackageCatalogId <String>
...
Get-MgEntitlementManagementCatalogResourceScopeResourceRoleResourceScope -AccessPackageCatalogId <String>
 ...
 -AccessPackageResourceScopeId1 <String> [-ExpandProperty <String[]>] [-Property <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/remove-mgentitlementmanagementcatalogresourcerole
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEntitlementManagementCatalogResourceRole -AccessPackageCatalogId <String>
...
### DeleteViaIdentity
```
Remove-MgEntitlementManagementCatalogResourceRole -InputObject <IIdentityGovernanceIdentity>

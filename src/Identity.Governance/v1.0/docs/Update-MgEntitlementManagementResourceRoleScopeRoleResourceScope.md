...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerolescoperoleresourcescope
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRoleScopeRoleResourceScope -AccessPackageResourceRoleScopeId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRoleScopeRoleResourceScope -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerolescoperole
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRoleScopeRole -AccessPackageResourceRoleScopeId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRoleScopeRole -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceRole> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourceroleresourcescope
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementResourceRoleResourceScope -AccessPackageResourceId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceRoleResourceScope -InputObject <IIdentityGovernanceIdentity>

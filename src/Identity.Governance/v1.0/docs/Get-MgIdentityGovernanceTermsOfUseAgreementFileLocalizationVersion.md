...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancetermsofuseagreementfilelocalizationversion
schema: 2.0.0
---
...
### List (Default)
```
Get-MgIdentityGovernanceTermsOfUseAgreementFileLocalizationVersion -AgreementFileLocalizationId <String>
...
### GetViaIdentity
```
Get-MgIdentityGovernanceTermsOfUseAgreementFileLocalizationVersion -InputObject <IIdentityGovernanceIdentity>

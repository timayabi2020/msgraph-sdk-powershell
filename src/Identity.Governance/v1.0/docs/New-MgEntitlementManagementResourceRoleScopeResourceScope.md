...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourcerolescoperesourcescope
schema: 2.0.0
---
...
```
New-MgEntitlementManagementResourceRoleScopeResourceScope -AccessPackageResourceRoleScopeId <String>
...
### CreateViaIdentity
```
New-MgEntitlementManagementResourceRoleScopeResourceScope -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceScope> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

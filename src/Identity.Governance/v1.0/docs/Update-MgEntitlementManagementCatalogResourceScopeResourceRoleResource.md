...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementcatalogresourcescoperesourceroleresource
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementCatalogResourceScopeResourceRoleResource -AccessPackageCatalogId <String>

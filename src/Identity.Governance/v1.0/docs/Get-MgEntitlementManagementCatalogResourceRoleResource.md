...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementcatalogresourceroleresource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementCatalogResourceRoleResource -AccessPackageCatalogId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementCatalogResourceRoleResource -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerolescoperesourceroleresourcescope
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRoleScopeResourceRoleResourceScope -AccessPackageResourceRoleId <String>

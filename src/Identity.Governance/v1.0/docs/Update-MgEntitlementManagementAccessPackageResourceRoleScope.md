...
Update-MgEntitlementManagementAccessPackageResourceRoleScope -AccessPackageId <String>
 ...
 [-Scope <IMicrosoftGraphAccessPackageResourceScope>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgEntitlementManagementAccessPackageResourceRoleScope -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceRoleScope> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

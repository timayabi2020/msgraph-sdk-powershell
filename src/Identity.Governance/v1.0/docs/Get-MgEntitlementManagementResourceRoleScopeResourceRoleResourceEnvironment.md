...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcerolescoperesourceroleresourceenvironment
schema: 2.0.0
---
...
```
Get-MgEntitlementManagementResourceRoleScopeResourceRoleResourceEnvironment
 -AccessPackageResourceRoleId <String> -AccessPackageResourceRoleScopeId <String> [-ExpandProperty <String[]>]

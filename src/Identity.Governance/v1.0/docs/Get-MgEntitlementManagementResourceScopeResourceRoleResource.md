...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcescoperesourceroleresource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementResourceScopeResourceRoleResource -AccessPackageResourceId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceScopeResourceRoleResource -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcerequestresourceroleresource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementResourceRequestResourceRoleResource -AccessPackageResourceRequestId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceRequestResourceRoleResource -InputObject <IIdentityGovernanceIdentity>

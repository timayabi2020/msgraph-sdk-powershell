...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourceenvironmentresourcerole
schema: 2.0.0
---
...
```
New-MgEntitlementManagementResourceEnvironmentResourceRole -AccessPackageResourceEnvironmentId <String>
...
### CreateViaIdentity
```
New-MgEntitlementManagementResourceEnvironmentResourceRole -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcescoperesource
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceScopeResource -AccessPackageResourceId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceScopeResource -InputObject <IIdentityGovernanceIdentity>

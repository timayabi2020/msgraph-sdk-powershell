...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementcatalogresourcescoperesource
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgEntitlementManagementCatalogResourceScopeResource -AccessPackageCatalogId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementCatalogResourceScopeResource -InputObject <IIdentityGovernanceIdentity>

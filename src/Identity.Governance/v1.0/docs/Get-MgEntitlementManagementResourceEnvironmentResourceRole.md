...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourceenvironmentresourcerole
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEntitlementManagementResourceEnvironmentResourceRole -AccessPackageResourceEnvironmentId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceEnvironmentResourceRole -InputObject <IIdentityGovernanceIdentity>

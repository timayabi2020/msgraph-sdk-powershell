...
Update-MgEntitlementManagementAssignmentPolicyCustomExtensionStageSetting
 ...
 [-Stage <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgEntitlementManagementAssignmentPolicyCustomExtensionStageSetting
 -AccessPackageAssignmentPolicyId <String> -CustomExtensionStageSettingId <String>
 -BodyParameter <IMicrosoftGraphCustomExtensionStageSetting> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

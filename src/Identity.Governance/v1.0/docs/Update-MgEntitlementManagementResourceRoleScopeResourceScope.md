...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerolescoperesourcescope
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRoleScopeResourceScope -AccessPackageResourceRoleScopeId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRoleScopeResourceScope -InputObject <IIdentityGovernanceIdentity>

...
### Get (Default)
```
Get-MgIdentityGovernanceTermsOfUseAgreementFile -AgreementId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgIdentityGovernanceTermsOfUseAgreementFile -InputObject <IIdentityGovernanceIdentity>

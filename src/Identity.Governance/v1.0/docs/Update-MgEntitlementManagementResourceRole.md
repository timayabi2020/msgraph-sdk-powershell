...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerole
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRole -AccessPackageResourceId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRole -InputObject <IIdentityGovernanceIdentity>

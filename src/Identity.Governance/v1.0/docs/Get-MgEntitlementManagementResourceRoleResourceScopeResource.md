...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourceroleresourcescoperesource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementResourceRoleResourceScopeResource -AccessPackageResourceId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceRoleResourceScopeResource -InputObject <IIdentityGovernanceIdentity>

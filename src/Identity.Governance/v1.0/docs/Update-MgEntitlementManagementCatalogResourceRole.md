...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementcatalogresourcerole
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementCatalogResourceRole -AccessPackageCatalogId <String>
...
### UpdateViaIdentity
```
Update-MgEntitlementManagementCatalogResourceRole -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResourceRole> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

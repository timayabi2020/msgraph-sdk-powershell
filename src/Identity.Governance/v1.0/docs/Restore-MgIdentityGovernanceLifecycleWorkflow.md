...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/restore-mgidentitygovernancelifecycleworkflow
schema: 2.0.0
---
...
### Restore (Default)
```
Restore-MgIdentityGovernanceLifecycleWorkflow -WorkflowId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgIdentityGovernanceLifecycleWorkflow -InputObject <IIdentityGovernanceIdentity>

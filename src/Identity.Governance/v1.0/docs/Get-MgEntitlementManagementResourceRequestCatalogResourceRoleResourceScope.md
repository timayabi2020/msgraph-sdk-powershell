...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcerequestcatalogresourceroleresourcescope
schema: 2.0.0
---
...
### Get1
```
Get-MgEntitlementManagementResourceRequestCatalogResourceRoleResourceScope -AccessPackageResourceId <String>
 -AccessPackageResourceRequestId <String> -AccessPackageResourceRoleId <String>
 -AccessPackageResourceScopeId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

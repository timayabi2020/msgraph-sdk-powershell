...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcescoperesource
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgEntitlementManagementResourceScopeResource -AccessPackageResourceId <String>
...
### GetViaIdentity
```
Get-MgEntitlementManagementResourceScopeResource -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerolescoperesourceroleresource
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRoleScopeResourceRoleResource -AccessPackageResourceRoleId <String>
 -AccessPackageResourceRoleScopeId <String> [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
...
```
Update-MgEntitlementManagementResourceRoleScopeResourceRoleResource -AccessPackageResourceRoleId <String>
 -AccessPackageResourceRoleScopeId <String> -BodyParameter <IMicrosoftGraphAccessPackageResource>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgEntitlementManagementResourceRoleScopeResourceRoleResource -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAccessPackageResource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

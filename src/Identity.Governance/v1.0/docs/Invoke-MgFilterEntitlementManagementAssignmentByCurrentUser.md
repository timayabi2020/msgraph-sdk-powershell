...
### Filter (Default)
```
Invoke-MgFilterEntitlementManagementAssignmentByCurrentUser -On <String> [-Count] [-Filter <String>]
...
### FilterViaIdentity
```
Invoke-MgFilterEntitlementManagementAssignmentByCurrentUser -InputObject <IIdentityGovernanceIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.functions/get-mgbetadevicemanagementdeponboardingsettingexpiringvpptokencount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementDepOnboardingSettingExpiringVppTokenCount -ExpiringBeforeDateTime <String>
...
```
Get-MgBetaDeviceManagementDepOnboardingSettingExpiringVppTokenCount
 -InputObject <IDeviceManagementFunctionsIdentity> [-CustomHeader <String>] [<CommonParameters>]
```

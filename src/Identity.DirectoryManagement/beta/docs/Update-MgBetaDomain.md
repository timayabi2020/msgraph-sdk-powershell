...
Update-MgBetaDomain -DomainId <String> [-AdditionalProperties <Hashtable>] [-AuthenticationType <String>]
 ...
 [-VerificationDnsRecords <IMicrosoftGraphDomainDnsRecord[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaDomain -DomainId <String> -BodyParameter <IMicrosoftGraphDomain> [-CustomHeader <String>]

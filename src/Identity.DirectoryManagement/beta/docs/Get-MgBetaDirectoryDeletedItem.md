...
### Get (Default)
```
Get-MgBetaDirectoryDeletedItem -DirectoryObjectId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDirectoryDeletedItem -InputObject <IIdentityDirectoryManagementIdentity>

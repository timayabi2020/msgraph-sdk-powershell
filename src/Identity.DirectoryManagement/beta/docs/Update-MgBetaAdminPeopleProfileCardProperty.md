...
Update-MgBetaAdminPeopleProfileCardProperty -ProfileCardPropertyId <String>
 ...
 [-DirectoryPropertyName <String>] [-Id <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaAdminPeopleProfileCardProperty -ProfileCardPropertyId <String>
 -BodyParameter <IMicrosoftGraphProfileCardProperty> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaOrganizationBrandingLocalization -OrganizationalBrandingLocalizationId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaOrganizationBrandingLocalization -InputObject <IIdentityDirectoryManagementIdentity>

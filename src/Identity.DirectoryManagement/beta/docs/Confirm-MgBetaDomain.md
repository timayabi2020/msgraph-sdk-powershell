...
### Verify (Default)
```
Confirm-MgBetaDomain -DomainId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### VerifyViaIdentity
```
Confirm-MgBetaDomain -InputObject <IIdentityDirectoryManagementIdentity> [-CustomHeader <String>] [-Confirm]

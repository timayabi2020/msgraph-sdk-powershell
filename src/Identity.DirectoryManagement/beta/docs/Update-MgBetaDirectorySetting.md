...
Update-MgBetaDirectorySetting -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphDirectorySetting> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDirectorySetting -InputObject <IIdentityDirectoryManagementIdentity>
 ...
 [-Values <IMicrosoftGraphSettingValue[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
```
New-MgBetaDeviceRegisteredUserByRef -DeviceId <String> -OdataId <String> [-AdditionalProperties <Hashtable>]
...
```
New-MgBetaDeviceRegisteredUserByRef -InputObject <IIdentityDirectoryManagementIdentity> -OdataId <String>

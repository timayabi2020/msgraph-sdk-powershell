...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetacontacttransitivememberofcountasadministrativeunit
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaContactTransitiveMemberOfCountAsAdministrativeUnit -OrgContactId <String> -ConsistencyLevel <String>

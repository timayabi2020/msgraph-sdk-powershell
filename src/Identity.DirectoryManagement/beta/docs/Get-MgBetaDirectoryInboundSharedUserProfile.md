...
### List (Default)
```
Get-MgBetaDirectoryInboundSharedUserProfile [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDirectoryInboundSharedUserProfile -InboundSharedUserProfileUserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDirectoryInboundSharedUserProfile -InputObject <IIdentityDirectoryManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

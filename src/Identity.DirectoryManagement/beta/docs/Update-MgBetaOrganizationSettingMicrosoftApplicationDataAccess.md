...
Update-MgBetaOrganizationSettingMicrosoftApplicationDataAccess -OrganizationId <String>
 ...
 [-IsEnabledForAllMicrosoftApplications] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaOrganizationSettingMicrosoftApplicationDataAccess -OrganizationId <String>
 -BodyParameter <IMicrosoftGraphMicrosoftApplicationDataAccessSettings> [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaOrganizationSettingMicrosoftApplicationDataAccess
 ...
 [-DisabledForGroup <String>] [-Id <String>] [-IsEnabledForAllMicrosoftApplications] [-CustomHeader <String>]

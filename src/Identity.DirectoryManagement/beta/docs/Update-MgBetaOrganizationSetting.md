...
Update-MgBetaOrganizationSetting -OrganizationId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-PeopleInsights <IMicrosoftGraphInsightsSettings>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaOrganizationSetting -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphOrganizationSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

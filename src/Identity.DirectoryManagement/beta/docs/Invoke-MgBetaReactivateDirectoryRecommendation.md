...
### Reactivate (Default)
```
Invoke-MgBetaReactivateDirectoryRecommendation -RecommendationId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ReactivateViaIdentity
```
Invoke-MgBetaReactivateDirectoryRecommendation -InputObject <IIdentityDirectoryManagementIdentity>

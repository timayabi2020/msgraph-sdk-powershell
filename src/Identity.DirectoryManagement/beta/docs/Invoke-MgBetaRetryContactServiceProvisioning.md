...
### Retry (Default)
```
Invoke-MgBetaRetryContactServiceProvisioning -OrgContactId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgBetaRetryContactServiceProvisioning -InputObject <IIdentityDirectoryManagementIdentity>

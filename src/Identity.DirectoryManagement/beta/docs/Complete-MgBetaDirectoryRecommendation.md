...
### Complete (Default)
```
Complete-MgBetaDirectoryRecommendation -RecommendationId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaDirectoryRecommendation -InputObject <IIdentityDirectoryManagementIdentity>

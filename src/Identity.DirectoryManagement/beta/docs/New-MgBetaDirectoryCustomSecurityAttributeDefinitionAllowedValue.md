...
```
New-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue -CustomSecurityAttributeDefinitionId <String>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-IsActive] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue -CustomSecurityAttributeDefinitionId <String>
 -BodyParameter <IMicrosoftGraphAllowedValue> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue
 ...
 [-IsActive] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

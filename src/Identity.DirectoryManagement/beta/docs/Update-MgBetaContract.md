...
### Update
```
Update-MgBetaContract -ContractId <String> -BodyParameter <IMicrosoftGraphContract> [-CustomHeader <String>]
...
Update-MgBetaContract -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphContract> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

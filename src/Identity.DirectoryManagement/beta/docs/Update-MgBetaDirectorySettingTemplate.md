...
Update-MgBetaDirectorySettingTemplate -DirectorySettingTemplateId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Values <IMicrosoftGraphSettingTemplateValue[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDirectorySettingTemplate -DirectorySettingTemplateId <String>
 -BodyParameter <IMicrosoftGraphDirectorySettingTemplate> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

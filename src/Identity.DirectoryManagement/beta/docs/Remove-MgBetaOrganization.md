...
### Delete (Default)
```
Remove-MgBetaOrganization -OrganizationId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaOrganization -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadirectoryroletemplate
schema: 2.0.0
---
...
Get-MgBetaDirectoryRoleTemplate [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
 [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-All] [-CountVariable <String>]
...
### GetViaIdentity
```
Get-MgBetaDirectoryRoleTemplate -InputObject <IIdentityDirectoryManagementIdentity>

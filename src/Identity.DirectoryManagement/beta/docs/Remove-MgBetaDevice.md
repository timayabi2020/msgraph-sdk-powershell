...
### Delete (Default)
```
Remove-MgBetaDevice -DeviceId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDevice -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>]

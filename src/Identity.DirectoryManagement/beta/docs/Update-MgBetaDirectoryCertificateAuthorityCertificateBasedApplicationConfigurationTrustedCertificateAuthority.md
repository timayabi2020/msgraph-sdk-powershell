...
Update-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfigurationTrustedCertificateAuthority
 ...
 [-Issuer <String>] [-IssuerSubjectKeyIdentifier <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfigurationTrustedCertificateAuthority
 -CertificateAuthorityAsEntityId <String> -CertificateBasedApplicationConfigurationId <String>
 -BodyParameter <IMicrosoftGraphCertificateAuthorityAsEntity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfigurationTrustedCertificateAuthority
 ...
 [-IssuerSubjectKeyIdentifier <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

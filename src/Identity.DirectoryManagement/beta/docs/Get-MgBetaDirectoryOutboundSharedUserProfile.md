...
### List (Default)
```
Get-MgBetaDirectoryOutboundSharedUserProfile [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDirectoryOutboundSharedUserProfile -OutboundSharedUserProfileUserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDirectoryOutboundSharedUserProfile -InputObject <IIdentityDirectoryManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

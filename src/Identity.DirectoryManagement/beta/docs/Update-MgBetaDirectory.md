...
Update-MgBetaDirectory [-AdditionalProperties <Hashtable>]
 ...
 [-Subscriptions <IMicrosoftGraphCompanySubscription[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaDirectory -BodyParameter <IMicrosoftGraphDirectory> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Promote (Default)
```
Invoke-MgBetaPromoteDomain -DomainId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### PromoteViaIdentity
```
Invoke-MgBetaPromoteDomain -InputObject <IIdentityDirectoryManagementIdentity> [-CustomHeader <String>]

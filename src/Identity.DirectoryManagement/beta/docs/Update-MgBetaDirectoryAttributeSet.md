...
Update-MgBetaDirectoryAttributeSet -AttributeSetId <String> [-AdditionalProperties <Hashtable>]
 [-Description <String>] [-Id <String>] [-MaxAttributesPerSet <Int32>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaDirectoryAttributeSet -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphAttributeSet> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

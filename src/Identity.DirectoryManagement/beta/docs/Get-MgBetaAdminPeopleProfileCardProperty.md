...
### List (Default)
```
Get-MgBetaAdminPeopleProfileCardProperty [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaAdminPeopleProfileCardProperty -ProfileCardPropertyId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaAdminPeopleProfileCardProperty -InputObject <IIdentityDirectoryManagementIdentity>

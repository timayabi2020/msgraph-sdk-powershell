...
### List (Default)
```
Get-MgBetaDirectoryDeletedItemAsGroup [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgBetaDirectoryDeletedItemAsGroup -DirectoryObjectId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDirectoryDeletedItemAsGroup -InputObject <IIdentityDirectoryManagementIdentity>

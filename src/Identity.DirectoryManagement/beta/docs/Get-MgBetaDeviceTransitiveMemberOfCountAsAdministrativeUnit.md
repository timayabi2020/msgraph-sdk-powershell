...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadevicetransitivememberofcountasadministrativeunit
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceTransitiveMemberOfCountAsAdministrativeUnit -DeviceId <String> -ConsistencyLevel <String>

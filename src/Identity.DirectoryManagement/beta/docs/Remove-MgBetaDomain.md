...
### Delete (Default)
```
Remove-MgBetaDomain -DomainId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDomain -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>]

...
```
New-MgBetaDirectoryAdministrativeUnitMemberByRef -AdministrativeUnitId <String> -OdataId <String>
...
### Create
```
New-MgBetaDirectoryAdministrativeUnitMemberByRef -AdministrativeUnitId <String>
...
### CreateViaIdentity
```
New-MgBetaDirectoryAdministrativeUnitMemberByRef -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IReferenceCreate> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

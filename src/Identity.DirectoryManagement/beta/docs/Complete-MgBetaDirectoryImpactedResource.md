...
### Complete (Default)
```
Complete-MgBetaDirectoryImpactedResource -ImpactedResourceId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaDirectoryImpactedResource -InputObject <IIdentityDirectoryManagementIdentity>

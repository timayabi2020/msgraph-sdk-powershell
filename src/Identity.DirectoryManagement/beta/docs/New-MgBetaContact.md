...
New-MgBetaContact [-AdditionalProperties <Hashtable>] [-Addresses <IMicrosoftGraphPhysicalOfficeAddress[]>]
 ...
 [-TransitiveReports <IMicrosoftGraphDirectoryObject[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgBetaContact -BodyParameter <IMicrosoftGraphOrgContact> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

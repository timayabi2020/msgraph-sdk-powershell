...
New-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfiguration
 ...
 [-TrustedCertificateAuthorities <IMicrosoftGraphCertificateAuthorityAsEntity[]>] [-CustomHeader <String>]
...
```
New-MgBetaDirectoryCertificateAuthorityCertificateBasedApplicationConfiguration
 -BodyParameter <IMicrosoftGraphCertificateBasedApplicationConfiguration> [-CustomHeader <String>] [-Confirm]

...
Update-MgDirectory [-AdditionalProperties <Hashtable>]
 ...
 [-OnPremisesSynchronization <IMicrosoftGraphOnPremisesDirectorySynchronization[]>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgDirectory -BodyParameter <IMicrosoftGraphDirectory> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

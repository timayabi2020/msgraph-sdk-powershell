...
### Delete (Default)
```
Remove-MgContact -OrgContactId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgContact -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>]

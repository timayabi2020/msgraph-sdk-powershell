...
### Promote (Default)
```
Invoke-MgPromoteDomain -DomainId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PromoteViaIdentity
```
Invoke-MgPromoteDomain -InputObject <IIdentityDirectoryManagementIdentity> [-CustomHeader <String>] [-Confirm]

...
### Restore (Default)
```
Restore-MgDirectoryDeletedItem -DirectoryObjectId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgDirectoryDeletedItem -InputObject <IIdentityDirectoryManagementIdentity> [-CustomHeader <String>]

...
### Delete (Default)
```
Remove-MgDeviceByDeviceId -DeviceId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDeviceByDeviceId -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>]

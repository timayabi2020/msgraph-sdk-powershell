...
New-MgOrganization [-AdditionalProperties <Hashtable>] [-AssignedPlans <IMicrosoftGraphAssignedPlan[]>]
 ...
 [-VerifiedDomains <IMicrosoftGraphVerifiedDomain[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgOrganization -BodyParameter <IMicrosoftGraphOrganization> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

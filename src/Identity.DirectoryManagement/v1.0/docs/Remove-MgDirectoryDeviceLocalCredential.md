...
### Delete (Default)
```
Remove-MgDirectoryDeviceLocalCredential -DeviceLocalCredentialInfoId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDirectoryDeviceLocalCredential -InputObject <IIdentityDirectoryManagementIdentity>

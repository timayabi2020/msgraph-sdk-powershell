...
### Get (Default)
```
Get-MgDeviceRegisteredOwnerCountAsAppRoleAssignment -DeviceId <String> -ConsistencyLevel <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceRegisteredOwnerCountAsAppRoleAssignment -InputObject <IIdentityDirectoryManagementIdentity>

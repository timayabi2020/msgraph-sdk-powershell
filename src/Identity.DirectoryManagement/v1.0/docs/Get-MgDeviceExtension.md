...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/get-mgdeviceextension
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceExtension -DeviceId <String> [-ExpandProperty <String[]>] [-Filter <String>]

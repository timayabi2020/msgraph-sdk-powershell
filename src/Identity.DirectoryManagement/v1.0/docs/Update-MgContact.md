...
Update-MgContact -OrgContactId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-TransitiveMemberOf <IMicrosoftGraphDirectoryObject[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgContact -OrgContactId <String> -BodyParameter <IMicrosoftGraphOrgContact> [-CustomHeader <String>]
...
Update-MgContact -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphOrgContact> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

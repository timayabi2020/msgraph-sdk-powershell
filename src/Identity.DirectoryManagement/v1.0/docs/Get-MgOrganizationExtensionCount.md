...
### Get (Default)
```
Get-MgOrganizationExtensionCount -OrganizationId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgOrganizationExtensionCount -InputObject <IIdentityDirectoryManagementIdentity> [-Filter <String>]

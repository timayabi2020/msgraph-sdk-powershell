...
### Verify (Default)
```
Confirm-MgDomain -DomainId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### VerifyViaIdentity
```
Confirm-MgDomain -InputObject <IIdentityDirectoryManagementIdentity> [-CustomHeader <String>] [-Confirm]

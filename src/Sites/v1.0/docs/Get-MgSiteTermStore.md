...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstore
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStore -SiteId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### List
```
Get-MgSiteTermStore -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]

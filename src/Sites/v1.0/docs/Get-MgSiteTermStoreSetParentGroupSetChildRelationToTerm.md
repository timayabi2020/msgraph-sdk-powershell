...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsetchildrelationtoterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteTermStoreSetParentGroupSetChildRelationToTerm -RelationId <String> -SetId <String> -SetId1 <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetChildRelationToTerm -InputObject <ISitesIdentity>

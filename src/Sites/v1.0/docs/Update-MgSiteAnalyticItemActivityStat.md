...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsiteanalyticitemactivitystat
schema: 2.0.0
---
...
```
Update-MgSiteAnalyticItemActivityStat -InputObject <ISitesIdentity> [-Access <IMicrosoftGraphItemActionStat>]

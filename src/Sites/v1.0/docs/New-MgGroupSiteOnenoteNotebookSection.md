...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsiteonenotenotebooksection
schema: 2.0.0
---
...
```
New-MgGroupSiteOnenoteNotebookSection -GroupId <String> -NotebookId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgGroupSiteOnenoteNotebookSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgGroupSiteOnenoteNotebookSection -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresetrelationtoterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetRelationToTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitecontenttypebase
schema: 2.0.0
---
...
### Get1
```
Get-MgSiteContentTypeBase -ContentTypeId <String> -ListId <String> [-SiteId <String>]

...
### Publish (Default)
```
Publish-MgSiteContentType -ContentTypeId <String> -SiteId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgSiteContentType -InputObject <ISitesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

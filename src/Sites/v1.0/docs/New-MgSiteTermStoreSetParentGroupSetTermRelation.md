...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoresetparentgroupsettermrelation
schema: 2.0.0
---
...
```
New-MgSiteTermStoreSetParentGroupSetTermRelation -SetId <String> -SetId1 <String> -SiteId <String>
...
```
New-MgSiteTermStoreSetParentGroupSetTermRelation -SetId <String> -SetId1 <String> -SiteId <String>
 -StoreId <String> -TermId <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>]
...
### CreateViaIdentity
```
New-MgSiteTermStoreSetParentGroupSetTermRelation -InputObject <ISitesIdentity>

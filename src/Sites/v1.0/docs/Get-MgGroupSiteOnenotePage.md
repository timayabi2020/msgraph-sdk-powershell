...
### List (Default)
```
Get-MgGroupSiteOnenotePage -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupSiteOnenotePage -GroupId <String> -OnenotePageId <String> -SiteId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupSiteOnenotePage -InputObject <ISitesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetchildrelationfromterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteTermStoreSetChildRelationFromTerm -RelationId <String> -SetId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetChildRelationFromTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

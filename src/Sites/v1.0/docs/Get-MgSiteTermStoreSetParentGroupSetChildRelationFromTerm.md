...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsetchildrelationfromterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteTermStoreSetParentGroupSetChildRelationFromTerm -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetChildRelationFromTerm -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitecontenttypecolumn
schema: 2.0.0
---
...
```
Update-MgGroupSiteContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteContentTypeColumn -InputObject <ISitesIdentity>
...
```
Update-MgGroupSiteContentTypeColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

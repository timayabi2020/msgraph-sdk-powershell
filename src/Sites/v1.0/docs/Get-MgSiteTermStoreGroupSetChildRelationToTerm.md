...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoregroupsetchildrelationtoterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteTermStoreGroupSetChildRelationToTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreGroupSetChildRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitecreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgGroupSiteCreatedByUserMailboxSetting -GroupId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteCreatedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresetparentgroupsettermchildrelationtoterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetParentGroupSetTermChildRelationToTerm -GroupId <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetParentGroupSetTermChildRelationToTerm -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

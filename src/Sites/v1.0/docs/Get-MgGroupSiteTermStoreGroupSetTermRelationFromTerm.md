...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoregroupsettermrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreGroupSetTermRelationFromTerm -GroupId <String> -GroupId1 <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreGroupSetTermRelationFromTerm -InputObject <ISitesIdentity>

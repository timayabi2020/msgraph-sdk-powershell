...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitetermstoresetparentgroupsetterm
schema: 2.0.0
---
...
```
New-MgGroupSiteTermStoreSetParentGroupSetTerm -GroupId <String> -SetId <String> -SetId1 <String>
...
```
New-MgGroupSiteTermStoreSetParentGroupSetTerm -GroupId <String> -SetId <String> -SetId1 <String>
 -SiteId <String> -StoreId <String> -BodyParameter <IMicrosoftGraphTermStoreTerm> [-CustomHeader <String>]
...
### CreateViaIdentity
```
New-MgGroupSiteTermStoreSetParentGroupSetTerm -InputObject <ISitesIdentity>

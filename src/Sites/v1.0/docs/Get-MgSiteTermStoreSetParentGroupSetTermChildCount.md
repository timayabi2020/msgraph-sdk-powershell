...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsettermchildcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreSetParentGroupSetTermChildCount -SetId <String> -SetId1 <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetTermChildCount -InputObject <ISitesIdentity> [-Filter <String>]

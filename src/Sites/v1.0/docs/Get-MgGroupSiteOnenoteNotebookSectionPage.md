...
### List (Default)
```
Get-MgGroupSiteOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String> -OnenoteSectionId <String>
...
### Get
```
Get-MgGroupSiteOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String> -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteOnenoteNotebookSectionPage -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

...
### Get (Default)
```
Get-MgSiteTermStoreSetTermChildRelationToTerm -RelationId <String> -SetId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetTermChildRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

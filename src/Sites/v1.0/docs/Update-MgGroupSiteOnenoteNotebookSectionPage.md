...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
```
Update-MgGroupSiteOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> [-AdditionalProperties <Hashtable>] [-ContentInputFile <String>]
 ...
 [-Title <String>] [-UserTags <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgGroupSiteOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String> -OnenotePageId <String>
 -OnenoteSectionId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphOnenotePage>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupSiteOnenoteNotebookSectionPage -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupSiteOnenoteNotebookSectionPage -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Self <String>] [-Title <String>] [-UserTags <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

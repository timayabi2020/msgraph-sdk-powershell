...
```
Update-MgGroupSiteListCreatedByUserMailboxSetting -GroupId <String> -ListId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteListCreatedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

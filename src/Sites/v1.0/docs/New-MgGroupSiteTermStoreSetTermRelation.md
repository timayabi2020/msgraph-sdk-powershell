...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitetermstoresettermrelation
schema: 2.0.0
---
...
### Create1
```
New-MgGroupSiteTermStoreSetTermRelation -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>

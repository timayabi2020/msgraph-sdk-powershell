...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresetparentgroupsetchildrelationtoterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupSiteTermStoreSetParentGroupSetChildRelationToTerm -GroupId <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetParentGroupSetChildRelationToTerm -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

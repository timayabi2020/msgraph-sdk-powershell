...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mgsitetermstoresettermrelation
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreSetTermRelation -InputObject <ISitesIdentity> [-IfMatch <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsettermchildrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreSetParentGroupSetTermChildRelationFromTerm -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetTermChildRelationFromTerm -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

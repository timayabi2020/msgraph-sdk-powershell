...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoregroupsettermrelationtoterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreGroupSetTermRelationToTerm -GroupId <String> -GroupId1 <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreGroupSetTermRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

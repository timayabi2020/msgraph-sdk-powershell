...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresetchildrelationset
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupSiteTermStoreSetChildRelationSet -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetChildRelationSet -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

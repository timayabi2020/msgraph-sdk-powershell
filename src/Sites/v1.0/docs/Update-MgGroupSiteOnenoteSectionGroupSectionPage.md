...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsiteonenotesectiongroupsectionpage
schema: 2.0.0
---
...
```
Update-MgGroupSiteOnenoteSectionGroupSectionPage -GroupId <String> -OnenotePageId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteOnenoteSectionGroupSectionPage -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

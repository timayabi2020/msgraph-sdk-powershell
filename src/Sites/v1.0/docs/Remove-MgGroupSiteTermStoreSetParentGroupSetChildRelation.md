...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mggroupsitetermstoresetparentgroupsetchildrelation
schema: 2.0.0
---
...
### Delete1 (Default)
```
Remove-MgGroupSiteTermStoreSetParentGroupSetChildRelation -GroupId <String> -RelationId <String>
...
```
Remove-MgGroupSiteTermStoreSetParentGroupSetChildRelation -GroupId <String> -RelationId <String>
 -SetId <String> -SetId1 <String> -SiteId <String> -StoreId <String> -TermId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgGroupSiteTermStoreSetParentGroupSetChildRelation -InputObject <ISitesIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

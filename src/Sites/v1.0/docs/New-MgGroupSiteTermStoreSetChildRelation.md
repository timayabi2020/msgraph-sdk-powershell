...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitetermstoresetchildrelation
schema: 2.0.0
---
...
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
...
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
 -TermId1 <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm]
...
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create2
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>
 -TermId <String> -TermId1 <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>]
...
```
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>
 -TermId <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
 ...
 [-ToTerm <IMicrosoftGraphTermStoreTerm>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-MgGroupSiteTermStoreSetChildRelation -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>
 ...
 [-Set <IMicrosoftGraphTermStoreSet>] [-ToTerm <IMicrosoftGraphTermStoreTerm>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgGroupSiteTermStoreSetChildRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgGroupSiteTermStoreSetChildRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-FromTerm <IMicrosoftGraphTermStoreTerm>] [-Id <String>] [-Relationship <String>]
 [-Set <IMicrosoftGraphTermStoreSet>] [-ToTerm <IMicrosoftGraphTermStoreTerm>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

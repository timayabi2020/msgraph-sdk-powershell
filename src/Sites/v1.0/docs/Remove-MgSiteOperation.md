...
### Delete (Default)
```
Remove-MgSiteOperation -RichLongRunningOperationId <String> -SiteId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSiteOperation -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

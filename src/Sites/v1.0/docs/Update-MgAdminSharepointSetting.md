...
Update-MgAdminSharepointSetting [-AdditionalProperties <Hashtable>] [-AllowedDomainGuidsForSyncApp <String[]>]
 ...
 [-TenantDefaultTimezone <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgAdminSharepointSetting -BodyParameter <IMicrosoftGraphSharepointSettings> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoregroupsettermchildrelationset
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreGroupSetTermChildRelationSet -GroupId <String> -GroupId1 <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreGroupSetTermChildRelationSet -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

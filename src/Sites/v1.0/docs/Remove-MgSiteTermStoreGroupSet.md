...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mgsitetermstoregroupset
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreGroupSet -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

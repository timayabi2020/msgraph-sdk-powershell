...
### Update1
```
Update-MgGroupSiteTermStoreSetTerm -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteTermStoreSetTerm -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphTermStoreTerm>

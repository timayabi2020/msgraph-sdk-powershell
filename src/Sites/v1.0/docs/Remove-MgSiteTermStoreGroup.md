...
### Delete (Default)
```
Remove-MgSiteTermStoreGroup -GroupId <String> -SiteId <String> [-IfMatch <String>] [-CustomHeader <String>]
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreGroup -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoregroupsettermchildset
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreGroupSetTermChildSet -GroupId <String> -GroupId1 <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreGroupSetTermChildSet -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

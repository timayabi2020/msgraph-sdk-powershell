...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitetermstoresettermchild
schema: 2.0.0
---
...
```
Update-MgGroupSiteTermStoreSetTermChild -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
...
### Update1
```
Update-MgGroupSiteTermStoreSetTermChild -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteTermStoreSetTermChild -InputObject <ISitesIdentity>
...
```
Update-MgGroupSiteTermStoreSetTermChild -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-Children <IMicrosoftGraphTermStoreTerm[]>] [-CreatedDateTime <DateTime>]
 [-Descriptions <IMicrosoftGraphTermStoreLocalizedDescription[]>] [-Id <String>]
 [-Labels <IMicrosoftGraphTermStoreLocalizedLabel[]>] [-LastModifiedDateTime <DateTime>]
 [-Properties <IMicrosoftGraphKeyValue[]>] [-Relations <IMicrosoftGraphTermStoreRelation[]>]

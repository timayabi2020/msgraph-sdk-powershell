...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsiteactivitybyinterval
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteActivityByInterval -SiteId <String> [-Count] [-Filter <String>] [-Property <String[]>]

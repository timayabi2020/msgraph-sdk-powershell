...
New-MgGroupSiteAnalyticItemActivityStatActivity -GroupId <String> -ItemActivityStatId <String>
 ...
 [-AdditionalProperties <Hashtable>] [-DriveItem <IMicrosoftGraphDriveItem>] [-Id <String>] [-Confirm]
...
```
New-MgGroupSiteAnalyticItemActivityStatActivity -GroupId <String> -ItemActivityStatId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphItemActivity> [-Confirm] [-WhatIf] [<CommonParameters>]
```

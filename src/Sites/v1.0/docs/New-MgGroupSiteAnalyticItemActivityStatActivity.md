...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsiteanalyticitemactivitystatactivity
schema: 2.0.0
---
...
```
New-MgGroupSiteAnalyticItemActivityStatActivity -GroupId <String> -ItemActivityStatId <String>
...
```
New-MgGroupSiteAnalyticItemActivityStatActivity -GroupId <String> -ItemActivityStatId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphItemActivity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

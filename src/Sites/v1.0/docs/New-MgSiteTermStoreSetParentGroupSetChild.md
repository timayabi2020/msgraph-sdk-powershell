...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoresetparentgroupsetchild
schema: 2.0.0
---
...
```
New-MgSiteTermStoreSetParentGroupSetChild -SetId <String> -SetId1 <String> -SiteId <String>
...
### Create1
```
New-MgSiteTermStoreSetParentGroupSetChild -SetId <String> -SetId1 <String> -SiteId <String> -StoreId <String>
 -BodyParameter <IMicrosoftGraphTermStoreTerm> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### Create2
```
New-MgSiteTermStoreSetParentGroupSetChild -SetId <String> -SetId1 <String> -SiteId <String> -TermId <String>
 -BodyParameter <IMicrosoftGraphTermStoreTerm> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgSiteTermStoreSetParentGroupSetChild -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreTerm> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgSiteTermStoreSetParentGroupSetChild -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoregroupsettermrelationcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreGroupSetTermRelationCount -GroupId <String> -SetId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreGroupSetTermRelationCount -InputObject <ISitesIdentity> [-Filter <String>]

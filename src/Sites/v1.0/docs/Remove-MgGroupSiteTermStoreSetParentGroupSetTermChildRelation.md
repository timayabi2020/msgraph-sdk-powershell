...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mggroupsitetermstoresetparentgroupsettermchildrelation
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation -GroupId <String> -RelationId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation -InputObject <ISitesIdentity>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

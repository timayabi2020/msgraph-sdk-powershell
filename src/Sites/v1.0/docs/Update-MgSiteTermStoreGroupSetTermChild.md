...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoregroupsettermchild
schema: 2.0.0
---
...
```
Update-MgSiteTermStoreGroupSetTermChild -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
...
```
Update-MgSiteTermStoreGroupSetTermChild -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
 -TermId1 <String> -BodyParameter <IMicrosoftGraphTermStoreTerm> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update1
```
Update-MgSiteTermStoreGroupSetTermChild -GroupId <String> -SetId <String> -SiteId <String> -StoreId <String>
...
### UpdateViaIdentity
```
Update-MgSiteTermStoreGroupSetTermChild -InputObject <ISitesIdentity>
...
```
Update-MgSiteTermStoreGroupSetTermChild -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-Children <IMicrosoftGraphTermStoreTerm[]>] [-CreatedDateTime <DateTime>]
 [-Descriptions <IMicrosoftGraphTermStoreLocalizedDescription[]>] [-Id <String>]
 [-Labels <IMicrosoftGraphTermStoreLocalizedLabel[]>] [-LastModifiedDateTime <DateTime>]
 [-Properties <IMicrosoftGraphKeyValue[]>] [-Relations <IMicrosoftGraphTermStoreRelation[]>]

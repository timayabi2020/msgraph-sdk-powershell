...
### Preview (Default)
```
Invoke-MgPreviewSiteOnenotePage -OnenotePageId <String> -SiteId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgPreviewSiteOnenotePage -InputObject <ISitesIdentity> [-CustomHeader <String>] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresettermchildrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreSetTermChildRelationFromTerm -RelationId <String> -SetId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetTermChildRelationFromTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

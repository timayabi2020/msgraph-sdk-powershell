...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoregroupsettermrelationtoterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreGroupSetTermRelationToTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreGroupSetTermRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

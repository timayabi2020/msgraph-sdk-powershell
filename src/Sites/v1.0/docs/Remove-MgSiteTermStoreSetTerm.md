...
### Delete1
```
Remove-MgSiteTermStoreSetTerm -SetId <String> -SiteId <String> -StoreId <String> -TermId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSiteTermStoreSetTerm -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

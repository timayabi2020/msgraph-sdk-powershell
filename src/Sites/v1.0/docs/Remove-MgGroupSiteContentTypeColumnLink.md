...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mggroupsitecontenttypecolumnlink
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgGroupSiteContentTypeColumnLink -InputObject <ISitesIdentity> [-IfMatch <String>]

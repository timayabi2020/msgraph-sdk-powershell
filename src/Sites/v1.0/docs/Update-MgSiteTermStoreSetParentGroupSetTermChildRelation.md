...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoresetparentgroupsettermchildrelation
schema: 2.0.0
---
...
```
Update-MgSiteTermStoreSetParentGroupSetTermChildRelation -RelationId <String> -SetId <String> -SetId1 <String>
...
### UpdateViaIdentity
```
Update-MgSiteTermStoreSetParentGroupSetTermChildRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoresetparentgroupsettermchildrelation
schema: 2.0.0
---
...
```
New-MgSiteTermStoreSetParentGroupSetTermChildRelation -SetId <String> -SetId1 <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteTermStoreSetParentGroupSetTermChildRelation -InputObject <ISitesIdentity>

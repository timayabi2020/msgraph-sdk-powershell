...
### Unpublish (Default)
```
Unpublish-MgSiteContentType -ContentTypeId <String> -SiteId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgSiteContentType -InputObject <ISitesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetParentGroupSetTermChildSet -GroupId <String> -SetId <String> -SetId1 <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetParentGroupSetTermChildSet -InputObject <ISitesIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoregroupsetchildrelationcount
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupSiteTermStoreGroupSetChildRelationCount -GroupId <String> -GroupId1 <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreGroupSetChildRelationCount -InputObject <ISitesIdentity> [-Filter <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresettermrelationset
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetTermRelationSet -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetTermRelationSet -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

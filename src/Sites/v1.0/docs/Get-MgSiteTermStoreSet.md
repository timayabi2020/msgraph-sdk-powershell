...
### List (Default)
```
Get-MgSiteTermStoreSet -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### List1
```
Get-MgSiteTermStoreSet -SiteId <String> -StoreId <String> [-ExpandProperty <String[]>] [-Filter <String>]

...
### List (Default)
```
Get-MgGroupSiteOnenoteNotebookSectionGroupSection -GroupId <String> -NotebookId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteOnenoteNotebookSectionGroupSection -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

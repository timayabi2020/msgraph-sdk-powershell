...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsettermchildrelationcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreSetParentGroupSetTermChildRelationCount -SetId <String> -SetId1 <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetTermChildRelationCount -InputObject <ISitesIdentity> [-Filter <String>]

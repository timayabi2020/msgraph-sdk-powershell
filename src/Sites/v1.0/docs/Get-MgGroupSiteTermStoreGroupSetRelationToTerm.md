...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoregroupsetrelationtoterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreGroupSetRelationToTerm -GroupId <String> -GroupId1 <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreGroupSetRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

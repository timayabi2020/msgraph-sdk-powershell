...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitelistlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgGroupSiteListLastModifiedByUserMailboxSetting -GroupId <String> -ListId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteListLastModifiedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

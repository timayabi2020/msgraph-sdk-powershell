...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitelistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgSiteListItemCreatedByUserMailboxSetting -ListId <String> -ListItemId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteListItemCreatedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

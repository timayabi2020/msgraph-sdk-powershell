...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsettermchildrelation
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteTermStoreSetParentGroupSetTermChildRelation -SetId <String> -SetId1 <String> -SiteId <String>
...
### Get
```
Get-MgSiteTermStoreSetParentGroupSetTermChildRelation -RelationId <String> -SetId <String> -SetId1 <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetTermChildRelation -InputObject <ISitesIdentity>

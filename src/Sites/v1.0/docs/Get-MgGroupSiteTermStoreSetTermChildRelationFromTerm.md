...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresettermchildrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetTermChildRelationFromTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetTermChildRelationFromTerm -InputObject <ISitesIdentity>

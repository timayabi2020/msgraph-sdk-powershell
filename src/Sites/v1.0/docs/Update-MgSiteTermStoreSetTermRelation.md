...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoresettermrelation
schema: 2.0.0
---
...
### Update1
```
Update-MgSiteTermStoreSetTermRelation -RelationId <String> -SetId <String> -SiteId <String> -StoreId <String>

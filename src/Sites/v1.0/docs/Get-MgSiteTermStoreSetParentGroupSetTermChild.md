...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsettermchild
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteTermStoreSetParentGroupSetTermChild -SetId <String> -SetId1 <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetTermChild -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

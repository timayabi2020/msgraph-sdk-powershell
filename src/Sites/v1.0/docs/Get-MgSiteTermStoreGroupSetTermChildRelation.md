...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoregroupsettermchildrelation
schema: 2.0.0
---
...
### List (Default)
```
Get-MgSiteTermStoreGroupSetTermChildRelation -GroupId <String> -SetId <String> -SiteId <String>
...
### Get
```
Get-MgSiteTermStoreGroupSetTermChildRelation -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreGroupSetTermChildRelation -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

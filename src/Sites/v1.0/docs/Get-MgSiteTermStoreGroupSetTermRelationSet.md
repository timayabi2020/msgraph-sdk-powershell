...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoregroupsettermrelationset
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreGroupSetTermRelationSet -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreGroupSetTermRelationSet -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

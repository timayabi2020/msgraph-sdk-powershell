...
### Publish (Default)
```
Publish-MgSiteListContentType -ContentTypeId <String> -ListId <String> -SiteId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgSiteListContentType -InputObject <ISitesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

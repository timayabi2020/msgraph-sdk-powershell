...
```
Update-MgGroupSiteTermStoreSetParentGroupSetTerm -GroupId <String> -SetId <String> -SetId1 <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteTermStoreSetParentGroupSetTerm -InputObject <ISitesIdentity>

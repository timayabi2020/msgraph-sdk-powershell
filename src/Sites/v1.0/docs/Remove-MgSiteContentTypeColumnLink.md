...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mgsitecontenttypecolumnlink
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgSiteContentTypeColumnLink -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

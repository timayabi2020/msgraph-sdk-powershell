...
### Delete (Default)
```
Remove-MgSitePermission -PermissionId <String> -SiteId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSitePermission -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

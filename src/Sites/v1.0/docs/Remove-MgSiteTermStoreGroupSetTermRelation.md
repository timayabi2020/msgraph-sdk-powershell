...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mgsitetermstoregroupsettermrelation
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreGroupSetTermRelation -InputObject <ISitesIdentity> [-IfMatch <String>]

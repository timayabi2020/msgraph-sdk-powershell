...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoresetparentgroupsetterm
schema: 2.0.0
---
...
```
Update-MgSiteTermStoreSetParentGroupSetTerm -SetId <String> -SetId1 <String> -SiteId <String> -TermId <String>
...
### Update1
```
Update-MgSiteTermStoreSetParentGroupSetTerm -SetId <String> -SetId1 <String> -SiteId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitetermstoregroupsetrelation
schema: 2.0.0
---
...
```
New-MgGroupSiteTermStoreGroupSetRelation -GroupId <String> -GroupId1 <String> -SetId <String> -SiteId <String>
...
```
New-MgGroupSiteTermStoreGroupSetRelation -GroupId <String> -GroupId1 <String> -SetId <String> -SiteId <String>
 -StoreId <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm]
...
### CreateViaIdentity
```
New-MgGroupSiteTermStoreGroupSetRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgGroupSiteTermStoreGroupSetRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitetermstoresetparentgroupsettermchildrelation
schema: 2.0.0
---
...
```
Update-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation -GroupId <String> -RelationId <String>
...
### UpdateViaIdentity
```
Update-MgGroupSiteTermStoreSetParentGroupSetTermChildRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

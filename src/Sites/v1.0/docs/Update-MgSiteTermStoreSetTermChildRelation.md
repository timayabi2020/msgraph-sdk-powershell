...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoresettermchildrelation
schema: 2.0.0
---
...
```
Update-MgSiteTermStoreSetTermChildRelation -RelationId <String> -SetId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteTermStoreSetTermChildRelation -InputObject <ISitesIdentity>
...
```
Update-MgSiteTermStoreSetTermChildRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-FromTerm <IMicrosoftGraphTermStoreTerm>] [-Id <String>] [-Relationship <String>]
 [-Set <IMicrosoftGraphTermStoreSet>] [-ToTerm <IMicrosoftGraphTermStoreTerm>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

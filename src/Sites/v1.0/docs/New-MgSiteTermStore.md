...
### Create
```
New-MgSiteTermStore -SiteId <String> -BodyParameter <IMicrosoftGraphTermStore> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSiteTermStore -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphTermStore>

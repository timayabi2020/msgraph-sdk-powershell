...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsiteonenotesectionpageparentsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteOnenoteSectionPageParentSection -GroupId <String> -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteOnenoteSectionPageParentSection -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

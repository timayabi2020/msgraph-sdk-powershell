...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoregroupsettermchildrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreGroupSetTermChildRelationFromTerm -GroupId <String> -GroupId1 <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreGroupSetTermChildRelationFromTerm -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgGroupSiteOnenoteSectionGroupSectionPageParentSection -GroupId <String> -OnenotePageId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteOnenoteSectionGroupSectionPageParentSection -InputObject <ISitesIdentity>

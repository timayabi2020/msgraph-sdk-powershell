...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresettermchildrelationcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetTermChildRelationCount -GroupId <String> -SetId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetTermChildRelationCount -InputObject <ISitesIdentity> [-Filter <String>]

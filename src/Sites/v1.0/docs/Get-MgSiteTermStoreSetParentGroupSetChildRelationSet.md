...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsetchildrelationset
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteTermStoreSetParentGroupSetChildRelationSet -RelationId <String> -SetId <String> -SetId1 <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetChildRelationSet -InputObject <ISitesIdentity>

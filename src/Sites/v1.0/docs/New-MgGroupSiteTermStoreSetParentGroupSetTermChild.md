...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitetermstoresetparentgroupsettermchild
schema: 2.0.0
---
...
```
New-MgGroupSiteTermStoreSetParentGroupSetTermChild -GroupId <String> -SetId <String> -SetId1 <String>
...
### CreateViaIdentity
```
New-MgGroupSiteTermStoreSetParentGroupSetTermChild -InputObject <ISitesIdentity>

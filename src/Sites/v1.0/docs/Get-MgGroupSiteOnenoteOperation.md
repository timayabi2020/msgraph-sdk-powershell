...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsiteonenoteoperation
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupSiteOnenoteOperation -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgGroupSiteOnenoteOperation -GroupId <String> -OnenoteOperationId <String> -SiteId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupSiteOnenoteOperation -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

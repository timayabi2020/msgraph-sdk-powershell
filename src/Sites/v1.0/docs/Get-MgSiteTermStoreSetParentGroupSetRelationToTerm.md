...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsetrelationtoterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreSetParentGroupSetRelationToTerm -RelationId <String> -SetId <String> -SetId1 <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

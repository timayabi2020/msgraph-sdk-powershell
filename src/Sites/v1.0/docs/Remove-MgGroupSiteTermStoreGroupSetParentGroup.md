...
### Delete (Default)
```
Remove-MgGroupSiteTermStoreGroupSetParentGroup -GroupId <String> -GroupId1 <String> -SetId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupSiteTermStoreGroupSetParentGroup -InputObject <ISitesIdentity> [-IfMatch <String>]

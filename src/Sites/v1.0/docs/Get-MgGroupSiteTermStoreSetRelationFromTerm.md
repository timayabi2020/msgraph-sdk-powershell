...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresetrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetRelationFromTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetRelationFromTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

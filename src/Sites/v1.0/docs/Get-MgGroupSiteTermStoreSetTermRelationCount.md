...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresettermrelationcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetTermRelationCount -GroupId <String> -SetId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetTermRelationCount -InputObject <ISitesIdentity> [-Filter <String>]

...
### List (Default)
```
Get-MgGroupSiteListContentTypeColumnPosition -ContentTypeId <String> -GroupId <String> -ListId <String>
...
### Get
```
Get-MgGroupSiteListContentTypeColumnPosition -ColumnDefinitionId <String> -ContentTypeId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteListContentTypeColumnPosition -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

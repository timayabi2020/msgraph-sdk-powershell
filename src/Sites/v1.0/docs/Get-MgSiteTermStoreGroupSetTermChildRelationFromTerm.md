...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoregroupsettermchildrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreGroupSetTermChildRelationFromTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreGroupSetTermChildRelationFromTerm -InputObject <ISitesIdentity>

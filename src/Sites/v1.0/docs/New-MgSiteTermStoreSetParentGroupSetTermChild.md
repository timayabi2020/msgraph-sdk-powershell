...
```
New-MgSiteTermStoreSetParentGroupSetTermChild -SetId <String> -SetId1 <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteTermStoreSetParentGroupSetTermChild -InputObject <ISitesIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresetparentgroupsetchildrelationset
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgGroupSiteTermStoreSetParentGroupSetChildRelationSet -GroupId <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetParentGroupSetChildRelationSet -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

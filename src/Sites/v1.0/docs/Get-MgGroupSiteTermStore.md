...
### Get (Default)
```
Get-MgGroupSiteTermStore -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgGroupSiteTermStore -GroupId <String> -SiteId <String> -StoreId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```
...
### List
```
Get-MgGroupSiteTermStore -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]

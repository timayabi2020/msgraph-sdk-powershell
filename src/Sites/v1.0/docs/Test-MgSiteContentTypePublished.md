...
### Is (Default)
```
Test-MgSiteContentTypePublished -ContentTypeId <String> -SiteId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### IsViaIdentity
```
Test-MgSiteContentTypePublished -InputObject <ISitesIdentity> [-CustomHeader <String>] [<CommonParameters>]
```

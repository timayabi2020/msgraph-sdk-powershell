...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoresetparentgroupsettermrelationset
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgSiteTermStoreSetParentGroupSetTermRelationSet -RelationId <String> -SetId <String> -SetId1 <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreSetParentGroupSetTermRelationSet -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

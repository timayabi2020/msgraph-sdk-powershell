...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresettermchildrelation
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupSiteTermStoreSetTermChildRelation -GroupId <String> -SetId <String> -SiteId <String>
...
### Get
```
Get-MgGroupSiteTermStoreSetTermChildRelation -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetTermChildRelation -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

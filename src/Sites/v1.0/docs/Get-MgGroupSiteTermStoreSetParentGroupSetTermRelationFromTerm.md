...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitetermstoresetparentgroupsettermrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgGroupSiteTermStoreSetParentGroupSetTermRelationFromTerm -GroupId <String> -RelationId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteTermStoreSetParentGroupSetTermRelationFromTerm -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

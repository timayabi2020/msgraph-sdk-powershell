...
### List (Default)
```
Get-MgGroupSiteOperation -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupSiteOperation -GroupId <String> -RichLongRunningOperationId <String> -SiteId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupSiteOperation -InputObject <ISitesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitetermstoregroupsetchildrelationset
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgSiteTermStoreGroupSetChildRelationSet -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgSiteTermStoreGroupSetChildRelationSet -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

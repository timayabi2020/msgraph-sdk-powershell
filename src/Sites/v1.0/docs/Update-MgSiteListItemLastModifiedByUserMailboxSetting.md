...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitelistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgSiteListItemLastModifiedByUserMailboxSetting -ListId <String> -ListItemId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgSiteListItemLastModifiedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

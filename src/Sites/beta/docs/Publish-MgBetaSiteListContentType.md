...
### Publish (Default)
```
Publish-MgBetaSiteListContentType -ContentTypeId <String> -ListId <String> -SiteId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaSiteListContentType -InputObject <ISitesIdentity> [-CustomHeader <String>] [-PassThru]

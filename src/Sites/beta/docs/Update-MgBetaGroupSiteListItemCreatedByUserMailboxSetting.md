...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitelistitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteListItemCreatedByUserMailboxSetting -GroupId <String> -ListId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteListItemCreatedByUserMailboxSetting -InputObject <ISitesIdentity>

...
### UpdateViaIdentity
```
Update-MgBetaSiteListItemField -InputObject <ISitesIdentity> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaSiteListItemField -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoresetparentgroupsetterm
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteTermStoreSetParentGroupSetTerm -GroupId <String> -SetId <String> -SetId1 <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteTermStoreSetParentGroupSetTerm -InputObject <ISitesIdentity>

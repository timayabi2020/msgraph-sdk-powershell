...
```
New-MgBetaGroupSiteOnenoteNotebookSectionGroupSection -GroupId <String> -NotebookId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteOnenoteNotebookSectionGroupSection -InputObject <ISitesIdentity>

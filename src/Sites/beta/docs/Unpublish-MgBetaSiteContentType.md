...
### Unpublish (Default)
```
Unpublish-MgBetaSiteContentType -ContentTypeId <String> -SiteId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgBetaSiteContentType -InputObject <ISitesIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitelistcontenttypecolumn
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaGroupSiteListContentTypeColumn -ContentTypeId <String> -GroupId <String> -ListId <String>
...
### Get
```
Get-MgBetaGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteListContentTypeColumn -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

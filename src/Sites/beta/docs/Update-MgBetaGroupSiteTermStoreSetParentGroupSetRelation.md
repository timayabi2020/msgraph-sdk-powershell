...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoresetparentgroupsetrelation
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteTermStoreSetParentGroupSetRelation -GroupId <String> -RelationId <String>
 -SetId <String> -SetId1 <String> -SiteId <String> [-AdditionalProperties <Hashtable>]
...
```
Update-MgBetaGroupSiteTermStoreSetParentGroupSetRelation -GroupId <String> -RelationId <String>
 -SetId <String> -SetId1 <String> -SiteId <String> -BodyParameter <IMicrosoftGraphTermStoreRelation>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaGroupSiteTermStoreSetParentGroupSetRelation -InputObject <ISitesIdentity>

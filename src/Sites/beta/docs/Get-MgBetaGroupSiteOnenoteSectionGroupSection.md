...
### List (Default)
```
Get-MgBetaGroupSiteOnenoteSectionGroupSection -GroupId <String> -SectionGroupId <String> -SiteId <String>
...
### Get
```
Get-MgBetaGroupSiteOnenoteSectionGroupSection -GroupId <String> -OnenoteSectionId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteOnenoteSectionGroupSection -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

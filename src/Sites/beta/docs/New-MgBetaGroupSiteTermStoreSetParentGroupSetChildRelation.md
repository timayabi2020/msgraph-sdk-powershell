...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresetparentgroupsetchildrelation
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetChildRelation -GroupId <String> -SetId <String> -SetId1 <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetChildRelation -InputObject <ISitesIdentity>

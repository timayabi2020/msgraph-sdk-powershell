...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoresettermchildrelation
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteTermStoreSetTermChildRelation -GroupId <String> -RelationId <String> -SetId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteTermStoreSetTermChildRelation -InputObject <ISitesIdentity>

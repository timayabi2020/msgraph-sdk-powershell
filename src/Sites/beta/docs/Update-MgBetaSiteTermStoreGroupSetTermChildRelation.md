...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitetermstoregroupsettermchildrelation
schema: 2.0.0
---
...
```
Update-MgBetaSiteTermStoreGroupSetTermChildRelation -GroupId <String> -RelationId <String> -SetId <String>
...
### UpdateViaIdentity
```
Update-MgBetaSiteTermStoreGroupSetTermChildRelation -InputObject <ISitesIdentity>

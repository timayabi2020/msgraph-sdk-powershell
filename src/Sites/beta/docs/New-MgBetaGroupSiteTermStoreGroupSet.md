...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoregroupset
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreGroupSet -GroupId <String> -GroupId1 <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreGroupSet -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreSet> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaGroupSiteTermStoreGroupSet -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

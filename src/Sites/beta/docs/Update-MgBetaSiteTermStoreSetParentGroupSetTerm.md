...
```
Update-MgBetaSiteTermStoreSetParentGroupSetTerm -SetId <String> -SetId1 <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgBetaSiteTermStoreSetParentGroupSetTerm -InputObject <ISitesIdentity>

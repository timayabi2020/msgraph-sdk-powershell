...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitetermstoresetchildrelationtoterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgBetaGroupSiteTermStoreSetChildRelationToTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteTermStoreSetChildRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

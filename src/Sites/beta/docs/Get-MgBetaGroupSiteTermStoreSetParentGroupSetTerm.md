...
### List (Default)
```
Get-MgBetaGroupSiteTermStoreSetParentGroupSetTerm -GroupId <String> -SetId <String> -SetId1 <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteTermStoreSetParentGroupSetTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

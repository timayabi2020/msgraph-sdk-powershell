...
### Delete (Default)
```
Remove-MgBetaSiteContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -SiteId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSiteContentTypeColumn -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

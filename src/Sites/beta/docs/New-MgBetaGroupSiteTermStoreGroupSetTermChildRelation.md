...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoregroupsettermchildrelation
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreGroupSetTermChildRelation -GroupId <String> -GroupId1 <String> -SetId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreGroupSetTermChildRelation -InputObject <ISitesIdentity>

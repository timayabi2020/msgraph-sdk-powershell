...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsiteonenotesection
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteOnenoteSection -GroupId <String> -OnenoteSectionId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteOnenoteSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaGroupSiteOnenoteSection -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

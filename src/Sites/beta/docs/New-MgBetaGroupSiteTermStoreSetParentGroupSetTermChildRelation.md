...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresetparentgroupsettermchildrelation
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetTermChildRelation -GroupId <String> -SetId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetTermChildRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoresetparentgroupsettermchildrelation
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteTermStoreSetParentGroupSetTermChildRelation -GroupId <String> -RelationId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteTermStoreSetParentGroupSetTermChildRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

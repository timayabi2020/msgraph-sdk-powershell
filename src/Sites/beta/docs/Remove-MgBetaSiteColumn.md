...
### Delete (Default)
```
Remove-MgBetaSiteColumn -ColumnDefinitionId <String> -SiteId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSiteColumn -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

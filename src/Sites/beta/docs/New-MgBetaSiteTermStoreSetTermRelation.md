...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitetermstoresettermrelation
schema: 2.0.0
---
...
```
New-MgBetaSiteTermStoreSetTermRelation -SetId <String> -SiteId <String> -TermId <String>
...
### CreateViaIdentity
```
New-MgBetaSiteTermStoreSetTermRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaSiteTermStoreSetTermRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

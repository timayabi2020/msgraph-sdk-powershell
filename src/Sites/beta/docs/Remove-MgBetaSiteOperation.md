...
### Delete (Default)
```
Remove-MgBetaSiteOperation -RichLongRunningOperationId <String> -SiteId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSiteOperation -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

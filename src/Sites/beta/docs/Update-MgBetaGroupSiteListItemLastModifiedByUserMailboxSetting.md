...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitelistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteListItemLastModifiedByUserMailboxSetting -GroupId <String> -ListId <String>
 -ListItemId <String> -SiteId <String> [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteListItemLastModifiedByUserMailboxSetting -InputObject <ISitesIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitetermstoregroupsettermrelationfromterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaSiteTermStoreGroupSetTermRelationFromTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgBetaSiteTermStoreGroupSetTermRelationFromTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

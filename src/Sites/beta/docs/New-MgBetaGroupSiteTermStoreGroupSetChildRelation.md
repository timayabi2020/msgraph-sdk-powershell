...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoregroupsetchildrelation
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreGroupSetChildRelation -GroupId <String> -GroupId1 <String> -SetId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreGroupSetChildRelation -InputObject <ISitesIdentity>

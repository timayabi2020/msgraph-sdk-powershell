...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistoperation
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteListOperation -GroupId <String> -ListId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteListOperation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphRichLongRunningOperation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaGroupSiteListOperation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
### Delete (Default)
```
Remove-MgBetaGroupSiteOnenoteSectionGroup -GroupId <String> -SectionGroupId <String> -SiteId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupSiteOnenoteSectionGroup -InputObject <ISitesIdentity> [-IfMatch <String>]

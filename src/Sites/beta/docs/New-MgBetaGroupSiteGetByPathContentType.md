...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitegetbypathcontenttype
schema: 2.0.0
---
...
### Create1
```
New-MgBetaGroupSiteGetByPathContentType -GroupId <String> -Path <String> -Path1 <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphContentType> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgBetaGroupSiteGetByPathContentType -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

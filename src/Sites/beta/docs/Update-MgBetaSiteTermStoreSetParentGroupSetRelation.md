...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitetermstoresetparentgroupsetrelation
schema: 2.0.0
---
...
```
Update-MgBetaSiteTermStoreSetParentGroupSetRelation -RelationId <String> -SetId <String> -SetId1 <String>
...
### UpdateViaIdentity
```
Update-MgBetaSiteTermStoreSetParentGroupSetRelation -InputObject <ISitesIdentity>

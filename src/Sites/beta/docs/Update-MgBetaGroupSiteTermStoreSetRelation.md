...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoresetrelation
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteTermStoreSetRelation -GroupId <String> -RelationId <String> -SetId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteTermStoreSetRelation -InputObject <ISitesIdentity>
...
```
Update-MgBetaGroupSiteTermStoreSetRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

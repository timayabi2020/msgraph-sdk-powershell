...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitelistcolumn
schema: 2.0.0
---

# Update-MgBetaGroupSiteListColumn
...
```
Update-MgBetaGroupSiteListColumn -ColumnDefinitionId <String> -GroupId <String> -ListId <String>
 ...
 [-Validation <IMicrosoftGraphColumnValidation>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaGroupSiteListColumn -ColumnDefinitionId <String> -GroupId <String> -ListId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaGroupSiteListColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupSiteListColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoregroupsetrelation
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreGroupSetRelation -GroupId <String> -GroupId1 <String> -SetId <String>
...
```
New-MgBetaGroupSiteTermStoreGroupSetRelation -GroupId <String> -GroupId1 <String> -SetId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreGroupSetRelation -InputObject <ISitesIdentity>
...
```
New-MgBetaGroupSiteTermStoreGroupSetRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsiteonenotenotebooksectiongroupsectionpage
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteOnenoteNotebookSectionGroupSectionPage -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteOnenoteNotebookSectionGroupSectionPage -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitelistcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteListCreatedByUserMailboxSetting -GroupId <String> -ListId <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteListCreatedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

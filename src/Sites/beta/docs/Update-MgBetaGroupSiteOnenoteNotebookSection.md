...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsiteonenotenotebooksection
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteOnenoteNotebookSection -GroupId <String> -NotebookId <String> -OnenoteSectionId <String>
 -SiteId <String> [-AdditionalProperties <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 ...
 [-Self <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaGroupSiteOnenoteNotebookSection -GroupId <String> -NotebookId <String> -OnenoteSectionId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaGroupSiteOnenoteNotebookSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupSiteOnenoteNotebookSection -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

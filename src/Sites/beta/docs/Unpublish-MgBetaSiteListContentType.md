...
### Unpublish (Default)
```
Unpublish-MgBetaSiteListContentType -ContentTypeId <String> -ListId <String> -SiteId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgBetaSiteListContentType -InputObject <ISitesIdentity> [-CustomHeader <String>] [-PassThru]

...
```
New-MgBetaSiteListContentTypeColumn -ContentTypeId <String> -ListId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgBetaSiteListContentTypeColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaSiteListContentTypeColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

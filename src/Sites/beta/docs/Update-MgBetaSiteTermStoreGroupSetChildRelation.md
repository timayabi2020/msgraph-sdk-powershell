...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitetermstoregroupsetchildrelation
schema: 2.0.0
---
...
```
Update-MgBetaSiteTermStoreGroupSetChildRelation -GroupId <String> -RelationId <String> -SetId <String>
...
### UpdateViaIdentity
```
Update-MgBetaSiteTermStoreGroupSetChildRelation -InputObject <ISitesIdentity>

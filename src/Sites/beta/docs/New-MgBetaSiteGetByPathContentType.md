...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitegetbypathcontenttype
schema: 2.0.0
---
...
```
New-MgBetaSiteGetByPathContentType -Path <String> -SiteId <String> [-AdditionalProperties <Hashtable>]
...
### Create1
```
New-MgBetaSiteGetByPathContentType -Path <String> -Path1 <String> -SiteId <String>
...
```
New-MgBetaSiteGetByPathContentType -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-AssociatedHubsUrls <String[]>] [-Base <IMicrosoftGraphContentType>]
 [-BaseTypes <IMicrosoftGraphContentType[]>] [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
 [-ColumnPositions <IMicrosoftGraphColumnDefinition[]>] [-Columns <IMicrosoftGraphColumnDefinition[]>]
 [-Description <String>] [-DocumentSet <IMicrosoftGraphDocumentSet>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsiteonenotenotebooksectiongroupsection
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteOnenoteNotebookSectionGroupSection -GroupId <String> -NotebookId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteOnenoteNotebookSectionGroupSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitetermstoresetparentgroupset
schema: 2.0.0
---
...
```
Update-MgBetaSiteTermStoreSetParentGroupSet -SetId <String> -SetId1 <String> -SiteId <String>
...
### UpdateViaIdentity
```
Update-MgBetaSiteTermStoreSetParentGroupSet -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreSet> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaSiteTermStoreSetParentGroupSet -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

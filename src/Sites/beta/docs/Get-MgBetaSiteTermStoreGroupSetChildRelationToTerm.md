...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitetermstoregroupsetchildrelationtoterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgBetaSiteTermStoreGroupSetChildRelationToTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgBetaSiteTermStoreGroupSetChildRelationToTerm -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

...
```
New-MgBetaSitePermission -SiteId <String> [-AdditionalProperties <Hashtable>] [-ExpirationDateTime <DateTime>]
...
### Create
```
New-MgBetaSitePermission -SiteId <String> -BodyParameter <IMicrosoftGraphPermission> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaSitePermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaSitePermission -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitetermstoreset
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaSiteTermStoreSet -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSiteTermStoreSet -SetId <String> -SiteId <String> [-ExpandProperty <String[]>]

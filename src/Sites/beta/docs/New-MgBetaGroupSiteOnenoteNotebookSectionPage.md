...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteOnenoteNotebookSectionPage -InputObject <ISitesIdentity>

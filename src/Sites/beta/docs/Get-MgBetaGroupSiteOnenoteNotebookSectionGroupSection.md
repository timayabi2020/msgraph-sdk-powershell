...
### List (Default)
```
Get-MgBetaGroupSiteOnenoteNotebookSectionGroupSection -GroupId <String> -NotebookId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteOnenoteNotebookSectionGroupSection -InputObject <ISitesIdentity>

...
### Delete (Default)
```
Remove-MgBetaGroupSiteTermStoreGroupSetTerm -GroupId <String> -GroupId1 <String> -SetId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaGroupSiteTermStoreGroupSetTerm -InputObject <ISitesIdentity> [-IfMatch <String>]

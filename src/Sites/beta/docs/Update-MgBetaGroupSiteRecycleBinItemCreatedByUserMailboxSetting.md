...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsiterecyclebinitemcreatedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteRecycleBinItemCreatedByUserMailboxSetting -GroupId <String> -RecycleBinItemId <String>
...
```
Update-MgBetaGroupSiteRecycleBinItemCreatedByUserMailboxSetting -GroupId <String> -RecycleBinItemId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaGroupSiteRecycleBinItemCreatedByUserMailboxSetting -InputObject <ISitesIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/remove-mgbetasitelistitemversionfield
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaSiteListItemVersionField -InputObject <ISitesIdentity> [-IfMatch <String>]

...
### List (Default)
```
Get-MgBetaGroupSiteInformationProtectionPolicyLabel -GroupId <String> -SiteId <String>
...
### Get
```
Get-MgBetaGroupSiteInformationProtectionPolicyLabel -GroupId <String> -InformationProtectionLabelId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteInformationProtectionPolicyLabel -InputObject <ISitesIdentity> [-ExpandProperty <String[]>]

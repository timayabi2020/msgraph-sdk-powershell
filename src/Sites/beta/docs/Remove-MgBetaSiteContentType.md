...
### Delete (Default)
```
Remove-MgBetaSiteContentType -ContentTypeId <String> -SiteId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSiteContentType -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

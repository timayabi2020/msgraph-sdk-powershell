...
### List2 (Default)
```
Get-MgBetaGroupSubSite -GroupId <String> [-SiteId <String>] [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgBetaGroupSubSite -GroupId <String> -SiteId1 <String> [-SiteId <String>] [-ExpandProperty <String[]>]

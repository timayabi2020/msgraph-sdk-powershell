...
### Is (Default)
```
Test-MgBetaSiteContentTypePublished -ContentTypeId <String> -SiteId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### IsViaIdentity
```
Test-MgBetaSiteContentTypePublished -InputObject <ISitesIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

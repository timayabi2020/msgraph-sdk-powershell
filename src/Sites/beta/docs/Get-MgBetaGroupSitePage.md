...
### List (Default)
```
Get-MgBetaGroupSitePage -GroupId <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaGroupSitePage -InputObject <ISitesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitetermstoregroupsetchildrelationfromterm
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-MgBetaGroupSiteTermStoreGroupSetChildRelationFromTerm -GroupId <String> -GroupId1 <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteTermStoreGroupSetChildRelationFromTerm -InputObject <ISitesIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

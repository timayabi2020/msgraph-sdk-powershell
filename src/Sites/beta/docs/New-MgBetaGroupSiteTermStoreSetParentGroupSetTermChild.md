...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresetparentgroupsettermchild
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetTermChild -GroupId <String> -SetId <String> -SetId1 <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetTermChild -InputObject <ISitesIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsiterecyclebinitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteRecycleBinItemLastModifiedByUserMailboxSetting -GroupId <String>
 -RecycleBinItemId <String> -SiteId <String> [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
 ...
 [-WorkingHours <IMicrosoftGraphWorkingHours>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaGroupSiteRecycleBinItemLastModifiedByUserMailboxSetting -GroupId <String>
 -RecycleBinItemId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphMailboxSettings>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaGroupSiteRecycleBinItemLastModifiedByUserMailboxSetting -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

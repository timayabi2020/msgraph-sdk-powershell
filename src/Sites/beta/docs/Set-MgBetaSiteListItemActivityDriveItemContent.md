...
Set-MgBetaSiteListItemActivityDriveItemContent -ItemActivityOldId <String> -ListId <String>
 -ListItemId <String> -SiteId <String> -InFile <String> [-Data <Stream>] [-ContentType <String>]
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaSiteListItemActivityDriveItemContent -InputObject <ISitesIdentity> -InFile <String> [-Data <Stream>]

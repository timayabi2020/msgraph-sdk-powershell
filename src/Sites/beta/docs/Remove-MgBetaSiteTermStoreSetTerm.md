...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/remove-mgbetasitetermstoresetterm
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaSiteTermStoreSetTerm -InputObject <ISitesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

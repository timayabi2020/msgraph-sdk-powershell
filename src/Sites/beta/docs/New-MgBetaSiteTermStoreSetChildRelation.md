...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitetermstoresetchildrelation
schema: 2.0.0
---
...
```
New-MgBetaSiteTermStoreSetChildRelation -SetId <String> -SiteId <String> -TermId <String>
...
### Create
```
New-MgBetaSiteTermStoreSetChildRelation -SetId <String> -SiteId <String> -TermId <String> -TermId1 <String>
...
### CreateViaIdentity
```
New-MgBetaSiteTermStoreSetChildRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaSiteTermStoreSetChildRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresetrelation
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreSetRelation -GroupId <String> -SetId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreSetRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaGroupSiteTermStoreSetRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivitytotaldistributioncount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamUserActivityTotalDistributionCount -Period <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamUserActivityTotalDistributionCount -InputObject <IReportsIdentity> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

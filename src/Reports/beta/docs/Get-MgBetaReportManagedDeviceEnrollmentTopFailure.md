...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportmanageddeviceenrollmenttopfailure
schema: 2.0.0
---
...
### Top (Default)
```
Get-MgBetaReportManagedDeviceEnrollmentTopFailure -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### Top1
```
Get-MgBetaReportManagedDeviceEnrollmentTopFailure -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### TopViaIdentity
```
Get-MgBetaReportManagedDeviceEnrollmentTopFailure -InputObject <IReportsIdentity> -OutFile <String>

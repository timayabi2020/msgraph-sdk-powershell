...
### Get (Default)
```
Get-MgBetaReportMailboxUsageMailboxCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportMailboxUsageMailboxCount -InputObject <IReportsIdentity> -OutFile <String>

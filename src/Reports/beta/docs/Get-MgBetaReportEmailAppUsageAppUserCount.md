...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportemailappusageappusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportEmailAppUsageAppUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportEmailAppUsageAppUserCount -InputObject <IReportsIdentity> -OutFile <String>

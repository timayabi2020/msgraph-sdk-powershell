...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailyinactiveuser
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaReportUserInsightDailyInactiveUser [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaReportUserInsightDailyInactiveUser -DailyInactiveUsersMetricId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportUserInsightDailyInactiveUser -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```
...
### -DailyInactiveUsersMetricId
The unique identifier of dailyInactiveUsersMetric
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDailyInactiveUsersMetric

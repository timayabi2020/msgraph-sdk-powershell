...
### Get (Default)
```
Get-MgBetaReportBrowserUserDetail -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportBrowserUserDetail -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

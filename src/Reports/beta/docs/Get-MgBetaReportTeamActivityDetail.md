...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamactivitydetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamActivityDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportTeamActivityDetail -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamActivityDetail -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailyinactiveuserbyapplication
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaReportUserInsightDailyInactiveUserByApplication [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaReportUserInsightDailyInactiveUserByApplication -DailyInactiveUsersByApplicationMetricId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportUserInsightDailyInactiveUserByApplication -InputObject <IReportsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```
...
### -DailyInactiveUsersByApplicationMetricId
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDailyInactiveUsersByApplicationMetric

...
### Get (Default)
```
Get-MgBetaReportOneDriveActivityFileCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportOneDriveActivityFileCount -InputObject <IReportsIdentity> -OutFile <String>

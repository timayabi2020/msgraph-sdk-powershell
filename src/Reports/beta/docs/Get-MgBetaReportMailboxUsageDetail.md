...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportmailboxusagedetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportMailboxUsageDetail -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportMailboxUsageDetail -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportformuseractivityuserdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportFormUserActivityUserDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportFormUserActivityUserDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportFormUserActivityUserDetail -InputObject <IReportsIdentity> -OutFile <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamdeviceusagetotalusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamDeviceUsageTotalUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamDeviceUsageTotalUserCount -InputObject <IReportsIdentity> -OutFile <String>

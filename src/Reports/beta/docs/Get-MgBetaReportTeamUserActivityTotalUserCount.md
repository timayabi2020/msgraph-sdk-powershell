...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivitytotalusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamUserActivityTotalUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamUserActivityTotalUserCount -InputObject <IReportsIdentity> -OutFile <String>

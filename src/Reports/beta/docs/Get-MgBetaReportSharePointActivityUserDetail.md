...
### Get (Default)
```
Get-MgBetaReportSharePointActivityUserDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportSharePointActivityUserDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSharePointActivityUserDetail -InputObject <IReportsIdentity> -OutFile <String>

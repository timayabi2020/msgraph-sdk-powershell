...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportoffice365activeusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportOffice365ActiveUserCount -Period <String> [-Count] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportOffice365ActiveUserCount -InputObject <IReportsIdentity> [-Count] [-Filter <String>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphOffice365ActiveUserCounts

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamactivitydistributioncount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamActivityDistributionCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamActivityDistributionCount -InputObject <IReportsIdentity> -OutFile <String>

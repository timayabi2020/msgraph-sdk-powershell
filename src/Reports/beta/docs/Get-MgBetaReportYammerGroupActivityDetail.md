...
### Get (Default)
```
Get-MgBetaReportYammerGroupActivityDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportYammerGroupActivityDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgBetaReportTeamDeviceUsageUserDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportTeamDeviceUsageUserDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamDeviceUsageUserDetail -InputObject <IReportsIdentity> -OutFile <String>

...
### Get (Default)
```
Get-MgBetaReportSharePointActivityFileCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSharePointActivityFileCount -InputObject <IReportsIdentity> -OutFile <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamdeviceusagedistributionusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamDeviceUsageDistributionUserCount -Period <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamDeviceUsageDistributionUserCount -InputObject <IReportsIdentity> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

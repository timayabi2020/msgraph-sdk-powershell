...
### Get (Default)
```
Get-MgBetaReportTeamActivityCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamActivityCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

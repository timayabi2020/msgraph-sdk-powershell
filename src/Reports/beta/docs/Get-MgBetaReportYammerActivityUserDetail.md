...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportyammeractivityuserdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportYammerActivityUserDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportYammerActivityUserDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerActivityUserDetail -InputObject <IReportsIdentity> -OutFile <String>

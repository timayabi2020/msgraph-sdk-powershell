...
### Get (Default)
```
Get-MgBetaReportM365AppUserDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportM365AppUserDetail -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportM365AppUserDetail -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

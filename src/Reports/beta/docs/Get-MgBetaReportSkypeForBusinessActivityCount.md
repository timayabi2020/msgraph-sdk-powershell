...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportskypeforbusinessactivitycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportSkypeForBusinessActivityCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSkypeForBusinessActivityCount -InputObject <IReportsIdentity> -OutFile <String>

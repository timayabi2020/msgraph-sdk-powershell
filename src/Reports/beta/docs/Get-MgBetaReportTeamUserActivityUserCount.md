...
### Get (Default)
```
Get-MgBetaReportTeamUserActivityUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamUserActivityUserCount -InputObject <IReportsIdentity> -OutFile <String>

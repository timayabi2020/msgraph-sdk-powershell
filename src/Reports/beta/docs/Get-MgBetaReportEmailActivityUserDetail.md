...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportemailactivityuserdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportEmailActivityUserDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportEmailActivityUserDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportEmailActivityUserDetail -InputObject <IReportsIdentity> -OutFile <String>

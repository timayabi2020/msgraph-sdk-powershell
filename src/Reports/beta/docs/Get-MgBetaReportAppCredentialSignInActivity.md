...
### List (Default)
```
Get-MgBetaReportAppCredentialSignInActivity [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaReportAppCredentialSignInActivity -AppCredentialSignInActivityId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportAppCredentialSignInActivity -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
...
### -AppCredentialSignInActivityId
The unique identifier of appCredentialSignInActivity
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAppCredentialSignInActivity

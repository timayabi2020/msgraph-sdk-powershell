...
### List (Default)
```
Get-MgBetaReportUserInsightMonthlyAuthentication [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaReportUserInsightMonthlyAuthentication -AuthenticationsMetricId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportUserInsightMonthlyAuthentication -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]

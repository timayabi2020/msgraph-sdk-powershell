...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportemailappusageusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportEmailAppUsageUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportEmailAppUsageUserCount -InputObject <IReportsIdentity> -OutFile <String>

...
### Get (Default)
```
Get-MgBetaReportSharePointSiteUsageDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportSharePointSiteUsageDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSharePointSiteUsageDetail -InputObject <IReportsIdentity> -OutFile <String>

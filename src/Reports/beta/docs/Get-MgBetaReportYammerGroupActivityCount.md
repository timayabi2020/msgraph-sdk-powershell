...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportyammergroupactivitycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportYammerGroupActivityCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerGroupActivityCount -InputObject <IReportsIdentity> -OutFile <String>

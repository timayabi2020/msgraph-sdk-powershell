...
### Get (Default)
```
Get-MgBetaReportEmailAppUsageVersionUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportEmailAppUsageVersionUserCount -InputObject <IReportsIdentity> -OutFile <String>

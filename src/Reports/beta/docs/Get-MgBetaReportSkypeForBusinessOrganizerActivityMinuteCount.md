...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportskypeforbusinessorganizeractivityminutecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportSkypeForBusinessOrganizerActivityMinuteCount -Period <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSkypeForBusinessOrganizerActivityMinuteCount -InputObject <IReportsIdentity> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

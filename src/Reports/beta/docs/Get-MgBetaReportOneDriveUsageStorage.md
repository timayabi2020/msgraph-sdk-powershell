...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportonedriveusagestorage
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportOneDriveUsageStorage -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportOneDriveUsageStorage -InputObject <IReportsIdentity> -OutFile <String>

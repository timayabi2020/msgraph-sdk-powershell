...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightmonthlyinactiveuser
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaReportUserInsightMonthlyInactiveUser [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaReportUserInsightMonthlyInactiveUser -MonthlyInactiveUsersMetricId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportUserInsightMonthlyInactiveUser -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
...
### -MonthlyInactiveUsersMetricId
The unique identifier of monthlyInactiveUsersMetric

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportsharepointactivitypage
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportSharePointActivityPage -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSharePointActivityPage -InputObject <IReportsIdentity> -OutFile <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

...
### Get (Default)
```
Get-MgBetaReportM365AppUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportM365AppUserCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

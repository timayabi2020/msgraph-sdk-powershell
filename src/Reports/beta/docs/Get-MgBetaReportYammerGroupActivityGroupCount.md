...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportyammergroupactivitygroupcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportYammerGroupActivityGroupCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerGroupActivityGroupCount -InputObject <IReportsIdentity> -OutFile <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamdeviceusageusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamDeviceUsageUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamDeviceUsageUserCount -InputObject <IReportsIdentity> -OutFile <String>

...
### Get (Default)
```
Get-MgBetaReportServiceActivityMetricForMfaSignInSuccess -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityMetricForMfaSignInSuccess -InputObject <IReportsIdentity>

...
### Get (Default)
```
Get-MgBetaReportBrowserUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportBrowserUserCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportmailboxusagestorage
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportMailboxUsageStorage -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportMailboxUsageStorage -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportemailactivitycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportEmailActivityCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportEmailActivityCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

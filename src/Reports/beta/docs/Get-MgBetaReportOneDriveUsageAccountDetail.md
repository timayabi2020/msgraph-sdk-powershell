...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportonedriveusageaccountdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportOneDriveUsageAccountDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportOneDriveUsageAccountDetail -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportOneDriveUsageAccountDetail -InputObject <IReportsIdentity> -OutFile <String>

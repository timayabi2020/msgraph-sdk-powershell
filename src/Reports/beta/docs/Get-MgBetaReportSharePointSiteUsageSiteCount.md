...
### Get (Default)
```
Get-MgBetaReportSharePointSiteUsageSiteCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSharePointSiteUsageSiteCount -InputObject <IReportsIdentity> -OutFile <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportonedriveusageaccountcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportOneDriveUsageAccountCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportOneDriveUsageAccountCount -InputObject <IReportsIdentity> -OutFile <String>

...
### List (Default)
```
Get-MgBetaReportUserInsightMonthlySignUp [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaReportUserInsightMonthlySignUp -UserSignUpMetricId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportUserInsightMonthlySignUp -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

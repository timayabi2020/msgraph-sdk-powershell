...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportsharepointsiteusagestorage
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportSharePointSiteUsageStorage -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSharePointSiteUsageStorage -InputObject <IReportsIdentity> -OutFile <String>

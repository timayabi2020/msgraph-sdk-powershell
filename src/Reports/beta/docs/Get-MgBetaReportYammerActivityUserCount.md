...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportyammeractivityusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportYammerActivityUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerActivityUserCount -InputObject <IReportsIdentity> -OutFile <String>

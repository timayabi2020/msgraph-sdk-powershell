...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportsharepointactivityusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportSharePointActivityUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSharePointActivityUserCount -InputObject <IReportsIdentity> -OutFile <String>

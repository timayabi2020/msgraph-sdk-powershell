...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportemailactivityusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportEmailActivityUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportEmailActivityUserCount -InputObject <IReportsIdentity> -OutFile <String>

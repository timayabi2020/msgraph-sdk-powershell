...
### Graph (Default)
```
Invoke-MgBetaGraphReportAuthenticationMethod [-CustomHeader <String>] [<CommonParameters>]
```
...
### GraphViaIdentity
```
Invoke-MgBetaGraphReportAuthenticationMethod -InputObject <IReportsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

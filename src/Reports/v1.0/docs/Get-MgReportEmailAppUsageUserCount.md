...
### Get (Default)
```
Get-MgReportEmailAppUsageUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportEmailAppUsageUserCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

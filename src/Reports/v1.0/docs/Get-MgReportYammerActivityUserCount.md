...
### Get (Default)
```
Get-MgReportYammerActivityUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerActivityUserCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

...
### Get (Default)
```
Get-MgReportSharePointActivityFileCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportSharePointActivityFileCount -InputObject <IReportsIdentity> -OutFile <String>

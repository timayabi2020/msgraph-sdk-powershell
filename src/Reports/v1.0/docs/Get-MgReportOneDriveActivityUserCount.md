...
### Get (Default)
```
Get-MgReportOneDriveActivityUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportOneDriveActivityUserCount -InputObject <IReportsIdentity> -OutFile <String>

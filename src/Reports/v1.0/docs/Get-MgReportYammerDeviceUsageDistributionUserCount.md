...
### Get (Default)
```
Get-MgReportYammerDeviceUsageDistributionUserCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerDeviceUsageDistributionUserCount -InputObject <IReportsIdentity> -OutFile <String>

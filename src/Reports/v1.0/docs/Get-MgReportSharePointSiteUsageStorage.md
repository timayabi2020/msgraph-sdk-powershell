...
### Get (Default)
```
Get-MgReportSharePointSiteUsageStorage -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportSharePointSiteUsageStorage -InputObject <IReportsIdentity> -OutFile <String>

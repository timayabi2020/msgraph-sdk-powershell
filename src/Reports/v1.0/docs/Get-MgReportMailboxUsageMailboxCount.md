...
### Get (Default)
```
Get-MgReportMailboxUsageMailboxCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportMailboxUsageMailboxCount -InputObject <IReportsIdentity> -OutFile <String>

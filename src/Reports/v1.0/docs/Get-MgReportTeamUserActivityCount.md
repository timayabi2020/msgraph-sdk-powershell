...
### Get (Default)
```
Get-MgReportTeamUserActivityCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamUserActivityCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

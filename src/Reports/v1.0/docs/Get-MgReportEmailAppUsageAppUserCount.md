...
### Get (Default)
```
Get-MgReportEmailAppUsageAppUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportEmailAppUsageAppUserCount -InputObject <IReportsIdentity> -OutFile <String>

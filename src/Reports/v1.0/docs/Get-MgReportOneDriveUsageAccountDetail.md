...
### Get (Default)
```
Get-MgReportOneDriveUsageAccountDetail -Date <DateTime> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### Get1
```
Get-MgReportOneDriveUsageAccountDetail -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

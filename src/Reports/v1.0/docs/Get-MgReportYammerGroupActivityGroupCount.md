...
### Get (Default)
```
Get-MgReportYammerGroupActivityGroupCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerGroupActivityGroupCount -InputObject <IReportsIdentity> -OutFile <String>

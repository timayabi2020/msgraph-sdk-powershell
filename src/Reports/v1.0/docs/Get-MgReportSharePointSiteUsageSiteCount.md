...
### Get (Default)
```
Get-MgReportSharePointSiteUsageSiteCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportSharePointSiteUsageSiteCount -InputObject <IReportsIdentity> -OutFile <String>

...
### Get (Default)
```
Get-MgReportOneDriveUsageStorage -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportOneDriveUsageStorage -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

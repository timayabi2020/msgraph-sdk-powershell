...
### Get (Default)
```
Get-MgReportM365AppPlatformUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportM365AppPlatformUserCount -InputObject <IReportsIdentity> -OutFile <String>

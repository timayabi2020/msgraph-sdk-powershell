...
### Graph (Default)
```
Invoke-MgGraphReportAuthenticationMethod [-CustomHeader <String>] [<CommonParameters>]
```
...
### GraphViaIdentity
```
Invoke-MgGraphReportAuthenticationMethod -InputObject <IReportsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

...
### Top (Default)
```
Get-MgReportManagedDeviceEnrollmentTopFailure -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### Top1
```
Get-MgReportManagedDeviceEnrollmentTopFailure -Period <String> -OutFile <String> [-CustomHeader <String>]

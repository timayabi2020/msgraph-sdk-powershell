...
### Get (Default)
```
Get-MgReportEmailActivityUserCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportEmailActivityUserCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

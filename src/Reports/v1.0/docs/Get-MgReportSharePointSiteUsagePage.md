...
### Get (Default)
```
Get-MgReportSharePointSiteUsagePage -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportSharePointSiteUsagePage -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

...
### Get (Default)
```
Get-MgReportOneDriveActivityFileCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportOneDriveActivityFileCount -InputObject <IReportsIdentity> -OutFile <String>

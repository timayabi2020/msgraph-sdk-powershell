...
### Get (Default)
```
Get-MgReportMailboxUsageQuotaStatusMailboxCount -Period <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportMailboxUsageQuotaStatusMailboxCount -InputObject <IReportsIdentity> -OutFile <String>

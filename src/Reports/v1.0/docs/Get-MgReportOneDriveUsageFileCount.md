...
### Get (Default)
```
Get-MgReportOneDriveUsageFileCount -Period <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportOneDriveUsageFileCount -InputObject <IReportsIdentity> -OutFile <String> [-CustomHeader <String>]

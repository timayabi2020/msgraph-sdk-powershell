...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappasmanagedandroidlobappcontentversion
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsManagedAndroidLobAppContentVersion -MobileAppId <String>
 [-AdditionalProperties <Hashtable>] [-ContainedApps <IMicrosoftGraphMobileContainedApp[]>]
 [-Files <IMicrosoftGraphMobileAppContentFile[]>] [-Id <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgDeviceAppManagementMobileAppAsManagedAndroidLobAppContentVersion -MobileAppId <String>
 -BodyParameter <IMicrosoftGraphMobileAppContent> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

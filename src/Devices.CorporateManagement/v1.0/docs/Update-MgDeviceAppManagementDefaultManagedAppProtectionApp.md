...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementdefaultmanagedappprotectionapp
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementDefaultManagedAppProtectionApp -DefaultManagedAppProtectionId <String>
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementDefaultManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>

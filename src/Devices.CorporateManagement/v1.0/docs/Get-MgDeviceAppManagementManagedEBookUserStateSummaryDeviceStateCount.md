...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedebookuserstatesummarydevicestatecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementManagedEBookUserStateSummaryDeviceStateCount -ManagedEBookId <String>
 -UserInstallStateSummaryId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

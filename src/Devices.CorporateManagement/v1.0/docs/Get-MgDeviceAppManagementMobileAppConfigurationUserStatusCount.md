...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappconfigurationuserstatuscount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementMobileAppConfigurationUserStatusCount -ManagedDeviceMobileAppConfigurationId <String>

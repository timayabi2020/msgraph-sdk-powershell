...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappaswindowsuniversalappxassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsWindowsUniversalAppXAssignment -MobileAppAssignmentId <String>

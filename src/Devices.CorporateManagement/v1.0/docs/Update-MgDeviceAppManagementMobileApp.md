...
Update-MgDeviceAppManagementMobileApp -MobileAppId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Publisher <String>] [-PublishingState <MobileAppPublishingState>] [-CustomHeader <String>] [-Confirm]
...
Update-MgDeviceAppManagementMobileApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileApp> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgDeviceAppManagementMobileApp -InputObject <IDevicesCorporateManagementIdentity>
 ...
 [-PublishingState <MobileAppPublishingState>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

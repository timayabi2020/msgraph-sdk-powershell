...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasmanagedioslobappassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsManagediOSLobAppAssignment -MobileAppAssignmentId <String>

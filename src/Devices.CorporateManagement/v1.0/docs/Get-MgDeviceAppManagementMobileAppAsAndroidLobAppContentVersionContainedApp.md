...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappasandroidlobappcontentversioncontainedapp
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppAsAndroidLobAppContentVersionContainedApp -MobileAppContentId <String>

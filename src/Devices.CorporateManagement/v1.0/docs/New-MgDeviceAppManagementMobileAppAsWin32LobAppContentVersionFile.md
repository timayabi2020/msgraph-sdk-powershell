...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappaswin32lobappcontentversionfile
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsWin32LobAppContentVersionFile -MobileAppContentId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedebookuserstatesummarydevicestate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementManagedEBookUserStateSummaryDeviceState -ManagedEBookId <String>
...
### Get
```
Get-MgDeviceAppManagementManagedEBookUserStateSummaryDeviceState -DeviceInstallStateId <String>

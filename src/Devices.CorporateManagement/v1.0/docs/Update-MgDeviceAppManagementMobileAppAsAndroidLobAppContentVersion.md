...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasandroidlobappcontentversion
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsAndroidLobAppContentVersion -MobileAppContentId <String>

...
### List (Default)
```
Get-MgDeviceAppManagementManagedAppPolicy [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDeviceAppManagementManagedAppPolicy -ManagedAppPolicyId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceAppManagementManagedAppPolicy -InputObject <IDevicesCorporateManagementIdentity>

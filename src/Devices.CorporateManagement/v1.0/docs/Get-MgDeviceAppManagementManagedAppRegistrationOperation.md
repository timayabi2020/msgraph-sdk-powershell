...
### List (Default)
```
Get-MgDeviceAppManagementManagedAppRegistrationOperation -ManagedAppRegistrationId <String>
...
### Get
```
Get-MgDeviceAppManagementManagedAppRegistrationOperation -ManagedAppOperationId <String>
...
### GetViaIdentity
```
Get-MgDeviceAppManagementManagedAppRegistrationOperation -InputObject <IDevicesCorporateManagementIdentity>

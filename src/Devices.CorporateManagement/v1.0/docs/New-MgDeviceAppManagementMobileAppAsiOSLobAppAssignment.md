...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappasioslobappassignment
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsiOSLobAppAssignment -MobileAppId <String>
...
### CreateViaIdentity
```
New-MgDeviceAppManagementMobileAppAsiOSLobAppAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

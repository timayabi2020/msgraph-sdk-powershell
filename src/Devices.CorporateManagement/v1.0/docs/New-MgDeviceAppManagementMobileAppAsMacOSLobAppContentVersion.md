...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappasmacoslobappcontentversion
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsMacOSLobAppContentVersion -MobileAppId <String>

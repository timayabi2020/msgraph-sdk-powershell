...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasmicrosoftstoreforbusinessappassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppAssignment -MobileAppAssignmentId <String>
...
Update-MgDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppAssignment
 ...
 [-Intent <InstallIntent>] [-Settings <Hashtable>] [-Target <Hashtable>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

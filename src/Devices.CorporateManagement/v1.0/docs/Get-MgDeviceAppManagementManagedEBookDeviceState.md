...
### List (Default)
```
Get-MgDeviceAppManagementManagedEBookDeviceState -ManagedEBookId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDeviceAppManagementManagedEBookDeviceState -InputObject <IDevicesCorporateManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

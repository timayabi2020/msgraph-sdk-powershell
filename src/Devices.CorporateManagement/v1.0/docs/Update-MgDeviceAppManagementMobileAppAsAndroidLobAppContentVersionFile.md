...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasandroidlobappcontentversionfile
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsAndroidLobAppContentVersionFile -MobileAppContentFileId <String>

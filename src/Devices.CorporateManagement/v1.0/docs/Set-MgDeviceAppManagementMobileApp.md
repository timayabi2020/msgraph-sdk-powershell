...
```
Set-MgDeviceAppManagementMobileApp -MobileAppId <String> [-AdditionalProperties <Hashtable>]
 [-MobileAppAssignments <IMicrosoftGraphMobileAppAssignment[]>] [-CustomHeader <String>] [-PassThru]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths12NzrcrDeviceappmanagementMobileappsMobileappIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema

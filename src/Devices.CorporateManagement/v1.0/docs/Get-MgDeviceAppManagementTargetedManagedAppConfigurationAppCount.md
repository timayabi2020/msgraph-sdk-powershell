...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementtargetedmanagedappconfigurationappcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementTargetedManagedAppConfigurationAppCount -TargetedManagedAppConfigurationId <String>

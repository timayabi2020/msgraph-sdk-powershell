...
```
New-MgDeviceAppManagementManagedEBook [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgDeviceAppManagementManagedEBook -BodyParameter <IMicrosoftGraphManagedEBook> [-CustomHeader <String>]

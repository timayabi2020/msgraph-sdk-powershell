...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasmanagedmobilelobappcontentversion
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsManagedMobileLobAppContentVersion -MobileAppContentId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappaswin32lobappcontentversioncontainedapp
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppAsWin32LobAppContentVersionContainedApp -MobileAppContentId <String>

...
Update-MgDeviceAppManagementManagedEBook -ManagedEBookId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UserStateSummary <IMicrosoftGraphUserInstallStateSummary[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceAppManagementManagedEBook -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedEBook> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceAppManagementManagedEBook -InputObject <IDevicesCorporateManagementIdentity>
 ...
 [-Publisher <String>] [-UserStateSummary <IMicrosoftGraphUserInstallStateSummary[]>] [-CustomHeader <String>]

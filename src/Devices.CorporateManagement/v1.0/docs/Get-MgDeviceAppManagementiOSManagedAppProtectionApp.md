...
### List (Default)
```
Get-MgDeviceAppManagementiOSManagedAppProtectionApp -IosManagedAppProtectionId <String>
...
### GetViaIdentity
```
Get-MgDeviceAppManagementiOSManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>

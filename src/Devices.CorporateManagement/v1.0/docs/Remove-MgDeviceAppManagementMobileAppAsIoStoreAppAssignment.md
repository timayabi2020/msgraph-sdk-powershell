...
### Delete (Default)
```
Remove-MgDeviceAppManagementMobileAppAsIoStoreAppAssignment -MobileAppAssignmentId <String>
...
### DeleteViaIdentity
```
Remove-MgDeviceAppManagementMobileAppAsIoStoreAppAssignment -InputObject <IDevicesCorporateManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappasmacosdmgappcontentversioncontainedapp
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppAsMacOSDmgAppContentVersionContainedApp -MobileAppContentId <String>

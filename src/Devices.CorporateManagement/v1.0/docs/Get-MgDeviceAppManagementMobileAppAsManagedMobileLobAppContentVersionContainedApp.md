...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappasmanagedmobilelobappcontentversioncontainedapp
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppAsManagedMobileLobAppContentVersionContainedApp -MobileAppContentId <String>

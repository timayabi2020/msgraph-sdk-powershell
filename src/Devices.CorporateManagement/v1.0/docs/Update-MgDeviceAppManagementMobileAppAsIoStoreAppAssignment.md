...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasiostoreappassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsIoStoreAppAssignment -MobileAppAssignmentId <String>
 -MobileAppId <String> [-AdditionalProperties <Hashtable>] [-Id <String>] [-Intent <InstallIntent>]
 [-Settings <Hashtable>] [-Target <Hashtable>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgDeviceAppManagementMobileAppAsIoStoreAppAssignment -MobileAppAssignmentId <String>
 -MobileAppId <String> -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgDeviceAppManagementMobileAppAsIoStoreAppAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceAppManagementMobileAppAsIoStoreAppAssignment -InputObject <IDevicesCorporateManagementIdentity>
 ...
 [-Target <Hashtable>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

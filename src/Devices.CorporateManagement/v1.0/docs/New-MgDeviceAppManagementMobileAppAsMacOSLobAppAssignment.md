...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappasmacoslobappassignment
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsMacOSLobAppAssignment -MobileAppId <String>
...
### CreateViaIdentity
```
New-MgDeviceAppManagementMobileAppAsMacOSLobAppAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

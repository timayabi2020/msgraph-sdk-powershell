...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappaswindowsuniversalappxcontentversion
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsWindowsUniversalAppXContentVersion -MobileAppContentId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappasmanagedandroidlobappcontentversionfile
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsManagedAndroidLobAppContentVersionFile -MobileAppContentId <String>
 ...
 [-UploadState <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgDeviceAppManagementMobileAppAsManagedAndroidLobAppContentVersionFile -MobileAppContentId <String>
 -MobileAppId <String> -BodyParameter <IMicrosoftGraphMobileAppContentFile> [-CustomHeader <String>]
...
New-MgDeviceAppManagementMobileAppAsManagedAndroidLobAppContentVersionFile
 ...
 [-SizeEncrypted <Int64>] [-UploadState <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

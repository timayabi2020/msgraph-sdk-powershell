...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedappregistrationappliedpolicycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementManagedAppRegistrationAppliedPolicyCount -ManagedAppRegistrationId <String>

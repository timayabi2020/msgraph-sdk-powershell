...
### Delete (Default)
```
Remove-MgUserManagedDeviceCompliancePolicyState -DeviceCompliancePolicyStateId <String>
...
### DeleteViaIdentity
```
Remove-MgUserManagedDeviceCompliancePolicyState -InputObject <IDevicesCorporateManagementIdentity>

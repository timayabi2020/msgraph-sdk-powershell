...
### Delete (Default)
```
Remove-MgDeviceAppManagementManagedAppRegistrationOperation -ManagedAppOperationId <String>
...
### DeleteViaIdentity
```
Remove-MgDeviceAppManagementManagedAppRegistrationOperation -InputObject <IDevicesCorporateManagementIdentity>

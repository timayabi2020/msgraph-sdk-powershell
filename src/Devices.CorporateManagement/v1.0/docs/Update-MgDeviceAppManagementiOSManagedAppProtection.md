...
Update-MgDeviceAppManagementiOSManagedAppProtection -IosManagedAppProtectionId <String>
 ...
 [-PrintBlocked] [-SaveAsBlocked] [-SimplePinBlocked] [-Version <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgDeviceAppManagementiOSManagedAppProtection -IosManagedAppProtectionId <String>
 -BodyParameter <IMicrosoftGraphIosManagedAppProtection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

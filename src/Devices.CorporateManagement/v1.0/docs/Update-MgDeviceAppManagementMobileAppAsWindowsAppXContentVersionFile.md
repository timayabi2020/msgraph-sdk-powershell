...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappaswindowsappxcontentversionfile
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsWindowsAppXContentVersionFile -MobileAppContentFileId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasmacoslobappassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsMacOSLobAppAssignment -MobileAppAssignmentId <String>

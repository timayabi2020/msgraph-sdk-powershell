...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappaswindowsappxcontentversion
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsWindowsAppXContentVersion -MobileAppContentId <String>

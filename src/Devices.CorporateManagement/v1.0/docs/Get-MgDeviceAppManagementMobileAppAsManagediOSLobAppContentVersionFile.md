...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppAsManagediOSLobAppContentVersionFile -MobileAppContentId <String>
...
### Get
```
Get-MgDeviceAppManagementMobileAppAsManagediOSLobAppContentVersionFile -MobileAppContentFileId <String>

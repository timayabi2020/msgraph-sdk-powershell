...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappconfigurationdevicestatus
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppConfigurationDeviceStatus -ManagedDeviceMobileAppConfigurationId <String>
...
### GetViaIdentity
```
Get-MgDeviceAppManagementMobileAppConfigurationDeviceStatus -InputObject <IDevicesCorporateManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

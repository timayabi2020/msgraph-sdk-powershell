...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmobileappasioslobappcontentversioncontainedapp
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceAppManagementMobileAppAsiOSLobAppContentVersionContainedApp -MobileAppContentId <String>

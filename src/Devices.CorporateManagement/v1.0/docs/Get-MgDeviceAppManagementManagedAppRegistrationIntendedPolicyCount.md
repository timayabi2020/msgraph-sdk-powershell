...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedappregistrationintendedpolicycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceAppManagementManagedAppRegistrationIntendedPolicyCount -ManagedAppRegistrationId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementtargetedmanagedappconfigurationapp
schema: 2.0.0
---
...
### CreateViaIdentity
```
New-MgDeviceAppManagementTargetedManagedAppConfigurationApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappasandroidstoreappassignment
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsAndroidStoreAppAssignment -MobileAppId <String>

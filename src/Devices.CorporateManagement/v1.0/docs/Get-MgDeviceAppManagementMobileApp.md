...
### List (Default)
```
Get-MgDeviceAppManagementMobileApp [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgDeviceAppManagementMobileApp -MobileAppId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceAppManagementMobileApp -InputObject <IDevicesCorporateManagementIdentity>

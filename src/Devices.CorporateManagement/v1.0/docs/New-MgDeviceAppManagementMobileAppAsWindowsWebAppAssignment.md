...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmanagementmobileappaswindowswebappassignment
schema: 2.0.0
---
...
```
New-MgDeviceAppManagementMobileAppAsWindowsWebAppAssignment -MobileAppId <String>
...
### CreateViaIdentity
```
New-MgDeviceAppManagementMobileAppAsWindowsWebAppAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

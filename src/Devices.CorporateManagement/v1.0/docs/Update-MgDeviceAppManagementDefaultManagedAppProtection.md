...
Update-MgDeviceAppManagementDefaultManagedAppProtection -DefaultManagedAppProtectionId <String>
 ...
 [-ScreenCaptureBlocked] [-SimplePinBlocked] [-Version <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgDeviceAppManagementDefaultManagedAppProtection -DefaultManagedAppProtectionId <String>
 -BodyParameter <IMicrosoftGraphDefaultManagedAppProtection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

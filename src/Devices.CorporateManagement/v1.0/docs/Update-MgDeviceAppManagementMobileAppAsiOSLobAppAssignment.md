...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmanagementmobileappasioslobappassignment
schema: 2.0.0
---
...
```
Update-MgDeviceAppManagementMobileAppAsiOSLobAppAssignment -MobileAppAssignmentId <String>
...
### UpdateViaIdentity
```
Update-MgDeviceAppManagementMobileAppAsiOSLobAppAssignment -InputObject <IDevicesCorporateManagementIdentity>

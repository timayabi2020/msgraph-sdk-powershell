...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappasmanagedioslobappassignment
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsManagediOSLobAppAssignment -MobileAppAssignmentId <String>

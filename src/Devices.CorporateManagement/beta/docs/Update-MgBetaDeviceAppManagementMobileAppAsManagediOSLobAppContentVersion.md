...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappasmanagedioslobappcontentversion
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsManagediOSLobAppContentVersion -MobileAppContentId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappaswindowsuniversalappxassignment
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsWindowsUniversalAppXAssignment -MobileAppAssignmentId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementtargetedmanagedappconfigurationapp
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementTargetedManagedAppConfigurationApp -ManagedMobileAppId <String>

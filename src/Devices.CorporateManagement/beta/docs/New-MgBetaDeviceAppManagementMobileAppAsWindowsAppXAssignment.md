...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappaswindowsappxassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsWindowsAppXAssignment -MobileAppId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetausermobileapptroubleshootingeventapplogcollectionrequest
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserMobileAppTroubleshootingEventAppLogCollectionRequest -MobileAppTroubleshootingEventId <String>
...
### Get
```
Get-MgBetaUserMobileAppTroubleshootingEventAppLogCollectionRequest -AppLogCollectionRequestId <String>
 -MobileAppTroubleshootingEventId <String> -UserId <String> [-ExpandProperty <String[]>]

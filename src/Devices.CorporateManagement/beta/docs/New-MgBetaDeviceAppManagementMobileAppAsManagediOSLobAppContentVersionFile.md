...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappasmanagedioslobappcontentversionfile
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsManagediOSLobAppContentVersionFile -MobileAppContentId <String>

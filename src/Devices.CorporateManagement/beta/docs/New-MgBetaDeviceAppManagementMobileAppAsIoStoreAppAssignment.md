...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappasiostoreappassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsIoStoreAppAssignment -MobileAppId <String>

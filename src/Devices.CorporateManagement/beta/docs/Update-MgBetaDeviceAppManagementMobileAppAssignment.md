...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappassignment
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAssignment -MobileAppAssignmentId <String> -MobileAppId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceAppManagementMobileAppAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

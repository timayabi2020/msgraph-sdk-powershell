...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappasmacosdmgappassignment
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsMacOSDmgAppAssignment -MobileAppAssignmentId <String>

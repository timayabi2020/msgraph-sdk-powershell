...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappasiovppappassignment
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsIoVppAppAssignment -MobileAppAssignmentId <String>

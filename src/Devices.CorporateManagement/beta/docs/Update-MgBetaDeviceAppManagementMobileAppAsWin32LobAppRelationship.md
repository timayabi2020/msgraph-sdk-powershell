...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappaswin32lobapprelationship
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsWin32LobAppRelationship -MobileAppId <String>

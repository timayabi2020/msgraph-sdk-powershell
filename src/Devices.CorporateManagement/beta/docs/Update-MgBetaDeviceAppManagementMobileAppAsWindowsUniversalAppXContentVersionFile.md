...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappaswindowsuniversalappxcontentversionfile
schema: 2.0.0
---
...
Update-MgBetaDeviceAppManagementMobileAppAsWindowsUniversalAppXContentVersionFile
 -MobileAppContentFileId <String> -MobileAppContentId <String> -MobileAppId <String>
 -BodyParameter <IMicrosoftGraphMobileAppContentFile> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

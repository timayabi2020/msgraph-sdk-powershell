...
Update-MgBetaDeviceAppManagementTask -DeviceAppManagementTaskId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Status <DeviceAppManagementTaskStatus>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaDeviceAppManagementTask -DeviceAppManagementTaskId <String>
 -BodyParameter <IMicrosoftGraphDeviceAppManagementTask> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

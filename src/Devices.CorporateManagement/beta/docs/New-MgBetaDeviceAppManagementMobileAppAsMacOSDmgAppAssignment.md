...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappasmacosdmgappassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsMacOSDmgAppAssignment -MobileAppId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementwindowsinformationprotectionpolicyassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementWindowsInformationProtectionPolicyAssignment
 -WindowsInformationProtectionPolicyId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]

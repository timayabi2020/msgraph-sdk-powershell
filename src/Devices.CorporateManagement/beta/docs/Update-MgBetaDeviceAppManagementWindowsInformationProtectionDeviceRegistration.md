...
Update-MgBetaDeviceAppManagementWindowsInformationProtectionDeviceRegistration
 ...
 [-Id <String>] [-LastCheckInDateTime <DateTime>] [-UserId <String>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaDeviceAppManagementWindowsInformationProtectionDeviceRegistration
 ...
 -BodyParameter <IMicrosoftGraphWindowsInformationProtectionDeviceRegistration> [-CustomHeader <String>]

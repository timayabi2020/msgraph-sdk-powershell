...
```
Update-MgBetaDeviceAppManagementWindowsInformationProtectionPolicy
 -WindowsInformationProtectionPolicyId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Version <String>] [-WindowsHelloForBusinessBlocked] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceAppManagementWindowsInformationProtectionPolicy
 ...
 -BodyParameter <IMicrosoftGraphWindowsInformationProtectionPolicy> [-CustomHeader <String>] [-Confirm]

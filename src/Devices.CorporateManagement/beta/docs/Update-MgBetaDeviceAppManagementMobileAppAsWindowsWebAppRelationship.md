...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappaswindowswebapprelationship
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsWindowsWebAppRelationship -MobileAppId <String>

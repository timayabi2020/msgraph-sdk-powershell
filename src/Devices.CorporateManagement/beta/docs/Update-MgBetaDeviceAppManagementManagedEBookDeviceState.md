...
Update-MgBetaDeviceAppManagementManagedEBookDeviceState -DeviceInstallStateId <String>
 ...
 [-OSDescription <String>] [-OSVersion <String>] [-UserName <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaDeviceAppManagementManagedEBookDeviceState -DeviceInstallStateId <String>
 -ManagedEBookId <String> -BodyParameter <IMicrosoftGraphDeviceInstallState> [-CustomHeader <String>]

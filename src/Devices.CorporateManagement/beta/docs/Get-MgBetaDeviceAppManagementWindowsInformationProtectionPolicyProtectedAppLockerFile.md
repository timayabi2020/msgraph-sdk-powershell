...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetadeviceappmanagementwindowsinformationprotectionpolicyprotectedapplockerfile
schema: 2.0.0
---
...
```
Get-MgBetaDeviceAppManagementWindowsInformationProtectionPolicyProtectedAppLockerFile
 -WindowsInformationProtectionPolicyId <String> [-ExpandProperty <String[]>] [-Filter <String>]

...
### Delete (Default)
```
Remove-MgBetaUserManagedDeviceCategory -ManagedDeviceId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserManagedDeviceCategory -InputObject <IDevicesCorporateManagementIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

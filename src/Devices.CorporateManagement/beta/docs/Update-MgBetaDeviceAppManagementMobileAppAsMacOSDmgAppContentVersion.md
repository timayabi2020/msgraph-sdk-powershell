...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappasmacosdmgappcontentversion
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsMacOSDmgAppContentVersion -MobileAppContentId <String>

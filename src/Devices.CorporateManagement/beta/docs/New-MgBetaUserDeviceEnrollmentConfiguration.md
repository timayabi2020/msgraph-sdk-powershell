...
```
New-MgBetaUserDeviceEnrollmentConfiguration -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-RoleScopeTagIds <String[]>] [-Version <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaUserDeviceEnrollmentConfiguration -UserId <String>
 -BodyParameter <IMicrosoftGraphDeviceEnrollmentConfiguration> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaUserDeviceEnrollmentConfiguration -InputObject <IDevicesCorporateManagementIdentity>
 ...
 [-Version <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

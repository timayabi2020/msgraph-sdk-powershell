...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappasmicrosoftstoreforbusinessapprelationship
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppRelationship -MobileAppId <String>
 ...
 [-TargetType <MobileAppRelationshipType>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppRelationship -MobileAppId <String>
 -BodyParameter <IMicrosoftGraphMobileAppRelationship> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaDeviceAppManagementMobileAppAsMicrosoftStoreForBusinessAppRelationship
 ...
 [-TargetPublisher <String>] [-TargetType <MobileAppRelationshipType>] [-CustomHeader <String>] [-Confirm]

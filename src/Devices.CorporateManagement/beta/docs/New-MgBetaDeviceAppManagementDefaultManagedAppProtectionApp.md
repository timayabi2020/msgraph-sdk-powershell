...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementdefaultmanagedappprotectionapp
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementDefaultManagedAppProtectionApp -DefaultManagedAppProtectionId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceAppManagementDefaultManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
New-MgBetaDeviceAppManagementTargetedManagedAppConfiguration [-AdditionalProperties <Hashtable>]
 ...
 [-TargetedAppManagementLevels <AppManagementLevel>] [-Version <String>] [-CustomHeader <String>] [-Confirm]
...
```
New-MgBetaDeviceAppManagementTargetedManagedAppConfiguration
 -BodyParameter <IMicrosoftGraphTargetedManagedAppConfiguration> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

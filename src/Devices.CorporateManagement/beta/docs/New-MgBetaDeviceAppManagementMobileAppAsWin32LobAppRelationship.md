...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappaswin32lobapprelationship
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsWin32LobAppRelationship -MobileAppId <String>

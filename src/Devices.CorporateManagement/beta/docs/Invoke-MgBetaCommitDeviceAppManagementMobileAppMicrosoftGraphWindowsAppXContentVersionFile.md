...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/invoke-mgbetacommitdeviceappmanagementmobileappmicrosoftgraphwindowsappxcontentversionfile
schema: 2.0.0
---
...
Invoke-MgBetaCommitDeviceAppManagementMobileAppMicrosoftGraphWindowsAppXContentVersionFile
 -MobileAppContentFileId <String> -MobileAppContentId <String> -MobileAppId <String>
 -BodyParameter <IPathsTmbu8ODeviceappmanagementMobileappsMobileappIdMicrosoftGraphWindowsappxContentversionsMobileappcontentIdFilesMobileappcontentfileIdMicrosoftGraphCommitPostRequestbodyContentApplicationJsonSchema>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsTmbu8ODeviceappmanagementMobileappsMobileappIdMicrosoftGraphWindowsappxContentversionsMobileappcontentIdFilesMobileappcontentfileIdMicrosoftGraphCommitPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsTmbu8ODeviceappmanagementMobileappsMobileappIdMicrosoftGraphWindowsappxContentversionsMobileappcontentIdFilesMobileappcontentfileIdMicrosoftGraphCommitPostRequestbodyContentApplicationJsonSchema

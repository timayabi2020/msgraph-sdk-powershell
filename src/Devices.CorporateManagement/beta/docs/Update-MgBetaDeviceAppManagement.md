...
Update-MgBetaDeviceAppManagement [-AdditionalProperties <Hashtable>]
 ...
 [-WindowsManagementApp <IMicrosoftGraphWindowsManagementApp>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaDeviceAppManagement -BodyParameter <IMicrosoftGraphDeviceAppManagement> [-CustomHeader <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappasiovppappassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsIoVppAppAssignment -MobileAppId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceAppManagementMobileAppAsIoVppAppAssignment -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphMobileAppAssignment> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappasandroidlobapprelationship
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsAndroidLobAppRelationship -MobileAppId <String>

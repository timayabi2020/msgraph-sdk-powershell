...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappasmanagedandroidlobappcontentversionfile
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsManagedAndroidLobAppContentVersionFile -MobileAppContentId <String>
...
New-MgBetaDeviceAppManagementMobileAppAsManagedAndroidLobAppContentVersionFile
 ...
 [-SizeInBytes <Int64>] [-UploadState <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

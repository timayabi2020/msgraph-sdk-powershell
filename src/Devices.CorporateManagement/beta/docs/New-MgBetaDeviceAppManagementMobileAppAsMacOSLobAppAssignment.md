...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappasmacoslobappassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsMacOSLobAppAssignment -MobileAppId <String>

...
### List (Default)
```
Get-MgBetaDeviceAppManagementManagedAppRegistrationAppliedPolicy -ManagedAppRegistrationId <String>
...
### Get
```
Get-MgBetaDeviceAppManagementManagedAppRegistrationAppliedPolicy -ManagedAppPolicyId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappaswindowsmobilemsirelationship
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsWindowsMobileMsiRelationship -MobileAppId <String>

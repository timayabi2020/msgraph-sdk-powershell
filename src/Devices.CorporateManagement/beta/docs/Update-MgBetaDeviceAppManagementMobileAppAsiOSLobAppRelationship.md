...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappasioslobapprelationship
schema: 2.0.0
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsiOSLobAppRelationship -MobileAppId <String>

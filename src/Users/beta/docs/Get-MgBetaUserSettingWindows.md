...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausersettingwindows
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserSettingWindows -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaUserSettingWindows -UserId <String> -WindowsSettingId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserSettingWindows -InputObject <IUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

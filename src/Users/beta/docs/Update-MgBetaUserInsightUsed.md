...
Update-MgBetaUserInsightUsed -UsedInsightId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-ResourceVisualization <IMicrosoftGraphResourceVisualization>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserInsightUsed -UsedInsightId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphUsedInsight> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauseroutlooktaskfoldertaskcount
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaUserOutlookTaskFolderTaskCount -InputObject <IUsersIdentity> [-Filter <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

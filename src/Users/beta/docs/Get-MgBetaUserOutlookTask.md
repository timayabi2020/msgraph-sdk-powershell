...
### List (Default)
```
Get-MgBetaUserOutlookTask -UserId <String> [-Filter <String>] [-Property <String[]>] [-Skip <Int32>]
...
### GetViaIdentity
```
Get-MgBetaUserOutlookTask -InputObject <IUsersIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

...
Update-MgBetaUserTodoListTaskLinkedResource -LinkedResourceId <String> -TodoTaskId <String>
 ...
 [-DisplayName <String>] [-ExternalId <String>] [-Id <String>] [-WebUrl <String>] [-CustomHeader <String>]
...
Update-MgBetaUserTodoListTaskLinkedResource -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphLinkedResource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

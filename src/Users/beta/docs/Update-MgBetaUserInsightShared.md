...
Update-MgBetaUserInsightShared -SharedInsightId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-SharingHistory <IMicrosoftGraphSharingDetail[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserInsightShared -SharedInsightId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphSharedInsight> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
Update-MgBetaUserTodoListTaskAttachmentSession -AttachmentSessionId <String> -TodoTaskId <String>
 ...
 [-ExpirationDateTime <DateTime>] [-Id <String>] [-NextExpectedRanges <String[]>] [-CustomHeader <String>]
...
Update-MgBetaUserTodoListTaskAttachmentSession -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphAttachmentSession> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserTodoListTaskAttachmentSession -InputObject <IUsersIdentity>
 ...
 [-Id <String>] [-NextExpectedRanges <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

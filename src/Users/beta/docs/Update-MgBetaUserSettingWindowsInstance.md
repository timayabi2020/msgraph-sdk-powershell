...
Update-MgBetaUserSettingWindowsInstance -UserId <String> -WindowsSettingId <String>
 -WindowsSettingInstanceId <String> [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 [-ExpirationDateTime <DateTime>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-Payload <String>]
...
```
Update-MgBetaUserSettingWindowsInstance -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>]

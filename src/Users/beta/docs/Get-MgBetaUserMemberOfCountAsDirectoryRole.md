...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausermemberofcountasdirectoryrole
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaUserMemberOfCountAsDirectoryRole -UserId <String> -ConsistencyLevel <String> [-Filter <String>]

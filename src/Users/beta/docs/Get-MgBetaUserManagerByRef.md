...
### Get (Default)
```
Get-MgBetaUserManagerByRef -UserId <String> [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserManagerByRef -InputObject <IUsersIdentity> [-CustomHeader <String>] [<CommonParameters>]
```

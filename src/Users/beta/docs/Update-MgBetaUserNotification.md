...
Update-MgBetaUserNotification -NotificationId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-TargetPolicy <IMicrosoftGraphTargetPolicyEndpoints>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaUserNotification -NotificationId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphNotification> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

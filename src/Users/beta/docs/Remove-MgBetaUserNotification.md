...
### Delete (Default)
```
Remove-MgBetaUserNotification -NotificationId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserNotification -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>]

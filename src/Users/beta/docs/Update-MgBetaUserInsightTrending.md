...
Update-MgBetaUserInsightTrending -TrendingId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-ResourceVisualization <IMicrosoftGraphResourceVisualization>] [-Weight <Double>] [-CustomHeader <String>]
...
Update-MgBetaUserInsightTrending -TrendingId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphTrending> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

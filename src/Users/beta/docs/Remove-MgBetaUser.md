...
### Delete (Default)
```
Remove-MgBetaUser -UserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUser -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

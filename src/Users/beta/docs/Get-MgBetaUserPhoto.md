...
### Get (Default)
```
Get-MgBetaUserPhoto -UserId <String> [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaUserPhoto -ProfilePhotoId <String> -UserId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserPhoto -InputObject <IUsersIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

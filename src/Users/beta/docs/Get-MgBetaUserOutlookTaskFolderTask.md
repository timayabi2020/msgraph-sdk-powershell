...
### List (Default)
```
Get-MgBetaUserOutlookTaskFolderTask -OutlookTaskFolderId <String> -UserId <String> [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaUserOutlookTaskFolderTask -InputObject <IUsersIdentity> [-Property <String[]>]

...
### Delete (Default)
```
Remove-MgBetaUserSponsor -DirectoryObjectId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserSponsor -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>]

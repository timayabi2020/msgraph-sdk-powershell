...
### List (Default)
```
Get-MgBetaUserAppRoleAssignedResource -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaUserAppRoleAssignedResource -ServicePrincipalId <String> -UserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserAppRoleAssignedResource -InputObject <IUsersIdentity> [-ExpandProperty <String[]>]

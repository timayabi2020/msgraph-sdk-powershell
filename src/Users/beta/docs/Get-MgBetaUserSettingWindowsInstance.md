...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausersettingwindowsinstance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserSettingWindowsInstance -UserId <String> -WindowsSettingId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaUserSettingWindowsInstance -UserId <String> -WindowsSettingId <String>
 -WindowsSettingInstanceId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserSettingWindowsInstance -InputObject <IUsersIdentity> [-ExpandProperty <String[]>]

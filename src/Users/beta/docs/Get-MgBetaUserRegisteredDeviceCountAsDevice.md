...
### Get (Default)
```
Get-MgBetaUserRegisteredDeviceCountAsDevice -UserId <String> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserRegisteredDeviceCountAsDevice -InputObject <IUsersIdentity> -ConsistencyLevel <String>

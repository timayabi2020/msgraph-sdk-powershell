...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetausersettingwindowsinstance
schema: 2.0.0
---
...
```
New-MgBetaUserSettingWindowsInstance -UserId <String> -WindowsSettingId <String>
...
### CreateViaIdentity
```
New-MgBetaUserSettingWindowsInstance -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphWindowsSettingInstance> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
New-MgBetaUserSettingWindowsInstance -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>]

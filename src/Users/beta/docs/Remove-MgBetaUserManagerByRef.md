...
### Delete (Default)
```
Remove-MgBetaUserManagerByRef -UserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserManagerByRef -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
New-MgBetaUserTodoList -UserId <String> [-AdditionalProperties <Hashtable>] [-DisplayName <String>]
 ...
 [-Tasks <IMicrosoftGraphTodoTask[]>] [-WellknownListName <String>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaUserTodoList -UserId <String> -BodyParameter <IMicrosoftGraphTodoTaskList> [-CustomHeader <String>]

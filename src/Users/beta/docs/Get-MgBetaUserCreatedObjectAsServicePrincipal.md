...
### List (Default)
```
Get-MgBetaUserCreatedObjectAsServicePrincipal -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaUserCreatedObjectAsServicePrincipal -DirectoryObjectId <String> -UserId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserCreatedObjectAsServicePrincipal -InputObject <IUsersIdentity> [-ExpandProperty <String[]>]

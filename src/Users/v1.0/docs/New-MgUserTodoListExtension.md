...
### Create
```
New-MgUserTodoListExtension -TodoTaskListId <String> -UserId <String> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserTodoListExtension -InputObject <IUsersIdentity> -BodyParameter <Hashtable> [-CustomHeader <String>]

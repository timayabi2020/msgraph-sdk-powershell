...
### Delete (Default)
```
Remove-MgUserOutlookMasterCategory -OutlookCategoryId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserOutlookMasterCategory -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>]

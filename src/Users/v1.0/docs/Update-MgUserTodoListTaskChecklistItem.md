...
Update-MgUserTodoListTaskChecklistItem -ChecklistItemId <String> -TodoTaskId <String> -TodoTaskListId <String>
 ...
 [-CreatedDateTime <DateTime>] [-DisplayName <String>] [-Id <String>] [-IsChecked] [-CustomHeader <String>]
...
```
Update-MgUserTodoListTaskChecklistItem -ChecklistItemId <String> -TodoTaskId <String> -TodoTaskListId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphChecklistItem> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgUserTodoListTaskChecklistItem -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphChecklistItem> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgUserTodoListTaskChecklistItem -InputObject <IUsersIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-IsChecked] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

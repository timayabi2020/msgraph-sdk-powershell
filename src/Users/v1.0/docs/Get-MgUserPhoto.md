...
### Get (Default)
```
Get-MgUserPhoto -UserId <String> [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgUserPhoto -ProfilePhotoId <String> -UserId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserPhoto -InputObject <IUsersIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

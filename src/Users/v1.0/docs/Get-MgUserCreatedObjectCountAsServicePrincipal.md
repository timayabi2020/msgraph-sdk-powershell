...
### Get (Default)
```
Get-MgUserCreatedObjectCountAsServicePrincipal -UserId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserCreatedObjectCountAsServicePrincipal -InputObject <IUsersIdentity> [-Filter <String>]

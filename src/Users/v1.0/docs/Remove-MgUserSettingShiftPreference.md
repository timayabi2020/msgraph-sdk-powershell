...
### Delete (Default)
```
Remove-MgUserSettingShiftPreference -UserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserSettingShiftPreference -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>]

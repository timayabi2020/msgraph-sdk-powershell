...
### Delete (Default)
```
Remove-MgUser -UserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUser -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

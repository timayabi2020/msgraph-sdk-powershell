...
### Get (Default)
```
Get-MgUserOwnedDeviceCount -UserId <String> -ConsistencyLevel <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOwnedDeviceCount -InputObject <IUsersIdentity> -ConsistencyLevel <String> [-Filter <String>]

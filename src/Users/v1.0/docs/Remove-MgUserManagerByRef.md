...
### Delete (Default)
```
Remove-MgUserManagerByRef -UserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserManagerByRef -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>]

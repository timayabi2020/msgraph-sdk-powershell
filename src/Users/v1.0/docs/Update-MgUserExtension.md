...
### Update
```
Update-MgUserExtension -ExtensionId <String> -UserId <String> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgUserExtension -InputObject <IUsersIdentity> -BodyParameter <Hashtable> [-CustomHeader <String>]

...
Update-MgUserSetting -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-ShiftPreferences <IMicrosoftGraphShiftPreferences>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgUserSetting -UserId <String> -BodyParameter <IMicrosoftGraphUserSettings> [-CustomHeader <String>]

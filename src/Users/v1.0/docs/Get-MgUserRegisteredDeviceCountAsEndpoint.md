...
### Get (Default)
```
Get-MgUserRegisteredDeviceCountAsEndpoint -UserId <String> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserRegisteredDeviceCountAsEndpoint -InputObject <IUsersIdentity> -ConsistencyLevel <String>

...
### Get (Default)
```
Get-MgUserOwnedDeviceCountAsEndpoint -UserId <String> -ConsistencyLevel <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOwnedDeviceCountAsEndpoint -InputObject <IUsersIdentity> -ConsistencyLevel <String>

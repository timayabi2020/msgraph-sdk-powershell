...
### Delete (Default)
```
Remove-MgUserTodoList -TodoTaskListId <String> -UserId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserTodoList -InputObject <IUsersIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

...
Set-MgUserManagerByRef -UserId <String> -OdataId <String> [-AdditionalProperties <Hashtable>]
 [-OdataType <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-MgUserManagerByRef -UserId <String> -BodyParameter <IReferenceUpdate> [-CustomHeader <String>] [-PassThru]

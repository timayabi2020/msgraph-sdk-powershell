...
### Get (Default)
```
Get-MgUserManagerByRef -UserId <String> [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserManagerByRef -InputObject <IUsersIdentity> [-CustomHeader <String>] [<CommonParameters>]
```

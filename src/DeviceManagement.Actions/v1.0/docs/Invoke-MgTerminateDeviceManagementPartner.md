...
### Terminate (Default)
```
Invoke-MgTerminateDeviceManagementPartner -DeviceManagementPartnerId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TerminateViaIdentity
```
Invoke-MgTerminateDeviceManagementPartner -InputObject <IDeviceManagementActionsIdentity>

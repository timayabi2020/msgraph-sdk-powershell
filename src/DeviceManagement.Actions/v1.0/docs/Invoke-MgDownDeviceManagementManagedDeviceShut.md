...
### Down (Default)
```
Invoke-MgDownDeviceManagementManagedDeviceShut -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DownViaIdentity
```
Invoke-MgDownDeviceManagementManagedDeviceShut -InputObject <IDeviceManagementActionsIdentity>

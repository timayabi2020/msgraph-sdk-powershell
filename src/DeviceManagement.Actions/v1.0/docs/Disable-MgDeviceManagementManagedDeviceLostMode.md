...
### Disable (Default)
```
Disable-MgDeviceManagementManagedDeviceLostMode -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgDeviceManagementManagedDeviceLostMode -InputObject <IDeviceManagementActionsIdentity>

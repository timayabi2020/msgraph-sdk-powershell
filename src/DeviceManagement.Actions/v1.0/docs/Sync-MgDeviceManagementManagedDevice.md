...
### Sync (Default)
```
Sync-MgDeviceManagementManagedDevice -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-CustomHeader <String>]

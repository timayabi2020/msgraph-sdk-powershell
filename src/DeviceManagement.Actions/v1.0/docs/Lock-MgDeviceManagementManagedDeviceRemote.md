...
### Lock (Default)
```
Lock-MgDeviceManagementManagedDeviceRemote -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LockViaIdentity
```
Lock-MgDeviceManagementManagedDeviceRemote -InputObject <IDeviceManagementActionsIdentity>

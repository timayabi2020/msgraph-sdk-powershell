...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/set-mgbetadevicemanagementwindowsdriverupdateprofile
schema: 2.0.0
---
...
```
Set-MgBetaDeviceManagementWindowsDriverUpdateProfile -WindowsDriverUpdateProfileId <String>
...
### AssignViaIdentity
```
Set-MgBetaDeviceManagementWindowsDriverUpdateProfile -InputObject <IDeviceManagementActionsIdentity>
 -BodyParameter <IPaths1F83Ez2DevicemanagementWindowsdriverupdateprofilesWindowsdriverupdateprofileIdMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

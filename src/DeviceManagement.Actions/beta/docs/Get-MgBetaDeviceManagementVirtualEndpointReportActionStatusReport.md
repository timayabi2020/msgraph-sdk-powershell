...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsXvswb4DevicemanagementVirtualendpointReportsMicrosoftGraphGetactionstatusreportsPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:

...
### Terminate (Default)
```
Invoke-MgBetaTerminateDeviceManagementPartner -DeviceManagementPartnerId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### TerminateViaIdentity
```
Invoke-MgBetaTerminateDeviceManagementPartner -InputObject <IDeviceManagementActionsIdentity>

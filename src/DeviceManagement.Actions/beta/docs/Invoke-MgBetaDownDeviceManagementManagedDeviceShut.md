...
### Down (Default)
```
Invoke-MgBetaDownDeviceManagementManagedDeviceShut -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DownViaIdentity
```
Invoke-MgBetaDownDeviceManagementManagedDeviceShut -InputObject <IDeviceManagementActionsIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetaretiredevicemanagementcomanageddevice
schema: 2.0.0
---
...
### Retire (Default)
```
Invoke-MgBetaRetireDeviceManagementComanagedDevice -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RetireViaIdentity
```
Invoke-MgBetaRetireDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity>

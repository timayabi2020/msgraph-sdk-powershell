...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/get-mgbetadevicemanagementelevationrequest
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementElevationRequest -PrivilegeManagementElevationRequestId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementElevationRequest -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

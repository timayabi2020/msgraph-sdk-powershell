...
Rename-MgBetaDeviceManagementVirtualEndpointCloudPcUserAccountType -CloudPcId <String>
 [-AdditionalProperties <Hashtable>] [-UserAccountType <String>] [-CustomHeader <String>] [-PassThru]
...
Rename-MgBetaDeviceManagementVirtualEndpointCloudPcUserAccountType
 ...
 [-UserAccountType <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetarotatedevicemanagementcomanageddevicebitlockerkey
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-MgBetaRotateDeviceManagementComanagedDeviceBitLockerKey -ManagedDeviceId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RotateViaIdentity
```
Invoke-MgBetaRotateDeviceManagementComanagedDeviceBitLockerKey -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

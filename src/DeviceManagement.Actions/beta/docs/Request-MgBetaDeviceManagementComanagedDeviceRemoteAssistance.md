...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/request-mgbetadevicemanagementcomanageddeviceremoteassistance
schema: 2.0.0
---
...
### Request (Default)
```
Request-MgBetaDeviceManagementComanagedDeviceRemoteAssistance -ManagedDeviceId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RequestViaIdentity
```
Request-MgBetaDeviceManagementComanagedDeviceRemoteAssistance -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

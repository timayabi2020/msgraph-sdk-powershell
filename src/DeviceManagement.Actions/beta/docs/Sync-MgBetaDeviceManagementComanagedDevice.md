...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/sync-mgbetadevicemanagementcomanageddevice
schema: 2.0.0
---
...
### Sync (Default)
```
Sync-MgBetaDeviceManagementComanagedDevice -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgBetaDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity>

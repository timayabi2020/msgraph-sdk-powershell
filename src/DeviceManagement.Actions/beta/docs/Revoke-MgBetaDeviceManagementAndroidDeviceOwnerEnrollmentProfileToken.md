...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/revoke-mgbetadevicemanagementandroiddeviceownerenrollmentprofiletoken
schema: 2.0.0
---
...
```
Revoke-MgBetaDeviceManagementAndroidDeviceOwnerEnrollmentProfileToken
 -AndroidDeviceOwnerEnrollmentProfileId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetagraphdevicemanagementdeponboardingsetting
schema: 2.0.0
---
...
### Graph (Default)
```
Invoke-MgBetaGraphDeviceManagementDepOnboardingSetting -DepOnboardingSettingId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GraphViaIdentity
```
Invoke-MgBetaGraphDeviceManagementDepOnboardingSetting -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

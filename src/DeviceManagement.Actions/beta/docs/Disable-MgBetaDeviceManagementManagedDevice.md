...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/disable-mgbetadevicemanagementmanageddevice
schema: 2.0.0
---
...
### Disable (Default)
```
Disable-MgBetaDeviceManagementManagedDevice -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgBetaDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity>

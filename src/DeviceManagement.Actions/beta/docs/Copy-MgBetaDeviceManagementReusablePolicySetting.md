...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/copy-mgbetadevicemanagementreusablepolicysetting
schema: 2.0.0
---
...
### Clone (Default)
```
Copy-MgBetaDeviceManagementReusablePolicySetting -DeviceManagementReusablePolicySettingId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CloneViaIdentity
```
Copy-MgBetaDeviceManagementReusablePolicySetting -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

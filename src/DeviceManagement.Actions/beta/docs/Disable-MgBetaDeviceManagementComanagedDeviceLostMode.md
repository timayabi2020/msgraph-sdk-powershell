...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/disable-mgbetadevicemanagementcomanageddevicelostmode
schema: 2.0.0
---
...
### Disable (Default)
```
Disable-MgBetaDeviceManagementComanagedDeviceLostMode -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgBetaDeviceManagementComanagedDeviceLostMode -InputObject <IDeviceManagementActionsIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/disable-mgbetadevicemanagementcomanageddevice
schema: 2.0.0
---
...
### Disable (Default)
```
Disable-MgBetaDeviceManagementComanagedDevice -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DisableViaIdentity
```
Disable-MgBetaDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity>

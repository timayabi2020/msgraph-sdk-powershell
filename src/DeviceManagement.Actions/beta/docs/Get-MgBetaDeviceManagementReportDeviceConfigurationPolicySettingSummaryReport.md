...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsRg67Q3DevicemanagementReportsMicrosoftGraphGetdeviceconfigurationpolicysettingssummaryreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:

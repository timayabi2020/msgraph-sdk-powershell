...
### Reboot (Default)
```
Restart-MgBetaDeviceManagementManagedDeviceNow -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RebootViaIdentity
```
Restart-MgBetaDeviceManagementManagedDeviceNow -InputObject <IDeviceManagementActionsIdentity>

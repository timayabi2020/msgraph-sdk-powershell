...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/revoke-mgbetadevicemanagementcomanageddeviceapplevpplicense
schema: 2.0.0
---
...
### Revoke (Default)
```
Revoke-MgBetaDeviceManagementComanagedDeviceAppleVppLicense -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RevokeViaIdentity
```
Revoke-MgBetaDeviceManagementComanagedDeviceAppleVppLicense -InputObject <IDeviceManagementActionsIdentity>

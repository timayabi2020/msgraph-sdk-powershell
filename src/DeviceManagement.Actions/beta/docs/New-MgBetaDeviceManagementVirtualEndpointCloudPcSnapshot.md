...
### Create (Default)
```
New-MgBetaDeviceManagementVirtualEndpointCloudPcSnapshot -CloudPcId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaDeviceManagementVirtualEndpointCloudPcSnapshot -InputObject <IDeviceManagementActionsIdentity>

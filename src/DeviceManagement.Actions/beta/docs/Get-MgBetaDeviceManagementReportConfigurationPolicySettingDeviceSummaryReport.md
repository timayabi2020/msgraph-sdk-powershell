...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths7Mtw3WDevicemanagementReportsMicrosoftGraphGetconfigurationpolicysettingsdevicesummaryreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:

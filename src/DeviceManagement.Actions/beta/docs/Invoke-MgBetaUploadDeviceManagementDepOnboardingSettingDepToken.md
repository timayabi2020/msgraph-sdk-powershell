...
Invoke-MgBetaUploadDeviceManagementDepOnboardingSettingDepToken -DepOnboardingSettingId <String>
 [-AdditionalProperties <Hashtable>] [-AppleId <String>] [-DepToken <String>] [-CustomHeader <String>]
...
Invoke-MgBetaUploadDeviceManagementDepOnboardingSettingDepToken
 ...
 [-DepToken <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

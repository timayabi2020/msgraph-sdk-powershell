...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetareenabledevicemanagementmanageddevice
schema: 2.0.0
---
...
### Reenable (Default)
```
Invoke-MgBetaReenableDeviceManagementManagedDevice -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReenableViaIdentity
```
Invoke-MgBetaReenableDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity>

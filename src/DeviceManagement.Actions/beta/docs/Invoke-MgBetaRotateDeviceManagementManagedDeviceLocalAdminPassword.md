...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetarotatedevicemanagementmanageddevicelocaladminpassword
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-MgBetaRotateDeviceManagementManagedDeviceLocalAdminPassword -ManagedDeviceId <String>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetarotatedevicemanagementmanageddevicefilevaultkey
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-MgBetaRotateDeviceManagementManagedDeviceFileVaultKey -ManagedDeviceId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RotateViaIdentity
```
Invoke-MgBetaRotateDeviceManagementManagedDeviceFileVaultKey -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
Get-MgBetaDeviceManagementMicrosoftTunnelSiteMicrosoftTunnelServerHealthMetricTimeSeries
 ...
 [-EndDateTime <DateTime>] [-MetricName <String>] [-StartDateTime <DateTime>] [-CustomHeader <String>]
...
Get-MgBetaDeviceManagementMicrosoftTunnelSiteMicrosoftTunnelServerHealthMetricTimeSeries
 ...
 [-MetricName <String>] [-StartDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

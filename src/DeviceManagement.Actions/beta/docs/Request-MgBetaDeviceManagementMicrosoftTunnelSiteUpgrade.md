...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/request-mgbetadevicemanagementmicrosofttunnelsiteupgrade
schema: 2.0.0
---
...
### Request (Default)
```
Request-MgBetaDeviceManagementMicrosoftTunnelSiteUpgrade -MicrosoftTunnelSiteId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RequestViaIdentity
```
Request-MgBetaDeviceManagementMicrosoftTunnelSiteUpgrade -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

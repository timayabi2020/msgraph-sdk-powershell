...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetarotatedevicemanagementcomanageddevicefilevaultkey
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-MgBetaRotateDeviceManagementComanagedDeviceFileVaultKey -ManagedDeviceId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RotateViaIdentity
```
Invoke-MgBetaRotateDeviceManagementComanagedDeviceFileVaultKey -InputObject <IDeviceManagementActionsIdentity>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

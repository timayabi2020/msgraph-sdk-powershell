...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/revoke-mgbetadevicemanagementmanageddeviceapplevpplicense
schema: 2.0.0
---
...
### Revoke (Default)
```
Revoke-MgBetaDeviceManagementManagedDeviceAppleVppLicense -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RevokeViaIdentity
```
Revoke-MgBetaDeviceManagementManagedDeviceAppleVppLicense -InputObject <IDeviceManagementActionsIdentity>

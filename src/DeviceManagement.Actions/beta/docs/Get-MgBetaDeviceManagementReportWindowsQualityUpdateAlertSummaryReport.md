...
### GetExpanded (Default)
```
Get-MgBetaDeviceManagementReportWindowsQualityUpdateAlertSummaryReport -OutFile <String>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsNun7U7DevicemanagementReportsMicrosoftGraphGetwindowsqualityupdatealertsummaryreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsNun7U7DevicemanagementReportsMicrosoftGraphGetwindowsqualityupdatealertsummaryreportPostRequestbodyContentApplicationJsonSchema

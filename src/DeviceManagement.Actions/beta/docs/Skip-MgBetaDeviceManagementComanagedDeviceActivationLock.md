...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/skip-mgbetadevicemanagementcomanageddeviceactivationlock
schema: 2.0.0
---
...
### Bypass (Default)
```
Skip-MgBetaDeviceManagementComanagedDeviceActivationLock -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### BypassViaIdentity
```
Skip-MgBetaDeviceManagementComanagedDeviceActivationLock -InputObject <IDeviceManagementActionsIdentity>

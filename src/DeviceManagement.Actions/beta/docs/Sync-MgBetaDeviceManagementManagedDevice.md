...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/sync-mgbetadevicemanagementmanageddevice
schema: 2.0.0
---
...
### Sync (Default)
```
Sync-MgBetaDeviceManagementManagedDevice -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgBetaDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity>

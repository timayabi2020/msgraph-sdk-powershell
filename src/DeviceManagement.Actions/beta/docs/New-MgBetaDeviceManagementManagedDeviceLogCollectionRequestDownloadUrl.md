...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/new-mgbetadevicemanagementmanageddevicelogcollectionrequestdownloadurl
schema: 2.0.0
---
...
### Create (Default)
```
New-MgBetaDeviceManagementManagedDeviceLogCollectionRequestDownloadUrl -DeviceLogCollectionResponseId <String>
 -ManagedDeviceId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaDeviceManagementManagedDeviceLogCollectionRequestDownloadUrl
 -InputObject <IDeviceManagementActionsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

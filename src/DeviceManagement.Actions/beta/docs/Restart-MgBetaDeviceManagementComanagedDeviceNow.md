...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/restart-mgbetadevicemanagementcomanageddevicenow
schema: 2.0.0
---
...
### Reboot (Default)
```
Restart-MgBetaDeviceManagementComanagedDeviceNow -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RebootViaIdentity
```
Restart-MgBetaDeviceManagementComanagedDeviceNow -InputObject <IDeviceManagementActionsIdentity>

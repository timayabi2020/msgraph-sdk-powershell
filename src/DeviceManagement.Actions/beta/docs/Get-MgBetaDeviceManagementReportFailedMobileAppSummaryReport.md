...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/get-mgbetadevicemanagementreportfailedmobileappsummaryreport
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgBetaDeviceManagementReportFailedMobileAppSummaryReport -OutFile <String>

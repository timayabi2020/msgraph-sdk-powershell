...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetareenabledevicemanagementcomanageddevice
schema: 2.0.0
---
...
### Reenable (Default)
```
Invoke-MgBetaReenableDeviceManagementComanagedDevice -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReenableViaIdentity
```
Invoke-MgBetaReenableDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity>

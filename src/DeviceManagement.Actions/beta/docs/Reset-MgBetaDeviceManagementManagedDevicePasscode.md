...
### Reset (Default)
```
Reset-MgBetaDeviceManagementManagedDevicePasscode -ManagedDeviceId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaDeviceManagementManagedDevicePasscode -InputObject <IDeviceManagementActionsIdentity>

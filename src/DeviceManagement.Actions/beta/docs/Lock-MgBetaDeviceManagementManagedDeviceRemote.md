...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/lock-mgbetadevicemanagementmanageddeviceremote
schema: 2.0.0
---
...
### Lock (Default)
```
Lock-MgBetaDeviceManagementManagedDeviceRemote -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LockViaIdentity
```
Lock-MgBetaDeviceManagementManagedDeviceRemote -InputObject <IDeviceManagementActionsIdentity>

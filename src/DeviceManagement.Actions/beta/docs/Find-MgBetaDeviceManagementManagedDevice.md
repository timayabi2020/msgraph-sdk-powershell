...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/find-mgbetadevicemanagementmanageddevice
schema: 2.0.0
---
...
### Locate (Default)
```
Find-MgBetaDeviceManagementManagedDevice -ManagedDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgBetaDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity>

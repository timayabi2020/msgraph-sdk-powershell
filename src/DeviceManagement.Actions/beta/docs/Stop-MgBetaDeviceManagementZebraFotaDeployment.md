...
### Cancel (Default)
```
Stop-MgBetaDeviceManagementZebraFotaDeployment -ZebraFotaDeploymentId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaDeviceManagementZebraFotaDeployment -InputObject <IDeviceManagementActionsIdentity>

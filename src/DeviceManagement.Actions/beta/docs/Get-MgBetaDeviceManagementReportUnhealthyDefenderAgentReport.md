...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/get-mgbetadevicemanagementreportunhealthydefenderagentreport
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgBetaDeviceManagementReportUnhealthyDefenderAgentReport -OutFile <String>

...
### Pause (Default)
```
Suspend-MgBetaEducationSynchronizationProfile -EducationSynchronizationProfileId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PauseViaIdentity
```
Suspend-MgBetaEducationSynchronizationProfile -InputObject <IEducationIdentity> [-CustomHeader <String>]

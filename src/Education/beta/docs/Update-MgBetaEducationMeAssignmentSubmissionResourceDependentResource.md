...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/update-mgbetaeducationmeassignmentsubmissionresourcedependentresource
schema: 2.0.0
---
...
```
Update-MgBetaEducationMeAssignmentSubmissionResourceDependentResource -EducationAssignmentId <String>
...
### UpdateViaIdentity
```
Update-MgBetaEducationMeAssignmentSubmissionResourceDependentResource -InputObject <IEducationIdentity>

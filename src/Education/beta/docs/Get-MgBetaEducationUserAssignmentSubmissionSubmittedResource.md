...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationuserassignmentsubmissionsubmittedresource
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaEducationUserAssignmentSubmissionSubmittedResource -EducationAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaEducationUserAssignmentSubmissionSubmittedResource -InputObject <IEducationIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

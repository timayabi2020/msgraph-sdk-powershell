...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/update-mgbetaeducationmeusermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaEducationMeUserMailboxSetting [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
...
### Update
```
Update-MgBetaEducationMeUserMailboxSetting -BodyParameter <IMicrosoftGraphMailboxSettings>

...
### List (Default)
```
Get-MgBetaEducationMeAssignmentResource -EducationAssignmentId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaEducationMeAssignmentResource -EducationAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaEducationMeAssignmentResource -InputObject <IEducationIdentity> [-ExpandProperty <String[]>]

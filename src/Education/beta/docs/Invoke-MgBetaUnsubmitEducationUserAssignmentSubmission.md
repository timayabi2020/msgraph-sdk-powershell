...
### Unsubmit (Default)
```
Invoke-MgBetaUnsubmitEducationUserAssignmentSubmission -EducationAssignmentId <String>
 -EducationSubmissionId <String> -EducationUserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnsubmitViaIdentity
```
Invoke-MgBetaUnsubmitEducationUserAssignmentSubmission -InputObject <IEducationIdentity>

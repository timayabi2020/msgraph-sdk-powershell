...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationmeassignmentsubmissionsubmittedresource
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaEducationMeAssignmentSubmissionSubmittedResource -EducationAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaEducationMeAssignmentSubmissionSubmittedResource -InputObject <IEducationIdentity>

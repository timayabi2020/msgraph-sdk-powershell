...
### Activate (Default)
```
Initialize-MgBetaEducationMeAssignment -EducationAssignmentId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ActivateViaIdentity
```
Initialize-MgBetaEducationMeAssignment -InputObject <IEducationIdentity> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

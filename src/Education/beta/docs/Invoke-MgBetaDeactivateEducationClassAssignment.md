...
### Deactivate (Default)
```
Invoke-MgBetaDeactivateEducationClassAssignment -EducationAssignmentId <String> -EducationClassId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeactivateViaIdentity
```
Invoke-MgBetaDeactivateEducationClassAssignment -InputObject <IEducationIdentity> [-CustomHeader <String>]

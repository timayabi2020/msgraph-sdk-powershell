...
### Publish (Default)
```
Publish-MgBetaEducationMeAssignment -EducationAssignmentId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaEducationMeAssignment -InputObject <IEducationIdentity> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

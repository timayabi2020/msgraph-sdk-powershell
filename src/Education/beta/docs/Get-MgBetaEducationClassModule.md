...
### List (Default)
```
Get-MgBetaEducationClassModule -EducationClassId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaEducationClassModule -EducationClassId <String> -EducationModuleId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaEducationClassModule -InputObject <IEducationIdentity> [-ExpandProperty <String[]>]

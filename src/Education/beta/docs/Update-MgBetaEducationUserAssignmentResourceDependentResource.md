...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/update-mgbetaeducationuserassignmentresourcedependentresource
schema: 2.0.0
---
...
```
Update-MgBetaEducationUserAssignmentResourceDependentResource -EducationAssignmentId <String>
...
### UpdateViaIdentity
```
Update-MgBetaEducationUserAssignmentResourceDependentResource -InputObject <IEducationIdentity>
 -BodyParameter <IMicrosoftGraphEducationAssignmentResource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

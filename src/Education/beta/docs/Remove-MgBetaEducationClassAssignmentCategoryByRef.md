...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/remove-mgbetaeducationclassassignmentcategorybyref
schema: 2.0.0
---
...
Remove-MgBetaEducationClassAssignmentCategoryByRef -EducationAssignmentId <String>
 -EducationCategoryId <String> -EducationClassId <String> [-Id <String>] [-IfMatch <String>]

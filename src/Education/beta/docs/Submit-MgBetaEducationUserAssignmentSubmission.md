...
Submit-MgBetaEducationUserAssignmentSubmission -EducationAssignmentId <String> -EducationSubmissionId <String>
 -EducationUserId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SubmitViaIdentity
```
Submit-MgBetaEducationUserAssignmentSubmission -InputObject <IEducationIdentity> [-CustomHeader <String>]

...
### Get (Default)
```
Get-MgBetaEducationUserAssignmentSubmissionResourceCount -EducationAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaEducationUserAssignmentSubmissionResourceCount -InputObject <IEducationIdentity> [-Filter <String>]

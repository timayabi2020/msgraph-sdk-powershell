...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/remove-mgbetaeducationuserassignmentsubmissionresourcedependentresource
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaEducationUserAssignmentSubmissionResourceDependentResource -EducationAssignmentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaEducationUserAssignmentSubmissionResourceDependentResource -InputObject <IEducationIdentity>

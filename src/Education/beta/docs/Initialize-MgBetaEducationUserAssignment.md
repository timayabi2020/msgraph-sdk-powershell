...
### Activate (Default)
```
Initialize-MgBetaEducationUserAssignment -EducationAssignmentId <String> -EducationUserId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ActivateViaIdentity
```
Initialize-MgBetaEducationUserAssignment -InputObject <IEducationIdentity> [-CustomHeader <String>] [-Confirm]

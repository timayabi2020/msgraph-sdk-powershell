...
### Delete (Default)
```
Remove-MgBetaEducationClassAssignmentSubmissionResource -EducationAssignmentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaEducationClassAssignmentSubmissionResource -InputObject <IEducationIdentity> [-IfMatch <String>]

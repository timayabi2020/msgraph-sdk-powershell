...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/remove-mgbetaeducationuserassignmentsubmissionsubmittedresource
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaEducationUserAssignmentSubmissionSubmittedResource -EducationAssignmentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaEducationUserAssignmentSubmissionSubmittedResource -InputObject <IEducationIdentity>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

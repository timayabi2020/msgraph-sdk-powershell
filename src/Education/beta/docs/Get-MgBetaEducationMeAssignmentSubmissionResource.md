...
### List (Default)
```
Get-MgBetaEducationMeAssignmentSubmissionResource -EducationAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaEducationMeAssignmentSubmissionResource -InputObject <IEducationIdentity>

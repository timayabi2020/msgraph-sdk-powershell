...
### List (Default)
```
Get-MgBetaEducationMeAssignmentSubmissionOutcome -EducationAssignmentId <String>
...
### Get
```
Get-MgBetaEducationMeAssignmentSubmissionOutcome -EducationAssignmentId <String> -EducationOutcomeId <String>
 -EducationSubmissionId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaEducationMeAssignmentSubmissionOutcome -InputObject <IEducationIdentity>

...
### Activate (Default)
```
Initialize-MgBetaEducationClassAssignment -EducationAssignmentId <String> -EducationClassId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ActivateViaIdentity
```
Initialize-MgBetaEducationClassAssignment -InputObject <IEducationIdentity> [-CustomHeader <String>]

...
### Delete (Default)
```
Remove-MgBetaEducationClassAssignmentGradingCategory -EducationAssignmentId <String>
 -EducationClassId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaEducationClassAssignmentGradingCategory -InputObject <IEducationIdentity> [-IfMatch <String>]

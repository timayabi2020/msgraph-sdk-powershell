...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/remove-mgbetaeducationclassassignmentsubmissionsubmittedresourcedependentresource
schema: 2.0.0
---
...
Remove-MgBetaEducationClassAssignmentSubmissionSubmittedResourceDependentResource
 ...
 -EducationSubmissionResourceId <String> -EducationSubmissionResourceId1 <String> [-IfMatch <String>]
...
```
Remove-MgBetaEducationClassAssignmentSubmissionSubmittedResourceDependentResource
 -InputObject <IEducationIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]

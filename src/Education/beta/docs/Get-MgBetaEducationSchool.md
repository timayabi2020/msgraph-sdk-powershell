...
### List (Default)
```
Get-MgBetaEducationSchool [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaEducationSchool -InputObject <IEducationIdentity> [-ExpandProperty <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationuserassignmentsubmissionsubmittedresourcedependentresource
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaEducationUserAssignmentSubmissionSubmittedResourceDependentResource -EducationAssignmentId <String>
...
```
Get-MgBetaEducationUserAssignmentSubmissionSubmittedResourceDependentResource
 -InputObject <IEducationIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]

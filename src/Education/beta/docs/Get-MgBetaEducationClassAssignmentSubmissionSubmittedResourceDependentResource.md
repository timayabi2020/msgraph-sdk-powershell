...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationclassassignmentsubmissionsubmittedresourcedependentresource
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaEducationClassAssignmentSubmissionSubmittedResourceDependentResource -EducationAssignmentId <String>

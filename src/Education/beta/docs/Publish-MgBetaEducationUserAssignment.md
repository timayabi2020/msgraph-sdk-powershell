...
### Publish (Default)
```
Publish-MgBetaEducationUserAssignment -EducationAssignmentId <String> -EducationUserId <String>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaEducationUserAssignment -InputObject <IEducationIdentity> [-CustomHeader <String>] [-Confirm]

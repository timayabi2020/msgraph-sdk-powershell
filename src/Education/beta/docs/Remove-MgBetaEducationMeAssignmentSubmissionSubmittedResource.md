...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/remove-mgbetaeducationmeassignmentsubmissionsubmittedresource
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaEducationMeAssignmentSubmissionSubmittedResource -EducationAssignmentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaEducationMeAssignmentSubmissionSubmittedResource -InputObject <IEducationIdentity>

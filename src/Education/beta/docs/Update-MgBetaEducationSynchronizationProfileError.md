...
Update-MgBetaEducationSynchronizationProfileError -EducationSynchronizationErrorId <String>
 ...
 [-RecordedDateTime <DateTime>] [-ReportableIdentifier <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaEducationSynchronizationProfileError -InputObject <IEducationIdentity>
 -BodyParameter <IMicrosoftGraphEducationSynchronizationError> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

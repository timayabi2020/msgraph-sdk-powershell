...
### Set (Default)
```
Set-MgEducationMeAssignmentUpResourceFolder -EducationAssignmentId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgEducationMeAssignmentUpResourceFolder -InputObject <IEducationIdentity> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
Update-MgEducationSchoolAdministrativeUnit -EducationSchoolId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-ScopedRoleMembers <IMicrosoftGraphScopedRoleMembership[]>] [-Visibility <String>] [-CustomHeader <String>]
...
Update-MgEducationSchoolAdministrativeUnit -EducationSchoolId <String>
 -BodyParameter <IMicrosoftGraphAdministrativeUnit> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgEducationSchoolAdministrativeUnit -InputObject <IEducationIdentity>
 ...
 [-Visibility <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

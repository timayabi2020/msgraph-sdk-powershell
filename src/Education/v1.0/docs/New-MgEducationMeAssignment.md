...
New-MgEducationMeAssignment [-AddedStudentAction <String>] [-AdditionalProperties <Hashtable>]
 ...
 [-Submissions <IMicrosoftGraphEducationSubmission[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgEducationMeAssignment -BodyParameter <IMicrosoftGraphEducationAssignment> [-CustomHeader <String>]

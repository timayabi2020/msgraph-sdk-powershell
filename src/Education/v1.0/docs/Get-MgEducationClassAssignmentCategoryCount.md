...
### Get (Default)
```
Get-MgEducationClassAssignmentCategoryCount -EducationClassId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### Get1
```
Get-MgEducationClassAssignmentCategoryCount -EducationAssignmentId <String> -EducationClassId <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationClassAssignmentCategoryCount -InputObject <IEducationIdentity> [-Filter <String>]

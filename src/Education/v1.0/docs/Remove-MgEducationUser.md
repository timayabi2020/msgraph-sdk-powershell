...
### Delete (Default)
```
Remove-MgEducationUser -EducationUserId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgEducationUser -InputObject <IEducationIdentity> [-IfMatch <String>] [-CustomHeader <String>]

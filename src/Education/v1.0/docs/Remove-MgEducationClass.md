...
### Delete (Default)
```
Remove-MgEducationClass -EducationClassId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgEducationClass -InputObject <IEducationIdentity> [-IfMatch <String>] [-CustomHeader <String>]

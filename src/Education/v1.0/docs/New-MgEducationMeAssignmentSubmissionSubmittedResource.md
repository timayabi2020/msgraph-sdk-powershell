...
```
New-MgEducationMeAssignmentSubmissionSubmittedResource -EducationAssignmentId <String>
...
### CreateViaIdentity
```
New-MgEducationMeAssignmentSubmissionSubmittedResource -InputObject <IEducationIdentity>

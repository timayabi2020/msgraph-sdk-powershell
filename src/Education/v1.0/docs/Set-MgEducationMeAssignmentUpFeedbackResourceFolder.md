...
### Set (Default)
```
Set-MgEducationMeAssignmentUpFeedbackResourceFolder -EducationAssignmentId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgEducationMeAssignmentUpFeedbackResourceFolder -InputObject <IEducationIdentity> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

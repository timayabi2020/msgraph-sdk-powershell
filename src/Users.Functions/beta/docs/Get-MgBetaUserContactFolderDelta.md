...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.functions/get-mgbetausercontactfolderdelta
schema: 2.0.0
---
...
### Delta (Default)
```
Get-MgBetaUserContactFolderDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserContactFolderDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

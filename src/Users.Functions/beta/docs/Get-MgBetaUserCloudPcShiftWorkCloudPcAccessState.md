...
### Get (Default)
```
Get-MgBetaUserCloudPcShiftWorkCloudPcAccessState -CloudPcId <String> -UserId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserCloudPcShiftWorkCloudPcAccessState -InputObject <IUsersFunctionsIdentity>

...
### Filter (Default)
```
Invoke-MgBetaFilterUserPendingAccessReviewInstanceByCurrentUser -On <String> -UserId <String> [-Count]
...
### FilterViaIdentity
```
Invoke-MgBetaFilterUserPendingAccessReviewInstanceByCurrentUser -InputObject <IUsersFunctionsIdentity>

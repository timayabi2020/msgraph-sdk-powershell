...
### Delta (Default)
```
Get-MgBetaUserPlannerPlanDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserPlannerPlanDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

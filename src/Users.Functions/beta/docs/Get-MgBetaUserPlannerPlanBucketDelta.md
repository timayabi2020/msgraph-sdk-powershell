...
### Delta (Default)
```
Get-MgBetaUserPlannerPlanBucketDelta -PlannerPlanId <String> -UserId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserPlannerPlanBucketDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

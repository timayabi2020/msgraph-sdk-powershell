...
### Delta (Default)
```
Get-MgBetaUserDriveListItemDelta -DriveId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### Delta1
```
Get-MgBetaUserDriveListItemDelta -DriveId <String> -Token <String> -UserId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserDriveListItemDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

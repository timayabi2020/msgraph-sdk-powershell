...
### Get (Default)
```
Get-MgBetaUserManagedAppPolicy -UserId <String> [-Count] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserManagedAppPolicy -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

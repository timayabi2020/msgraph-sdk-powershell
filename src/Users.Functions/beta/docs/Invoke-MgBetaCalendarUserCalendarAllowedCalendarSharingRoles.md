...
### Calendar1
```
Invoke-MgBetaCalendarUserCalendarAllowedCalendarSharingRoles -CalendarId <String> -User <String>
 -UserId <String> [-Count] [-Filter <String>] [-Search <String>] [-Skip <Int32>] [-Top <Int32>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.functions/get-mgbetausermailfolderdelta
schema: 2.0.0
---
...
### Delta (Default)
```
Get-MgBetaUserMailFolderDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserMailFolderDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

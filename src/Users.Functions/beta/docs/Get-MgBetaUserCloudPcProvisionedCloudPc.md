...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.functions/get-mgbetausercloudpcprovisionedcloudpc
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaUserCloudPcProvisionedCloudPc -GroupId <String> -ServicePlanId <String> -UserId <String> [-Count]
...
### GetViaIdentity
```
Get-MgBetaUserCloudPcProvisionedCloudPc -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

...
### Preview (Default)
```
Invoke-MgBetaPreviewUserOnenotePage -OnenotePageId <String> -UserId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgBetaPreviewUserOnenotePage -InputObject <IUsersFunctionsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

...
### Delta (Default)
```
Get-MgBetaUserDeviceDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserDeviceDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

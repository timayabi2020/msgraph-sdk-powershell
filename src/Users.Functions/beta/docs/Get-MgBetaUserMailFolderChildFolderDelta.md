...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.functions/get-mgbetausermailfolderchildfolderdelta
schema: 2.0.0
---
...
### Delta (Default)
```
Get-MgBetaUserMailFolderChildFolderDelta -MailFolderId <String> -UserId <String> [-Filter <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.functions/get-mgbetausercontactfoldercontactdelta
schema: 2.0.0
---
...
### Delta (Default)
```
Get-MgBetaUserContactFolderContactDelta -ContactFolderId <String> -UserId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserContactFolderContactDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

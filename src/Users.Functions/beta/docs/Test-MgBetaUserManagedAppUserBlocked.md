...
### Is (Default)
```
Test-MgBetaUserManagedAppUserBlocked -UserId <String> [-CustomHeader <String>] [<CommonParameters>]
```

### IsViaIdentity
```
Test-MgBetaUserManagedAppUserBlocked -InputObject <IUsersFunctionsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

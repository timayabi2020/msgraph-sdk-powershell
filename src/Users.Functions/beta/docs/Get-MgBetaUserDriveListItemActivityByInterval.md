...
### Get (Default)
```
Get-MgBetaUserDriveListItemActivityByInterval -DriveId <String> -EndDateTime <String> -Interval <String>
...
### GetViaIdentity
```
Get-MgBetaUserDriveListItemActivityByInterval -InputObject <IUsersFunctionsIdentity> [-Count]

...
### Delta (Default)
```
Get-MgBetaUserTodoListDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserTodoListDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

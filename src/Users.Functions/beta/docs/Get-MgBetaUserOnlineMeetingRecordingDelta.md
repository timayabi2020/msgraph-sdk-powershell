...
### Delta (Default)
```
Get-MgBetaUserOnlineMeetingRecordingDelta -OnlineMeetingId <String> -UserId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserOnlineMeetingRecordingDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

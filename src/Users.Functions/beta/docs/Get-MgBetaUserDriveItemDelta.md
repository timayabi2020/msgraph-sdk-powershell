...
### Delta (Default)
```
Get-MgBetaUserDriveItemDelta -DriveId <String> -DriveItemId <String> -UserId <String> [-Filter <String>]
...
### Delta1
```
Get-MgBetaUserDriveItemDelta -DriveId <String> -DriveItemId <String> -Token <String> -UserId <String>
...
### DeltaViaIdentity
```
Get-MgBetaUserDriveItemDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

...
### Delta (Default)
```
Get-MgUserContactFolderChildFolderDelta -ContactFolderId <String> -UserId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgUserContactFolderChildFolderDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

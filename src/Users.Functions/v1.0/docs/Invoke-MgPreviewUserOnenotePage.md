...
### Preview (Default)
```
Invoke-MgPreviewUserOnenotePage -OnenotePageId <String> -UserId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgPreviewUserOnenotePage -InputObject <IUsersFunctionsIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgUserManagedAppPolicy -UserId <String> [-Count] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgUserManagedAppPolicy -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

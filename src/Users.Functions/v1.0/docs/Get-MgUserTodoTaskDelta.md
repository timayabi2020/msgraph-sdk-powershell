...
### Delta (Default)
```
Get-MgUserTodoTaskDelta -TodoTaskListId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity
```
Get-MgUserTodoTaskDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

...
### Delta (Default)
```
Get-MgUserMessageDelta -UserId <String> [-ChangeType <String>] [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity
```
Get-MgUserMessageDelta -InputObject <IUsersFunctionsIdentity> [-ChangeType <String>] [-Count]

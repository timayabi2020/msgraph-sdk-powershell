...
### Search (Default)
```
Search-MgUserDriveRoot -DriveId <String> -Q <String> -UserId <String> [-Count] [-Filter <String>]
...
### SearchViaIdentity
```
Search-MgUserDriveRoot -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-CustomHeader <String>] [<CommonParameters>]
```

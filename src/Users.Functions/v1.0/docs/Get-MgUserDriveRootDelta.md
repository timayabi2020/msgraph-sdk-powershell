...
### Delta (Default)
```
Get-MgUserDriveRootDelta -DriveId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### Delta1
```
Get-MgUserDriveRootDelta -DriveId <String> -Token <String> -UserId <String> [-Filter <String>]

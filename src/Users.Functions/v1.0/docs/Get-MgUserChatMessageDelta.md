...
### Delta (Default)
```
Get-MgUserChatMessageDelta -ChatId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity
```
Get-MgUserChatMessageDelta -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]

...
### List (Default)
```
Get-MgDeviceManagementWindowsInformationProtectionAppLearningSummary [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDeviceManagementWindowsInformationProtectionAppLearningSummary -InputObject <IDeviceManagementIdentity>

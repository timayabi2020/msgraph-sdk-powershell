...
New-MgDeviceManagementUserExperienceAnalyticBaseline [-AdditionalProperties <Hashtable>]
 ...
 [-WorkFromAnywhereMetrics <IMicrosoftGraphUserExperienceAnalyticsCategory>] [-CustomHeader <String>]
...
```
New-MgDeviceManagementUserExperienceAnalyticBaseline
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsBaseline> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

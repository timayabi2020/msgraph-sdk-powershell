...
### List (Default)
```
Get-MgDeviceManagementDeviceCompliancePolicyAssignment -DeviceCompliancePolicyId <String>
...
### Get
```
Get-MgDeviceManagementDeviceCompliancePolicyAssignment -DeviceCompliancePolicyAssignmentId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementDeviceCompliancePolicyAssignment -InputObject <IDeviceManagementIdentity>

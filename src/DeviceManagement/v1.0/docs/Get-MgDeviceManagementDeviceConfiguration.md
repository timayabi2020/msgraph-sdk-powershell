...
### List (Default)
```
Get-MgDeviceManagementDeviceConfiguration [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgDeviceManagementDeviceConfiguration -InputObject <IDeviceManagementIdentity>

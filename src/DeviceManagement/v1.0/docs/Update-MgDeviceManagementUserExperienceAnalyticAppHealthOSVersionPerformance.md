...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementuserexperienceanalyticapphealthosversionperformance
schema: 2.0.0
---
...
Update-MgDeviceManagementUserExperienceAnalyticAppHealthOSVersionPerformance
 ...
 [-OSBuildNumber <String>] [-OSVersion <String>] [-OSVersionAppHealthScore <Double>] [-CustomHeader <String>]
...
Update-MgDeviceManagementUserExperienceAnalyticAppHealthOSVersionPerformance
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsAppHealthOSVersionPerformance> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgDeviceManagementUserExperienceAnalyticAppHealthOSVersionPerformance
 ...
 [-OSVersionAppHealthScore <Double>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

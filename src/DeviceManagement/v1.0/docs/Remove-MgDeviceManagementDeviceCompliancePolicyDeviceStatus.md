...
### Delete (Default)
```
Remove-MgDeviceManagementDeviceCompliancePolicyDeviceStatus -DeviceComplianceDeviceStatusId <String>
...
### DeleteViaIdentity
```
Remove-MgDeviceManagementDeviceCompliancePolicyDeviceStatus -InputObject <IDeviceManagementIdentity>

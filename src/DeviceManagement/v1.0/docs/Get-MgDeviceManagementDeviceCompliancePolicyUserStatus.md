...
### List (Default)
```
Get-MgDeviceManagementDeviceCompliancePolicyUserStatus -DeviceCompliancePolicyId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementDeviceCompliancePolicyUserStatus -InputObject <IDeviceManagementIdentity>

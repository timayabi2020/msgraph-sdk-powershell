...
Update-MgDeviceManagementUserExperienceAnalyticAppHealthApplicationPerformance
 ...
 [-AppUsageDuration <Int32>] [-Id <String>] [-MeanTimeToFailureInMinutes <Int32>] [-CustomHeader <String>]
...
Update-MgDeviceManagementUserExperienceAnalyticAppHealthApplicationPerformance
 ...
 [-MeanTimeToFailureInMinutes <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
Update-MgAdminEdgeInternetExplorerModeSiteListSite -BrowserSiteId <String> -BrowserSiteListId <String>
 ...
 [-TargetEnvironment <BrowserSiteTargetEnvironment>] [-WebUrl <String>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgAdminEdgeInternetExplorerModeSiteListSite -BrowserSiteId <String> -BrowserSiteListId <String>
 -BodyParameter <IMicrosoftGraphBrowserSite> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

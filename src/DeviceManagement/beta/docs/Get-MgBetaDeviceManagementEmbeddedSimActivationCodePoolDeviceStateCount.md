...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementembeddedsimactivationcodepooldevicestatecount
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementEmbeddedSimActivationCodePoolDeviceStateCount
 -EmbeddedSimActivationCodePoolId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

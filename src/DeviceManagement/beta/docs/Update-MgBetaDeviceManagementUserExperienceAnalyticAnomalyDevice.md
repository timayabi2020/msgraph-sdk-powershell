...
Update-MgBetaDeviceManagementUserExperienceAnalyticAnomalyDevice
 ...
 [-OSName <String>] [-OSVersion <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementUserExperienceAnalyticAnomalyDevice
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsAnomalyDevice> [-CustomHeader <String>] [-Confirm]

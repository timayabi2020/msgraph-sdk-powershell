...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcategorysettingdefinition
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementCategorySettingDefinition -DeviceManagementSettingCategoryId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementCategorySettingDefinition -InputObject <IDeviceManagementIdentity>

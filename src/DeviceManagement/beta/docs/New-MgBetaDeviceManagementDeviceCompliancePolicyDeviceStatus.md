...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementdevicecompliancepolicydevicestatus
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementDeviceCompliancePolicyDeviceStatus -DeviceCompliancePolicyId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceManagementDeviceCompliancePolicyDeviceStatus -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceComplianceDeviceStatus> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

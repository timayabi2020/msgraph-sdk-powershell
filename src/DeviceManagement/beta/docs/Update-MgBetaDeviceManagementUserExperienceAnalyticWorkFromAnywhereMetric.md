...
Update-MgBetaDeviceManagementUserExperienceAnalyticWorkFromAnywhereMetric
 ...
 [-MetricDevices <IMicrosoftGraphUserExperienceAnalyticsWorkFromAnywhereDevice[]>] [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementUserExperienceAnalyticWorkFromAnywhereMetric
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsWorkFromAnywhereMetric> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

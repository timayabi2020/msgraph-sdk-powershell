...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementembeddedsimactivationcodepoolassignment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementEmbeddedSimActivationCodePoolAssignment -EmbeddedSimActivationCodePoolId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementEmbeddedSimActivationCodePoolAssignment -InputObject <IDeviceManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

...
Update-MgBetaDeviceManagementUserExperienceAnalyticResourcePerformance
 ...
 [-RamSpikeTimePercentageThreshold <Double>] [-RamSpikeTimeScore <Int32>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaDeviceManagementUserExperienceAnalyticResourcePerformance
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsResourcePerformance> [-CustomHeader <String>]

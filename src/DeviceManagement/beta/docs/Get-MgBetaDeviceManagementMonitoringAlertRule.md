...
### List (Default)
```
Get-MgBetaDeviceManagementMonitoringAlertRule [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementMonitoringAlertRule -AlertRuleId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementMonitoringAlertRule -InputObject <IDeviceManagementIdentity>

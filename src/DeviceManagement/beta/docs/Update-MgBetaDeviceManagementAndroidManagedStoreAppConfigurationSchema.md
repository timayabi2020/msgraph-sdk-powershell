...
Update-MgBetaDeviceManagementAndroidManagedStoreAppConfigurationSchema
 ...
 [-SchemaItems <IMicrosoftGraphAndroidManagedStoreAppConfigurationSchemaItem[]>] [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementAndroidManagedStoreAppConfigurationSchema
 ...
 -BodyParameter <IMicrosoftGraphAndroidManagedStoreAppConfigurationSchema> [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaDeviceManagementAndroidManagedStoreAppConfigurationSchema
 -InputObject <IDeviceManagementIdentity> [-AdditionalProperties <Hashtable>] [-ExampleJsonInputFile <String>]

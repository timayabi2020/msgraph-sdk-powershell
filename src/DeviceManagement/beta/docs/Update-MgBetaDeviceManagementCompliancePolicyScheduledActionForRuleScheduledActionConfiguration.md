...
Update-MgBetaDeviceManagementCompliancePolicyScheduledActionForRuleScheduledActionConfiguration
 ...
 [-NotificationTemplateId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementCompliancePolicyScheduledActionForRuleScheduledActionConfiguration
 -DeviceManagementComplianceActionItemId <String> -DeviceManagementCompliancePolicyId <String>
 -DeviceManagementComplianceScheduledActionForRuleId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementComplianceActionItem> [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaDeviceManagementCompliancePolicyScheduledActionForRuleScheduledActionConfiguration
 ...
 [-NotificationMessageCcList <String[]>] [-NotificationTemplateId <String>] [-CustomHeader <String>]

...
New-MgBetaDeviceManagementResourceAccessProfile [-AdditionalProperties <Hashtable>]
 ...
 [-LastModifiedDateTime <DateTime>] [-RoleScopeTagIds <String[]>] [-Version <Int32>] [-CustomHeader <String>]
...
```
New-MgBetaDeviceManagementResourceAccessProfile
 -BodyParameter <IMicrosoftGraphDeviceManagementResourceAccessProfileBase> [-CustomHeader <String>] [-Confirm]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementuserexperienceanalyticdevicetimelineevent
schema: 2.0.0
---
...
Update-MgBetaDeviceManagementUserExperienceAnalyticDeviceTimelineEvent
 ...
 [-EventName <String>] [-EventSource <String>] [-Id <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementUserExperienceAnalyticDeviceTimelineEvent
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsDeviceTimelineEvent> [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementUserExperienceAnalyticDeviceTimelineEvent
 ...
 [-EventSource <String>] [-Id <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

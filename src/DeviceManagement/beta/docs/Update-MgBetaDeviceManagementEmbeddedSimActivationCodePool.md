...
Update-MgBetaDeviceManagementEmbeddedSimActivationCodePool -EmbeddedSimActivationCodePoolId <String>
 ...
 [-DisplayName <String>] [-Id <String>] [-ModifiedDateTime <DateTime>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaDeviceManagementEmbeddedSimActivationCodePool -EmbeddedSimActivationCodePoolId <String>
 -BodyParameter <IMicrosoftGraphEmbeddedSimActivationCodePool> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementmanageddevicemobileappconfigurationstate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementManagedDeviceMobileAppConfigurationState -ManagedDeviceId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementManagedDeviceMobileAppConfigurationState -InputObject <IDeviceManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementintentcategorysettingdefinition
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementIntentCategorySettingDefinition -DeviceManagementIntentId <String>
 ...
 [-ValueType <DeviceManangementIntentValueType>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaDeviceManagementIntentCategorySettingDefinition -DeviceManagementIntentId <String>
 ...
 -BodyParameter <IMicrosoftGraphDeviceManagementSettingDefinition> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaDeviceManagementIntentCategorySettingDefinition -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementSettingDefinition> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

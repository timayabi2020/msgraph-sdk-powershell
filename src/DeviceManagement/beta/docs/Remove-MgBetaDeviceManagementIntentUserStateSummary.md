...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementintentuserstatesummary
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementIntentUserStateSummary -DeviceManagementIntentId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementIntentUserStateSummary -InputObject <IDeviceManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementdevicehealthscriptassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceHealthScriptAssignment -DeviceHealthScriptAssignmentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDeviceHealthScriptAssignment -InputObject <IDeviceManagementIdentity>

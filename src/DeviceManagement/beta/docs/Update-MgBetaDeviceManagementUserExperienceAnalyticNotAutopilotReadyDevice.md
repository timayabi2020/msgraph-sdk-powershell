...
Update-MgBetaDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice
 ...
 [-SerialNumber <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsNotAutopilotReadyDevice> [-CustomHeader <String>]

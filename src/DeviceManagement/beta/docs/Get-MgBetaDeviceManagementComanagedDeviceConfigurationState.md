...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcomanageddeviceconfigurationstate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementComanagedDeviceConfigurationState -ManagedDeviceId <String>
...
### Get
```
Get-MgBetaDeviceManagementComanagedDeviceConfigurationState -DeviceConfigurationStateId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementComanagedDeviceConfigurationState -InputObject <IDeviceManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementscriptuserrunstate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementScriptUserRunState -DeviceManagementScriptId <String>
 -DeviceManagementScriptUserStateId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementScriptUserRunState -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementdeviceshellscriptuserrunstate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementDeviceShellScriptUserRunState -DeviceShellScriptId <String>
...
### Get
```
Get-MgBetaDeviceManagementDeviceShellScriptUserRunState -DeviceManagementScriptUserStateId <String>
 -DeviceShellScriptId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementDeviceShellScriptUserRunState -InputObject <IDeviceManagementIdentity>
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDeviceManagementScriptUserState

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementscriptassignment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementScriptAssignment -DeviceManagementScriptId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDeviceManagementScriptAssignment -DeviceManagementScriptAssignmentId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementScriptAssignment -InputObject <IDeviceManagementIdentity>

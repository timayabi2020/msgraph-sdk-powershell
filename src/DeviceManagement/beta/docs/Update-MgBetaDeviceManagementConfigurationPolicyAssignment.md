...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementconfigurationpolicyassignment
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgBetaDeviceManagementConfigurationPolicyAssignment -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementConfigurationPolicyAssignment> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementintentassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementIntentAssignment -DeviceManagementIntentId <String>
...
```
New-MgBetaDeviceManagementIntentAssignment -DeviceManagementIntentId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementIntentAssignment> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgBetaDeviceManagementIntentAssignment -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementIntentAssignment> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
`BODYPARAMETER <IMicrosoftGraphDeviceManagementIntentAssignment>`: Intent assignment entity

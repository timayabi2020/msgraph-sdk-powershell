...
### Delete (Default)
```
Remove-MgBetaDeviceManagementManagedDeviceCompliancePolicyState -DeviceCompliancePolicyStateId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementManagedDeviceCompliancePolicyState -InputObject <IDeviceManagementIdentity>

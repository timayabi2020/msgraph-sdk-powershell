...
```
Update-MgBetaAdminEdgeInternetExplorerMode [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-SiteLists <IMicrosoftGraphBrowserSiteList[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
```
Update-MgBetaDeviceManagementIntent -DeviceManagementIntentId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UserStateSummary <IMicrosoftGraphDeviceManagementIntentUserStateSummary>] [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementIntent -DeviceManagementIntentId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementIntent> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementtemplatecategorysettingdefinition
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementTemplateCategorySettingDefinition -DeviceManagementSettingDefinitionId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementTemplateCategorySettingDefinition -InputObject <IDeviceManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementtemplatesetting
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementTemplateSetting -DeviceManagementSettingInstanceId <String>
 -DeviceManagementTemplateId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementTemplateSetting -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementconfigurationpolicyassignment
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementConfigurationPolicyAssignment -InputObject <IDeviceManagementIdentity>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

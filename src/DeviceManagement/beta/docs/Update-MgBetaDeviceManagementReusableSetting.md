...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementreusablesetting
schema: 2.0.0
---
...
```
Update-MgBetaDeviceManagementReusableSetting -DeviceManagementConfigurationSettingDefinitionId <String>
 ...
 [-Visibility <DeviceManagementConfigurationSettingVisibility>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementReusableSetting -DeviceManagementConfigurationSettingDefinitionId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementConfigurationSettingDefinition> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaDeviceManagementReusableSetting -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementConfigurationSettingDefinition> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementReusableSetting -InputObject <IDeviceManagementIdentity> [-AccessTypes <String>]

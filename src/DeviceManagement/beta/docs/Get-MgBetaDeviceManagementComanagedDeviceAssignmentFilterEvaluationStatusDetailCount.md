...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcomanageddeviceassignmentfilterevaluationstatusdetailcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementComanagedDeviceAssignmentFilterEvaluationStatusDetailCount -ManagedDeviceId <String>

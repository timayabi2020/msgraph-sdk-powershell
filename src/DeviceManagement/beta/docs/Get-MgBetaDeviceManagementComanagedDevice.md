...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcomanageddevice
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementComanagedDevice [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementComanagedDevice -InputObject <IDeviceManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentcategorycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementIntentCategoryCount -DeviceManagementIntentId <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementIntentCategoryCount -InputObject <IDeviceManagementIdentity> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

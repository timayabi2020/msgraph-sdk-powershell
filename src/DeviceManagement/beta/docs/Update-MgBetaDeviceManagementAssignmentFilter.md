...
Update-MgBetaDeviceManagementAssignmentFilter -DeviceAndAppManagementAssignmentFilterId <String>
 ...
 [-Platform <DevicePlatformType>] [-RoleScopeTags <String[]>] [-Rule <String>] [-CustomHeader <String>]
...
```
Update-MgBetaDeviceManagementAssignmentFilter -DeviceAndAppManagementAssignmentFilterId <String>
 -BodyParameter <IMicrosoftGraphDeviceAndAppManagementAssignmentFilter> [-CustomHeader <String>] [-Confirm]

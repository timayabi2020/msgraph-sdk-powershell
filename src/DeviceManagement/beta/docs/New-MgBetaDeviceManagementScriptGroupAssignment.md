...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementscriptgroupassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementScriptGroupAssignment -DeviceManagementScriptId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceManagementScriptGroupAssignment -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementScriptGroupAssignment> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

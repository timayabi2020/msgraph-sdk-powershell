...
### List (Default)
```
Get-MgBetaAdminEdgeInternetExplorerModeSiteList [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaAdminEdgeInternetExplorerModeSiteList -BrowserSiteListId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaAdminEdgeInternetExplorerModeSiteList -InputObject <IDeviceManagementIdentity>

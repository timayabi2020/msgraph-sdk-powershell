...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementscriptuserrunstate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementScriptUserRunState -DeviceManagementScriptId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDeviceManagementScriptUserRunState -DeviceManagementScriptId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementScriptUserRunState -InputObject <IDeviceManagementIdentity>

...
Update-MgBetaDeviceManagementMicrosoftTunnelSiteMicrosoftTunnelConfiguration -MicrosoftTunnelSiteId <String>
 ...
 [-RoutesExclude <String[]>] [-RoutesInclude <String[]>] [-SplitDns <String[]>] [-CustomHeader <String>]
...
```
Update-MgBetaDeviceManagementMicrosoftTunnelSiteMicrosoftTunnelConfiguration -MicrosoftTunnelSiteId <String>
 -BodyParameter <IMicrosoftGraphMicrosoftTunnelConfiguration> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementMicrosoftTunnelSiteMicrosoftTunnelConfiguration
 ...
 [-RoutesInclude <String[]>] [-SplitDns <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
Update-MgBetaDeviceManagementAdvancedThreatProtectionOnboardingStateSummary
 ...
 [-RemediatedDeviceCount <Int32>] [-UnknownDeviceCount <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementAdvancedThreatProtectionOnboardingStateSummary
 -BodyParameter <IMicrosoftGraphAdvancedThreatProtectionOnboardingStateSummary> [-CustomHeader <String>]

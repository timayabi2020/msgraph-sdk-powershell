...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementconfigurationpolicysettingdefinitioncount
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementConfigurationPolicySettingDefinitionCount
 -DeviceManagementConfigurationPolicyId <String> -DeviceManagementConfigurationSettingId <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementConfigurationPolicySettingDefinitionCount -InputObject <IDeviceManagementIdentity>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

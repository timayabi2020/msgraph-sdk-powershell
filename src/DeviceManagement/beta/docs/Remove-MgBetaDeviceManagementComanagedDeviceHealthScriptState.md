...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementcomanageddevicehealthscriptstate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementComanagedDeviceHealthScriptState -DeviceId <String> -Id <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementComanagedDeviceHealthScriptState -InputObject <IDeviceManagementIdentity>

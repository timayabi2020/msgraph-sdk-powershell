...
Update-MgBetaDeviceManagementMicrosoftTunnelServerLogCollectionResponse
 ...
 [-Status <MicrosoftTunnelLogCollectionStatus>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementMicrosoftTunnelServerLogCollectionResponse
 ...
 -BodyParameter <IMicrosoftGraphMicrosoftTunnelServerLogCollectionResponse> [-CustomHeader <String>]

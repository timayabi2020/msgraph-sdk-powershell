...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementcategorysettingdefinition
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementCategorySettingDefinition -DeviceManagementSettingCategoryId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceManagementCategorySettingDefinition -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementSettingDefinition> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

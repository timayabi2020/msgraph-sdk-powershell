...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementuserexperienceanalyticresourceperformance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticResourcePerformance [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementUserExperienceAnalyticResourcePerformance -InputObject <IDeviceManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementcomanageddevicesecuritybaselinestatesettingstate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementComanagedDeviceSecurityBaselineStateSettingState -ManagedDeviceId <String>
 -SecurityBaselineSettingStateId <String> -SecurityBaselineStateId <String> [-IfMatch <String>]

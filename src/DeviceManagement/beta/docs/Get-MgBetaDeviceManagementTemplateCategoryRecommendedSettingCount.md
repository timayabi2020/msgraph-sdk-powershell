...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatecategoryrecommendedsettingcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementTemplateCategoryRecommendedSettingCount -DeviceManagementTemplateId <String>
 -DeviceManagementTemplateSettingCategoryId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementTemplateCategoryRecommendedSettingCount -InputObject <IDeviceManagementIdentity>

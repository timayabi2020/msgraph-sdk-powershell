...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatemigratabletocategoryrecommendedsetting
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementTemplateMigratableToCategoryRecommendedSetting -DeviceManagementTemplateId <String>

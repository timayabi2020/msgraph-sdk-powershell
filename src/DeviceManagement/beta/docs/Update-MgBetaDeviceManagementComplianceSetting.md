...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementcompliancesetting
schema: 2.0.0
---
...
```
Update-MgBetaDeviceManagementComplianceSetting -DeviceManagementConfigurationSettingDefinitionId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceManagementComplianceSetting -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementConfigurationSettingDefinition> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

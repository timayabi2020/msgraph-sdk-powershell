...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementresourceaccessprofileassignment
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementResourceAccessProfileAssignment
 -DeviceManagementResourceAccessProfileBaseId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
Get-MgBetaDeviceManagementResourceAccessProfileAssignment
 ...
 -DeviceManagementResourceAccessProfileBaseId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementResourceAccessProfileAssignment -InputObject <IDeviceManagementIdentity>

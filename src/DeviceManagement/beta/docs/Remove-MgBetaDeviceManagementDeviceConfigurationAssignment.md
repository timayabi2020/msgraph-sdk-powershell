...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementdeviceconfigurationassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceConfigurationAssignment -DeviceConfigurationAssignmentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDeviceConfigurationAssignment -InputObject <IDeviceManagementIdentity>

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmicrosofttunnelsitemicrosofttunnelservercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementMicrosoftTunnelSiteMicrosoftTunnelServerCount -MicrosoftTunnelSiteId <String>

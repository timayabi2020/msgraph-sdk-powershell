...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetaadminedgeinternetexplorermodesitelistsharedcookiecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaAdminEdgeInternetExplorerModeSiteListSharedCookieCount -BrowserSiteListId <String>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaAdminEdgeInternetExplorerModeSiteListSharedCookieCount -InputObject <IDeviceManagementIdentity>
 [-Filter <String>] [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

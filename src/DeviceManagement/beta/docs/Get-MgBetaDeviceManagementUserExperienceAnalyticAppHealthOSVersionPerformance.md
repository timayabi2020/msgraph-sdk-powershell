...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementuserexperienceanalyticapphealthosversionperformance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticAppHealthOSVersionPerformance [-ExpandProperty <String[]>]
...
```
Get-MgBetaDeviceManagementUserExperienceAnalyticAppHealthOSVersionPerformance
 -UserExperienceAnalyticsAppHealthOSVersionPerformanceId <String> [-ExpandProperty <String[]>]

...
Update-MgBetaDeviceManagementCompliancePolicy -DeviceManagementCompliancePolicyId <String>
 ...
 [-Technologies <DeviceManagementConfigurationTechnologies>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceManagementCompliancePolicy -DeviceManagementCompliancePolicyId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementCompliancePolicy> [-CustomHeader <String>] [-Confirm]

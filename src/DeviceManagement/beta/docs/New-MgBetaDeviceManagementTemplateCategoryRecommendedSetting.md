...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementtemplatecategoryrecommendedsetting
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementTemplateCategoryRecommendedSetting -DeviceManagementTemplateId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceManagementTemplateCategoryRecommendedSetting -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementSettingInstance> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

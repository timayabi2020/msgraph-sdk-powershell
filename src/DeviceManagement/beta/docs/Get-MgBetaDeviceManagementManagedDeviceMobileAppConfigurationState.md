...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicemobileappconfigurationstate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementManagedDeviceMobileAppConfigurationState -ManagedDeviceId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementManagedDeviceMobileAppConfigurationState -InputObject <IDeviceManagementIdentity>

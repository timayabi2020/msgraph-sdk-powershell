...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementuserexperienceanalyticbatteryhealthdeviceperformance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthDevicePerformance [-ExpandProperty <String[]>]
...
```
Get-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthDevicePerformance
 -UserExperienceAnalyticsBatteryHealthDevicePerformanceId <String> [-ExpandProperty <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementuserexperienceanalyticbatteryhealthosperformance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthOSPerformance [-ExpandProperty <String[]>]
...
```
Get-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthOSPerformance
 -UserExperienceAnalyticsBatteryHealthOSPerformanceId <String> [-ExpandProperty <String[]>]

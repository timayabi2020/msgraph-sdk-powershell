...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementtemplatecategorysettingdefinition
schema: 2.0.0
---
...
```
Update-MgBetaDeviceManagementTemplateCategorySettingDefinition -DeviceManagementSettingDefinitionId <String>
...
### UpdateViaIdentity
```
Update-MgBetaDeviceManagementTemplateCategorySettingDefinition -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementSettingDefinition> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

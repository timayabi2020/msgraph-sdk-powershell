...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementintentcategorysettingdefinition
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementIntentCategorySettingDefinition -DeviceManagementIntentId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementIntentCategorySettingDefinition -InputObject <IDeviceManagementIdentity>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

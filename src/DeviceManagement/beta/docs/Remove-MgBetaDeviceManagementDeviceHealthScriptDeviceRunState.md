...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementdevicehealthscriptdevicerunstate
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceHealthScriptDeviceRunState -DeviceHealthScriptDeviceStateId <String>
 -DeviceHealthScriptId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDeviceHealthScriptDeviceRunState -InputObject <IDeviceManagementIdentity>

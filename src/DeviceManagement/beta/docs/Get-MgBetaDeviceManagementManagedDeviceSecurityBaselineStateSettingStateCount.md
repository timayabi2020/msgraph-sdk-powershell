...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicesecuritybaselinestatesettingstatecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementManagedDeviceSecurityBaselineStateSettingStateCount -ManagedDeviceId <String>
 -SecurityBaselineStateId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

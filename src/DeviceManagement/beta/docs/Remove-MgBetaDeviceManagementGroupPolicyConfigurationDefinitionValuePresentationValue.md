...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementgrouppolicyconfigurationdefinitionvaluepresentationvalue
schema: 2.0.0
---
...
Remove-MgBetaDeviceManagementGroupPolicyConfigurationDefinitionValuePresentationValue
 ...
 -GroupPolicyPresentationValueId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]

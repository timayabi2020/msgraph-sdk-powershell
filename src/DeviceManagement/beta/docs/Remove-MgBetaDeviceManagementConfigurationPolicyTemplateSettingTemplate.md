...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementconfigurationpolicytemplatesettingtemplate
schema: 2.0.0
---
...
Remove-MgBetaDeviceManagementConfigurationPolicyTemplateSettingTemplate
 ...
 -DeviceManagementConfigurationSettingTemplateId <String> [-IfMatch <String>] [-CustomHeader <String>]

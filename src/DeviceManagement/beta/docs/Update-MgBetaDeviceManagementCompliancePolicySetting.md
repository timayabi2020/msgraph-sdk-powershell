...
Update-MgBetaDeviceManagementCompliancePolicySetting -DeviceManagementCompliancePolicyId <String>
 ...
 [-SettingInstance <IMicrosoftGraphDeviceManagementConfigurationSettingInstance>] [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementCompliancePolicySetting -DeviceManagementCompliancePolicyId <String>
 ...
 -BodyParameter <IMicrosoftGraphDeviceManagementConfigurationSetting> [-CustomHeader <String>] [-Confirm]

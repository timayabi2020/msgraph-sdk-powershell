...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementandroidmanagedstoreappconfigurationschema
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementAndroidManagedStoreAppConfigurationSchema [-ExpandProperty <String[]>]
...
```
Get-MgBetaDeviceManagementAndroidManagedStoreAppConfigurationSchema
 -AndroidManagedStoreAppConfigurationSchemaId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementAndroidManagedStoreAppConfigurationSchema -InputObject <IDeviceManagementIdentity>

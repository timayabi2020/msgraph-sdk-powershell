...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementintentcategory
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementIntentCategory -DeviceManagementIntentId <String>
 -DeviceManagementIntentSettingCategoryId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementIntentCategory -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]

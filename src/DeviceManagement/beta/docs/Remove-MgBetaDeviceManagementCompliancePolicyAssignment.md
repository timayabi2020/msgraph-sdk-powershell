...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementcompliancepolicyassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementCompliancePolicyAssignment -DeviceManagementCompliancePolicyId <String>
 -DeviceManagementConfigurationPolicyAssignmentId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementCompliancePolicyAssignment -InputObject <IDeviceManagementIdentity>

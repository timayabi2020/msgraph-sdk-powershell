...
Update-MgBetaDeviceManagementMonitoringAlertRule -AlertRuleId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Severity <String>] [-Threshold <IMicrosoftGraphDeviceManagementRuleThreshold>] [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementMonitoringAlertRule -AlertRuleId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementAlertRule> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementMonitoringAlertRule -InputObject <IDeviceManagementIdentity>
 ...
 [-Threshold <IMicrosoftGraphDeviceManagementRuleThreshold>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

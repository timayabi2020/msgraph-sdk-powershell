...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementsettingdefinition
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementSettingDefinition -DeviceManagementSettingDefinitionId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementSettingDefinition -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]

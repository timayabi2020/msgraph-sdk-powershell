...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementmanageddeviceassignmentfilterevaluationstatusdetail
schema: 2.0.0
---
...
Update-MgBetaDeviceManagementManagedDeviceAssignmentFilterEvaluationStatusDetail
 ...
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-PayloadId <String>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaDeviceManagementManagedDeviceAssignmentFilterEvaluationStatusDetail
 -AssignmentFilterEvaluationStatusDetailsId <String> -ManagedDeviceId <String>
 -BodyParameter <IMicrosoftGraphAssignmentFilterEvaluationStatusDetails> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementManagedDeviceAssignmentFilterEvaluationStatusDetail
 ...
 [-PayloadId <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

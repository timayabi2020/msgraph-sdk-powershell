...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticDeviceStartupProcess [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementUserExperienceAnalyticDeviceStartupProcess -InputObject <IDeviceManagementIdentity>

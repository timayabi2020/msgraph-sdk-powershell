...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddeviceconfigurationstatecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementManagedDeviceConfigurationStateCount -ManagedDeviceId <String> [-Filter <String>]
 [-Search <String>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementManagedDeviceConfigurationStateCount -InputObject <IDeviceManagementIdentity>

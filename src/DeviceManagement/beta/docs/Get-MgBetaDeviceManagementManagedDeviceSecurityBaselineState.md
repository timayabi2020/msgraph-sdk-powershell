...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicesecuritybaselinestate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementManagedDeviceSecurityBaselineState -ManagedDeviceId <String>
...
```
Get-MgBetaDeviceManagementManagedDeviceSecurityBaselineState -ManagedDeviceId <String>
 -SecurityBaselineStateId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementManagedDeviceSecurityBaselineState -InputObject <IDeviceManagementIdentity>

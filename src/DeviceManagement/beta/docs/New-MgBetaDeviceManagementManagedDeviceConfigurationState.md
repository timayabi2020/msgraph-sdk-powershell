...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementmanageddeviceconfigurationstate
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementManagedDeviceConfigurationState -ManagedDeviceId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceManagementManagedDeviceConfigurationState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceConfigurationState> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

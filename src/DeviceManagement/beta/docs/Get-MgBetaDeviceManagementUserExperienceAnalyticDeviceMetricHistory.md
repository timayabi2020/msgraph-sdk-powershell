...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementuserexperienceanalyticdevicemetrichistory
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticDeviceMetricHistory [-ExpandProperty <String[]>]
...
```
Get-MgBetaDeviceManagementUserExperienceAnalyticDeviceMetricHistory
 -UserExperienceAnalyticsMetricHistoryId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementUserExperienceAnalyticDeviceMetricHistory -InputObject <IDeviceManagementIdentity>

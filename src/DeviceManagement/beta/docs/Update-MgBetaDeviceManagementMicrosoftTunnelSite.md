...
Update-MgBetaDeviceManagementMicrosoftTunnelSite -MicrosoftTunnelSiteId <String>
 ...
 [-UpgradeWindowStartTime <String>] [-UpgradeWindowUtcOffsetInMinutes <Int32>] [-CustomHeader <String>]
...
```
Update-MgBetaDeviceManagementMicrosoftTunnelSite -MicrosoftTunnelSiteId <String>
 -BodyParameter <IMicrosoftGraphMicrosoftTunnelSite> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

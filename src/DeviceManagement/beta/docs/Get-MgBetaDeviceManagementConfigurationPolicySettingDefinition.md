...
### List (Default)
```
Get-MgBetaDeviceManagementConfigurationPolicySettingDefinition -DeviceManagementConfigurationPolicyId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementConfigurationPolicySettingDefinition -InputObject <IDeviceManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

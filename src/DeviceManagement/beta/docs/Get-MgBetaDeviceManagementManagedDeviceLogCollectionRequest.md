...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicelogcollectionrequest
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementManagedDeviceLogCollectionRequest -ManagedDeviceId <String>
...
### Get
```
Get-MgBetaDeviceManagementManagedDeviceLogCollectionRequest -DeviceLogCollectionResponseId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementManagedDeviceLogCollectionRequest -InputObject <IDeviceManagementIdentity>

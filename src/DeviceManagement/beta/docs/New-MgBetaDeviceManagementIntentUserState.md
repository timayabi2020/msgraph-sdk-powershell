...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementintentuserstate
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementIntentUserState -DeviceManagementIntentId <String>
...
### CreateViaIdentity
```
New-MgBetaDeviceManagementIntentUserState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementIntentUserState> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementconfigurationpolicytemplatesettingtemplatecount
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementConfigurationPolicyTemplateSettingTemplateCount
 -DeviceManagementConfigurationPolicyTemplateId <String> [-Filter <String>] [-Search <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementdevicecategory
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementDeviceCategory [-ExpandProperty <String[]>] [-Filter <String>]

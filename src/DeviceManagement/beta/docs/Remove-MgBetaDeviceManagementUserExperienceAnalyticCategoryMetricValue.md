...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementuserexperienceanalyticcategorymetricvalue
schema: 2.0.0
---
...
```
Remove-MgBetaDeviceManagementUserExperienceAnalyticCategoryMetricValue
 -UserExperienceAnalyticsCategoryId <String> -UserExperienceAnalyticsMetricId <String> [-IfMatch <String>]

...
Update-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthDeviceAppImpact
 ...
 [-DeviceId <String>] [-Id <String>] [-IsForegroundApp] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthDeviceAppImpact
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsBatteryHealthDeviceAppImpact> [-CustomHeader <String>]

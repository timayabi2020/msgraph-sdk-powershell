...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementuserexperienceanalyticapphealthdeviceperformance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementUserExperienceAnalyticAppHealthDevicePerformance [-ExpandProperty <String[]>]
...
```
Get-MgBetaDeviceManagementUserExperienceAnalyticAppHealthDevicePerformance
 -UserExperienceAnalyticsAppHealthDevicePerformanceId <String> [-ExpandProperty <String[]>]

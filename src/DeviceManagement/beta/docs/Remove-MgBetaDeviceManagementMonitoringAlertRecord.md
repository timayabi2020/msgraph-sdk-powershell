...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementmonitoringalertrecord
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementMonitoringAlertRecord -AlertRecordId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementMonitoringAlertRecord -InputObject <IDeviceManagementIdentity>

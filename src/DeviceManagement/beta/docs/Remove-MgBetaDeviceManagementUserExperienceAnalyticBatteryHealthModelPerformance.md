...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementuserexperienceanalyticbatteryhealthmodelperformance
schema: 2.0.0
---
...
```
Remove-MgBetaDeviceManagementUserExperienceAnalyticBatteryHealthModelPerformance
 -UserExperienceAnalyticsBatteryHealthModelPerformanceId <String> [-IfMatch <String>] [-CustomHeader <String>]

...
Update-MgBetaDeviceManagementMicrosoftTunnelHealthThreshold -MicrosoftTunnelHealthThresholdId <String>
 ...
 [-HealthyThreshold <Int64>] [-Id <String>] [-UnhealthyThreshold <Int64>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaDeviceManagementMicrosoftTunnelHealthThreshold -MicrosoftTunnelHealthThresholdId <String>
 -BodyParameter <IMicrosoftGraphMicrosoftTunnelHealthThreshold> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

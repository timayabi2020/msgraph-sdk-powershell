...
### List (Default)
```
Get-MgBetaDeviceManagementMonitoringAlertRecord [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementMonitoringAlertRecord -AlertRecordId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementMonitoringAlertRecord -InputObject <IDeviceManagementIdentity>

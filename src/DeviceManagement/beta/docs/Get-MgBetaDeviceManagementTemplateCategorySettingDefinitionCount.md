...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatecategorysettingdefinitioncount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementTemplateCategorySettingDefinitionCount -DeviceManagementTemplateId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementTemplateCategorySettingDefinitionCount -InputObject <IDeviceManagementIdentity>

...
Update-MgBetaDeviceManagementMacOSSoftwareUpdateAccountSummary -MacOSSoftwareUpdateAccountSummaryId <String>
 ...
 [-TotalUpdateCount <Int32>] [-UserId <String>] [-UserPrincipalName <String>] [-CustomHeader <String>]
...
```
Update-MgBetaDeviceManagementMacOSSoftwareUpdateAccountSummary -MacOSSoftwareUpdateAccountSummaryId <String>
 -BodyParameter <IMicrosoftGraphMacOSSoftwareUpdateAccountSummary> [-CustomHeader <String>] [-Confirm]

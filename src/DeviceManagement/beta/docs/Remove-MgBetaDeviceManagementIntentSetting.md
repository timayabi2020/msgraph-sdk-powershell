...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementintentsetting
schema: 2.0.0
---
...
Remove-MgBetaDeviceManagementIntentSetting -DeviceManagementIntentId <String>
 -DeviceManagementSettingInstanceId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

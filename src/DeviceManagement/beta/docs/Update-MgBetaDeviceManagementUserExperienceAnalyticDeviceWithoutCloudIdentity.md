...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementuserexperienceanalyticdevicewithoutcloudidentity
schema: 2.0.0
---
...
Update-MgBetaDeviceManagementUserExperienceAnalyticDeviceWithoutCloudIdentity
 ...
 [-AzureAdDeviceId <String>] [-DeviceName <String>] [-Id <String>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaDeviceManagementUserExperienceAnalyticDeviceWithoutCloudIdentity
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsDeviceWithoutCloudIdentity> [-CustomHeader <String>]
...
Update-MgBetaDeviceManagementUserExperienceAnalyticDeviceWithoutCloudIdentity
 ...
 [-DeviceName <String>] [-Id <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

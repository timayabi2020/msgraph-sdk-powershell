...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementmobileapptroubleshootingeventapplogcollectionrequest
schema: 2.0.0
---
...
```
Remove-MgBetaDeviceManagementMobileAppTroubleshootingEventAppLogCollectionRequest
 -AppLogCollectionRequestId <String> -MobileAppTroubleshootingEventId <String> [-IfMatch <String>]

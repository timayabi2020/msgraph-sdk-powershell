...
### Delete (Default)
```
Remove-MgBetaUserMessage -MessageId <String> -UserId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserMessage -InputObject <IMailIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

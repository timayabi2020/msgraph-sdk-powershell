...
### Get (Default)
```
Get-MgBetaUserInferenceClassification -UserId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserInferenceClassification -InputObject <IMailIdentity> [-Property <String[]>]

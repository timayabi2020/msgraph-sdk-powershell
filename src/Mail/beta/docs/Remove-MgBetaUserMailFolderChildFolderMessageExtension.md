...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/remove-mgbetausermailfolderchildfoldermessageextension
schema: 2.0.0
---
...
Remove-MgBetaUserMailFolderChildFolderMessageExtension -ExtensionId <String> -MailFolderId <String>
 -MailFolderId1 <String> -MessageId <String> -UserId <String> [-IfMatch <String>] [-CustomHeader <String>]

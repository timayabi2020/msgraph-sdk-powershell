...
### List (Default)
```
Get-MgBetaUserMailFolderMessageRule -MailFolderId <String> -UserId <String> [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaUserMailFolderMessageRule -InputObject <IMailIdentity> [-Property <String[]>]

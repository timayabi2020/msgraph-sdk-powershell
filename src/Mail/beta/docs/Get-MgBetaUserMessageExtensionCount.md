...
### Get (Default)
```
Get-MgBetaUserMessageExtensionCount -MessageId <String> -UserId <String> [-Filter <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserMessageExtensionCount -InputObject <IMailIdentity> [-Filter <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

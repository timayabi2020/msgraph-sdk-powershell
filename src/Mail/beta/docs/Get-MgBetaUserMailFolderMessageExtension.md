...
### List (Default)
```
Get-MgBetaUserMailFolderMessageExtension -MailFolderId <String> -MessageId <String> -UserId <String>
...
### Get
```
Get-MgBetaUserMailFolderMessageExtension -ExtensionId <String> -MailFolderId <String> -MessageId <String>
...
### GetViaIdentity
```
Get-MgBetaUserMailFolderMessageExtension -InputObject <IMailIdentity> [-ExpandProperty <String[]>]

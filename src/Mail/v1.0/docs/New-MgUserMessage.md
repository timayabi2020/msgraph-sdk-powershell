...
### Create
```
New-MgUserMessage -UserId <String> -BodyParameter <IMicrosoftGraphMessage> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserMessage -InputObject <IMailIdentity> -BodyParameter <IMicrosoftGraphMessage>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

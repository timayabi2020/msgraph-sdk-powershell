...
New-MgUserMailFolder -UserId <String> [-AdditionalProperties <Hashtable>] [-ChildFolderCount <Int32>]
 ...
 [-TotalItemCount <Int32>] [-UnreadItemCount <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-MgUserMailFolder -UserId <String> -BodyParameter <IMicrosoftGraphMailFolder> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserMailFolder -InputObject <IMailIdentity> -BodyParameter <IMicrosoftGraphMailFolder>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserMailFolder -InputObject <IMailIdentity> [-AdditionalProperties <Hashtable>]

...
Update-MgUserMailFolderChildFolderMessageRule -MailFolderId <String> -MailFolderId1 <String>
 ...
 [-IsEnabled] [-IsReadOnly] [-Sequence <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgUserMailFolderChildFolderMessageRule -MailFolderId <String> -MailFolderId1 <String>
 -MessageRuleId <String> -UserId <String> -BodyParameter <IMicrosoftGraphMessageRule> [-CustomHeader <String>]
...
Update-MgUserMailFolderChildFolderMessageRule -InputObject <IMailIdentity>
 -BodyParameter <IMicrosoftGraphMessageRule> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgUserMailFolderChildFolderMessageRule -InputObject <IMailIdentity>
 ...
 [-Sequence <Int32>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

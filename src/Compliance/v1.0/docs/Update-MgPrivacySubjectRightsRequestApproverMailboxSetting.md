...
```
Update-MgPrivacySubjectRightsRequestApproverMailboxSetting -SubjectRightsRequestId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgPrivacySubjectRightsRequestApproverMailboxSetting -InputObject <IComplianceIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

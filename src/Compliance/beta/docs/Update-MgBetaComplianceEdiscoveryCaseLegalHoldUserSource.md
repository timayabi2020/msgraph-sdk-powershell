...
```
Update-MgBetaComplianceEdiscoveryCaseLegalHoldUserSource -CaseId <String> -LegalHoldId <String>
 -UserSourceId <String> -BodyParameter <IMicrosoftGraphEdiscoveryUserSource> [-CustomHeader <String>]
...
Update-MgBetaComplianceEdiscoveryCaseLegalHoldUserSource -InputObject <IComplianceIdentity>
 -BodyParameter <IMicrosoftGraphEdiscoveryUserSource> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

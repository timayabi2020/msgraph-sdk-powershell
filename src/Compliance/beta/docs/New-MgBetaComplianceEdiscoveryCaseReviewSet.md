...
New-MgBetaComplianceEdiscoveryCaseReviewSet -CaseId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-Queries <IMicrosoftGraphEdiscoveryReviewSetQuery[]>] [-CustomHeader <String>] [-Confirm]
...
New-MgBetaComplianceEdiscoveryCaseReviewSet -CaseId <String>
 -BodyParameter <IMicrosoftGraphEdiscoveryReviewSet> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

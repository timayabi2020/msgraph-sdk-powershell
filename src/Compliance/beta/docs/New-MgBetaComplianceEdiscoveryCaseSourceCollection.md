...
New-MgBetaComplianceEdiscoveryCaseSourceCollection -CaseId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-NoncustodialSources <IMicrosoftGraphEdiscoveryNoncustodialDataSource[]>] [-CustomHeader <String>]
...
New-MgBetaComplianceEdiscoveryCaseSourceCollection -CaseId <String>
 -BodyParameter <IMicrosoftGraphEdiscoverySourceCollection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

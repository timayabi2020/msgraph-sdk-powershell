...
### Close (Default)
```
Close-MgBetaComplianceEdiscoveryCase -CaseId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CloseViaIdentity
```
Close-MgBetaComplianceEdiscoveryCase -InputObject <IComplianceIdentity> [-CustomHeader <String>] [-PassThru]

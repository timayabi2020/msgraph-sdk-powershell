...
### Activate (Default)
```
Initialize-MgBetaComplianceEdiscoveryCaseCustodian -CaseId <String> -CustodianId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ActivateViaIdentity
```
Initialize-MgBetaComplianceEdiscoveryCaseCustodian -InputObject <IComplianceIdentity> [-CustomHeader <String>]

...
### Reopen (Default)
```
Invoke-MgBetaReopenComplianceEdiscoveryCase -CaseId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ReopenViaIdentity
```
Invoke-MgBetaReopenComplianceEdiscoveryCase -InputObject <IComplianceIdentity> [-CustomHeader <String>]

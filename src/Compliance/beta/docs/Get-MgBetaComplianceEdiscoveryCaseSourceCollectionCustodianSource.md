...
### List (Default)
```
Get-MgBetaComplianceEdiscoveryCaseSourceCollectionCustodianSource -CaseId <String>
 -SourceCollectionId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
Get-MgBetaComplianceEdiscoveryCaseSourceCollectionCustodianSource -CaseId <String> -DataSourceId <String>
 -SourceCollectionId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

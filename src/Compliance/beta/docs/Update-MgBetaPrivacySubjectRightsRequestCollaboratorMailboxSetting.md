...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.compliance/update-mgbetaprivacysubjectrightsrequestcollaboratormailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaPrivacySubjectRightsRequestCollaboratorMailboxSetting -SubjectRightsRequestId <String>
...
### UpdateViaIdentity
```
Update-MgBetaPrivacySubjectRightsRequestCollaboratorMailboxSetting -InputObject <IComplianceIdentity>

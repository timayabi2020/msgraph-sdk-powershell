...
Update-MgBetaComplianceEdiscoveryCaseSetting -CaseId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-TopicModeling <IMicrosoftGraphEdiscoveryTopicModelingSettings>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaComplianceEdiscoveryCaseSetting -CaseId <String>
 -BodyParameter <IMicrosoftGraphEdiscoveryCaseSettings> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamprimarychannelmessage
schema: 2.0.0
---
...
```
Update-MgBetaGroupTeamPrimaryChannelMessage -ChatMessageId <String> -GroupId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupTeamPrimaryChannelMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaGroupTeamPrimaryChannelMessage -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]

...
### Remove (Default)
```
Remove-MgBetaTeamworkDeletedTeamChannelEmail -ChannelId <String> -DeletedTeamId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>]

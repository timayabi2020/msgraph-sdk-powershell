...
### List (Default)
```
Get-MgBetaGroupTeamOwner -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaGroupTeamOwner -GroupId <String> -UserId <String> [-ExpandProperty <String[]>]

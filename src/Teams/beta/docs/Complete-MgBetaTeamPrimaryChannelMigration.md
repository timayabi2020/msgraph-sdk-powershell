...
### Complete (Default)
```
Complete-MgBetaTeamPrimaryChannelMigration -TeamId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaTeamPrimaryChannelMigration -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru]

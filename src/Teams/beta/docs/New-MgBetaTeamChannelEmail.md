...
### Provision (Default)
```
New-MgBetaTeamChannelEmail -ChannelId <String> -TeamId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaTeamChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

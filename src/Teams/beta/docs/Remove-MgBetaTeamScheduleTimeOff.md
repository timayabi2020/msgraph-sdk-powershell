...
### Delete (Default)
```
Remove-MgBetaTeamScheduleTimeOff -TeamId <String> -TimeOffId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamScheduleTimeOff -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

...
### Delta (Default)
```
Get-MgBetaChatMessageReplyDelta -ChatId <String> -ChatMessageId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaChatMessageReplyDelta -InputObject <ITeamsIdentity> [-Count] [-Filter <String>]

...
### Delete (Default)
```
Remove-MgBetaGroupTeamScheduleSchedulingGroup -GroupId <String> -SchedulingGroupId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupTeamScheduleSchedulingGroup -InputObject <ITeamsIdentity> [-IfMatch <String>]

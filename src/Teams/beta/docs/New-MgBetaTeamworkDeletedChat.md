...
```
New-MgBetaTeamworkDeletedChat [-AdditionalProperties <Hashtable>] [-Id <String>] [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaTeamworkDeletedChat -BodyParameter <Hashtable> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

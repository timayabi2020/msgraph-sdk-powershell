...
### Delete (Default)
```
Remove-MgBetaTeamworkDeletedTeamChannelSharedWithTeam -ChannelId <String> -DeletedTeamId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaTeamworkDeletedTeamChannelSharedWithTeam -InputObject <ITeamsIdentity> [-IfMatch <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetagroupteampermissiongrant
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaGroupTeamPermissionGrant -InputObject <ITeamsIdentity> [-IfMatch <String>]

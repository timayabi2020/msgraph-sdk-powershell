...
### Delete (Default)
```
Remove-MgBetaTeamInstalledApp -TeamId <String> -TeamsAppInstallationId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

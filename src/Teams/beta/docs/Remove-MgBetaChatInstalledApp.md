...
### Delete (Default)
```
Remove-MgBetaChatInstalledApp -ChatId <String> -TeamsAppInstallationId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaChatInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

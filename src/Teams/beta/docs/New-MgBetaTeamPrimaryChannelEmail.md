...
### Provision (Default)
```
New-MgBetaTeamPrimaryChannelEmail -TeamId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaTeamPrimaryChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

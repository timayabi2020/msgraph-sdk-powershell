...
Update-MgBetaGroupTeamScheduleTimeCard -GroupId <String> -TimeCardId <String>
 ...
 [-OriginalEntry <IMicrosoftGraphTimeCardEntry>] [-State <String>] [-UserId <String>] [-CustomHeader <String>]
...
```
Update-MgBetaGroupTeamScheduleTimeCard -GroupId <String> -TimeCardId <String>
 -BodyParameter <IMicrosoftGraphTimeCard> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

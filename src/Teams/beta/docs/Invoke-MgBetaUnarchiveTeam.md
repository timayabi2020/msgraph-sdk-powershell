...
### Unarchive (Default)
```
Invoke-MgBetaUnarchiveTeam -TeamId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UnarchiveViaIdentity
```
Invoke-MgBetaUnarchiveTeam -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

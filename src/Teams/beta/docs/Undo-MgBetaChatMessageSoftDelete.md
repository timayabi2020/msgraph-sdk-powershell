...
### Undo (Default)
```
Undo-MgBetaChatMessageSoftDelete -ChatId <String> -ChatMessageId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UndoViaIdentity
```
Undo-MgBetaChatMessageSoftDelete -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

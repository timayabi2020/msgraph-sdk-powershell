...
```
New-MgBetaTeamScheduleTimeOffReason -TeamId <String> [-AdditionalProperties <Hashtable>] [-Code <String>]
...
### Create
```
New-MgBetaTeamScheduleTimeOffReason -TeamId <String> -BodyParameter <IMicrosoftGraphTimeOffReason> [-Confirm]

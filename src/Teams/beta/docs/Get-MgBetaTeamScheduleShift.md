...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamscheduleshift
schema: 2.0.0
---
...
### Get
```
Get-MgBetaTeamScheduleShift -ShiftId <String> -TeamId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaTeamScheduleShift -InputObject <ITeamsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

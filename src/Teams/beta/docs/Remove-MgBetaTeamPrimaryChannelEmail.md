...
### Remove (Default)
```
Remove-MgBetaTeamPrimaryChannelEmail -TeamId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaTeamPrimaryChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru]

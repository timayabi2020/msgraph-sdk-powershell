...
Update-MgBetaTeamworkDeviceHealth -TeamworkDeviceId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-SoftwareUpdateHealth <IMicrosoftGraphTeamworkSoftwareUpdateHealth>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaTeamworkDeviceHealth -TeamworkDeviceId <String>
 -BodyParameter <IMicrosoftGraphTeamworkDeviceHealth> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

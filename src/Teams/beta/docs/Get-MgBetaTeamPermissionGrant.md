...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateampermissiongrant
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaTeamPermissionGrant -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetauserchatmessagehostedcontent
schema: 2.0.0
---
...
```
New-MgBetaUserChatMessageHostedContent -ChatId <String> -ChatMessageId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgBetaUserChatMessageHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaUserChatMessageHostedContent -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]

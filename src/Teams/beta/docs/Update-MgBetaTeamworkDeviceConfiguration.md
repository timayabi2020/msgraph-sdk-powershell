...
Update-MgBetaTeamworkDeviceConfiguration -TeamworkDeviceId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-TeamsClientConfiguration <IMicrosoftGraphTeamworkTeamsClientConfiguration>] [-CustomHeader <String>]
...
Update-MgBetaTeamworkDeviceConfiguration -TeamworkDeviceId <String>
 -BodyParameter <IMicrosoftGraphTeamworkDeviceConfiguration> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

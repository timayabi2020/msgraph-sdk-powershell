...
### Delete (Default)
```
Remove-MgBetaChatTab -ChatId <String> -TeamsTabId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaChatTab -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

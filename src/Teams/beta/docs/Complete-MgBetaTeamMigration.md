...
### Complete (Default)
```
Complete-MgBetaTeamMigration -TeamId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaTeamMigration -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

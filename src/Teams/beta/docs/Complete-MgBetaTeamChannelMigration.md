...
### Complete (Default)
```
Complete-MgBetaTeamChannelMigration -ChannelId <String> -TeamId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaTeamChannelMigration -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

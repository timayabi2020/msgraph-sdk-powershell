...
Update-MgBetaGroupTeamScheduleDayNote -DayNoteId <String> -GroupId <String>
 ...
 [-SharedDayNote <IMicrosoftGraphItemBody>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaGroupTeamScheduleDayNote -DayNoteId <String> -GroupId <String>
 -BodyParameter <IMicrosoftGraphDayNote> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

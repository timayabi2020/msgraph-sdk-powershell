...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetachatmessagehostedcontent
schema: 2.0.0
---
...
### Get
```
Get-MgBetaChatMessageHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```
...
```
Get-MgBetaChatMessageHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -OutFile <String> [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```
...
### GetViaIdentity1
```
Get-MgBetaChatMessageHostedContent -InputObject <ITeamsIdentity> -OutFile <String> [-CustomHeader <String>]

...
### Confirm (Default)
```
Confirm-MgBetaTeamScheduleTimeCard -TeamId <String> -TimeCardId <String> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ConfirmViaIdentity
```
Confirm-MgBetaTeamScheduleTimeCard -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

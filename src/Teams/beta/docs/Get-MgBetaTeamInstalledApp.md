...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateaminstalledapp
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaTeamInstalledApp -TeamId <String> [-ExpandProperty <String[]>] [-Filter <String>]

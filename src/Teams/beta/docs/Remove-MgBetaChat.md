...
### Delete (Default)
```
Remove-MgBetaChat -ChatId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaChat -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

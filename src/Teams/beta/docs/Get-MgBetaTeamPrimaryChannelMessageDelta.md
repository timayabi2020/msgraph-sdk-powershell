...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamprimarychannelmessagedelta
schema: 2.0.0
---
...
### Delta (Default)
```
Get-MgBetaTeamPrimaryChannelMessageDelta -TeamId <String> [-Filter <String>] [-Property <String[]>]

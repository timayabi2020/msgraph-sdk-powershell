...
```
New-MgBetaTeamChannelMessageReply -ChannelId <String> -ChatMessageId <String> -TeamId <String>
...
### CreateViaIdentity
```
New-MgBetaTeamChannelMessageReply -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChatMessage>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaTeamChannelMessageReply -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]

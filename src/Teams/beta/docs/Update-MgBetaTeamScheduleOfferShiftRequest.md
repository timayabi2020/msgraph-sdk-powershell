...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamscheduleoffershiftrequest
schema: 2.0.0
---
...
```
Update-MgBetaTeamScheduleOfferShiftRequest -OfferShiftRequestId <String> -TeamId <String>
 ...
 [-SenderShiftId <String>] [-State <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaTeamScheduleOfferShiftRequest -OfferShiftRequestId <String> -TeamId <String>
 -BodyParameter <IMicrosoftGraphOfferShiftRequest> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgBetaTeamScheduleOfferShiftRequest -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphOfferShiftRequest> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaTeamScheduleOfferShiftRequest -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]

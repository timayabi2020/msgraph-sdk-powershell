...
### List (Default)
```
Get-MgBetaTeamworkDeletedChat [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgBetaTeamworkDeletedChat -DeletedChatId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaTeamworkDeletedChat -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDeletedChat

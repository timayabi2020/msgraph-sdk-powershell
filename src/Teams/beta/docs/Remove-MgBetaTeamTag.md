...
### Delete (Default)
```
Remove-MgBetaTeamTag -TeamId <String> -TeamworkTagId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamTag -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

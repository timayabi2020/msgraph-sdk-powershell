...
### Delete (Default)
```
Remove-MgBetaGroupTeamTag -GroupId <String> -TeamworkTagId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupTeamTag -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

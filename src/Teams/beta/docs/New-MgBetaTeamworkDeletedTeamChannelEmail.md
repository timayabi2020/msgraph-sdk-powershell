...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelemail
schema: 2.0.0
---
...
### Provision (Default)
```
New-MgBetaTeamworkDeletedTeamChannelEmail -ChannelId <String> -DeletedTeamId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-Confirm]

...
### Delete (Default)
```
Remove-MgBetaAppCatalogTeamAppDefinitionBot -TeamsAppDefinitionId <String> -TeamsAppId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaAppCatalogTeamAppDefinitionBot -InputObject <ITeamsIdentity> [-IfMatch <String>]

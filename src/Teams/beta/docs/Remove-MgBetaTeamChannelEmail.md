...
### Remove (Default)
```
Remove-MgBetaTeamChannelEmail -ChannelId <String> -TeamId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaTeamChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

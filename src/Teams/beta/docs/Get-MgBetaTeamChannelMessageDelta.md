...
### Delta (Default)
```
Get-MgBetaTeamChannelMessageDelta -ChannelId <String> -TeamId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaTeamChannelMessageDelta -InputObject <ITeamsIdentity> [-Count] [-Filter <String>]

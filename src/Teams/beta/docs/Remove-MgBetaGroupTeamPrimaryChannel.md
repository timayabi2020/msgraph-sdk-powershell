...
### Delete (Default)
```
Remove-MgBetaGroupTeamPrimaryChannel -GroupId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupTeamPrimaryChannel -InputObject <ITeamsIdentity> [-IfMatch <String>]

...
### Run (Default)
```
Start-MgBetaTeamworkDeviceDiagnostic -TeamworkDeviceId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RunViaIdentity
```
Start-MgBetaTeamworkDeviceDiagnostic -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

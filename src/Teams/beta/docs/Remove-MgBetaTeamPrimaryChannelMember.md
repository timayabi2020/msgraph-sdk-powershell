...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetateamprimarychannelmember
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaTeamPrimaryChannelMember -InputObject <ITeamsIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaGroupTeamScheduleShift -GroupId <String> -ShiftId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupTeamScheduleShift -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

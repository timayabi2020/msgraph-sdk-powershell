...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamworkdeletedteamchannelmessagereply
schema: 2.0.0
---
...
```
New-MgTeamworkDeletedTeamChannelMessageReply -ChannelId <String> -ChatMessageId <String>
 -DeletedTeamId <String> -BodyParameter <IMicrosoftGraphChatMessage> [-CustomHeader <String>] [-Confirm]

...
### Delete (Default)
```
Remove-MgTeamTag -TeamId <String> -TeamworkTagId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamTag -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

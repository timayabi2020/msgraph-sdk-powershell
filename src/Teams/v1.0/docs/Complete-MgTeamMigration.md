...
### Complete (Default)
```
Complete-MgTeamMigration -TeamId <String> [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgTeamMigration -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

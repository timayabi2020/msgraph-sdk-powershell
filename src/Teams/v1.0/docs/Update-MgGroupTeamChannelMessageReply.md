...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteamchannelmessagereply
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgGroupTeamChannelMessageReply -InputObject <ITeamsIdentity>

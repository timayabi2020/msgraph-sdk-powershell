...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mggroupteamchanneltab
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgGroupTeamChannelTab -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

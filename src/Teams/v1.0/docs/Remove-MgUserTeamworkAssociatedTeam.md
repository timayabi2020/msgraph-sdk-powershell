...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mguserteamworkassociatedteam
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgUserTeamworkAssociatedTeam -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

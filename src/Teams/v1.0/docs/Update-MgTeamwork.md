...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamwork
schema: 2.0.0
---
...
```
Update-MgTeamwork [-AdditionalProperties <Hashtable>] [-DeletedChats <IMicrosoftGraphDeletedChat[]>]
 [-DeletedTeams <IMicrosoftGraphDeletedTeam[]>] [-Id <String>] [-ResponseHeadersVariable <String>]
 [-TeamsAppSettings <IMicrosoftGraphTeamsAppSettings>]
 [-WorkforceIntegrations <IMicrosoftGraphWorkforceIntegration[]>] [-Headers <IDictionary>] [-Confirm]
...
`BODYPARAMETER <IMicrosoftGraphTeamwork>`: teamwork
  ...
  - `[DeletedChats <IMicrosoftGraphDeletedChat[]>]`: 
    - `[Id <String>]`: The unique identifier for an entity. Read-only.
  ...
  - `[TeamsAppSettings <IMicrosoftGraphTeamsAppSettings>]`: teamsAppSettings
    - `[(Any) <Object>]`: This indicates any property can be added to this object.
    - `[Id <String>]`: The unique identifier for an entity. Read-only.

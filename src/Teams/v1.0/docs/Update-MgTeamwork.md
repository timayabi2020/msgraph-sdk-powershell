...
Update-MgTeamwork [-AdditionalProperties <Hashtable>] [-DeletedTeams <IMicrosoftGraphDeletedTeam[]>]
 [-Id <String>] [-TeamsAppSettings <IMicrosoftGraphTeamsAppSettings>]
 [-WorkforceIntegrations <IMicrosoftGraphWorkforceIntegration[]>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgTeamwork -BodyParameter <IMicrosoftGraphTeamwork> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgTeamPhotoContent -TeamId <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamPhotoContent -InputObject <ITeamsIdentity> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

...
### Provision (Default)
```
New-MgTeamPrimaryChannelEmail -TeamId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgTeamPrimaryChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

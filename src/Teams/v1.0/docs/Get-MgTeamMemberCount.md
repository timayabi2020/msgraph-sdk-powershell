...
### Get (Default)
```
Get-MgTeamMemberCount -TeamId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamMemberCount -InputObject <ITeamsIdentity> [-Filter <String>] [-Search <String>]

...
### Delete (Default)
```
Remove-MgGroupTeamChannelSharedWithTeam -ChannelId <String> -GroupId <String>
...
### DeleteViaIdentity
```
Remove-MgGroupTeamChannelSharedWithTeam -InputObject <ITeamsIdentity> [-IfMatch <String>]

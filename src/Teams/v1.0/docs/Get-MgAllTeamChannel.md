...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgallteamchannel
schema: 2.0.0
---
...
### List (Default)
```
Get-MgAllTeamChannel -TeamId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]

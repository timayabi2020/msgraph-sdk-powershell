...
### Provision (Default)
```
New-MgTeamworkDeletedTeamChannelEmail -ChannelId <String> -DeletedTeamId <String> [-CustomHeader <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-Confirm]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgchatmessagereplyhostedcontent
schema: 2.0.0
---
...
```
New-MgChatMessageReplyHostedContent -ChatId <String> -ChatMessageId <String> -ChatMessageId1 <String>
...
### CreateViaIdentity
```
New-MgChatMessageReplyHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgChatMessageReplyHostedContent -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]

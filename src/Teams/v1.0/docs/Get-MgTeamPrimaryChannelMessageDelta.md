...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychannelmessagedelta
schema: 2.0.0
---
...
### Delta (Default)
```
Get-MgTeamPrimaryChannelMessageDelta -TeamId <String> [-Filter <String>] [-Property <String[]>]

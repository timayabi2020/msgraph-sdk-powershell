...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamscheduletimeoffreason
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgGroupTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-Property <String[]>]
 [-CustomHeader <String>] [<CommonParameters>]
```

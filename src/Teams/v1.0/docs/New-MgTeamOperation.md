...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamoperation
schema: 2.0.0
---
...
### Create
```
New-MgTeamOperation -TeamId <String> -BodyParameter <IMicrosoftGraphTeamsAsyncOperation>

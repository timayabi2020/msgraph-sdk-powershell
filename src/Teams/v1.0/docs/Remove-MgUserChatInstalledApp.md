...
### Delete (Default)
```
Remove-MgUserChatInstalledApp -ChatId <String> -TeamsAppInstallationId <String> -UserId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserChatInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

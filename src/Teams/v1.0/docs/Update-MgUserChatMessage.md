...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mguserchatmessage
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgUserChatMessage -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChatMessage>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserChatMessage -InputObject <ITeamsIdentity> [-ChatId <String>] [-AdditionalProperties <Hashtable>]

...
### Get (Default)
```
Get-MgTeamPrimaryChannelFileFolderContent -TeamId <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamPrimaryChannelFileFolderContent -InputObject <ITeamsIdentity> -OutFile <String>

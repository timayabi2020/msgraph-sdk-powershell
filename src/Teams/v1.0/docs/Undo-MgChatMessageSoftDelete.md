...
### Undo (Default)
```
Undo-MgChatMessageSoftDelete -ChatId <String> -ChatMessageId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UndoViaIdentity
```
Undo-MgChatMessageSoftDelete -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

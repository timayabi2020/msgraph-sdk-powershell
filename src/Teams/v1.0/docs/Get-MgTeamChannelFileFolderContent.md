...
### Get (Default)
```
Get-MgTeamChannelFileFolderContent -ChannelId <String> -TeamId <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamChannelFileFolderContent -InputObject <ITeamsIdentity> -OutFile <String> [-CustomHeader <String>]

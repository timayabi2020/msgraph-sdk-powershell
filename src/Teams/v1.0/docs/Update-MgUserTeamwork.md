...
Update-MgUserTeamwork -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-InstalledApps <IMicrosoftGraphUserScopeTeamsAppInstallation[]>] [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgUserTeamwork -UserId <String> -BodyParameter <IMicrosoftGraphUserTeamwork> [-CustomHeader <String>]
...
To construct, see NOTES section for ASSOCIATEDTEAMS properties and create a hash table.

```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAssociatedTeamInfo[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:

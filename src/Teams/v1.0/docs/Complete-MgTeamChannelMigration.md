...
### Complete (Default)
```
Complete-MgTeamChannelMigration -ChannelId <String> -TeamId <String> [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgTeamChannelMigration -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]

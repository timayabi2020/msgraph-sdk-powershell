...
### Remove (Default)
```
Remove-MgTeamChannelEmail -ChannelId <String> -TeamId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgTeamChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

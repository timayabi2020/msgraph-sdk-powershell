...
### Complete (Default)
```
Complete-MgTeamPrimaryChannelMigration -TeamId <String> [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgTeamPrimaryChannelMigration -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru]

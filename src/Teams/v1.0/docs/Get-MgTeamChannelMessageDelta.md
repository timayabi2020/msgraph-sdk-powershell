...
### Delta (Default)
```
Get-MgTeamChannelMessageDelta -ChannelId <String> -TeamId <String> [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity
```
Get-MgTeamChannelMessageDelta -InputObject <ITeamsIdentity> [-Count] [-Filter <String>] [-Property <String[]>]

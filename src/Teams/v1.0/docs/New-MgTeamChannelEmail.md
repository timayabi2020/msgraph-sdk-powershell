...
### Provision (Default)
```
New-MgTeamChannelEmail -ChannelId <String> -TeamId <String> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgTeamChannelEmail -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

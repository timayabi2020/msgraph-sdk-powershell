...
### Get (Default)
```
Get-MgGroupTeamPrimaryChannelFileFolderContent -GroupId <String> -OutFile <String> [-CustomHeader <String>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupTeamPrimaryChannelFileFolderContent -InputObject <ITeamsIdentity> -OutFile <String>

...
### Undo (Default)
```
Undo-MgTeamChannelMessageSoftDelete -ChannelId <String> -ChatMessageId <String> -TeamId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UndoViaIdentity
```
Undo-MgTeamChannelMessageSoftDelete -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru]

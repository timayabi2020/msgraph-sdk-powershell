...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelsharedwithteam
schema: 2.0.0
---
...
### List (Default)
```
Get-MgGroupTeamPrimaryChannelSharedWithTeam -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgGroupTeamPrimaryChannelSharedWithTeam -GroupId <String> -SharedWithChannelTeamInfoId <String>
...
### GetViaIdentity
```
Get-MgGroupTeamPrimaryChannelSharedWithTeam -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]

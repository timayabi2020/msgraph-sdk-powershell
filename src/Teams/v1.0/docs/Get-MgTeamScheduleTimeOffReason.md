...
### List (Default)
```
Get-MgTeamScheduleTimeOffReason -TeamId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### GetViaIdentity
```
Get-MgTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

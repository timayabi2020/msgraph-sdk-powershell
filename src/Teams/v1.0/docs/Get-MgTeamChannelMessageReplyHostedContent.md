...
### List (Default)
```
Get-MgTeamChannelMessageReplyHostedContent -ChannelId <String> -ChatMessageId <String>
...
### GetViaIdentity
```
Get-MgTeamChannelMessageReplyHostedContent -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgTeamChannelMessageReplyHostedContent -InputObject <ITeamsIdentity> -OutFile <String>

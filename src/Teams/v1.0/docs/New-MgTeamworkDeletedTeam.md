...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamworkdeletedteam
schema: 2.0.0
---
...
### Create
```
New-MgTeamworkDeletedTeam -BodyParameter <IMicrosoftGraphDeletedTeam> [-ResponseHeadersVariable <String>]

...
### Get (Default)
```
Get-MgTeamScheduleShiftCount -TeamId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamScheduleShiftCount -InputObject <ITeamsIdentity> [-Filter <String>] [-Search <String>]

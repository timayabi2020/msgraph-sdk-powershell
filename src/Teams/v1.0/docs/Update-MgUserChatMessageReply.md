...
```
Update-MgUserChatMessageReply -ChatId <String> -ChatMessageId <String> -ChatMessageId1 <String>
...
```
Update-MgUserChatMessageReply -ChatId <String> -ChatMessageId <String> -ChatMessageId1 <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphChatMessage> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgUserChatMessageReply -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChatMessage>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserChatMessageReply -InputObject <ITeamsIdentity> [-ChatId <String>]

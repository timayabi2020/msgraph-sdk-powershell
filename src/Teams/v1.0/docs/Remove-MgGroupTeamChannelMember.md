...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mggroupteamchannelmember
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgGroupTeamChannelMember -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

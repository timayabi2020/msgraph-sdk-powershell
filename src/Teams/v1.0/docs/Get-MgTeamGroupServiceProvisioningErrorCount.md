...
### Get (Default)
```
Get-MgTeamGroupServiceProvisioningErrorCount -TeamId <String> [-Filter <String>] [-Search <String>]
 [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamGroupServiceProvisioningErrorCount -InputObject <ITeamsIdentity> [-Filter <String>]

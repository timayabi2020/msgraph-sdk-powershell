...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamworkdeletedteamchannelmember
schema: 2.0.0
---
...
Update-MgTeamworkDeletedTeamChannelMember -ChannelId <String> -ConversationMemberId <String>
 ...
 [-Roles <String[]>] [-VisibleHistoryStartDateTime <DateTime>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgTeamworkDeletedTeamChannelMember -ChannelId <String> -ConversationMemberId <String>
 -DeletedTeamId <String> -BodyParameter <IMicrosoftGraphConversationMember> [-CustomHeader <String>]

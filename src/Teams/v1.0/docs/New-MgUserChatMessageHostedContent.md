...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mguserchatmessagehostedcontent
schema: 2.0.0
---
...
```
New-MgUserChatMessageHostedContent -ChatId <String> -ChatMessageId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserChatMessageHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserChatMessageHostedContent -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]

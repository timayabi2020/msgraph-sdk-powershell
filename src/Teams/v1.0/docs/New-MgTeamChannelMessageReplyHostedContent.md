...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamchannelmessagereplyhostedcontent
schema: 2.0.0
---
...
```
New-MgTeamChannelMessageReplyHostedContent -ChannelId <String> -ChatMessageId <String>
...
```
New-MgTeamChannelMessageReplyHostedContent -ChannelId <String> -ChatMessageId <String>
 -ChatMessageId1 <String> -TeamId <String> -BodyParameter <Hashtable> [-CustomHeader <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgTeamChannelMessageReplyHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable>

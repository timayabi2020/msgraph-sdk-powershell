...
### Get
```
Get-MgTeamScheduleShift -ShiftId <String> -TeamId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamScheduleShift -InputObject <ITeamsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

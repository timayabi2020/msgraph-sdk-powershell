...
### Undo (Default)
```
Undo-MgTeamPrimaryChannelMessageSoftDelete -ChatMessageId <String> -TeamId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UndoViaIdentity
```
Undo-MgTeamPrimaryChannelMessageSoftDelete -InputObject <ITeamsIdentity> [-CustomHeader <String>] [-PassThru]

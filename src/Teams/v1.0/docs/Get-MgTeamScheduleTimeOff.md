...
### Get
```
Get-MgTeamScheduleTimeOff -TeamId <String> -TimeOffId <String> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamScheduleTimeOff -InputObject <ITeamsIdentity> [-Property <String[]>] [-CustomHeader <String>]
 [<CommonParameters>]
```

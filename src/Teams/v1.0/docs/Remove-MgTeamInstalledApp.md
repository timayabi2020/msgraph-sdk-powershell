...
### Delete (Default)
```
Remove-MgTeamInstalledApp -TeamId <String> -TeamsAppInstallationId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

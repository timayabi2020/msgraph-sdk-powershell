...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychannelmessagereplyhostedcontent
schema: 2.0.0
---
...
```
Get-MgTeamPrimaryChannelMessageReplyHostedContent -ChatMessageHostedContentId <String> -ChatMessageId <String>
 -ChatMessageId1 <String> -TeamId <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```
...
### GetViaIdentity1
```
Get-MgTeamPrimaryChannelMessageReplyHostedContent -InputObject <ITeamsIdentity> -OutFile <String>

...
### Delete (Default)
```
Remove-MgChatPinnedMessage -ChatId <String> -PinnedChatMessageInfoId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgChatPinnedMessage -InputObject <ITeamsIdentity> [-IfMatch <String>] [-CustomHeader <String>]

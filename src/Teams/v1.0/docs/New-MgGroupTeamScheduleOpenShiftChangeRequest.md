...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamscheduleopenshiftchangerequest
schema: 2.0.0
---
...
```
New-MgGroupTeamScheduleOpenShiftChangeRequest -GroupId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgGroupTeamScheduleOpenShiftChangeRequest -GroupId <String>
...
### CreateViaIdentity
```
New-MgGroupTeamScheduleOpenShiftChangeRequest -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphOpenShiftChangeRequest> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

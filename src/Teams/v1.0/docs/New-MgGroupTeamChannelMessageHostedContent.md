...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamchannelmessagehostedcontent
schema: 2.0.0
---
...
```
New-MgGroupTeamChannelMessageHostedContent -ChannelId <String> -ChatMessageId <String> -GroupId <String>
...
### CreateViaIdentity
```
New-MgGroupTeamChannelMessageHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupTeamChannelMessageHostedContent -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]

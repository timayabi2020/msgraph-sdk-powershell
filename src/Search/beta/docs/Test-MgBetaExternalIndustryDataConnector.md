...
### Validate (Default)
```
Test-MgBetaExternalIndustryDataConnector -IndustryDataConnectorId <String> [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ValidateViaIdentity
```
Test-MgBetaExternalIndustryDataConnector -InputObject <ISearchIdentity> [-CustomHeader <String>] [-PassThru]

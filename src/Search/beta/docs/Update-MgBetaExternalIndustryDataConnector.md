...
Update-MgBetaExternalIndustryDataConnector -IndustryDataConnectorId <String>
 ...
 [-SourceSystem <IMicrosoftGraphIndustryDataSourceSystemDefinition>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaExternalIndustryDataConnector -IndustryDataConnectorId <String>
 -BodyParameter <IMicrosoftGraphIndustryDataConnector> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

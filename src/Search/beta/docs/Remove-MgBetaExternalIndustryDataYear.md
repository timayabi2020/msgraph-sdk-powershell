...
### Delete (Default)
```
Remove-MgBetaExternalIndustryDataYear -YearTimePeriodDefinitionId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaExternalIndustryDataYear -InputObject <ISearchIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-MgBetaExternalIndustryDataRoleGroup -RoleGroupId <String> [-IfMatch <String>] [-CustomHeader <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaExternalIndustryDataRoleGroup -InputObject <ISearchIdentity> [-IfMatch <String>]

...
### Delete (Default)
```
Remove-MgBetaSearchBookmark -BookmarkId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSearchBookmark -InputObject <ISearchIdentity> [-IfMatch <String>] [-CustomHeader <String>]

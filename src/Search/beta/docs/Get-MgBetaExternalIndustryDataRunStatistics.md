...
### Get1 (Default)
```
Get-MgBetaExternalIndustryDataRunStatistics [-CustomHeader <String>] [<CommonParameters>]
```

### Get
```
Get-MgBetaExternalIndustryDataRunStatistics -IndustryDataRunId <String> [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaExternalIndustryDataRunStatistics -InputObject <ISearchIdentity> [-CustomHeader <String>]
 [<CommonParameters>]
```

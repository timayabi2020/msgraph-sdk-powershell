...
Update-MgBetaExternalIndustryDataInboundFlow -InboundFlowId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Year <IMicrosoftGraphIndustryDataYearTimePeriodDefinition>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaExternalIndustryDataInboundFlow -InboundFlowId <String>
 -BodyParameter <IMicrosoftGraphIndustryDataInboundFlow> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

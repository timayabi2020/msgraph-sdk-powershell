...
### Delete (Default)
```
Remove-MgBetaSearchAcronym -AcronymId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSearchAcronym -InputObject <ISearchIdentity> [-IfMatch <String>] [-CustomHeader <String>]

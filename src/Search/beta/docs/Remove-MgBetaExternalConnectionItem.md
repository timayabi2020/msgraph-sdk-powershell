...
### Delete (Default)
```
Remove-MgBetaExternalConnectionItem -ExternalConnectionId <String> -ExternalItemId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaExternalConnectionItem -InputObject <ISearchIdentity> [-IfMatch <String>]

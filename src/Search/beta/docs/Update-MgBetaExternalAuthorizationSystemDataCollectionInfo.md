...
Update-MgBetaExternalAuthorizationSystemDataCollectionInfo -AuthorizationSystemId <String>
 [-AdditionalProperties <Hashtable>] [-Entitlements <Hashtable>] [-Id <String>] [-CustomHeader <String>]
...
```
Update-MgBetaExternalAuthorizationSystemDataCollectionInfo -AuthorizationSystemId <String>
 -BodyParameter <IMicrosoftGraphDataCollectionInfo> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

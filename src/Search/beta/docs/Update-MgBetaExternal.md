...
Update-MgBetaExternal [-AdditionalProperties <Hashtable>]
 ...
 [-IndustryData <IMicrosoftGraphIndustryDataRoot>] [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-MgBetaExternal -BodyParameter <IMicrosoftGraphExternalConnectorsExternal> [-CustomHeader <String>]

...
Update-MgBetaExternalAuthorizationSystem -AuthorizationSystemId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-DataCollectionInfo <IMicrosoftGraphDataCollectionInfo>] [-Id <String>] [-CustomHeader <String>] [-Confirm]
...
Update-MgBetaExternalAuthorizationSystem -AuthorizationSystemId <String>
 -BodyParameter <IMicrosoftGraphAuthorizationSystem> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Get (Default)
```
Get-MgBetaExternalIndustryDataInboundFlowDataConnector -InboundFlowId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaExternalIndustryDataInboundFlowDataConnector -InputObject <ISearchIdentity>

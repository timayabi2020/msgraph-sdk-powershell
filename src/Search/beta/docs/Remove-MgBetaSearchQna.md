...
### Delete (Default)
```
Remove-MgBetaSearchQna -QnaId <String> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSearchQna -InputObject <ISearchIdentity> [-IfMatch <String>] [-CustomHeader <String>] [-PassThru]

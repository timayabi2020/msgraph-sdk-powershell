...
Function Find-MgGraphCommand {
    ...
    param (
        [Parameter(ParameterSetName = "FindByUri", Mandatory = $true, Position = 0, ValueFromPipeline = $true, HelpMessage = "The URI of the Microsoft Graph PowerShell command to find.")]
        [string[]]$Uri,

        [Parameter(ParameterSetName = "FindByUri", HelpMessage = "The HTTP method of the Microsoft Graph PowerShell command to find.")]
        [ValidateSet("GET", "POST", "PUT", "PATCH", "DELETE")]
        [string]$Method,

        [Parameter(ParameterSetName = "FindByCommandOrUri", HelpMessage = "The API version of the Microsoft Graph PowerShell command to find.")]
        [Parameter(ParameterSetName = "FindByUri", HelpMessage = "The API version of the Microsoft Graph PowerShell command to find.")]
        [Parameter(ParameterSetName = "FindByCommand", HelpMessage = "The API version of the Microsoft Graph PowerShell command to find.")]
        [ValidateSet("v1.0", "beta")]
        [string]$ApiVersion,

        [Parameter(ParameterSetName = "FindByCommand", Mandatory = $true, HelpMessage = "The name of the Microsoft Graph PowerShell command to find.")]
        [ValidateNotNullorEmpty()]
        [string[]]$Command,

        [Parameter(ParameterSetName = 'FindByCommandOrUri', Mandatory = $true, Position = 0, ValueFromPipeline = $true, HelpMessage = "The name or URI of the Microsoft Graph PowerShell command to find.")]
        [object[]]$InputObject
    )

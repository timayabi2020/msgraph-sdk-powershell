...
New-MgBetaSchemaExtension [-AdditionalProperties <Hashtable>] [-Description <String>] [-Id <String>]
 ...
 [-TargetTypes <String[]>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgBetaSchemaExtension -BodyParameter <IMicrosoftGraphSchemaExtension> [-CustomHeader <String>] [-Confirm]

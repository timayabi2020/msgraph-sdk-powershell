...
### Set (Default)
```
Set-MgBetaGroupOnenoteResourceContent -GroupId <String> -OnenoteResourceId <String> -InFile <String>
 [-Data <Stream>] [-ContentType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaGroupOnenoteResourceContent -InputObject <INotesIdentity> -InFile <String> [-Data <Stream>]

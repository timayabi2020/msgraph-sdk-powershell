...
### Set (Default)
```
Set-MgBetaSiteOnenotePageContent -OnenotePageId <String> -SiteId <String> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaSiteOnenotePageContent -InputObject <INotesIdentity> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

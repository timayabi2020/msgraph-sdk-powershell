...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotesection
schema: 2.0.0
---
...
```
Update-MgBetaUserOnenoteSection -OnenoteSectionId <String> -UserId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserOnenoteSection -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenoteSection>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaUserOnenoteSection -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]

...
```
New-MgBetaGroupOnenoteNotebookSectionGroup -GroupId <String> -NotebookId <String>
...
### CreateViaIdentity
```
New-MgBetaGroupOnenoteNotebookSectionGroup -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaGroupOnenoteNotebookSectionGroup -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]

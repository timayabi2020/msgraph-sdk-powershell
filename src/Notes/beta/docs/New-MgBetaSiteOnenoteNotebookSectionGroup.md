...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotenotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgBetaSiteOnenoteNotebookSectionGroup -NotebookId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgBetaSiteOnenoteNotebookSectionGroup -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgBetaSiteOnenoteNotebookSectionGroup -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]

...
### Delete (Default)
```
Remove-MgBetaUserOnenoteNotebook -NotebookId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserOnenoteNotebook -InputObject <INotesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

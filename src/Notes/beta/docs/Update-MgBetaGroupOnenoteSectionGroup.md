...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetagrouponenotesectiongroup
schema: 2.0.0
---
...
```
Update-MgBetaGroupOnenoteSectionGroup -GroupId <String> -SectionGroupId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupOnenoteSectionGroup -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaGroupOnenoteSectionGroup -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]

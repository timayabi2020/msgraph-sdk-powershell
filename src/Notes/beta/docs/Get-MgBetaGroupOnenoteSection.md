...
### List (Default)
```
Get-MgBetaGroupOnenoteSection -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaGroupOnenoteSection -InputObject <INotesIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-CustomHeader <String>] [<CommonParameters>]
```

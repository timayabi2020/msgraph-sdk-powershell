...
### Delete (Default)
```
Remove-MgBetaGroupOnenotePage -GroupId <String> -OnenotePageId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupOnenotePage -InputObject <INotesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

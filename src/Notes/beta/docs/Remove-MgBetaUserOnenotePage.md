...
### Delete (Default)
```
Remove-MgBetaUserOnenotePage -OnenotePageId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserOnenotePage -InputObject <INotesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

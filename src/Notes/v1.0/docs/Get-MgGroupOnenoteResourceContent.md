...
### Get (Default)
```
Get-MgGroupOnenoteResourceContent -GroupId <String> -OnenoteResourceId <String> -OutFile <String>
 [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupOnenoteResourceContent -InputObject <INotesIdentity> -OutFile <String> [-CustomHeader <String>]

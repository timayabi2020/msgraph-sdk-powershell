...
### Get (Default)
```
Get-MgUserOnenoteSectionCount -UserId <String> [-Filter <String>] [-Search <String>] [-CustomHeader <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOnenoteSectionCount -InputObject <INotesIdentity> [-Filter <String>] [-Search <String>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mgsiteonenotesectiongroupsection
schema: 2.0.0
---
...
```
New-MgSiteOnenoteSectionGroupSection -SectionGroupId <String> -SiteId <String>
...
### CreateViaIdentity
```
New-MgSiteOnenoteSectionGroupSection -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgSiteOnenoteSectionGroupSection -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]

...
### Delete (Default)
```
Remove-MgUserOnenoteNotebook -NotebookId <String> -UserId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserOnenoteNotebook -InputObject <INotesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

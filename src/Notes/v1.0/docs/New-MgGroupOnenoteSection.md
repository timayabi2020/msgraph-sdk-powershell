...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotesection
schema: 2.0.0
---
...
### Create
```
New-MgGroupOnenoteSection -GroupId <String> -BodyParameter <IMicrosoftGraphOnenoteSection>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupOnenoteSection -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenoteSection>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Set (Default)
```
Set-MgSiteOnenotePageContent -OnenotePageId <String> -SiteId <String> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgSiteOnenotePageContent -InputObject <INotesIdentity> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

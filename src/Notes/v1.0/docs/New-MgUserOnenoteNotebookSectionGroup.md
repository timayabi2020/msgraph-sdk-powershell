...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mguseronenotenotebooksectiongroup
schema: 2.0.0
---
...
```
New-MgUserOnenoteNotebookSectionGroup -NotebookId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgUserOnenoteNotebookSectionGroup -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
New-MgUserOnenoteNotebookSectionGroup -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotesectiongroupsection
schema: 2.0.0
---
...
```
New-MgGroupOnenoteSectionGroupSection -GroupId <String> -SectionGroupId <String>
...
### CreateViaIdentity
```
New-MgGroupOnenoteSectionGroupSection -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

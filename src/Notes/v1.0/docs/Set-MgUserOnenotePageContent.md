...
### Set (Default)
```
Set-MgUserOnenotePageContent -OnenotePageId <String> -UserId <String> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgUserOnenotePageContent -InputObject <INotesIdentity> -InFile <String> [-Data <Stream>]
 [-ContentType <String>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

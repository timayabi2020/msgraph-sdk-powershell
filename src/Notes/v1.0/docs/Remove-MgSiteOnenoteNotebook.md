...
### Delete (Default)
```
Remove-MgSiteOnenoteNotebook -NotebookId <String> -SiteId <String> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSiteOnenoteNotebook -InputObject <INotesIdentity> [-IfMatch <String>] [-CustomHeader <String>]

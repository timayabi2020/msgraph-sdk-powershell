...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/remove-mgbetafinancialcompanycustomerpaymentmethod
schema: 2.0.0
---
...
### Delete1
```
Remove-MgBetaFinancialCompanyCustomerPaymentMethod -CompanyId <String> -CustomerId <String>
 [-IfMatch <String>] [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

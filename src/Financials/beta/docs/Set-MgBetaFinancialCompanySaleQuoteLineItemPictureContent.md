...
Set-MgBetaFinancialCompanySaleQuoteLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesQuoteLineId <String> -InFile <String> [-Data <Stream>] [-ContentType <String>] [-CustomHeader <String>]
...
```
Set-MgBetaFinancialCompanySaleQuoteLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesQuoteId <String> -SalesQuoteLineId <String> -InFile <String> [-Data <Stream>] [-ContentType <String>]

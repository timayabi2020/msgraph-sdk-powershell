...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanypurchaseinvoicevendorcurrency
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanyPurchaseInvoiceVendorCurrency -CompanyId <String> -PurchaseInvoiceId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanyPurchaseInvoiceVendorCurrency -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphCurrency> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

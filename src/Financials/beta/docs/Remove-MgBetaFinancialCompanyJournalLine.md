...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/remove-mgbetafinancialcompanyjournalline
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaFinancialCompanyJournalLine -InputObject <IFinancialsIdentity> [-IfMatch <String>]
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanysalecreditmemopaymentterm
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanySaleCreditMemoPaymentTerm -CompanyId <String> -SalesCreditMemoId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanySaleCreditMemoPaymentTerm -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphPaymentTerm> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

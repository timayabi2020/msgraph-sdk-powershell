...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanyvendorcurrency
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanyVendorCurrency -CompanyId <String> -VendorId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanyVendorCurrency -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphCurrency> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

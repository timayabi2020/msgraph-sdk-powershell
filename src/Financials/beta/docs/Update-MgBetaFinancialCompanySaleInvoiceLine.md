...
```
Update-MgBetaFinancialCompanySaleInvoiceLine -CompanyId <String> -SalesInvoiceLineId <String>
 -BodyParameter <IMicrosoftGraphSalesInvoiceLine> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaFinancialCompanySaleInvoiceLine -CompanyId <String> -SalesInvoiceId <String>
 -SalesInvoiceLineId <String> -BodyParameter <IMicrosoftGraphSalesInvoiceLine> [-CustomHeader <String>]

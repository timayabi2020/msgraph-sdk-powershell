...
### Post (Default)
```
Invoke-MgBetaFinancialCompanyPurchaseInvoice -CompanyId <String> -PurchaseInvoiceId <String>
 [-CustomHeader <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-MgBetaFinancialCompanyPurchaseInvoice -InputObject <IFinancialsIdentity> [-CustomHeader <String>]

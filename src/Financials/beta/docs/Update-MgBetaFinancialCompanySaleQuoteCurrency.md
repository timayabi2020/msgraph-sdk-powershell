...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanysalequotecurrency
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanySaleQuoteCurrency -CompanyId <String> -SalesQuoteId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanySaleQuoteCurrency -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphCurrency> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanypurchaseinvoiceline
schema: 2.0.0
---
...
Update-MgBetaFinancialCompanyPurchaseInvoiceLine -CompanyId <String> -PurchaseInvoiceLineId <String>
 ...
 [-TaxCode <String>] [-TaxPercent <Decimal>] [-TotalTaxAmount <Decimal>] [-UnitCost <Decimal>]
...
```
Update-MgBetaFinancialCompanyPurchaseInvoiceLine -CompanyId <String> -PurchaseInvoiceLineId <String>
 -BodyParameter <IMicrosoftGraphPurchaseInvoiceLine> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgBetaFinancialCompanyPurchaseInvoiceLine -CompanyId <String> -PurchaseInvoiceId <String>
 -PurchaseInvoiceLineId <String> -BodyParameter <IMicrosoftGraphPurchaseInvoiceLine> [-CustomHeader <String>]
...
Update-MgBetaFinancialCompanyPurchaseInvoiceLine -CompanyId <String> -PurchaseInvoiceId <String>
 ...
 [-UnitCost <Decimal>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

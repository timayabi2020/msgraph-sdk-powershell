...
Update-MgBetaFinancialCompanyJournal -CompanyId <String> -JournalId <String>
 ...
 [-JournalLines <IMicrosoftGraphJournalLine[]>] [-LastModifiedDateTime <DateTime>] [-CustomHeader <String>]
...
```
Update-MgBetaFinancialCompanyJournal -CompanyId <String> -JournalId <String>
 -BodyParameter <IMicrosoftGraphJournal> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

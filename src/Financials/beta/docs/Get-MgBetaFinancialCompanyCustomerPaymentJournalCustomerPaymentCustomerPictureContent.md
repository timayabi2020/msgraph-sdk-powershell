...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/get-mgbetafinancialcompanycustomerpaymentjournalcustomerpaymentcustomerpicturecontent
schema: 2.0.0
---
...
```
Get-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentCustomerPictureContent
 -InputObject <IFinancialsIdentity> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

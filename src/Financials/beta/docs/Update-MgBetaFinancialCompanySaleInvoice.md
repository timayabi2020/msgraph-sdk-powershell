...
Update-MgBetaFinancialCompanySaleInvoice -CompanyId <String> -SalesInvoiceId <String>
 ...
 [-TotalAmountIncludingTax <Decimal>] [-TotalTaxAmount <Decimal>] [-CustomHeader <String>] [-Confirm]
...
```
Update-MgBetaFinancialCompanySaleInvoice -CompanyId <String> -SalesInvoiceId <String>
 -BodyParameter <IMicrosoftGraphSalesInvoice> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

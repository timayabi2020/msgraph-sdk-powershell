...
New-MgBetaFinancialCompanyJournalLine -CompanyId <String> -JournalId <String>
 -BodyParameter <IMicrosoftGraphJournalLine> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-MgBetaFinancialCompanyJournalLine -CompanyId <String> -JournalId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-LineNumber <Int32>] [-PostingDate <DateTime>] [-CustomHeader <String>]

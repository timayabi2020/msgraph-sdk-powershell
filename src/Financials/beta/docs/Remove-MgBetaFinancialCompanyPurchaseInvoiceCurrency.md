...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/remove-mgbetafinancialcompanypurchaseinvoicecurrency
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaFinancialCompanyPurchaseInvoiceCurrency -InputObject <IFinancialsIdentity> [-IfMatch <String>]

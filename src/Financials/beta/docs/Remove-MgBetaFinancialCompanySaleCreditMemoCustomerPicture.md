...
### Delete (Default)
```
Remove-MgBetaFinancialCompanySaleCreditMemoCustomerPicture -CompanyId <String> -PictureId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaFinancialCompanySaleCreditMemoCustomerPicture -InputObject <IFinancialsIdentity>

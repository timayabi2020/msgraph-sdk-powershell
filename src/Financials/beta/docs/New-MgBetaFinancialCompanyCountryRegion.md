...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/new-mgbetafinancialcompanycountryregion
schema: 2.0.0
---
...
New-MgBetaFinancialCompanyCountryRegion -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphCountryRegion> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
`BODYPARAMETER <IMicrosoftGraphCountryRegion>`: countryRegion

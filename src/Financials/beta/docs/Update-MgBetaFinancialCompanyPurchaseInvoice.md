...
Update-MgBetaFinancialCompanyPurchaseInvoice -CompanyId <String> -PurchaseInvoiceId <String>
 ...
 [-VendorInvoiceNumber <String>] [-VendorName <String>] [-VendorNumber <String>] [-CustomHeader <String>]
...
```
Update-MgBetaFinancialCompanyPurchaseInvoice -CompanyId <String> -PurchaseInvoiceId <String>
 -BodyParameter <IMicrosoftGraphPurchaseInvoice> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

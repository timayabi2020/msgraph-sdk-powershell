...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanysaleinvoicecustomercurrency
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanySaleInvoiceCustomerCurrency -CompanyId <String> -SalesInvoiceId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanySaleInvoiceCustomerCurrency -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphCurrency> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

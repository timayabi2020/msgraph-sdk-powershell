...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/new-mgbetafinancialcompanytaxgroup
schema: 2.0.0
---
...
### Create
```
New-MgBetaFinancialCompanyTaxGroup -CompanyId <String> -BodyParameter <IMicrosoftGraphTaxGroup>
 [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

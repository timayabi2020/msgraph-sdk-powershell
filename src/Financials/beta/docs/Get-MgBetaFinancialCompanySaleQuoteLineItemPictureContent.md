...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/get-mgbetafinancialcompanysalequotelineitempicturecontent
schema: 2.0.0
---
...
Get-MgBetaFinancialCompanySaleQuoteLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesQuoteLineId <String> -OutFile <String> [-CustomHeader <String>] [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaFinancialCompanySaleQuoteLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesQuoteId <String> -SalesQuoteLineId <String> -OutFile <String> [-CustomHeader <String>] [-PassThru]
 [<CommonParameters>]
```

...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanysaleordercustomercurrency
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanySaleOrderCustomerCurrency -CompanyId <String> -SalesOrderId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanySaleOrderCustomerCurrency -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphCurrency> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

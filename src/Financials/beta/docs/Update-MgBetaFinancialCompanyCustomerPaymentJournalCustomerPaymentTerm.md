...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanycustomerpaymentjournalcustomerpaymentterm
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentTerm -CompanyId <String>
...
### UpdateViaIdentity
```
Update-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentTerm -InputObject <IFinancialsIdentity>
...
Update-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentTerm -InputObject <IFinancialsIdentity>
 ...
 [-DueDateCalculation <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>] [-CustomHeader <String>]

...
Update-MgBetaFinancialCompanySaleOrder -CompanyId <String> -SalesOrderId <String>
 ...
 [-TotalTaxAmount <Decimal>] [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgBetaFinancialCompanySaleOrder -CompanyId <String> -SalesOrderId <String>
 -BodyParameter <IMicrosoftGraphSalesOrder> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

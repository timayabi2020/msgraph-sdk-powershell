...
Update-MgBetaFinancialCompanyInformation -CompanyId <String> -CompanyInformationId <String>
 ...
 [-PictureInputFile <String>] [-TaxRegistrationNumber <String>] [-Website <String>] [-CustomHeader <String>]
...
```
Update-MgBetaFinancialCompanyInformation -CompanyId <String> -CompanyInformationId <String>
 -BodyParameter <IMicrosoftGraphCompanyInformation> [-CustomHeader <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

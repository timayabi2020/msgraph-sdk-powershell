...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/new-mgbetafinancialcompanysaleinvoicelineitempicture
schema: 2.0.0
---
...
```
New-MgBetaFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -SalesInvoiceLineId <String>
...
### Create1
```
New-MgBetaFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -SalesInvoiceId <String>
 -SalesInvoiceLineId <String> -BodyParameter <IMicrosoftGraphPicture> [-CustomHeader <String>] [-Confirm]
...
### CreateViaIdentity
```
New-MgBetaFinancialCompanySaleInvoiceLineItemPicture -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphPicture> [-CustomHeader <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
